import{m as k}from"./mainView.class-C4NLGCWW.js";import{u as B,g as h,t as r,L as g}from"./index-Vufosqdv.js";import{N as S}from"./navbar.component-C2I7DYmt.js";import{l as v,Z as f,C as x,P as T,t as L,H as E,m as _,e as P}from"./mftsccs-browser-fkDlgrMi.js";import"./codemirror-D1H9tReK.js";import"./vendor-DEYWGvhS.js";import"./ckeditor-Cw9bcqxY.js";import"./eslint4b-BLWGvIOa.js";import"./prettier-ClL2wQep.js";import"./loginModal.service-D9xKDpD7.js";class G extends k{constructor(a){super(a),this.setTitle("Settings")}async getHtml(){const a=await B(),i=await new S(a).getHtml(),n=await h(),c=n?.email?.slice(0,1)?.toUpperCase()||"?";return`
      ${i}
      <div class="sp-page">
