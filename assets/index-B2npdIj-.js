...
import{p as Z,v as Yn,G as Kn,U as ei,K as M,g as kn,E as pe,a as j,V as Xt,l as Zn,_ as xe,b as St,H as oe,F as z,R as we,N as Eo,c as Wa,d as ti,O as ze,S as To,e as D,x as Ia,f as Y,h as se,M as Ae,J as So,i as Ct,t as ni,j as Pe,o as Co,k as ue,m as Ce,n as Lo,q as Be,r as je,s as J,D as Mn,Y as ai,u as xo,I as Nt,w as ii,y as wt,z as oi,A as Ao,Q as Xn,B as Wo}from"./mftsccs-browser-D_uubYVV.js";import{E as te,b as at,o as it,j as en,a as tn,c as Io,l as ea,d as ta,e as ko,f as Le,k as nn,h as Mo,g as Po}from"./codemirror-D1H9tReK.js";import{J as an,n as $o}from"./vendor-DEYWGvhS.js";import{z as Bo}from"./eslint4b-BLWGvIOa.js";import{l as ot,p as on,r as sn,a as No,b as jo}from"./prettier-ClL2wQep.js";import{C as Do}from"./ckeditor-Cw9bcqxY.js";const Ho=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return so},get addJSLibrary(){return ro},get applyPageProperties(){return Qn},get applyPageProperty(){return Ee},get filterChildrenByWrapper(){return no},get getAttributeType(){return gc},get getAttributeValue(){return co},get getElementAttribute(){return ic},get getElementAttributeDetails(){return Ta},get getElementData(){return eo},get getLayoutAttributeValue(){return uo},get getPropertiesByIdFromStorage(){return It},get handleDirectContentEdit(){return oc},get handlePageProperties(){return ao},get initializeApp(){return vn},get initializeLibrary(){return Sa},get listJSLibraries(){return kt},get removeCSSLibrariesFromHead(){return Yt},get removeJSLibrariesFromHead(){return Ca},get setAttributeValue(){return hc},get toggleSpacingBox(){return La},get updateAttribute(){return rc},get updateCSSLibrary(){return Qe},get updateElementAttribute(){return yn},get updateElementAttributeViaEditor(){return sc},get updateJSLibrary(){return Ye},get updateMetaTag(){return Tt},get updateMultipleElementAttribute(){return io},get updateWidgetTypeValue(){return to}},Symbol.toStringTag,{value:"Module"}));(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const U={baseURL:"https://boomconsole.com/api/v1",baseNodeUrl:"https://boomconsole.com",boomURL:"https://boomconsole.com",aiURL:"https://www.ai.freeschema.com/api",deployURL:"https://deploy.freeschema.com",agentURL:"https://wico-ai.freeschema.com",CLIENT_ID:"636550695311-ctc09991hhu6iav4kkhnp1ge537nec2i.apps.googleusercontent.com",logserver:"https://logger.freeschema.com",enableSW:!1,courses_widget:103581935,course_widget:103503610,discussion_community:101765915,ai_widget:101934087,visual_widget:103478558,visual_prototype_widget:101938499,video_tutorial_widget:102040172,subscriptionId:102121109,documentation_preview_widget:102097744,folder_widget:102400016,assets_widget:102410590,VITE_DEV_BASE:"http://localhost:5173",VITE_CDN_BASE:"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master"},Oo=U?.boomURL;async function q(n,e,t){const a=await Z(`the_${n}`,"",!0,e,4,999);for(const[i,o]of Object.entries(t)){let s=i;const r=await Z(`${s}`,`${o}`,!1,e,4,999);await H(a,r,s)}return a}async function H(n,e,t){const a=n.userId,i=999,o=999,s=n.type?.characterValue,r=t,l=s+"_"+r,u=await Yn(l,i,o,a);await Kn(n.id,e.id,u.id,1e3)}async function qo(n,e){try{const t=new Headers;return t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),await(await fetch(`${Oo}/api/get-entity-from-user?userConceptId=${n}`,{method:"GET",headers:t,redirect:"follow"})).json()}catch(t){throw console.error(t),t}}async function Yc(n){const e=await qo(n?.data?.userConcept,n?.data?.token);let t={token:n?.data?.token,refreshToken:n?.data?.refreshtoken,email:n?.data?.email,userId:n?.data?.entity?.[0]?.userId,userConcept:n?.data?.userConcept,entityId:e?.entity,amcode:btoa(JSON.stringify(n?.data?.roles))};return ei(t.token),localStorage.setItem("profile",JSON.stringify(t)),!0}async function k(){return new Promise(n=>{let e=localStorage?.getItem("profile")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}async function si(){return new Promise(n=>{let e=localStorage?.getItem("tempwidget")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}class Te{static instance;static getInstance(){return Te.instance||(Te.instance=new Te),Te.instance}async getLoginInfo(){const e=await k(),t=await this.checkIfUserIsAdmin(e?.userConcept);let a="",i=!1,o=!1;if(e?.token){i=!0;let s="",r="";if(e?.entityId){let l=new M;l.typeConnection="the_entity_firstname",l.name="entity_firstname";let u=new M;u.typeConnection="the_entity_lastname",u.name="entity_lastname";let c=new M;c.typeConnection="the_entity_tour_status",c.name="entity_tour_status";let d=new M;d.type="the_entity",d.name="top",d.conceptIds=[e.entityId],d.freeschemaQueries=[l,u,c],d.outputFormat=kn;let g;await pe(d,"").subscribe(m=>{g=m}),s=g?.[0]?.the_entity?.the_entity_firstname?.the_firstname||"",r=g?.[0]?.the_entity?.the_entity_lastname?.the_lastname||"",o=g?.[0]?.the_entity?.the_entity_tour_status?.the_tour_status==="true"}a=`
  ...
  `,e?.appendChild(t)}function aa(){const n=document.querySelector(".content-target");n.innerHTML="",n.textContent="Widget Loading..."}function ia(){return document.querySelectorAll(".content-target")[0]}function ja(n){const e={past:[],present:n,future:[]};return{getState(){return{current:e.present,canUndo:e.past.length>0,canRedo:e.future.length>0}},push(t){e.past.push(e.present),e.present=t,e.future=[]},undo(){if(e.past.length===0)return;const t=e.past[e.past.length-1];return e.past=e.past.slice(0,-1),e.future=[e.present,...e.future],e.present=t,t},redo(){if(e.future.length===0)return;const t=e.future[0];return e.future=e.future.slice(1),e.past=[...e.past,e.present],e.present=t,t}}}class N{static actionHistories;static renderActionButtons(){const e=document.getElementById("undo-btn"),t=document.getElementById("redo-btn");e?.addEventListener("click",N.undoAction),t?.addEventListener("click",N.redoAction)}static renderActionHistory(){N.actionHistories=ja(JSON.stringify(f?.staticWidgetTree)),ja(JSON.stringify(f?.staticWidgetTree))}static updateButtonStates(){const{canUndo:e,canRedo:t}=N.actionHistories.getState(),a=document.getElementById("undo-btn"),i=document.getElementById("redo-btn");a&&(a.disabled=!e),i&&(i.disabled=!t)}static async undoAction(){const e=N.actionHistories.undo();e!==void 0&&(Ra(e||""),N.updateButtonStates())}static async redoAction(){const e=N.actionHistories.redo();e!==void 0&&(Ra(e||""),N.updateButtonStates())}static updateActionHistories(){N.actionHistories.push(JSON.stringify(f.staticWidgetTree)),N.updateButtonStates()}}async function Ss(){const n=document.getElementById("widget-prompt-modal");n&&n.remove()}async function Cs(){document.getElementById("widget-prompt-modal").classList.add("d-none");const e=document.getElementById("widget-prompt-tab");e.classList.remove("d-none"),e.classList.add("d-flex")}async function Ls(){document.getElementById("widget-prompt-tab").classList.add("d-none");const e=document.getElementById("widget-prompt-modal");e.classList.remove("d-none"),e.classList.add("d-flex")}function xs(){const n=document.getElementById("prompt-text");n.addEventListener("input",()=>{n.style.height="auto";const e=Math.min(n.scrollHeight-8,120);n.style.height=`${e}px`,n.style.overflowY=e===120?"auto":"hidden"})}class _i{widgetPromptHTML;assistantChatId;randomSuggestionEl;constructor(e){this.assistantChatId=e,this.randomSuggestionEl="",this.init()}init(){if(!this.assistantChatId){const t=["Newsletter signup form with email validation","Create a header section for portfolio website","Quick contact form with name, email, and message fields","Create a customer satisfaction survey form","Countdown timer for upcoming events or launches","Currency converter widget with real-time exchange rates","Task list widget with checkboxes and progress tracking"],i=((o,s=3)=>{if(o.length<s)return[];const r=new Set;for(;r.size<s;){const l=Math.floor(Math.random()*o.length);r.add(l)}return[...r]})(t,2);this.randomSuggestionEl=i?.map(o=>`<div class="suggestion-prompt">
    ...
    `,l?.appendChild(d);const g=document.createElement("div");g.classList.add("sub-tab-content","custom-editor-content"),g.id=`${a}-editor-split`,g.setAttribute("data-subtab",a),r?.appendChild(g);const m=`${a}-editor-split`;ks(m)}document.getElementById("codeBlocksContainer").querySelectorAll(".sub-tab-btn").forEach(d=>{d.addEventListener("click",function(){const g=d.getAttribute("data-subtab"),m=d.closest(".tab-content");m?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(p=>{p.classList.remove("active")}),d.classList.add("active"),m?.querySelector(`.sub-tab-content[data-subtab="${g}"]`)?.classList.add("active")})}),setTimeout(async()=>{const d=document.querySelector(`#${a}-editor-split .cm-editor .cm-scroller .cm-content.cm-lineWrapping`);if(d&&(d.textContent="/* Write your code here */",t))try{const g=await ot.format(t,{parser:"babel",plugins:[on,sn],tabWidth:2,semi:!0,singleQuote:!0,bracketSpacing:!0,printWidth:80});d.textContent=g}catch(g){console.error("JS formatting error:",g),d.textContent=t}},500)}async function ks(n){await new ae(n).initializeEditor()}async function Ms(n,e,t){const a=e.trim().toLocaleLowerCase().split(" ").join("-"),i=f.staticWidgetTree?.custom_functions?.filter(c=>c.slug===n);i[0].name=e,i[0].slug=a;const o=document.querySelector(`button[data-subtab=${n}]`);o?.setAttribute("data-subtab",a),o.innerHTML=`
...
${t?.css}`:t?.css;if(await vi(o,s),de(n?.html),await wi(n?.after_render),await bi(n?.before_render),n?.custom_functions?.length){const r=document.querySelectorAll(".custom-service-btn"),l=Array.from(r)?.map(d=>d.getAttribute("data-subtab")??""),u=n.custom_functions?.map(d=>d.slug);(l?.filter(d=>!u.includes(d))).forEach(d=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${d}"]`);g&&g.remove(),document.getElementById(`${d}-editor-split`)?.remove()}),Da(),n.custom_functions?.forEach(d=>{Si(d)})}else document.querySelectorAll(".custom-service-btn").forEach(u=>{u.remove()}),document.querySelectorAll(".custom-editor-content").forEach(u=>{u.remove()}),Da();(a||i)&&rn(n?.origin?n?.origin:n?.widgetId),a&&n?.assistant?.id&&Rs(n?.assistant)}const Fn="drop-indicator";function xi(){let n=document.querySelector(`.${Fn}`);return n||(n=document.createElement("div"),n.className=Fn,document.body.appendChild(n)),n}function zs(n,e){const t=xi(),a=n.getBoundingClientRect();e==="top"?t.style.top=`${a.top-5}px`:e==="bottom"&&(t.style.top=`${a.bottom-5}px`),t.style.left=`${a.left}px`,t.style.width=`${a.width}px`,t.style.opacity="1",t.style.transform="scaleY(1)"}function Ai(){document.querySelectorAll(`.${Fn}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function Js(n,e,t){if(e.length===0)return{element:t,position:"top"};const a=n.clientY;let i=e[0],o=Math.abs(i.getBoundingClientRect().top-a);Math.abs(i.getBoundingClientRect().bottom-a);for(const u of e){const c=u.getBoundingClientRect(),d=Math.abs(c.top-a);Math.abs(c.bottom-a),d<o&&(i=u,o=d)}const s=i.getBoundingClientRect(),r=s.top+s.height/2,l=a<r?"top":"bottom";return{element:i,position:l}}async function De(n){const e=document.querySelectorAll("link.vde-css");e?.length&&e?.forEach(a=>{a.remove()});const t=document.querySelectorAll("script.vde-js");if(t?.length&&t?.forEach(a=>{a.remove()}),await vn(n),n?.children?.length)for(const a of n?.children){const i=a?.library;i?.css?.length&&i?.css?.forEach(o=>{const s=o?.url,r=document.createElement("link");r.classList.add("vde-css"),r.setAttribute("rel","stylesheet"),r.setAttribute("href",s),document.head.appendChild(r)}),i?.js.length&&i?.js?.forEach(async o=>{await new Promise((s,r)=>{const l=o?.url,u=document.createElement("script");u.classList.add("vde-js"),u.setAttribute("type","text/javascript"),u.setAttribute("src",l),u.setAttribute("crossorigin","anonymous"),u.onload=()=>{s()},u.onerror=c=>{console.error("Failed to load script:",l,c),r(new Error(`Failed to load script: ${l}`))},document.body.appendChild(u)})})}}let G=null,ne;function cn(){const n=document.querySelector(".content-target > .mftsccs-marking-element");if(n){const e=document.querySelector(".content-target");Se.fixContentTargetHeight(e,n)}}function Gs(n){G=n.target;const e=n.target;let t={data_type:n.target.getAttribute("data-type"),data_default:n.target.getAttribute("data-default"),data_void:n.target.getAttribute("data-void"),data_text:n.target.getAttribute("data-text"),elementId:n.target.getAttribute("data-elementId"),dataId:n.target.id,imageUrl:e.imageUrl,displayType:e.displayType};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.setData("id",n.target.id),n.dataTransfer.effectAllowed="move"}async function Qs(n){n.stopPropagation();const e=n.target,t={widgetcodeId:n.target.getAttribute("data-widgetId"),sourceElementId:n.target.id,className:n.target.className,imageUrl:e.imageUrl,displayType:e.displayType,type:e.Type};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.effectAllowed="move"}function Ys(n){n.preventDefault(),n.stopPropagation(),n.target.classList.add("dragging-area"),At.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",hs()}function Ks(n){n.preventDefault(),n.stopPropagation(),n.target.classList.remove("dragging-area")}function Zs(n){n.preventDefault(),n.stopPropagation(),(!G||!(n.currentTarget instanceof HTMLElement))&&(G=n?.target);const e=n.target,t=Array.from(e.children).filter(i=>i!==G);xi();const a=Js(n,t,e);ne=a,zs(a.element,a.position)}function Xs(){$.checkContent()?$.enableWidgetButtons():$.disableWidgetButtons()}async function er(n){const e=await dn(n);G=null,Ai(),N.updateActionHistories(),At.collapseNavbar(),Xs(),cn(),ge(),e&&(de(),rn(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),ye()}function Ft(n,e){return Array.isArray(n?.children)&&(n.children=n?.children.filter(t=>t?.wrapper!==e),n.children.forEach(t=>Ft(t,e))),n}function Ge(n,e){let t;return Array.isArray(n?.children)&&(t=n?.children.filter(a=>a?.wrapper===e),n.children.forEach(a=>Ge(a,e))),t?.[0]}async function tr(n){n.preventDefault(),n.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(d=>{const g=document.getElementById(`${d}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};Et(m,`${d}-content`)}});const t=document.getElementById("element-attributes");if(t&&t.style.display==="block"){const d={target:document.querySelector("#icon-attribute")};Et(d,"element-attributes")}const a=F.staticElement,i=a?.parentElement,o=i?.parentElement,s=o?.dataset?.widgetid,r=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container"),l=a.querySelectorAll(".added-widget-container");if(a?.classList?.contains("added-widget-container")){const d=a?.id;Ft(f?.staticWidgetTree,d)}else l.length&&l.forEach(d=>{const g=d?.id;Ft(f?.staticWidgetTree,g)});if(r){const d=r.id;if(a?.remove(),F.staticElement.remove(),Dt(),a?.classList?.contains("added-widget-container")){const g=Ge(f?.staticWidgetTree,d);if(g){const m=r.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,ee(g)}}else{const m=document.getElementById(d).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,ee(f.selectedStaticWidgetTreeInfo.widgetTree)}ge(),N.updateActionHistories();return}i?.classList.contains("mftsccs-marking-element")&&i.children.length===1&&i?.remove(),s&&(o?.children?.length||o?.remove()),a?.remove(),F.staticElement.remove(),Dt();const u=await tt();return f.staticWidgetTree.html=u,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},ec(),ee(f?.staticWidgetTree),ge(),N.updateActionHistories(),$.checkContent()||($.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}function nr(n){return"drag"}function ar(n){return n.dataTransfer.setData("text",n.target.id),"start drag"}function ir(n){console.log("dragEndWidgetElement event ->",n)}function or(n){return n.preventDefault(),n.stopPropagation(),"dragOverWidgetElement"}async function sr(n){await dn(n),de()}let Vt=null;async function Wi(n,e){if(!n)return console.error("dropFolderElement called without event"),!1;(c=>"dataTransfer"in c&&c.dataTransfer!==null)(n)&&(n.preventDefault(),n.stopPropagation());const a=n.target instanceof HTMLElement?n.target:null;if(!G)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let o=n.target;if(!o.classList.contains("mftsccs-marking-element")&&!o.classList.contains("fslayout-col")&&o.id!=="builder-workarea"){const c=document.getElementById("builder-workarea"),d=o.closest(".mftsccs-marking-element"),g=o.closest(".fslayout-col");o=d||g||c}if((G.contains(o)||G===o)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),o=document.getElementById("builder-workarea")),!o)return console.error("Invalid dropzone"),!1;o?.classList.remove("dragging-area");let s=jn(n,e);if(!s.status)return alert(s.message),G=null,!1;const r=e.dataType||e.type||e.data_type,l=r==="photo"||r==="Image"||r==="img",u=r==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(l){let c,d=!1;if(G&&G.tagName&&G.tagName.toLowerCase()==="img"){if(d=!0,c=G,c.parentElement===o&&console.log("Image is already in this dropzone, just repositioning"),!(c instanceof Node))return console.error("draggedItem is not a valid DOM node:",c),G=null,!1;(!c.hasAttribute("style")||!c.style.width)&&c.setAttribute("style","width: 200px;")}else{const w=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(o.querySelectorAll(`img[src="${w}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),G=null,!1;c=document.createElement("img"),c.setAttribute("src",w),c.setAttribute("style","width: 200px;")}let g=Se.generateUUID();c.setAttribute("element-info-id",g);const m=o.classList.contains("file-item")&&o.classList.contains("photo-file")&&o.classList.contains("dragging");let p=c;if(m){const w=document.createElement("div");w.appendChild(c),p=w}try{if(d){const w=m&&c.parentElement?.parentElement||c.parentElement,b=m?c.parentElement:c;w&&w!==o&&b&&w.removeChild(b)}ne?.position==="top"&&o?.children?.length&&ne?.element?o.contains(ne.element)&&!p.contains(ne.element)&&p!==ne.element?o.insertBefore(p,ne.element):(console.warn("Invalid indicator element for top position, appending to dropzone"),o.appendChild(p)):ne?.position==="bottom"&&ne?.element?o.contains(ne.element)&&!p.contains(ne.element)&&p!==ne.element?ne.element.insertAdjacentElement("afterend",p):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),o.appendChild(p)):o.appendChild(p)}catch(w){console.error("Error positioning element:",w instanceof Error?w.message:w);try{o.appendChild(p)}catch(b){return console.error("Cannot append element:",b),G=null,!1}}c.removeAttribute("element-info-id");const h=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(h){const w=h.id,b=Ge(f?.staticWidgetTree,w);if(b){const C=h.querySelector(".mftsccs-marking-element");C&&(b.html=C.innerHTML,await ee(b))}return G=null,!1}return rr(),G=null,!0}else if(u){if(!s.status)return alert(s.message),G=null,!1;if(e.sourceElementId){const S=e.sourceElementId||e.fileId;console.log("sourceElement ->",S)}let c=e.widget_id;if(!c)return console.error("Widget ID is missing from data"),G=null,!1;o.classList.remove("dragging-area");const d=document.createElement("div");d.classList.add("wb-initial-empty"),d.style.display="block",d.style.marginBottom="10px",d.setAttribute("data-widget-id",c.toString());const g=Se.generateUUID();d.id=`widget-${g}`;const m=await k();let p=o.classList.contains("publicWidgetRouter"),h=await ue(Number(c));const w=n.clientY,b=o.getBoundingClientRect(),C=bt(b,w);let T;if(!p){const S=await ke(Number(c),m.token);h=await ue(S?S.widgetId:Number(c)),h?.children?.length&&await un(h),T=$t(o,S?S.widgetId:c,!1,s.elementBelowDrag,C,n)}const v=$.clearDraggedWidget(h),y=await Ce(v,T);v.wrapper=T?.id,Ai();const E=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(E){const S=E.id,x=Ge(f?.staticWidgetTree,S);x&&x.children.push(v);const P=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=P?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=P?.style.cssText,await ee(f.selectedStaticWidgetTreeInfo.widgetTree),G=null,!1}const L=await _t();f.staticWidgetTree.html=L,f.staticWidgetTree?.children?.push(v);const _=f.widgetTree.children.indexOf(v);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},await De(v),await ee(v,!1,y),$.enableWidgetButtons(),G=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),G=null,!1}function rr(){document.querySelectorAll(".mftsccs-marking-element img").forEach(n=>{n.setAttribute("draggable","true"),n.addEventListener("dragstart",e=>{e.stopPropagation(),Vt=Date.now()}),n.addEventListener("dragend",e=>{e.stopPropagation(),setTimeout(()=>{Vt=null},100)})})}function lr(){Vt=null,G=null,console.log("dragStartTime",Vt)}async function dn(n,e=!1,t,a){if(!n&&e&&t&&a){const l=await ue(Number(t)),u=$t(a,t,!1,null,"below",n),c=$.clearDraggedWidget(l);let d=await Ce(c,u);c.wrapper=u?.id;const g=await tt();f.staticWidgetTree.html=g,f.staticWidgetTree?.children?.push(c);const m=f.widgetTree.children.indexOf(c);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[m],isChildWidget:!0,childWidgetIndex:m},await De(c),ee(c,!1,d),$.enableWidgetButtons();return}if(!n){console.error("dropElement called without event");return}n.preventDefault(),n.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let o=n.dataTransfer.getData("text");if((l=>{try{return JSON.parse(l),!0}catch{return!1}})(o))if(Object.keys(JSON.parse(o)).includes("widgetcodeId")){const l=JSON.parse(o);let u=jn(n,l);const c=l.className.split(" ");if(!u.status){alert(u.message);return}const d=JSON.parse(o);if(d.sourceElementId){const x=document.getElementById(d.sourceElementId.toString());if(x){n.target.insertBefore(x,u.elementBelowDrag??null);return}}let g=ys(d),m=u?.dropzoneEl;m.classList.remove("dragging-area");const p=await k();let h=!1;c.includes("publicWidgetRouter")&&(h=!0);let w=null,b=null;const C=n.clientY,T=m.getBoundingClientRect(),v=bt(T,C);if(h){w=await ue(Number(g)),b=$t(m,g,!1,u.elementBelowDrag,v,n);const x=document.getElementById("widgetNameValue");x&&w?.name&&(x.value=w?.name);const W=document.getElementById("widget-builder");W&&w?.name&&(W.textContent="Widget Builder Panel: "+w?.name)}else{const x=await ke(g,p.token);w=await ue(x?x.widgetId:Number(g));const W=document.getElementById("widgetNameValue");W&&w?.name&&(W.value=w?.name);const P=document.getElementById("widget-builder");P&&w?.name&&(P.textContent="Widget Builder Panel: "+w?.name),w?.children?.length&&await un(w),b=$t(m,x?x.widgetId:g,!1,u.elementBelowDrag,v,n)}const y=$.clearDraggedWidget(w);let E=await Ce(y,b);y.wrapper=b?.id;const L=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(L){const x=L.id,W=Ge(f?.staticWidgetTree,x);W&&W.children.push(y);const B=document.getElementById(x).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=B?.innerHTML,await De(f.selectedStaticWidgetTreeInfo.widgetTree),ee(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const _=await tt();f.staticWidgetTree.html=_,f.staticWidgetTree?.children?.push(y);const S=f.widgetTree.children.indexOf(y);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[S],isChildWidget:!0,childWidgetIndex:S},await De(y),ee(y,!1,E),$.enableWidgetButtons()}else{let l=function(w,b){document.getElementById("builder-workarea")===w&&(b="inside");let T=Se.generateUUID();const v=Zl(T,u),y=document.createElement("div");y.innerHTML=v;const E=y.firstChild,L=w.parentElement;if(b==="above")L.insertBefore(E,w);else if(b==="below"){const S=w.nextElementSibling;S?L.insertBefore(E,S):L.appendChild(E)}else if(b==="inside"){const S=ra(w,n.clientY);S==null?w.appendChild(E):w.insertBefore(E,S)}n.target.classList.remove("dragging-area");let _=E;u.data_type=="layout"?_.querySelectorAll(".fslayout-col").forEach(x=>{x.classList.add("wb-initial-empty")}):(_.classList.add("wb-initial-empty"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))),_.removeAttribute("element-info-id"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))};const u=JSON.parse(o);let c=jn(n,u);const d=c?.dropzoneEl;if(c.status){const w=n.clientY,b=d.getBoundingClientRect(),C=bt(b,w);l(d,C)}else alert(c.message);const g=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(g){const w=g.id,b=Ge(f?.staticWidgetTree,w);if(b){const C=g.querySelector(".mftsccs-marking-element");b.html=C?.innerHTML,await ee(b)}return n.dataTransfer.clearData(),!1}const m=document.querySelector(".content-target"),h=(await We(m,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=h;try{n.dataTransfer.clearData()}catch(w){console.error("error in clearing data",w instanceof Error?w.message:String(w))}return!0}else{const l=F.staticElement,u=n.target;u.classList.remove("dragging-area"),ne?.position==="top"&&u?.children?.length?u.insertBefore(l,ne?.element):ne?.position==="bottom"?ne?.element?.insertAdjacentElement("afterend",l):u.appendChild(l),Dt();const c=await tt();f.staticWidgetTree.html=c}}function ra(n,e){return Array.from(n.children)?.reduce((a,i)=>{const o=i.getBoundingClientRect(),s=e-o.top-o.height/2;return s<0&&s>a.offset?{offset:s,element:i}:a},{offset:Number.NEGATIVE_INFINITY,element:null}).element}function bt(n,e){const t=n.height,a=e-n.top;return a<t*.25?"above":a>t*.75?"below":"inside"}function cr(n){const o=new DOMParser().parseFromString(n,"text/html").body.querySelector("div")?.id,r=document.getElementById(o)?.parentElement?.closest(".added-widget-container"),l=r?.id,u=r?.querySelectorAll(".widget_container_disabled");return u?.length&&u?.forEach(c=>{const d=Se.generateUUID();c.id=`wdgt${d}`}),l?.toString()}async function un(n){return Array.isArray(n.children)&&n.children.forEach(e=>{Ii(e,n),e.children.length&&un(e)}),n}function Ii(n,e){const t=n.wrapper,o=new DOMParser().parseFromString(e?.html,"text/html").body,s=o.querySelector(`#${t}`);if(!s)return n;const l=`wdgtcopy${Se.generateUUID()}`;return s.id=l,n.wrapper=l,e.html=o.innerHTML.toString(),n}const dr=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:cn,dragElement:nr,dragEndWidgetElement:ir,dragOverWidgetElement:or,dragStartWidgetElement:ar,dropElement:dn,dropFolderElement:Wi,dropWidgetElement:sr,findChildByWrapper:Ge,getChildWrapperId:cr,getChildrenWrapperId:Ii,getDragAfterElement:ra,getDropType:bt,onDragEnter:Ys,onDragLeave:Ks,onDragOver:Zs,onDragStart:Gs,onDrop:er,onWidgetDragStart:Qs,removeChildByWrapper:Ft,removeElement:tr,resetDragState:lr,updateAllChildWidgets:un},Symbol.toStringTag,{value:"Module"})),ur=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],la=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class ki{constructor(){}async getLayoutListHTML(){return la.map(t=>`
      ...
      `).join("")}async getTemplateLayoutsHTML(){const e=await $l();if(!e||e.length===0)return'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No templates available</p></li>';const t=await k(),a=t?.entityId===101651686||t?.entityId===101279491;return e.map(i=>i.id?`
      ...
      `:"").join("")}}const mr=n=>{const e=n?.id;if(!e)return null;const t=n?.data?.the_widget;return{widgetId:e,widgetVersion:t?.the_widget_version?.[0]?.data?.the_version??null,widgetName:t?.the_widget_name?.[0]?.data?.the_name??"",widgetType:t?.the_widget_type?.[0]?.data?.the_type??""}},gr=async n=>{const e=new Map,t=new M;t.typeConnection="the_widget_version",t.name="version";const a=(r,l,u=!1)=>{const c=new M;return c.typeConnection=r,c.name=l,c.freeschemaQueries=[t],c.selectors=["the_widget_name","the_widget_type"],u&&(c.reverse=!0),c},i=a("the_widget_s_copy","copywidgets"),o=a("the_widget_root","rootwidgets",!0),s=new M;return s.conceptIds=[n],s.freeschemaQueries=[i,o],s.inpage=100,s.outputFormat=Lo,await new Promise(r=>{pe(s,"").subscribe(l=>{const u=l?.[0]?.data?.the_widget;if(!u){console.warn("No widget data found."),r();return}const c=[...u?.the_widget_s_copy??[],...u?.the_widget_root_reverse??[]];for(let d=0;d<c.length;d++){const g=mr(c[d]);g&&e.set(g.widgetId,g)}r()})}),e};async function ke(n,e){let t=new z;t.composition=n,t.fullLinkers=["the_widget_recent","the_widget_latest"],t.inpage=100;let a=new z;a.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],a.inpage=100;const o=await we([t,a],e),r=await je(n,"the_widget_recent"),l=o?.data?.the_widget?.the_widget_recent||o?.data?.the_widget?.the_widget_latest||[],u=o?.data?.the_widget?.the_widget_latest||null;if(l.length){const c=l[0],d=c?.data.the_widget.the_widget_name?.[0].data.the_name,g=c?.data.the_widget.the_widget_html?.[0].data.the_html,m=c?.id,p=c?.data.the_widget.the_widget_css?.[0].data.the_css,h=c?.data.the_widget.the_widget_js?.[0].data.the_js,w=c?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,b=c?.data.the_widget.the_widget_version?.[0].data.the_version,C=c?.data.the_widget.the_widget_origin?.[0].data.the_origin|n;return{widgetName:d,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:w,widgetVersion:Number(b||u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||u.id,origin:Number(C),connectionIdLatest:r,publishedWidgetVersion:u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const $=(()=>{const n=async()=>{const v=document.getElementById("fslayout-template-container");if(v){v.innerHTML=`
        ...
        </li>`;const E=await new ki().getTemplateLayoutsHTML();v.innerHTML=E}},e=async()=>{const v=document.getElementById("public-widget-list-container");if(v){const y=await Jn();!y||y.trim()===""?v.innerHTML=`
            <li class="list-unstyled">
...
`;m?.file(`${d.slug}.index.ts`,p)}e?.file("routes.ts",mn(t))},Wr=async(n,e,t)=>{console.log("widgetsDir",t);const i=(await k())?.token,o=await va(n,i,!0);let s=e?.folder("home");const r=`
...
`;s?.file("home.index.ts",r),o?.css&&s?.file("home.style.css",o?.css)},Ir=async n=>{if(me)return;me=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new an;const a=await pn(t),i=a?.widgetsDir,o=a?.pagesDir;let s="";i&&o&&(s=await kr(n,o)),a?.routesDir?.file("routes.ts",mn(e)),t.generateAsync({type:"blob"}).then(function(r){let l=document.createElement("a");l.href=URL.createObjectURL(r),l.download=`${s||"page"}.zip`,l.click()}),me=!1},kr=async(n,e)=>{const t=await k(),a=t?.entityId,i=t?.token,o=await va(n,i,!0),s=new z;s.composition=a,s.inpage=100,s.fullLinkers=["the_entity_s_page"];const r=new z;r.inpage=100,r.composition=n,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const u=(await we([s,r],i))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==n),c=u?.[0]?.data?.the_page?.the_page_body?.[0]?.id,d=u?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    import * as tsccs from "mftsccs-browser";
...
.custom-menu-item {
  ...
  `,document.body.appendChild(o);const s=o.querySelector("#pasteArea"),r=o.querySelector("#widgetThumbnail"),l=o.querySelector("#imagePreview img"),u=o.querySelector("#imagePreview"),c=o.querySelector("#pasteText");function d(p){const h=new FileReader;h.onload=w=>{l&&w.target?.result&&(l.src=w.target.result,u.classList.remove("d-none"),c.classList.add("d-none"))},h.readAsDataURL(p)}r?.addEventListener("change",p=>{const h=p.target.files?.[0];h&&d(h)});function g(p){const h=p.clipboardData?.items;if(h){for(let w=0;w<h.length;w++)if(h[w].type.indexOf("image")!==-1){const b=h[w].getAsFile();if(b&&r){const C=new DataTransfer;C.items.add(b),r.files=C.files,d(b);break}}}}s?.addEventListener("paste",p=>g(p)),o.addEventListener("paste",p=>g(p)),o.querySelector("#post-widget-form")?.addEventListener("submit",p=>{p.preventDefault(),Ml(e,o)}),o.showModal()}async function Ml(n,e){const t=document.querySelector(`#spinner-${n}`),a=e.querySelector('button[type="submit"]');try{a&&(a.disabled=!0,a.textContent="Posting...",A.infoMessageToast("Posting Widget to Public...",0)),t&&t.classList.remove("d-none"),await qe();const i=await k(),o=document.getElementById("widgetPublicName").value,s=document.getElementById("widgetDescription").value,r=document.getElementById("widgetThumbnail");if(!r?.files?.length)throw console.error("File validation failed:",{inputExists:!!r,filesLength:r?.files?.length}),new Error("Please provide a thumbnail image");const l=r.files?.[0];if(!l||!r.value)throw new Error("Please provide a thumbnail image");const u=await zi(l);if(!u.success)throw new Error("Failed to upload thumbnail");const c=await ke(n,i.token);if(c&&(await je(c.widgetId,"the_public_widget_s_widget",!0)).length){document.querySelector(".infoMessageToast")?.remove(),A.infoMessageToast("Widget is already public.");return}const d=document.getElementById("postAsTemplate")?.checked;let g=null;if(c)g=await j(c.widgetId);else{const C=await Y(n);g=await $.createWidgetCopy(C,i.userId,i.token)}const m=await Z("public_name",o,!1,i.userId,4,999),p=await Z("description",s,!1,i.userId,4,999),h=await Z("thumbnail",u.url||"no attachment",!1,i.userId,4,999);await H(g,p,"description"),await H(g,h,"thumbnail"),await H(g,m,"public_name");const w=await Z("public_widget","",!1,i.userId,4,999);if(await H(w,g,"s_widget"),d){const T=await Z("template_name",o,!1,i.userId,4,999),v=await Z("template_thumbnail",u.url||"no attachment",!1,i.userId,4,999);await H(g,v,"template_thumbnail"),await H(g,T,"template_name");const y=await Z("template_widget","",!1,i.userId,4,999);await H(y,g,"s_widget")}await D.SyncDataOnline(),await $.renderPublicWidgets(),await $.renderSavedWidgets(),d&&await $.renderTemplateLayouts(),e.close(),document.querySelector(".infoMessageToast")?.remove(),setTimeout(()=>{A.successfullToast(`Widget Posted to Public${d?" and Templates":""}`)},300)}catch(i){console.error("Error posting widget:",i),document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Failed to post widget"),a&&(a.disabled=!1,a.textContent="Post Widget")}finally{t&&t.classList.add("d-none")}}async function Jn(n=""){try{const e=await k();if(!e)return`
    ...
    `}catch(e){console.error("error",e),e?.status===401&&$e()}}async function Pl(n=""){try{const e=await k();if(!e)return`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary">No Folder widget</p>
        </li>
