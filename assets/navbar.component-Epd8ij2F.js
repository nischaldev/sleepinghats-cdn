import{m as f}from"./mainView.class-C4NLGCWW.js";import{L as b,D as c,M as g,A as y,F as w,N as h}from"./index-C66kEi0o.js";import{L as S,s as L,r as m,S as k,a as E}from"./loginModal.service-BCQk_qw2.js";class M{constructor(){this.init()}init(){document.getElementById("wico_btn-logout")?.addEventListener("click",e=>{e.preventDefault(),this.logout()}),document.querySelectorAll(".wico_btn-openLoginModal")?.forEach(e=>{e?.addEventListener("click",d=>{d.preventDefault(),this.openLoginModal()})}),document.querySelectorAll(".wico_btn-openSignupModal")?.forEach(e=>{e?.addEventListener("click",d=>{d.preventDefault(),this.openSignupModal()})})}async logout(){localStorage.removeItem("profile"),localStorage.removeItem("unsaved_widget"),await b("/"),setTimeout(()=>{document.body.style.overflow=""},1e3)}async openLoginModal(n,r){c("signup-dialog"),document.getElementById("login-dialog")?.remove(),new S;const e=document.getElementById("login-dialog");if(e){const u=e.querySelector(".subtitle-wrapper");if(r&&u){const t=document.createElement("p");t.textContent=r,u?.appendChild(t)}const o=e.querySelector(".password-toggle");o?.addEventListener("click",()=>{const t=e.querySelector("#password");t.type==="password"?(t.type="text",o.textContent="visibility"):(t.type="password",o.textContent="visibility_off")}),e.querySelector(".close-button")?.addEventListener("click",()=>{c("login-dialog"),document.body.classList.remove("modal-open")}),e.addEventListener("click",t=>{const l=e.getBoundingClientRect();(t.clientX<l.left||t.clientX>l.right||t.clientY<l.top||t.clientY>l.bottom)&&(c("login-dialog"),document.body.classList.remove("modal-open"))}),e.querySelector(".signup-trigger")?.addEventListener("click",()=>{this.openSignupModal(n)});const s=e.querySelector("#remember-me");if(s&&localStorage.getItem("remember-me")==="true"){s.checked=!0;const l=localStorage.getItem("remembered-email");l&&(e.querySelector("#email").value=l)}const p=e.querySelector("form");p&&(p.addEventListener("submit",t=>{t.preventDefault(),t.stopPropagation(),L(t)}),e.addEventListener("keydown",t=>{if(t.key==="Enter")if(t.preventDefault(),p.checkValidity()){const l=new Event("submit",{cancelable:!0});p.dispatchEvent(l)}else p.reportValidity()}))}g("login-dialog"),document.body.classList.add("modal-open"),document.querySelector("#login-dialog #email")?.focus(),m("google-sign-in-button-login")}async openSignupModal(n){c("login-dialog"),document.getElementById("signup-dialog")?.remove(),new k;const i=document.getElementById("signup-dialog");if(i){i.querySelectorAll(".password-toggle").forEach(o=>{o.addEventListener("click",()=>{const s=o.closest(".password-field-wrapper")?.querySelector("input");s.type==="password"?(s.type="text",o.textContent="visibility"):(s.type="password",o.textContent="visibility_off")})}),i.querySelector(".close-button")?.addEventListener("click",()=>{c("signup-dialog"),document.body.classList.remove("modal-open")}),i.addEventListener("click",o=>{const a=i.getBoundingClientRect();(o.clientX<a.left||o.clientX>a.right||o.clientY<a.top||o.clientY>a.bottom)&&(c("signup-dialog"),document.body.classList.remove("modal-open"))}),i.querySelector(".login-trigger")?.addEventListener("click",()=>{this.openLoginModal(n)});const u=i.querySelector("form");u&&u.addEventListener("submit",o=>{o.preventDefault(),o.stopPropagation(),E(o)})}g("signup-dialog"),document.body.classList.add("modal-open"),m("google-sign-in-button-signup")}}class B extends f{appName;_authService;constructor(n){super({}),this.appName=n,this._authService=y.getInstance()}async getHtml(){window.headerFunctions=w,window.logout=this._authService.logout,window.scrollToSection=this.scrollToSection;const n=await this._authService.getLoginInfo();return setTimeout(()=>{new M},0),`
        ...
        `}scrollToSection=async n=>{window.location.pathname!=="/"&&await h("/"),document.getElementById(n)?.scrollIntoView({behavior:"smooth"})}}export{M as A,B as N};
