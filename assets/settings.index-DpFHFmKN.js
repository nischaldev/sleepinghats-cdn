import{m as k}from"./mainView.class-C4NLGCWW.js";import{y as B,g as h,t as r,M as g}from"./index-F3rzlyVL.js";import{N as S}from"./navbar.component-DwdNqluC.js";import{d as v,e as f,I as x,P as T,i as L,q as E,m as _,h as P}from"./mftsccs-browser-8J-t7mQ6.js";import"./codemirror-B6qdlLvx.js";import"./vendor-vUhUC0ZM.js";import"./ckeditor-Cw9bcqxY.js";import"./eslint4b-BLWGvIOa.js";import"./prettier-ClL2wQep.js";import"./loginModal.service-DN3hCsFI.js";class G extends k{constructor(a){super(a),this.setTitle("Settings")}async getHtml(){const a=await B(),i=await new S(a).getHtml(),n=await h(),c=n?.email?.slice(0,1)?.toUpperCase()||"?";return`
      ${i}
      <div class="sp-page">
