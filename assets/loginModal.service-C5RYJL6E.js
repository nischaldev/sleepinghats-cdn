import{A as I,$ as M}from"./mftsccs-browser-Cj5m6_BU.js";import{B as g,L as y,H as b,N as w,A as h}from"./index-T8V7Ehpu.js";class S{constructor(){this.init()}init(){const s=this.getHtml();document.querySelector("body #app")?.insertAdjacentHTML("afterend",s)}getHtml(){return`
