const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home.index-ol4-avJJ.js","assets/mainView.class-C4NLGCWW.js","assets/navbar.component-vMNHwDSV.js","assets/loginModal.service-FI1sfshb.js","assets/mftsccs-browser-D_uubYVV.js","assets/loginModal-DGhNYttL.css","assets/vendor-DEYWGvhS.js","assets/ckeditor-Cw9bcqxY.js","assets/vendor-TRZluGMH.css","assets/codemirror-D1H9tReK.js","assets/eslint4b-BLWGvIOa.js","assets/prettier-ClL2wQep.js","assets/home-bXvBobv9.css","assets/preview.index-DyiAZneH.js","assets/page-preview.index-BQPl0wrt.js","assets/page-preview-BJCVd99J.css","assets/documentation.index-Ihu41qDd.js","assets/highlight-CFrhCzdo.js","assets/highlight-ZgkIHsf0.css","assets/documentation-CtKxHXjz.css","assets/subscription.index-CvZDwHi7.js","assets/subscription-Dc24vCVe.css","assets/video-tutorial.index-B8hHw0-H.js","assets/video-tutorial-Dg46rKRD.css","assets/community.index-DQu8PuS_.js","assets/community-CARjtQbC.css","assets/courses.index-BgVAz05W.js","assets/course.index-5fMqCQc9.js","assets/initialLoadWICO-C-lkiRwq.js"])))=>i.map(i=>d[i]);
import{p as X,v as Zn,G as Xn,U as ni,K as M,g as Pn,E as ye,a as D,V as en,l as ea,_ as Ae,b as St,H as oe,F as z,R as be,N as So,c as Ia,d as ai,O as Ge,S as Co,e as j,x as Ma,f as Y,h as se,M as We,J as Lo,i as Ct,t as ii,j as Be,o as xo,k as ge,m as fe,n as Ao,q as De,r as He,s as J,D as Bn,Y as oi,u as Wo,I as Dt,w as si,y as wt,z as ri,A as ko,Q as ta,B as Io}from"./mftsccs-browser-D_uubYVV.js";import{E as te,b as ot,o as st,j as tn,a as nn,c as Mo,l as na,d as aa,e as Po,f as xe,k as an,h as Bo,g as $o}from"./codemirror-D1H9tReK.js";import{J as on,n as No}from"./vendor-DEYWGvhS.js";import{z as Do}from"./eslint4b-BLWGvIOa.js";import{l as rt,p as sn,r as rn,a as jo,b as Ho}from"./prettier-ClL2wQep.js";import{C as Oo}from"./ckeditor-Cw9bcqxY.js";const qo=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return lo},get addJSLibrary(){return co},get applyPageProperties(){return Kn},get applyPageProperty(){return Se},get filterChildrenByWrapper(){return io},get getAttributeType(){return hc},get getAttributeValue(){return mo},get getElementAttribute(){return sc},get getElementAttributeDetails(){return Ca},get getElementData(){return no},get getLayoutAttributeValue(){return go},get getPropertiesByIdFromStorage(){return kt},get handleDirectContentEdit(){return rc},get handlePageProperties(){return oo},get initializeApp(){return _n},get initializeLibrary(){return La},get listJSLibraries(){return It},get removeCSSLibrariesFromHead(){return Kt},get removeJSLibrariesFromHead(){return xa},get setAttributeValue(){return yc},get toggleSpacingBox(){return Aa},get updateAttribute(){return cc},get updateCSSLibrary(){return Ke},get updateElementAttribute(){return vn},get updateElementAttributeViaEditor(){return lc},get updateJSLibrary(){return Ze},get updateMetaTag(){return Tt},get updateMultipleElementAttribute(){return so},get updateWidgetTypeValue(){return ao}},Symbol.toStringTag,{value:"Module"}));(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const U={baseURL:"https://boomconsole.com/api/v1",baseNodeUrl:"https://boomconsole.com",boomURL:"https://boomconsole.com",aiURL:"https://www.ai.freeschema.com/api",deployURL:"https://deploy.freeschema.com",agentURL:"https://wico-ai.freeschema.com",CLIENT_ID:"636550695311-ctc09991hhu6iav4kkhnp1ge537nec2i.apps.googleusercontent.com",logserver:"https://logger.freeschema.com",enableSW:!1,courses_widget:103581935,course_widget:103503610,discussion_community:101765915,ai_widget:101934087,visual_widget:103478558,visual_prototype_widget:101938499,video_tutorial_widget:102040172,subscriptionId:102121109,documentation_preview_widget:102097744,folder_widget:102400016,assets_widget:102410590,VITE_DEV_BASE:"http://localhost:5173",VITE_CDN_BASE:"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master"},Fo=U?.boomURL;async function q(n,e,t){const a=await X(`the_${n}`,"",!0,e,4,999);for(const[i,o]of Object.entries(t)){let s=i;const r=await X(`${s}`,`${o}`,!1,e,4,999);await H(a,r,s)}return a}async function H(n,e,t){const a=n.userId,i=999,o=999,s=n.type?.characterValue,r=t,l=s+"_"+r,u=await Zn(l,i,o,a);await Xn(n.id,e.id,u.id,1e3)}async function Vo(n,e){try{const t=new Headers;return t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),await(await fetch(`${Fo}/api/get-entity-from-user?userConceptId=${n}`,{method:"GET",headers:t,redirect:"follow"})).json()}catch(t){throw console.error(t),t}}async function Zc(n){const e=await Vo(n?.data?.userConcept,n?.data?.token);let t={token:n?.data?.token,refreshToken:n?.data?.refreshtoken,email:n?.data?.email,userId:n?.data?.entity?.[0]?.userId,userConcept:n?.data?.userConcept,entityId:e?.entity,amcode:btoa(JSON.stringify(n?.data?.roles))};return ni(t.token),localStorage.setItem("profile",JSON.stringify(t)),!0}async function I(){return new Promise(n=>{let e=localStorage?.getItem("profile")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}async function li(){return new Promise(n=>{let e=localStorage?.getItem("tempwidget")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}class Ce{static instance;static getInstance(){return Ce.instance||(Ce.instance=new Ce),Ce.instance}async getLoginInfo(){const e=await I(),t=await this.checkIfUserIsAdmin(e?.userConcept);let a="",i=!1,o=!1;if(e?.token){i=!0;let s="",r="";if(e?.entityId){let l=new M;l.typeConnection="the_entity_firstname",l.name="entity_firstname";let u=new M;u.typeConnection="the_entity_lastname",u.name="entity_lastname";let c=new M;c.typeConnection="the_entity_tour_status",c.name="entity_tour_status";let d=new M;d.type="the_entity",d.name="top",d.conceptIds=[e.entityId],d.freeschemaQueries=[l,u,c],d.outputFormat=Pn;let g;await ye(d,"").subscribe(m=>{g=m}),s=g?.[0]?.the_entity?.the_entity_firstname?.the_firstname||"",r=g?.[0]?.the_entity?.the_entity_lastname?.the_lastname||"",o=g?.[0]?.the_entity?.the_entity_tour_status?.the_tour_status==="true"}a=`
      ...
      `;return{loginInfoHTML:a,isLoggedIn:i,isAdmin:t,tourStatus:o}}async checkIfUserIsAdmin(e){try{return(await D(e))?.accessId===3}catch(t){return console.error("Error fetching user concept:",t),!1}}async logout(){const e=await li();await en(e?.id),localStorage.removeItem("profile"),localStorage.removeItem("tempwidget"),location.reload()}async checkAndUpdateToken(){try{const e=await I();if(!e?.token){console.warn("No token found in local storage.");return}const t=e.token,a=e.refreshToken,i=new Headers;i.append("Content-Type","application/json");const o={accessToken:t,refreshToken:a},r=await(await fetch(`${ea.BASE_URL}/api/Auth/refresh`,{method:"POST",headers:i,body:JSON.stringify(o)})).json();if(r.success&&r.data){const{accessToken:l,refreshToken:u}=r.data;e.token=l,e.refreshToken=u,localStorage.removeItem("profile"),localStorage.setItem("profile",JSON.stringify(e))}else this.logout()}catch(e){console.error("Error refreshing token:",e)}}}const Ro=Ce.getInstance();(function(){const e=window.fetch;window.fetch=async(...t)=>{const a=t[1]||{};try{const i=await e(...t);if(i.status===401){console.warn("401 Unauthorized - Refreshing token"),await Ro.checkAndUpdateToken();const o=await I();if(!o?.token)return console.error("Token refresh failed. User not logged in."),i;if(a.headers){const s=new Headers(a.headers);s.set("Authorization",`Bearer ${o.token}`),s.has("Content-Type")||s.set("Content-Type","application/json"),a.headers=s}return e(t[0],a)}return i}catch(i){throw console.error("Intercepted Fetch Error:",i),i}}})();const Uo="modulepreload",zo=function(n){return"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master/"+n},Pa={},ce=function(e,t,a){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=s?.nonce||s?.getAttribute("nonce");i=Promise.allSettled(t.map(l=>{if(l=zo(l),l in Pa)return;Pa[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":Uo,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((g,m)=>{d.addEventListener("load",g),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return i.then(s=>{for(const r of s||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function $n(n,e=0){let t=`<ul style="list-style: none; margin: 10px 0px; ${e==0?" padding-left: 0px; ":""}" id="sortable-list">`;for(let a=0;a<n.length;a++){const i=n[a];i.edit?t+=`
            ...
            `:t+=`
                ...
                <li>${i.menus?`${$n(i.menus,e+1)}`:""}</li>
            `}return t+="</ul>",t}function dt(n){console.log("menus",n);const e=$n(n),t=document.getElementById("menu-items");t&&(t.innerHTML=e);let a=null;document.querySelectorAll("#sortable-list li").forEach(i=>{i.addEventListener("dragstart",o=>{a=i,o.dataTransfer.effectAllowed="move"}),i.addEventListener("dragover",o=>{o.preventDefault(),i.classList.add("drag-over")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-over")}),i.addEventListener("drop",o=>{o.preventDefault(),i.classList.remove("drag-over"),a!==i&&!i.contains(a)&&i?.parentNode?.insertBefore(a,i.nextSibling)}),i.addEventListener("dragend",()=>{document.querySelectorAll(".drag-over").forEach(o=>o.classList.remove("drag-over"))})})}async function ci(n){console.log("projectId",n);let e;if(n||(e=mi()),!n&&!e?.projectId)return console.log("Project Id not found"),[];if(!n&&e.projectId&&(n=e?.projectId),console.log("projectId 2",n),!n)return[];const t=["the_item_menu_name","the_item_menu_link","the_item_menu_action","the_item_menu_auth","the_item_menu_order","the_item_menu_page"],a=new M;a.typeConnection="the_menu_s_item",a.selectors=t;function i(c,d=5){if(d==5)return;const g=new M;g.typeConnection="the_menu_s_item",g.selectors=t,c.name=d.toString(),c.freeschemaQueries=[g];const m=d+1;i(g,m)}const o=new M;o.conceptIds=[n],i(o,1);const s=await Ae(o,"");console.log("valllu",s);const r=s?.[0]?.the_project?.the_menu_s_item||[],l=(c=[])=>{let d=[];for(let g=0;g<c.length;g++){const m=c[g];d.push({name:m?.the_item_menu?.the_item_menu_name?.the_name??"",link:m?.the_item_menu?.the_item_menu_link?.the_link??"",action:m?.the_item_menu?.the_item_menu_action?.the_action??"",page:m?.the_item_menu?.the_item_menu_page?.the_page?Number(m?.the_item_menu?.the_item_menu_page?.the_page):"",order:m?.the_item_menu?.the_item_menu_order?.the_order?Number(m?.the_item_menu?.the_item_menu_order?.the_order):0,auth:m?.the_item_menu?.the_item_menu_auth?.the_auth=="true",menus:l(m?.the_item_menu?.the_menu_s_item)??[]})}return d.sort((g,m)=>g.order-m.order)};return l(r)}async function Jo(n,e=[]){console.log("menus",e);const t=await new St;try{await t.initialize();const a=await D(n);await oe(n,"the_menu_s_item"),await di(a,e,t),await t.commitTransaction(),console.log("output concept",n)}catch(a){console.error(a),await t.rollbackTransaction()}}async function di(n,e=[],t){for(let a=0;a<e.length;a++){const i=e[a],o=await t.MakeTheInstanceConceptLocal("the_item_menu","",!0,999,4);await t.CreateConnection(n,o,"the_menu_s_item");for(let[s,r]of Object.entries(i))if(console.log("key",s,r),!!["name","link","action","auth","order","page","menus"].includes(s)&&!(s=="menus"&&!Array.isArray(r)))if(s=="menus")await di(o,r,t);else{const u=await t.MakeTheInstanceConceptLocal("the_"+s,r,!0,999,4);await t.CreateConnection(o,u,"the_item_menu_"+s)}}}const Go=async()=>{const n=U.enableSW;"serviceWorker"in navigator&&n&&await new Promise((e,t)=>{navigator.serviceWorker.register("/sw.js").then(a=>{a.addEventListener("updatefound",()=>{const i=a.installing;i?.addEventListener("statechange",()=>{i.state==="installed"&&navigator.serviceWorker.controller&&(i.postMessage("skipWaiting"),setTimeout(()=>{confirm("A reload is required to update to latest")&&window.location.reload()},500))})}),e(void 0)}).catch(a=>{console.error("Service Worker Init error",a),t(a)}),setTimeout(()=>{t()},3e4)})},ui="wico_site";function mi(){const n=atob(localStorage.getItem(ui)||"");return n?JSON.parse(n):{}}function gi(n,e){const t=mi();t[n]=e,localStorage.setItem(ui,btoa(JSON.stringify(t)))}function pi(){window.wico={fetchMenus:ci}}async function Qo(){await Go()}const W={PAGE_COMP_NAME:"page",WIDGET_COMP_NAME:"widget",PROJECT_COMP_NAME:"project"},ie={ENTITY_PAGE_LINKER:"s_page",PAGE_WIDGET_LINKER:"body",ENTITY_PROJECT_LINKER:"s_project",PROJECT_PAGE_LINKER:"s_page"},Lt=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],ia=[{name:"accept",type:"string"},{name:"action",type:"string"},{name:"alt",type:"string"},{name:"autocomplete",type:"boolean",value:"on"},{name:"checked",type:"boolean"},{name:"cols",type:"string"},{name:"disabled",type:"boolean"},{name:"download",type:"string"},{name:"draggable",type:"boolean"},{name:"for",type:"string"},{name:"hidden",type:"boolean"},{name:"href",type:"string"},{name:"label",type:"string"},{name:"loading",type:"array",value:"eager,lazy",default:"eager"},{name:"max",type:"string"},{name:"maxlength",type:"string"},{name:"media",type:"string"},{name:"method",type:"array",value:"get,post,dialog"},{name:"min",type:"string"},{name:"minlength",type:"string"},{name:"multiple",type:"boolean"},{name:"muted",type:"boolean"},{name:"name",type:"string"},{name:"pattern",type:"string"},{name:"placeholder",type:"string"},{name:"readonly",type:"boolean"},{name:"rel",type:"string"},{name:"required",type:"boolean"},{name:"rows",type:"string"},{name:"selected",type:"boolean"},{name:"size",type:"string"},{name:"src",type:"string",value:""},{name:"start",type:"string"},{name:"style",type:"string"},{name:"title",type:"string"},{name:"target",type:"array",value:"_blank,_self,_parent,_top"},{name:"type",type:"array"},{name:"value",type:"string"},{name:"wrap",type:"array",value:"soft, hard"},{name:"width",type:"string",value:""}],Nn=[{name:"className",type:"string",value:""},{name:"id",type:"string",value:""}],Yo=[{name:"className",type:"string",value:""},{name:"Width",type:"string",value:""},{name:"Height",type:"string",value:""},{name:"Background Color",type:"color",value:"#FFFFFF"},{name:"Color",type:"color",value:"#000000"},{name:"Margin",type:"string",value:""},{name:"Padding",type:"string",value:""}];let Ba=[],$a=[];async function Ko(n){let e="";for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t)){const a=n[t];e+=` ${t}="${a}" `}return e}async function Zo(n,e){const t=new z;t.composition=n,t.fullLinkers=["the_widget_html","the_widget_css","the_widget_js"];const a=await be([t],e),i=a?.data?.the_widget?.the_widget_html?.[0]?.id,o=a?.data?.the_widget?.the_widget_css?.[0]?.data.the_widgetCSS,s=a?.data?.the_widget?.the_widget_js?.[0]?.data.the_widgetJS;if(!i)return{html:"",css:"",js:""};const r=await So(i,["contain_s"]);Ba=await Ia(r.externalConnections),$a=await Ia(r.internalConnections);let l=await hi(i,Ba,$a);const u=document.createElement("div");return u.innerHTML=l,{html:(u?.querySelector(".widget-wrapper")).innerHTML,css:o||"",js:s||""}}async function hi(n,e,t){try{let a="",o=es(e)[n];if(o!=null){let s=ts(o);const l=(await Qi())?.map(g=>{const m=g?.id,p=g?.data?.the_element?.the_element_name?.[0]?.data?.the_name,h=g?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag,w=g?.data?.the_element?.the_element_void?.[0]?.data?.the_void,C=g?.data?.the_element?.the_element_s_attribute?.map(T=>{const b=T?.data?.the_attribute,y=b?.the_attribute_name?.[0]?.data?.the_name,E=b?.the_attribute_type?.[0]?.data?.the_type,L=b?.the_attribute_value?.[0]?.data?.the_value;return{name:y,type:E,value:L}});return{id:m,name:p,tag:h,void:w,attributes:C}}),u=[...ia,...Nn],d=(await I())?.userId;for(let g=0;g<s.length;g++){const m=s[g];if(m.ofTheConceptId==n){const p=await Xo(m.toTheConceptId,t),h=Object.keys(p.data)[0],w=p.data[h],v=Lt.includes(h),C=await Ko(w?.attributes||[]),T=l.find(y=>y.tag===h.toLowerCase().trim()),b=w?.attributes;for(const y in b){const E=u.find(S=>y===S?.name?.toLowerCase().trim()),L=b[y],_=E?.type;T.attributes=T?.attributes?.map(S=>(S?.name==="className"&&y==="class"?S.value=L:S?.name==="elementContent"?S.value=w?.innerText:y===S?.name&&(_==="array"?S.selected=L:_==="boolean"?S.value="":S.value=L),S))}if(h!="text"){const y=await ai(p.id,d);y?.length&&await en(y?.[0]?.id);const E={[`wdgt${p.id}`]:T},L=await Ge(E,null,null,null,d);console.log("elementAttributeComp ->",L),a+=`
  ...
  `,e?.appendChild(t)}function oa(){const n=document.querySelector(".content-target");n.innerHTML="",n.textContent="Widget Loading..."}function cn(){return document.querySelectorAll(".content-target")[0]}function Ha(n){const e={past:[],present:n,future:[]};return{getState(){return{current:e.present,canUndo:e.past.length>0,canRedo:e.future.length>0}},push(t){e.past.push(e.present),e.present=t,e.future=[]},undo(){if(e.past.length===0)return;const t=e.past[e.past.length-1];return e.past=e.past.slice(0,-1),e.future=[e.present,...e.future],e.present=t,t},redo(){if(e.future.length===0)return;const t=e.future[0];return e.future=e.future.slice(1),e.past=[...e.past,e.present],e.present=t,t}}}class N{static actionHistories;static renderActionButtons(){const e=document.getElementById("undo-btn"),t=document.getElementById("redo-btn");e?.addEventListener("click",N.undoAction),t?.addEventListener("click",N.redoAction)}static renderActionHistory(){N.actionHistories=Ha(JSON.stringify(f?.staticWidgetTree)),Ha(JSON.stringify(f?.staticWidgetTree))}static updateButtonStates(){const{canUndo:e,canRedo:t}=N.actionHistories.getState(),a=document.getElementById("undo-btn"),i=document.getElementById("redo-btn");a&&(a.disabled=!e),i&&(i.disabled=!t)}static async undoAction(){const e=N.actionHistories.undo();e!==void 0&&(za(e||""),N.updateButtonStates())}static async redoAction(){const e=N.actionHistories.redo();e!==void 0&&(za(e||""),N.updateButtonStates())}static updateActionHistories(){N.actionHistories.push(JSON.stringify(f.staticWidgetTree)),N.updateButtonStates()}}async function Ls(){const n=document.getElementById("widget-prompt-modal");n&&n.remove()}async function xs(){document.getElementById("widget-prompt-modal").classList.add("d-none");const e=document.getElementById("widget-prompt-tab");e.classList.remove("d-none"),e.classList.add("d-flex")}async function As(){document.getElementById("widget-prompt-tab").classList.add("d-none");const e=document.getElementById("widget-prompt-modal");e.classList.remove("d-none"),e.classList.add("d-flex")}function Ws(){const n=document.getElementById("prompt-text");n.addEventListener("input",()=>{n.style.height="auto";const e=Math.min(n.scrollHeight-8,120);n.style.height=`${e}px`,n.style.overflowY=e===120?"auto":"hidden"})}class Ti{widgetPromptHTML;assistantChatId;randomSuggestionEl;constructor(e){this.assistantChatId=e,this.randomSuggestionEl="",this.init()}init(){if(!this.assistantChatId){const t=["Newsletter signup form with email validation","Create a header section for portfolio website","Quick contact form with name, email, and message fields","Create a customer satisfaction survey form","Countdown timer for upcoming events or launches","Currency converter widget with real-time exchange rates","Task list widget with checkboxes and progress tracking"],i=((o,s=3)=>{if(o.length<s)return[];const r=new Set;for(;r.size<s;){const l=Math.floor(Math.random()*o.length);r.add(l)}return[...r]})(t,2);this.randomSuggestionEl=i?.map(o=>`<div class="suggestion-prompt">
    ...
    `}}async function ks(n){const e=document.getElementById("widget-btn-wrapper");if(e.querySelector("#updateFsPage")||e.querySelector("#fspage-save-button"))return;e.innerHTML=`
      ...
      })();`;this.scriptElement.textContent=t,document.body.appendChild(this.scriptElement),f.selectedStaticWidgetTreeInfo?.widgetTree&&(f.selectedStaticWidgetTreeInfo.widgetTree.js=e)}async getHtml(){return window.getEditorContentJS=this.getEditorContentJS.bind(this),""}handleTab=e=>{const{state:t,dispatch:a}=e,{selection:i}=t;return i.ranges.length===0?!1:(a({changes:{from:i.ranges[0].from,to:i.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){this.editorInitialized=!0;const e=document.getElementById("editor-container-js-split");e&&(e.innerHTML="",this.editorView=new te({doc:"/* Write your JavaScript here */",extensions:[ot,st,tn(),nn(),te.lineWrapping,xe.tabSize.of(2),xe.allowMultipleSelections.of(!0),te.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),an.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),te.updateListener.of(async t=>{if(t.docChanged){const a=this.editorView?.state.doc.toString()||"";this.updateJS(a)}})],parent:e}))}getEditorContentJS(){return this.editorView?this.editorView.state.doc.toString():""}}async function Oa(){const n=document.getElementById("codeBlocksContainer"),e=n.querySelectorAll(".sub-tab-btn");if(!n.querySelector(".sub-tab-btn.active")){e?.[0]?.classList.add("active");const a=document.getElementById("onmount-editor-split");a&&a.classList.add("active")}}async function Li(n){const e=n?.id,t=n?.code,a=n?.slug,i=n?.name,o=document.querySelectorAll(".custom-service-btn"),s=Array.from(o)?.filter(d=>d?.getAttribute("data-subtab")===a),r=document.getElementById("lifecycle"),l=r?.querySelector(".sub-tab-nav");if(!s.length){const d=document.createElement("button");d.classList.add("sub-tab-btn","custom-service-btn"),d.setAttribute("data-subtab",a),d.innerHTML=`
...
${t?.css}`:t?.css;if(await _i(o,s),me(n?.html),await bi(n?.after_render),await Ei(n?.before_render),n?.custom_functions?.length){const r=document.querySelectorAll(".custom-service-btn"),l=Array.from(r)?.map(d=>d.getAttribute("data-subtab")??""),u=n.custom_functions?.map(d=>d.slug);(l?.filter(d=>!u.includes(d))).forEach(d=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${d}"]`);g&&g.remove(),document.getElementById(`${d}-editor-split`)?.remove()}),Oa(),n.custom_functions?.forEach(d=>{Li(d)})}else document.querySelectorAll(".custom-service-btn").forEach(u=>{u.remove()}),document.querySelectorAll(".custom-editor-content").forEach(u=>{u.remove()}),Oa();(a||i)&&ln(n?.origin?n?.origin:n?.widgetId),a&&n?.assistant?.id&&zs(n?.assistant)}const Rn="drop-indicator";function Wi(){let n=document.querySelector(`.${Rn}`);return n||(n=document.createElement("div"),n.className=Rn,document.body.appendChild(n)),n}function Gs(n,e){const t=Wi(),a=n.getBoundingClientRect();e==="top"?t.style.top=`${a.top-5}px`:e==="bottom"&&(t.style.top=`${a.bottom-5}px`),t.style.left=`${a.left}px`,t.style.width=`${a.width}px`,t.style.opacity="1",t.style.transform="scaleY(1)"}function ki(){document.querySelectorAll(`.${Rn}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function Qs(n,e,t){if(e.length===0)return{element:t,position:"top"};const a=n.clientY;let i=e[0],o=Math.abs(i.getBoundingClientRect().top-a);Math.abs(i.getBoundingClientRect().bottom-a);for(const u of e){const c=u.getBoundingClientRect(),d=Math.abs(c.top-a);Math.abs(c.bottom-a),d<o&&(i=u,o=d)}const s=i.getBoundingClientRect(),r=s.top+s.height/2,l=a<r?"top":"bottom";return{element:i,position:l}}async function Oe(n){const e=document.querySelectorAll("link.vde-css");e?.length&&e?.forEach(a=>{a.remove()});const t=document.querySelectorAll("script.vde-js");if(t?.length&&t?.forEach(a=>{a.remove()}),await _n(n),n?.children?.length)for(const a of n?.children){const i=a?.library;i?.css?.length&&i?.css?.forEach(o=>{const s=o?.url,r=document.createElement("link");r.classList.add("vde-css"),r.setAttribute("rel","stylesheet"),r.setAttribute("href",s),document.head.appendChild(r)}),i?.js.length&&i?.js?.forEach(async o=>{await new Promise((s,r)=>{const l=o?.url,u=document.createElement("script");u.classList.add("vde-js"),u.setAttribute("type","text/javascript"),u.setAttribute("src",l),u.setAttribute("crossorigin","anonymous"),u.onload=()=>{s()},u.onerror=c=>{console.error("Failed to load script:",l,c),r(new Error(`Failed to load script: ${l}`))},document.body.appendChild(u)})})}}let G=null,ne;function un(){const n=document.querySelector(".content-target > .mftsccs-marking-element");if(n){const e=document.querySelector(".content-target");Le.fixContentTargetHeight(e,n)}}function Ys(n){G=n.target;const e=n.target;let t={data_type:n.target.getAttribute("data-type"),data_default:n.target.getAttribute("data-default"),data_void:n.target.getAttribute("data-void"),data_text:n.target.getAttribute("data-text"),elementId:n.target.getAttribute("data-elementId"),dataId:n.target.id,imageUrl:e.imageUrl,displayType:e.displayType};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.setData("id",n.target.id),n.dataTransfer.effectAllowed="move"}async function Ks(n){n.stopPropagation();const e=n.target,t={widgetcodeId:n.target.getAttribute("data-widgetId"),sourceElementId:n.target.id,className:n.target.className,imageUrl:e.imageUrl,displayType:e.displayType,type:e.Type};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.effectAllowed="move"}function Zs(n){n.preventDefault(),n.stopPropagation(),n.target.classList.add("dragging-area"),At.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",ys()}function Xs(n){n.preventDefault(),n.stopPropagation(),n.target.classList.remove("dragging-area")}function er(n){n.preventDefault(),n.stopPropagation(),(!G||!(n.currentTarget instanceof HTMLElement))&&(G=n?.target);const e=n.target,t=Array.from(e.children).filter(i=>i!==G);Wi();const a=Qs(n,t,e);ne=a,Gs(a.element,a.position)}function tr(){B.checkContent()?B.enableWidgetButtons():B.disableWidgetButtons()}async function nr(n){const e=await mn(n);G=null,ki(),N.updateActionHistories(),At.collapseNavbar(),tr(),un(),de(),e&&(me(),ln(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),pe()}function Vt(n,e){return Array.isArray(n?.children)&&(n.children=n?.children.filter(t=>t?.wrapper!==e),n.children.forEach(t=>Vt(t,e))),n}function Ye(n,e){let t;return Array.isArray(n?.children)&&(t=n?.children.filter(a=>a?.wrapper===e),n.children.forEach(a=>Ye(a,e))),t?.[0]}async function ar(n){n.preventDefault(),n.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(d=>{const g=document.getElementById(`${d}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};Et(m,`${d}-content`)}});const t=document.getElementById("element-attributes");if(t&&t.style.display==="block"){const d={target:document.querySelector("#icon-attribute")};Et(d,"element-attributes")}const a=F.staticElement,i=a?.parentElement,o=i?.parentElement,s=o?.dataset?.widgetid,r=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container"),l=a.querySelectorAll(".added-widget-container");if(a?.classList?.contains("added-widget-container")){const d=a?.id;Vt(f?.staticWidgetTree,d)}else l.length&&l.forEach(d=>{const g=d?.id;Vt(f?.staticWidgetTree,g)});if(r){const d=r.id;if(a?.remove(),F.staticElement.remove(),Ht(),a?.classList?.contains("added-widget-container")){const g=Ye(f?.staticWidgetTree,d);if(g){const m=r.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,K(g)}}else{const m=document.getElementById(d).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,K(f.selectedStaticWidgetTreeInfo.widgetTree)}de(),N.updateActionHistories();return}i?.classList.contains("mftsccs-marking-element")&&i.children.length===1&&i?.remove(),s&&(o?.children?.length||o?.remove()),a?.remove(),F.staticElement.remove(),Ht();const u=await $t();return f.staticWidgetTree.html=u,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},nc(),K(f?.staticWidgetTree),de(),N.updateActionHistories(),B.checkContent()||(B.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}function ir(n){return"drag"}function or(n){return n.dataTransfer.setData("text",n.target.id),"start drag"}function sr(n){console.log("dragEndWidgetElement event ->",n)}function rr(n){return n.preventDefault(),n.stopPropagation(),"dragOverWidgetElement"}async function lr(n){await mn(n),me()}let Rt=null;async function Ii(n,e){if(!n)return console.error("dropFolderElement called without event"),!1;(c=>"dataTransfer"in c&&c.dataTransfer!==null)(n)&&(n.preventDefault(),n.stopPropagation());const a=n.target instanceof HTMLElement?n.target:null;if(!G)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let o=n.target;if(!o.classList.contains("mftsccs-marking-element")&&!o.classList.contains("fslayout-col")&&o.id!=="builder-workarea"){const c=document.getElementById("builder-workarea"),d=o.closest(".mftsccs-marking-element"),g=o.closest(".fslayout-col");o=d||g||c}if((G.contains(o)||G===o)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),o=document.getElementById("builder-workarea")),!o)return console.error("Invalid dropzone"),!1;o?.classList.remove("dragging-area");let s=Hn(n,e);if(!s.status)return alert(s.message),G=null,!1;const r=e.dataType||e.type||e.data_type,l=r==="photo"||r==="Image"||r==="img",u=r==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(l){let c,d=!1;if(G&&G.tagName&&G.tagName.toLowerCase()==="img"){if(d=!0,c=G,c.parentElement===o&&console.log("Image is already in this dropzone, just repositioning"),!(c instanceof Node))return console.error("draggedItem is not a valid DOM node:",c),G=null,!1;(!c.hasAttribute("style")||!c.style.width)&&c.setAttribute("style","width: 200px;")}else{const w=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(o.querySelectorAll(`img[src="${w}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),G=null,!1;c=document.createElement("img"),c.setAttribute("src",w),c.setAttribute("style","width: 200px;")}let g=Le.generateUUID();c.setAttribute("element-info-id",g);const m=o.classList.contains("file-item")&&o.classList.contains("photo-file")&&o.classList.contains("dragging");let p=c;if(m){const w=document.createElement("div");w.appendChild(c),p=w}try{if(d){const w=m&&c.parentElement?.parentElement||c.parentElement,v=m?c.parentElement:c;w&&w!==o&&v&&w.removeChild(v)}ne?.position==="top"&&o?.children?.length&&ne?.element?o.contains(ne.element)&&!p.contains(ne.element)&&p!==ne.element?o.insertBefore(p,ne.element):(console.warn("Invalid indicator element for top position, appending to dropzone"),o.appendChild(p)):ne?.position==="bottom"&&ne?.element?o.contains(ne.element)&&!p.contains(ne.element)&&p!==ne.element?ne.element.insertAdjacentElement("afterend",p):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),o.appendChild(p)):o.appendChild(p)}catch(w){console.error("Error positioning element:",w instanceof Error?w.message:w);try{o.appendChild(p)}catch(v){return console.error("Cannot append element:",v),G=null,!1}}c.removeAttribute("element-info-id");const h=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(h){const w=h.id,v=Ye(f?.staticWidgetTree,w);if(v){const C=h.querySelector(".mftsccs-marking-element");C&&(v.html=C.innerHTML,await K(v))}return G=null,!1}return cr(),G=null,!0}else if(u){if(!s.status)return alert(s.message),G=null,!1;if(e.sourceElementId){const S=e.sourceElementId||e.fileId;console.log("sourceElement ->",S)}let c=e.widget_id;if(!c)return console.error("Widget ID is missing from data"),G=null,!1;o.classList.remove("dragging-area");const d=document.createElement("div");d.classList.add("wb-initial-empty"),d.style.display="block",d.style.marginBottom="10px",d.setAttribute("data-widget-id",c.toString());const g=Le.generateUUID();d.id=`widget-${g}`;const m=await I();let p=o.classList.contains("publicWidgetRouter"),h=await ge(Number(c));const w=n.clientY,v=o.getBoundingClientRect(),C=bt(v,w);let T;if(!p){const S=await Me(Number(c),m.token);h=await ge(S?S.widgetId:Number(c)),h?.children?.length&&await gn(h),T=Bt(o,S?S.widgetId:c,!1,s.elementBelowDrag,C,n)}const b=B.clearDraggedWidget(h),y=await fe(b,T);b.wrapper=T?.id,ki();const E=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(E){const S=E.id,x=Ye(f?.staticWidgetTree,S);x&&x.children.push(b);const P=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=P?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=P?.style.cssText,await K(f.selectedStaticWidgetTreeInfo.widgetTree),G=null,!1}const L=await _t();f.staticWidgetTree.html=L,f.staticWidgetTree?.children?.push(b);const _=f.widgetTree.children.indexOf(b);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},await Oe(b),await K(b,!1,y),B.enableWidgetButtons(),G=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),G=null,!1}function cr(){document.querySelectorAll(".mftsccs-marking-element img").forEach(n=>{n.setAttribute("draggable","true"),n.addEventListener("dragstart",e=>{e.stopPropagation(),Rt=Date.now()}),n.addEventListener("dragend",e=>{e.stopPropagation(),setTimeout(()=>{Rt=null},100)})})}function dr(){Rt=null,G=null,console.log("dragStartTime",Rt)}async function mn(n,e=!1,t,a){if(!n&&e&&t&&a){const l=await ge(Number(t)),u=Bt(a,t,!1,null,"below",n),c=B.clearDraggedWidget(l);let d=await fe(c,u);c.wrapper=u?.id;const g=await $t();f.staticWidgetTree.html=g,f.staticWidgetTree?.children?.push(c);const m=f.widgetTree.children.indexOf(c);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[m],isChildWidget:!0,childWidgetIndex:m},await Oe(c),K(c,!1,d),B.enableWidgetButtons();return}if(!n){console.error("dropElement called without event");return}n.preventDefault(),n.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let o=n.dataTransfer.getData("text");if((l=>{try{return JSON.parse(l),!0}catch{return!1}})(o))if(Object.keys(JSON.parse(o)).includes("widgetcodeId")){const l=JSON.parse(o);let u=Hn(n,l);const c=l.className.split(" ");if(!u.status){alert(u.message);return}const d=JSON.parse(o);if(d.sourceElementId){const x=document.getElementById(d.sourceElementId.toString());if(x){n.target.insertBefore(x,u.elementBelowDrag??null);return}}let g=vs(d),m=u?.dropzoneEl;m.classList.remove("dragging-area");const p=await I();let h=!1;c.includes("publicWidgetRouter")&&(h=!0);let w=null,v=null;const C=n.clientY,T=m.getBoundingClientRect(),b=bt(T,C);if(h){w=await ge(Number(g)),v=Bt(m,g,!1,u.elementBelowDrag,b,n);const x=document.getElementById("widgetNameValue");x&&w?.name&&(x.value=w?.name);const k=document.getElementById("widget-builder");k&&w?.name&&(k.textContent="Widget Builder Panel: "+w?.name)}else{const x=await Me(g,p.token);w=await ge(x?x.widgetId:Number(g));const k=document.getElementById("widgetNameValue");k&&w?.name&&(k.value=w?.name);const P=document.getElementById("widget-builder");P&&w?.name&&(P.textContent="Widget Builder Panel: "+w?.name),w?.children?.length&&await gn(w),v=Bt(m,x?x.widgetId:g,!1,u.elementBelowDrag,b,n)}const y=B.clearDraggedWidget(w);let E=await fe(y,v);y.wrapper=v?.id;const L=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(L){const x=L.id,k=Ye(f?.staticWidgetTree,x);k&&k.children.push(y);const $=document.getElementById(x).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=$?.innerHTML,await Oe(f.selectedStaticWidgetTreeInfo.widgetTree),K(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const _=await $t();f.staticWidgetTree.html=_,f.staticWidgetTree?.children?.push(y);const S=f.widgetTree.children.indexOf(y);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[S],isChildWidget:!0,childWidgetIndex:S},await Oe(y),K(y,!1,E),B.enableWidgetButtons()}else{let l=function(w,v){document.getElementById("builder-workarea")===w&&(v="inside");let T=Le.generateUUID();const b=ec(T,u),y=document.createElement("div");y.innerHTML=b;const E=y.firstChild,L=w.parentElement;if(v==="above")L.insertBefore(E,w);else if(v==="below"){const S=w.nextElementSibling;S?L.insertBefore(E,S):L.appendChild(E)}else if(v==="inside"){const S=la(w,n.clientY);S==null?w.appendChild(E):w.insertBefore(E,S)}n.target.classList.remove("dragging-area");let _=E;u.data_type=="layout"?_.querySelectorAll(".fslayout-col").forEach(x=>{x.classList.add("wb-initial-empty")}):(_.classList.add("wb-initial-empty"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))),_.removeAttribute("element-info-id"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))};const u=JSON.parse(o);let c=Hn(n,u);const d=c?.dropzoneEl;if(c.status){const w=n.clientY,v=d.getBoundingClientRect(),C=bt(v,w);l(d,C)}else alert(c.message);const g=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(g){const w=g.id,v=Ye(f?.staticWidgetTree,w);if(v){const C=g.querySelector(".mftsccs-marking-element");v.html=C?.innerHTML,await K(v)}return n.dataTransfer.clearData(),!1}const m=document.querySelector(".content-target"),h=(await ke(m,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=h;try{n.dataTransfer.clearData()}catch(w){console.error("error in clearing data",w instanceof Error?w.message:String(w))}return!0}else{const l=F.staticElement,u=n.target;u.classList.remove("dragging-area"),ne?.position==="top"&&u?.children?.length?u.insertBefore(l,ne?.element):ne?.position==="bottom"?ne?.element?.insertAdjacentElement("afterend",l):u.appendChild(l),Ht();const c=await $t();f.staticWidgetTree.html=c}}function la(n,e){return Array.from(n.children)?.reduce((a,i)=>{const o=i.getBoundingClientRect(),s=e-o.top-o.height/2;return s<0&&s>a.offset?{offset:s,element:i}:a},{offset:Number.NEGATIVE_INFINITY,element:null}).element}function bt(n,e){const t=n.height,a=e-n.top;return a<t*.25?"above":a>t*.75?"below":"inside"}function ur(n){const o=new DOMParser().parseFromString(n,"text/html").body.querySelector("div")?.id,r=document.getElementById(o)?.parentElement?.closest(".added-widget-container"),l=r?.id,u=r?.querySelectorAll(".widget_container_disabled");return u?.length&&u?.forEach(c=>{const d=Le.generateUUID();c.id=`wdgt${d}`}),l?.toString()}async function gn(n){return Array.isArray(n.children)&&n.children.forEach(e=>{Mi(e,n),e.children.length&&gn(e)}),n}function Mi(n,e){const t=n.wrapper,o=new DOMParser().parseFromString(e?.html,"text/html").body,s=o.querySelector(`#${t}`);if(!s)return n;const l=`wdgtcopy${Le.generateUUID()}`;return s.id=l,n.wrapper=l,e.html=o.innerHTML.toString(),n}const mr=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:un,dragElement:ir,dragEndWidgetElement:sr,dragOverWidgetElement:rr,dragStartWidgetElement:or,dropElement:mn,dropFolderElement:Ii,dropWidgetElement:lr,findChildByWrapper:Ye,getChildWrapperId:ur,getChildrenWrapperId:Mi,getDragAfterElement:la,getDropType:bt,onDragEnter:Zs,onDragLeave:Xs,onDragOver:er,onDragStart:Ys,onDrop:nr,onWidgetDragStart:Ks,removeChildByWrapper:Vt,removeElement:ar,resetDragState:dr,updateAllChildWidgets:gn},Symbol.toStringTag,{value:"Module"})),gr=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],ca=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class Pi{constructor(){}async getLayoutListHTML(){return ca.map(t=>`
      ...
      `:"").join("")}}const pr=n=>{const e=n?.id;if(!e)return null;const t=n?.data?.the_widget;return{widgetId:e,widgetVersion:t?.the_widget_version?.[0]?.data?.the_version??null,widgetName:t?.the_widget_name?.[0]?.data?.the_name??"",widgetType:t?.the_widget_type?.[0]?.data?.the_type??""}},hr=async n=>{const e=new Map,t=new M;t.typeConnection="the_widget_version",t.name="version";const a=(r,l,u=!1)=>{const c=new M;return c.typeConnection=r,c.name=l,c.freeschemaQueries=[t],c.selectors=["the_widget_name","the_widget_type"],u&&(c.reverse=!0),c},i=a("the_widget_s_copy","copywidgets"),o=a("the_widget_root","rootwidgets",!0),s=new M;return s.conceptIds=[n],s.freeschemaQueries=[i,o],s.inpage=100,s.outputFormat=Ao,await new Promise(r=>{ye(s,"").subscribe(l=>{const u=l?.[0]?.data?.the_widget;if(!u){console.warn("No widget data found."),r();return}const c=[...u?.the_widget_s_copy??[],...u?.the_widget_root_reverse??[]];for(let d=0;d<c.length;d++){const g=pr(c[d]);g&&e.set(g.widgetId,g)}r()})}),e};async function Me(n,e){let t=new z;t.composition=n,t.fullLinkers=["the_widget_recent","the_widget_latest"],t.inpage=100;let a=new z;a.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],a.inpage=100;const o=await be([t,a],e),r=await He(n,"the_widget_recent"),l=o?.data?.the_widget?.the_widget_recent||o?.data?.the_widget?.the_widget_latest||[],u=o?.data?.the_widget?.the_widget_latest||null;if(l.length){const c=l[0],d=c?.data.the_widget.the_widget_name?.[0].data.the_name,g=c?.data.the_widget.the_widget_html?.[0].data.the_html,m=c?.id,p=c?.data.the_widget.the_widget_css?.[0].data.the_css,h=c?.data.the_widget.the_widget_js?.[0].data.the_js,w=c?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,v=c?.data.the_widget.the_widget_version?.[0].data.the_version,C=c?.data.the_widget.the_widget_origin?.[0].data.the_origin|n;return{widgetName:d,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:w,widgetVersion:Number(v||u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||u.id,origin:Number(C),connectionIdLatest:r,publishedWidgetVersion:u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const B=(()=>{const n=async()=>{const b=document.getElementById("fslayout-template-container");if(b){b.innerHTML=`
        ...
        </li>`;const E=await new Pi().getTemplateLayoutsHTML();b.innerHTML=E}},e=async()=>{const b=document.getElementById("public-widget-list-container");if(b){const y=await Qn();!y||y.trim()===""?b.innerHTML=`
            <li class="list-unstyled">
...
`;m?.file(`${d.slug}.index.ts`,p)}e?.file("routes.ts",pn(t))},Ir=async(n,e,t)=>{console.log("widgetsDir",t);const i=(await I())?.token,o=await _a(n,i,!0);let s=e?.folder("home");const r=`
...
`;s?.file("home.index.ts",r),o?.css&&s?.file("home.style.css",o?.css)},Mr=async n=>{if(he)return;he=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new on;const a=await fn(t),i=a?.widgetsDir,o=a?.pagesDir;let s="";i&&o&&(s=await Pr(n,o)),a?.routesDir?.file("routes.ts",pn(e)),t.generateAsync({type:"blob"}).then(function(r){let l=document.createElement("a");l.href=URL.createObjectURL(r),l.download=`${s||"page"}.zip`,l.click()}),he=!1},Pr=async(n,e)=>{const t=await I(),a=t?.entityId,i=t?.token,o=await _a(n,i,!0),s=new z;s.composition=a,s.inpage=100,s.fullLinkers=["the_entity_s_page"];const r=new z;r.inpage=100,r.composition=n,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const u=(await be([s,r],i))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==n),c=u?.[0]?.data?.the_page?.the_page_body?.[0]?.id,d=u?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    ...
    `;return g?.file("home.index.ts",m),o?.css&&g?.file("home.style.css",o?.css),d},Br=async n=>{if(he)return;if(!n){console.log("Project id is required");return}const i=(await new hn().getProjectById(n))?.data?.the_project?.the_project_name?.[0]?.data?.the_name?.replace(/\s/g,"_").toLowerCase();he=!0;let o=new on;const s=await fn(o),r=s?.routesDir,l=s?.pagesDir;await $r(l,r,n),o.generateAsync({type:"blob"}).then(function(u){let c=document.createElement("a");c.href=URL.createObjectURL(u),c.download=`the_${i}.zip`,c.click()}),he=!1},$r=async(n,e,t)=>{if(!n&&!e)return;let a=[];const o=(await I())?.token,s=new z;s.composition=t,s.inpage=100,s.fullLinkers=["the_project_s_page","the_project_main_page"];const r=new z;r.inpage=100,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const l=await be([s,r],o),u=l?.data.the_project?.the_project_main_page?.[0]?.id;if(l?.data.the_project?.the_project_s_page?.length)for(let c=0;c<l?.data.the_project?.the_project_s_page?.length;c++){const d=l.data.the_project.the_project_s_page[c];let g={page:d?.id,title:d?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:d?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:d?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:d?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:d?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:d?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!g.page)continue;const m=`${g.slug.split("-").map((w,v)=>v===0?w.charAt(0).toLowerCase()+w.slice(1):w.charAt(0).toUpperCase()+w.slice(1)).join("")}`;a.push({path:`/${g.slug}`,content:`${m}Index`,importFrom:`/${g.slug}/${g.slug}.index.ts`}),g.page==u&&a.push({path:"/",content:`${m}Index`});let p=n?.folder(g.slug);const h=`
                ...
                }`;p?.file(`${g.slug}.index.ts`,h)}e?.file("routes.ts",pn(a))};async function Nr(){const n=new ae("mountchildwidgets-editor-split"),e=document.getElementById("mountchildwidgets-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Dr(){const n=new ae("onupdate-editor-split"),e=document.getElementById("onupdate-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Bi(){await Nr(),await Dr(),await Ts(),await Ss()}function jr(){document.getElementById("widget-lifecycle-form")?.remove(),document.createElement("div").setAttribute("id","widget-lifecycle-form")}function $i(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.add("saveWidgetDisabled")})}function Un(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.remove("saveWidgetDisabled")})}class Ni{arrowBtn=null;updateOnlyButton=null;isDroppedDown=!1;constructor(){}async LoadPageWidget(e){const a=(await I())?.token;oa(),$i(),document.querySelector("#widget-properties #widget-type input")?.remove(),jr(),await Bi();let o=cn(),s=await Me(e,a),r=await ge(s?.widgetId??e),l=await fe(r,o);this.addPageUpdate(e),Un(),f.resetWidgetTree(),f.widgetTree=r,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),K(r,!1,l,!0),B.enableWidgetButtons(),un(),de(),pe()}toggleUpdate(e){this.updateOnlyButton&&this.arrowBtn&&(this.isDroppedDown&&e!==!0?(this.updateOnlyButton.classList.remove("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.updateOnlyButton.classList.add("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isDroppedDown=!this.isDroppedDown)}addPageUpdate(e){const t=document.getElementById("widget-btn-wrapper");t.innerHTML=`
        <div class="position-relative" style="z-index: 100;">
          <div class="w-100 d-flex justify-content-center">
    ...
    `}let xn,gt;async function Vr(n,e){xn=n;const t=Fr(e,typeof n=="object"?0:n),a=document.createElement("div");a.innerHTML=t;const i=a.querySelector("#folder-widget-container");document.querySelector("body #app")?.appendChild(i),await re("folder-widget-container");const o=await I();if(!o)return;let s,r,u=(await lt(xn,o.token))?.data?.the_widget?.the_widget_name?.[0]?.data?.the_name;e===!0?(s=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name"),s&&(s.value=u),r=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")):(s=document.getElementById("folder-widget-container")?.querySelector("input#folder-name"),r=document.getElementById("folder-widget-container")?.querySelector("textarea#description"));const c=document.getElementById("widgetFolder");gt=await Be(U.folder_widget,c,{widgetName:s.value,widgetDescription:r?.value,widgetId:xn,showCheckbox:!0,showFiles:!1})}async function Rr(n,e,t,a){n.preventDefault(),console.warn("asdfads",gt.selectedConceptIds);let i=[];gt&&gt?.selectedConceptIds?.length>0&&(i=gt.selectedConceptIds||[]);try{A.infoMessageToast("Saving Widget...",0),await Fe();const o=document.getElementById("folder-widget-container"),s=o?.querySelector('button[type="submit"]');s.textContent="Saving";const r=o?.querySelector("input"),l=o?.querySelectorAll("button"),c=(document.getElementById("save-to-folder-name")||document.getElementById("folder-name")).value;l&&l.forEach(T=>{T.disabled=!0}),r&&(r.disabled=!0),await Ne();let d;if(!a){F.staticElement?.removeAttribute("draggable");const T=document.querySelectorAll(".edited-widget-container");T?.length&&T.forEach(async E=>{if(E.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[E.id]){const L=await ke(E,"div.mftsccs-marking-element");f.editedWidgets[E.id].html=L.innerHTML}});const b=await Ji();f.staticWidgetTree.html=b;const y=await f.saveWidget(c);d=await Y(y.id),t=d.id}const g=await I(),m=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name")?.value||document.getElementById("folder-widget-container")?.querySelector("input#folder-name")?.value,p=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")?.value,h={title:m,source_url:window.location.href,widget_id:t,short_desc:p,note:"",data_type:"widget",created_on:Date.now()};if(i.length==0){const T=g?.userConcept;d=await Y(Number(t));let b={...h,boom_folder:{name:"",parent:T}};const y=await Ge({boomgpt:b},void 0,void 0,void 0,g.userId,4);await Dt(await Y(Number(T)),y,"the_boom_folder_s_contain"),await J(y,d,"the_refer")}else if(i?.length>0)for(let T=0;T<i.length;T++){const b=i[T];d=await Y(Number(t));const y=await Y(Number(b));if(!y)throw new Error("Selected folder concept not found!");let E={...h,boom_folder:{name:y.name||"",parent:b}};const L=await Ge({boomgpt:E},void 0,void 0,void 0,g.userId,4);await Dt(await Y(Number(b)),L,"the_boom_folder_s_contain"),await J(L,d,"the_refer")}await j.SyncDataOnline(),document.getElementById(e)?.querySelector("form")?.reset(),_e("folder-widget-container"),xt(),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget saved successfully!"),a||(await B.renderSavedWidgets(),Wt(n,Number(t)))}catch(o){document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Error in saving widget"),ha(o,"There is an error on saving widget")}}class ji extends Ct{mainConcept=0;mainData;data=0;phonebooks=[];the_params;component_heading;saveButtonHTML;saveBoomButtonHTML;previewButtonHTML;tryAIButtonHTML="";responsiveButtonHTML="";environmentSelector="";_pageBuilderService;previewArrowButton=null;previewCacheButton=null;isPreviewDroppedDown=!1;constructor(e){super(),this.component_heading="Widget Builder Panel",this.saveButtonHTML="",this.saveBoomButtonHTML="";const t=I();if(t&&(this.environmentSelector=`
      <style>
    ...
    `,e){this.the_params=e,this._pageBuilderService=new Ni;const a=this.the_params?.data?.the_page_title?.data?.the_title;this.component_heading=this.the_params.type?"Page Builder: "+a:"Widget Builder";const i=this.the_params?.page_id;t&&e.type==da.page&&(this.saveBoomButtonHTML=`
         <div class="text-end d-flex flex-row" id="widget-btn-wrapper">
...
`}before_render(){this.render()}after_render(){if(this.the_params){this.initializePreviewDropDown(),document.getElementById("fspage-save-button").addEventListener("click",ua);const t=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!t){un();return}this._pageBuilderService.LoadPageWidget(Number(t))}}initializePreviewDropDown(){this.previewArrowButton=document.getElementById("updateDropDownPagePreview"),this.previewCacheButton=document.getElementById("preview-cache-btn"),this.previewCacheButton.addEventListener("click",()=>{this.togglePreviewUpdate(!0)}),this.previewArrowButton.addEventListener("click",()=>{this.togglePreviewUpdate(!1)})}togglePreviewUpdate(e){this.previewCacheButton&&this.previewArrowButton&&(!this.isPreviewDroppedDown&&e!==!0?(this.previewCacheButton.classList.remove("d-none"),this.previewArrowButton.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.previewCacheButton.classList.add("d-none"),this.previewArrowButton.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isPreviewDroppedDown=!this.isPreviewDroppedDown)}getHtml(){return window.openSaveWidgetModal=wa,window.saveWidget=zi,window.updateWidget=va,window.newWidget=Je,window.previewWidget=ol,window.downloadWebsite=Ar,window.moveUp=Le.moveUp,window.moveDown=Le.moveDown,window.copyElement=Le.copyElement,window.editWidget=Le.editWidget,window.openConvertModal=ll,window.convertToWidget=sl,window.updatePage=ma,window.previewPage=Or,window.previewPageCahe=qr,window.undoAction=N.undoAction,window.redoAction=N.redoAction,window.saveWidgetToFolderBtn=Vr,window.openPromptModal=qs,window.openAIModal=xi,window.refineAIData=Vn,`
  ...
  `,document.querySelector("body #app")?.appendChild(r),await re(o);const l=document.getElementById("environment-editor-container");if(!l)return;const u=aa(m=>{const p=[],h=m.state.doc.toString();try{JSON.parse(h)}catch(w){const v=w,C=v.message.match(/position (\d+)/),T=C?parseInt(C[1]):0;p.push({from:Math.max(0,T-1),to:Math.min(h.length,T+1),severity:"error",message:v.message})}return p});let c=null;c=new te({doc:JSON.stringify(e,null,2),extensions:[ot,st,tn(),na(),u,te.lineWrapping,xe.tabSize.of(2)],parent:l}),document.getElementById("format-json-btn")?.addEventListener("click",()=>{try{const m=c?.state.doc.toString()||"{}",p=JSON.parse(m),h=JSON.stringify(p,null,2);c?.dispatch({changes:{from:0,to:c.state.doc.length,insert:h}}),alert("JSON formatted successfully!")}catch(m){alert("Invalid JSON: "+m.message)}});const g=document.getElementById("save-environment-btn");g?.addEventListener("click",async()=>{try{g.disabled=!0,g.textContent="Saving...";const p=document.getElementById("environment-name-input")?.value?.trim()||"default";if(!p){alert("Environment name is required"),g.disabled=!1,g.textContent="Save Changes";return}const h=c?.state.doc.toString()||"{}";let w;try{w=JSON.parse(h)}catch(y){alert("Invalid JSON: "+y.message),g.disabled=!1,g.textContent="Save Changes";return}const v=await new St;await v.initialize();let C;t?(console.log("Editing existing environment:",t),C=await D(t),a&&await oe(t,"the_environment_name"),i&&await oe(t,"the_environment_value")):(console.log("Creating new environment"),C=await v.MakeTheInstanceConceptLocal("the_environment","",!0,999,4));const T=await v.MakeTheInstanceConceptLocal("the_name",p,!1,999,4),b=await v.MakeTheInstanceConceptLocal("the_environment_value",JSON.stringify(w),!1,999,4);if(await v.CreateConnection(C,T,"the_environment_name"),await v.CreateConnection(C,b,"the_environment_value"),!t){const E=(await I())?.entityId;if(E){const L=await D(E);await v.CreateConnection(L,C,"the_entity_s_environment")}}await v.commitTransaction();try{const{refreshEnvironmentDropdown:y,saveEnvironmentToStorage:E}=await ce(async()=>{const{refreshEnvironmentDropdown:L,saveEnvironmentToStorage:_}=await Promise.resolve().then(()=>bo);return{refreshEnvironmentDropdown:L,saveEnvironmentToStorage:_}},void 0);if(await y(),t){const _=(window.__allEnvironments||[]).findIndex(S=>S.id===t);_!==-1&&(E(w,_),console.log(`Updated environment "${p}" in RAM and localStorage`))}}catch(y){console.log("Could not refresh environment dropdown:",y)}alert("Environment variables updated successfully!"),g.disabled=!1,g.textContent="Save Changes",window.closeModal(o)}catch(m){console.error("Error saving environment:",m),alert("Failed to save environment variables: "+m),g.disabled=!1,g.textContent="Save Changes"}})},Gr=Object.freeze(Object.defineProperty({__proto__:null,createEnvironmentEditor:pa,createEnvironmentEditorWithData:Jr},Symbol.toStringTag,{value:"Module"}));function Qr(n,e=[],t=[]){return`
  <style>
  .accordion-header {
  background: gray;
  color: white;
...
.custom-menu-item {
  ...
  `}async function nl(n,e){if(n.preventDefault(),!(await Ce.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const a=new FormData(n.target),i=Object.fromEntries(a);console.log(i,"update formValues");const o=await Vi(a,e);await fa("update-element-dialog");const s=await yn();if(o){const r=document.getElementById("created-elements");r?!s||s.trim()===""?r.innerHTML=`
      ...
      `:r.innerHTML=s||"":console.error("Widget list container not found in the DOM.")}return o}class al{createElemenModaltHTML;singleElement;constructor(e){e&&this.init(e)}async init(e){this.getSingleElementDetails(e)}async getSingleElementDetails(e){const t=await Ca(e);this.singleElement=t,this.createElemenModaltHTML=this.getHtml(),t&&(document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML),document.getElementById("update-element-dialog").showModal(),await ya(this.singleElement.attributes))}getHtml(){return window.updateNewElement=nl,window.closeElementModal=fa,`<dialog id="update-element-dialog" class="col-md-4 a-dialog update-element-dialog">
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class il{createElemenModaltHTML;constructor(){window._dragService=mr,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=Zr,window.cancelAttributeRow=Ri,window.addAttribute=Xr,window.removeSelectedAttribute=el,window.closeElementModal=fa,`
    ...
    `}}async function re(n){document.getElementById(n).showModal()}async function _e(n){const e=document.getElementById(n);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function Ui(n,e){n?.stopPropagation();const t=document.getElementById(`menu-${e}`),a=t?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(o=>{o.classList.remove("show")}),t&&!a&&t.classList.add("show")}async function td(n){new il,await re(n)}async function nd(n,e,t){n.stopPropagation(),console.log("modalId",e),Ui(n,Number(t)),new al(t)}async function ad(n,e){Ui(n,e),confirm("Are you sure you want to delete the element?")&&(await We(e),A.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const a=await yn(),i=document.getElementById("created-elements");i?!a||a.trim()===""?i.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
  ...
  `,document.querySelector("body #app")?.appendChild(e),re("save-widget-dialog"),new Promise((t,a)=>{const i=e.querySelector("#save-widget-form");i.onsubmit=async s=>{s.preventDefault();try{const r=new FormData(i),u=Object.fromEntries(r).widgetName,c=s.target;if(!u?.trim()){const d=c.querySelector("#widgetName");d?.focus(),d.style.border="2px solid red",d.style.outline="none",d.addEventListener("input",()=>{d.style.border=""});return}await zi(s,u),_e("save-widget-dialog"),t("Widget saved successfully")}catch(r){console.error("Error saving widget:",r),a("Error saving widget")}};const o=e.querySelector("button[type='button']");o.onclick=()=>{_e("save-widget-dialog"),t("Widget saving canceled")}})}async function zi(n,e){n.preventDefault();try{A.infoMessageToast("Saving Widget...",0),await Fe();const t=document.getElementById("save-widget-dialog"),a=t?.querySelector('button[type="submit"]');a.textContent="Saving";const i=t?.querySelector("input"),o=t?.querySelectorAll("button");o&&o.forEach(d=>{d.disabled=!0}),i&&(i.disabled=!0),await Ne(),F.staticElement?.removeAttribute("draggable");const s=document.querySelectorAll(".edited-widget-container");s?.length&&s.forEach(async d=>{if(d.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[d.id]){const g=await ke(d,"div.mftsccs-marking-element");f.editedWidgets[d.id].html=g.innerHTML}});const r=await Ji();f.staticWidgetTree.html=r;const l=await f.saveWidget(e),u=await Y(l.id);_e("save-widget-dialog"),xt(),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget saved successfully!"),await B.renderSavedWidgets(),Wt(n,u.id);return}catch(t){document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Error in saving widget"),ha(t,"There is an error on saving widget")}}async function va(n,e,t){const a=document.getElementById("update-publish-widget-btn");try{const i=document.getElementById("update-widget-btn");a&&a.classList.add("disabled"),i&&(i.classList.add("disabled"),i.textContent="Updating...",A.infoMessageToast("Updating Widget...",0)),await Ne(),F.staticElement?.removeAttribute("draggable");const o=document.querySelectorAll(".edited-widget-container");o?.length&&o.forEach(async u=>{if(u.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[u.id]){const c=await ke(u,"div.mftsccs-marking-element");f.editedWidgets[u.id].html=c.innerHTML}});const s=await ba();f.staticWidgetTree.html=s,await f.updateWidget(),xt(),pe(),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget Updated Successfully"),await B.renderSavedWidgets(),await B.renderBoomWidgets();const l=document.getElementById("widget-builder");l.textContent="Widget Builder Panel",await Wt(n,f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:e),t&&t===!0&&await f.publish();return}catch(i){document.querySelector(".infoMessageToast")?.remove();const s=document.getElementById("update-widget-btn");s&&(s.classList.remove("disabled"),s.innerHTML=`
    ...
    `}}async function _l(n,e){const t=document.getElementById("documentation-view");await Be(U.documentation_preview_widget,t,{currentWidgetId:e})}let ft,Wn="",zn,Jn;async function El(n,e){zn=n,e==="preview"?new bl:new vl;const t=new M;t.typeConnection="the_widget_documentation",t.name="documentationText",t.selectors=["the_documentation_text"];const a=new M;a.typeConnection="the_widget_s_documentation",a.name="documentationBlank",a.selectors=["the_documentation_text","the_documentation_content","the_documentation_language","the_documentation_doc_title","the_documentation_folder","the_documentation_creator_email","the_documentation_created_by","the_documentation_content","the_documentation_type","the_documentation_s_doc_url","the_documentation_s_image_url","the_documentation_s_video_link","the_documentation_auth_type","the_documentation_bearer_token","the_documentation_method","the_documentation_method_url","the_documentation_username","the_documentation_password","the_documentation_s_json_list","the_documentation_api_script","the_documentation_api_body","the_documentation_code_editor","the_documentation_return"];const i=new M;i.typeConnection="the_documentation_s_json_list",i.name="documentationJSON",i.selectors=["the_json_list_key","the_json_list_value"],a.freeschemaQueries=[i];const o=new M;o.conceptIds=[zn],o.freeschemaQueries=[t,a],o.inpage=100,o.outputFormat=se,await ye(o,"").subscribe(async s=>{const r=s?.[0]?.data?.the_widget?.the_widget_documentation?.data?.the_documentation?.the_documentation_text?.data?.the_text||"";r&&(Wn=r);const l=s?.[0]?.data?.the_widget?.the_widget_s_documentation;l?.length&&(Wn=l?.map(c=>{const d=c?.data?.the_documentation,g=d?.the_documentation_type?.data?.the_type,m=d?.the_documentation_content?.data?.the_content,p=d?.the_documentation_creator_email?.data?.the_creator_email,h=d?.the_documentation_doc_title?.data?.the_doc_title,w=d?.the_documentation_method?.data?.the_method,v=d?.the_documentation_method_url?.data?.the_method_url,C=d?.the_documentation_bearer_token?.data?.the_bearer_token,T=d?.the_documentation_username?.data?.the_username,b=d?.the_documentation_password?.data?.the_password,y=d?.the_documentation_auth_type?.data?.the_auth_type,E=d?.the_documentation_s_json_list,L=d?.the_documentation_api_script?.data?.the_api_script,_=d?.the_documentation_api_body?.data?.the_api_body,S=d?.the_documentation_language?.data?.the_language,x=d?.the_documentation_return?.data?.the_return,k=d?.the_documentation_code_editor?.data?.the_code_editor,P=d?.the_documentation_s_doc_url,$=d?.the_documentation_s_image_url,V=d?.the_documentation_s_video_link;let O={type:g,content:m,creatorEmail:p,title:h};if(g==="blank")O={...O};else if(g==="api"){const R=[];E?.length&&E?.forEach(Q=>{R.push({key:Q?.data?.the_json_list?.the_json_list_key?.data?.the_key,value:Q?.data?.the_json_list?.the_json_list_value?.data?.the_value})}),O={...O,method:w,methodURL:v,authType:y,username:T,password:b,bearerToken:C,json:R,script:L,body:_}}else g==="function"&&(O={...O,language:S,return:x,codeEditor:k});const Ve=[],Ee=[],Te=[];return $?.length&&$?.forEach(R=>{Ve.push(R?.data?.the_image_url)}),V?.length&&V?.forEach(R=>{Ee.push(R?.data?.the_video_link)}),P?.length&&P?.forEach(R=>{Te.push(R.data?.the_doc_url)}),O={...O,imageList:Ve,linkList:Te,videoList:Ee},O})),Jn=s?.[0]?.data?.the_widget?.the_widget_documentation?.id,e!=="preview"&&Sl(r)}),e==="preview"?(await re("widget-documentation-preview-modal"),_l(Wn,n)):await re("widget-documentation-modal")}async function Tl(){if(ft){const n=ft.getData(),e=await D(zn),a=(await I())?.userId;if(Jn)await it(Jn,"the_documentation_text","text",n,a),await j.SyncDataOnline();else{const i=await q("documentation",a,{text:n});await J(e,i,"documentation"),await j.SyncDataOnline()}A.successfullToast("Documentation is saved."),ft.setData(n)}else console.error("Editor not initialized"),A.errorToast("Documentation couldn't saved.")}function Sl(n){const e=document.querySelector("#documentation-editor");e&&Oo.create(e,{licenseKey:"GPL"}).then(t=>{ft=t;const a=n;ft.setData(a)}).catch(t=>{console.error("Error initializing CKEditor:",t)})}class Cl{constructor(){this.init()}init(){document.getElementById("btn-take-tour")?.addEventListener("click",t=>{if(t.target.matches(".btn-tour")){const a=t.target.dataset.tourStatus;this.startTour(a)}})}startTour(e){const t=new No.Tour({defaultStepOptions:{classes:"wico",scrollTo:!0,cancelIcon:{enabled:!0}},useModalOverlay:!0}),a=[{classes:"back-button",text:"Back",action:t.back},{classes:"next-button",text:"Next",action:t.next}];t.addStep({id:"welcome",title:"👋 Welcome to Widget Conceptualizer",text:["This short tour will walk you through the essentials. Let's begin. Start building widgets today!"],buttons:[{text:"Remind me later",classes:"back-button",action:t.complete},{text:"Next",classes:"next-button",action:()=>{t.next()}}]}),t.addStep({id:"step-create-widget",title:"Create a New Widget",text:["Start by creating a new widget."],classes:"onboarding-boomconsole",highlightClass:"highlight",attachTo:{element:".wico_header-section",on:"bottom-start"},buttons:a}),t.addStep({id:"step-widget-panel",classes:"tour-widget-panel",title:"Workspace Area",text:"This is your creative canvas. Drag and drop elements, build widgets, apps, or full pages—right in the workspace.",attachTo:{element:".content-target",on:"top"},buttons:a}),t.addStep({id:"step-builder-meu",title:"Builder Menu",text:"This menu provides essential navigation tools. Use it to manage projects, access assets, open pages, and explore saved widgets.",attachTo:{element:".sidebar-collapsed",on:"left"},buttons:a}),t.addStep({id:"step-properties",title:"Properties Panel",text:"Adjust Styling, add properties like layout, colors, fonts, and more.",attachTo:{element:()=>{const i=document.querySelector("#tab-container .tab button:nth-child(2)"),o=new Event("click",{bubbles:!0,cancelable:!0});return i.dispatchEvent(o),".right-aside"},on:"left"},buttons:a}),t.addStep({id:"step-design-code-mode",title:"Design & Code Modes",text:[`
      ...
      `;const e=n?.entityId;await Fe();const t=new wt;t.type="the_public_widget",t.search="",t.operateon="public",t.name="publicfilter",t.logicoperator="=";const a=new M;a.typeConnection="the_public_widget_s_widget",a.freeschemaQueries=[],a.name="public",a.reverse=!0;const i=new M;i.typeConnection="the_widget_recent",i.name="copywidgets",i.selectors=["the_widget","the_widget_name","the_widget_timestamp","the_widget_version","the_widget_origin"],i.freeschemaQueries=[a];const o=new M;o.typeConnection="the_entity_s_widget",o.name="mywidgets",o.selectors=["the_widget","the_widget_name","the_widget_timestamp","the_widget_recent"],o.freeschemaQueries=[i];const s=new M;return s.conceptIds=[e],s.freeschemaQueries=[o],s.inpage=100,s.outputFormat=se,await new Promise((l,u)=>{ye(s,"").subscribe(async c=>{const d=c?.[0]?.data?.the_entity?.the_entity_s_widget||[];if(!d.length)return l(`
              <li class="list-unstyled">
                <p class="text-center my-3 text-secondary">No saved widget</p>
              </li>
...
`).join("<br>"),o=`
  ...
  `,s=document.getElementById("widget-detail-modal");s&&s.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",o),re("widget-detail-modal")}window.viewPublicWidgetDetails=ql;window.openCSSEditor=Et;class Zi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let t=function(i){if(!i)return;const{wrapper:o}=i,s=o&&o!=="0"?`#${o}`:".content-target";a=a+`${s} { ${i.css} }`,i.children.forEach(r=>{t(r)})},a="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),t(f.widgetTree),this.styleElement.textContent=a}}async getWidgetHtml(e){let t=[];e.forEach(a=>{a.classList.forEach(i=>{t.push(i)})}),this.insertCSS(t)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:t,dispatch:a}=e,{selection:i}=t;return i.ranges.length===0?!1:(a({changes:{from:i.ranges[0].from,to:i.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new te({doc:"/* Write your CSS here */",extensions:[ot,st,$o(),nn(),te.lineWrapping,xe.tabSize.of(2),xe.allowMultipleSelections.of(!0),te.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),an.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),te.updateListener.of(async t=>{if(t.docChanged){const a=this.editorView?.state.doc.toString()||"";this.updateCSS(a)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const t of e)if(this.editorView){const{state:a,dispatch:i}=this.editorView;i({changes:{from:0,to:a.doc.length,insert:`.${t} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const Ja=async n=>{const e=new ri,t=Vl(n);if(Object.keys(t).length>0){const a=await e.validateField(t),i=await Yn(a),o=Yn(i);return Ul(n,o)}},Fl=async n=>{const t=await new ri().validateField(n);return Object.keys(t).length>0?{status:!1,details:Yn(t)}:{status:!0}},Vl=n=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},t=n?.attributes;if(Array.isArray(t))t.forEach(a=>{const i=Rl(a);switch(a.name){case"name":e.fieldName=i||"";break;case"value":e.value=i||null;break;case"fieldtype":e.fieldType=i?i.trim():null;break;case"pattern":e.pattern=i||null;break;case"datatype":e.dataType=i?i.trim():null;break;case"typeconcept":e.conceptType=i||null;break;case"maxlength":e.maxLength=i?parseInt(i):null;break;case"minlength":e.minLength=i?parseInt(i):null;break;case"max":e.maxValue=i?parseInt(i):null;break;case"min":e.minValue=i?parseInt(i):null;break;case"accept":e.accept=i||null;break;case"file":e.file=i||null;break;case"required":e.required=i===!0;break;case"unique":e.isUnique=i===!0;break}});else throw console.error('attributesData["attributes"] is not an array',n.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},Rl=n=>{switch(n.type){case"boolean":return n.value==="on";case"array":return n.selected||null;case"string":return n.value||null;default:return null}},Yn=n=>({datatype:n.dataType,pattern:n.pattern,max:n.maxValue,min:n.minValue,minlength:n.minLength,maxlength:n.maxLength,accept:n.accept,file:n.file,required:n.required,unique:n.unique}),Ul=(n,e)=>(n.attributes.forEach(t=>{const a=e[t.name];t.validationStatus=a?"invalid":"valid",t.validationErrorMessage=a||""}),n),zl=n=>({fieldName:n.getAttribute("name"),value:n instanceof HTMLInputElement?n.value:null,fieldType:n.getAttribute("fieldtype"),dataType:n.getAttribute("datatype"),pattern:n.getAttribute("pattern"),conceptType:n.getAttribute("typeconcept"),maxLength:n.getAttribute("maxlength"),minLength:n.getAttribute("minlength"),minValue:n.getAttribute("min"),maxValue:n.getAttribute("max"),file:n.hasAttribute("file"),accept:n.hasAttribute("accept"),required:n.hasAttribute("required"),isUnique:n.getAttribute("unique")==="on"});async function Xi(n){let e=n.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",n.parentNode?.insertBefore(e,n.nextSibling)),e.innerHTML="";const t=zl(n),a=await Fl(t);try{if(a.status)n.classList.remove("invalid"),n.classList.add("valid");else if(n.classList.remove("valid"),n.classList.add("invalid"),a.details&&typeof a.details=="object"){const i=document.createElement("span");i.className="error-message",i.style.color="red",i.style.fontSize="12px";const o=Object.values(a.details).filter(Boolean);i.innerHTML=o.join("<br>"),e.appendChild(i)}}catch(i){console.error("Validation error:",i);const o=document.createElement("span");o.className="error-message",o.style.color="red",o.textContent="Validation failed. Please try again.",e.appendChild(o)}}var et=(n=>(n.STYLE="style",n.BOOLEAN="boolean",n.FORM="form",n.SPECIAL="special",n))(et||{});const Jl=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),Ea=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],Ta=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],Gt=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Gl=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Qt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],ve=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Ql=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Yl=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),Kl=new Set(["elementContent","className","id"]),eo=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function pt(n){return n.toLowerCase()==="type"?!0:eo.has(n.toLowerCase())}function Pt(n,e,t){const a=n.toLowerCase();if(a==="type"){const i=t?Jl.get(t.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):i}return eo.get(a)||[]}class wn{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=qo}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,t){Jt.staticTabName=t;let a,i,o=document.getElementsByClassName("tabcontent");for(a=0;a<o.length;a++)o[a].style.display="none";for(i=document.getElementsByClassName("tablinks"),a=0;a<i.length;a++)i[a].className=i[a].className.replace(" active","");const s=document.getElementById(t);s.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let t=this;for(let i=0;i<e.length;i++)e[i].addEventListener("click",function(o){const s=e[i].getAttribute("data-tab-id");t.openTab(o,s)});const a=document.querySelector(`button[data-tab-id='${Jt.staticTabName}']`);a?a.click():e[0].click()}sortAttributes(e){return e.sort((t,a)=>{if(!t?.name||!a?.name)return 0;const i=this.findAttributeInMap(t.name),o=this.findAttributeInMap(a.name);if(i==="Other"&&o!=="Other")return 1;if(i!=="Other"&&o==="Other")return-1;if(i===o){const s=this.categoryMap[i].findIndex(l=>l.toLowerCase()===t.name.toLowerCase()),r=this.categoryMap[o].findIndex(l=>l.toLowerCase()===a.name.toLowerCase());return s-r}return 0})}getCategoryForAttribute(e){if(!e)return"General";const t=e.toLowerCase();for(const[a,i]of Object.entries(this.categoryMap))if(a!=="Other"&&i.some(o=>o.toLowerCase()===t))return a;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,t){setTimeout(()=>{const a=document.getElementById("element-attributes");if(!a){this.setAttributes(e,t);return}a.innerHTML="";const i=document.createElement("div");if(i.className="row",a.appendChild(i),!e){i.innerHTML="";return}(async()=>await Ja(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const s=this.sortAttributes(e.attributes),r={};s.forEach(u=>{const c=this.getCategoryForAttribute(u.name);r[c]||(r[c]=[]),r[c].push(u)});let l="";Object.entries(r).forEach(([u,c])=>{const d=c.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
                ...
                `;else if(m.name==="Alignment"){const h=e?.tag?.toLowerCase();Ea.includes(h)&&(p=`
                  ...
                  `)}else if(m.name==="Font Family"){const h=e?.tag?.toLowerCase();if(Ta.includes(h)&&pt(m.name)){const v=Pt(m.name,m.value,e?.tag).map(C=>{const T=C.toLowerCase()===(m?.value||"").replace(/"/g,"").trim().toLowerCase();return`<option value="${C}" ${T?"selected":""}>${C}</option>`}).join("");p=`
                      <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                        <option value="">Select Font Family</option>
                        ${v}
                      </select>
                    `}}else if(m.name==="Font Weight"){const h=e?.tag?.toLowerCase();if(Gt.includes(h)&&pt(m.name)){const v=Pt(m.name,m.value,e?.tag).map(C=>{const T=C.toLowerCase()===(m?.value||"").replace(/"/g,"").trim().toLowerCase();return`<option value="${C}" ${T?"selected":""}>${C}</option>`}).join("");p=`
                      <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                  ...
                  <div class="col-12 my-1 hidden">
                    ...
                    >${m?.value||""}</textarea>`;else if(pt(m.name)){const w=Pt(m.name,m.value,e?.tag).map(v=>`<option value="${v}" ${v===m?.value?"selected":""}>${v}</option>`).join("");p=`
                    <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                      <option value="">Select ${m.name}</option>
                      ${w}
                    </select>
