...
${t?.css}`:t?.css;if(await ai(s,o),le(n?.html),await ni(n?.after_render),await ii(n?.before_render),n?.custom_functions?.length){const r=document.querySelectorAll(".custom-service-btn"),l=Array.from(r)?.map(c=>c.getAttribute("data-subtab")??""),d=n.custom_functions?.map(c=>c.slug);(l?.filter(c=>!d.includes(c))).forEach(c=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${c}"]`);g&&g.remove(),document.getElementById(`${c}-editor-split`)?.remove()}),ba(),n.custom_functions?.forEach(c=>{li(c)})}else document.querySelectorAll(".custom-service-btn").forEach(d=>{d.remove()}),document.querySelectorAll(".custom-editor-content").forEach(d=>{d.remove()}),ba();(a||i)&&Kt(n?.origin?n?.origin:n?.widgetId),a&&n?.assistant?.id&&Co(n?.assistant)}const Wn="drop-indicator";function ui(){let n=document.querySelector(`.${Wn}`);return n||(n=document.createElement("div"),n.className=Wn,document.body.appendChild(n)),n}function Wo(n,e){const t=ui(),a=n.getBoundingClientRect();e==="top"?t.style.top=`${a.top-5}px`:e==="bottom"&&(t.style.top=`${a.bottom-5}px`),t.style.left=`${a.left}px`,t.style.width=`${a.width}px`,t.style.opacity="1",t.style.transform="scaleY(1)"}function xo(){document.querySelectorAll(`.${Wn}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function ko(n,e,t){if(e.length===0)return{element:t,position:"top"};const a=n.clientY;let i=e[0],s=Math.abs(i.getBoundingClientRect().top-a);Math.abs(i.getBoundingClientRect().bottom-a);for(const d of e){const u=d.getBoundingClientRect(),c=Math.abs(u.top-a);Math.abs(u.bottom-a),c<s&&(i=d,s=c)}const o=i.getBoundingClientRect(),r=o.top+o.height/2,l=a<r?"top":"bottom";return{element:i,position:l}}let K=null,N;function Xt(){const n=document.querySelector(".content-target > .mftsccs-marking-element");if(n){const e=document.querySelector(".content-target");Ee.fixContentTargetHeight(e,n)}}function Mo(n){K=n.target;let e={data_type:n.target.getAttribute("data-type"),data_default:n.target.getAttribute("data-default"),data_void:n.target.getAttribute("data-void"),data_text:n.target.getAttribute("data-text"),elementId:n.target.getAttribute("data-elementId"),dataId:n.target.id,imageUrl:n.target.imageUrl,displayType:n.target.displayType};n.dataTransfer.setData("text",JSON.stringify(e)),n.dataTransfer.setData("id",n.target.id),n.dataTransfer.effectAllowed="move"}async function Io(n){n.stopPropagation();const e={widgetcodeId:n.target.getAttribute("data-widgetId"),sourceElementId:n.target.id,className:n.target.className,imageUrl:n.target.imageUrl,displayType:n.target.displayType,type:n.target.Type};n.dataTransfer.setData("text",JSON.stringify(e)),n.dataTransfer.effectAllowed="move"}function Po(n){n.preventDefault(),n.stopPropagation(),n.target.classList.add("dragging-area"),vt.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",Gs()}function $o(n){n.preventDefault(),n.stopPropagation(),n.target.classList.remove("dragging-area")}function Bo(n){n.preventDefault(),n.stopPropagation(),(!K||!(n.currentTarget instanceof HTMLElement))&&(K=n?.target);const e=n.target,t=Array.from(e.children).filter(i=>i!==K);ui();const a=ko(n,t,e);N=a,Wo(a.element,a.position)}function jo(){D.checkContent()?D.enableWidgetButtons():D.disableWidgetButtons()}async function Do(n){const e=await en(n);K=null,xo(),q.updateActionHistories(),vt.collapseNavbar(),jo(),Xt(),ue(),e&&(le(),Kt(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),ye()}function Mt(n,e){return Array.isArray(n?.children)&&(n.children=n?.children.filter(t=>t?.wrapper!==e),n.children.forEach(t=>Mt(t,e))),n}function Re(n,e){let t;return Array.isArray(n?.children)&&(t=n?.children.filter(a=>a?.wrapper===e),n.children.forEach(a=>Re(a,e))),t?.[0]}async function No(n){n.preventDefault(),n.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(c=>{const g=document.getElementById(`${c}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};ft(m,`${c}-content`)}});const t=document.getElementById("element-attributes");if(t&&t.style.display==="block"){const c={target:document.querySelector("#icon-attribute")};ft(c,"element-attributes")}const a=R.staticElement,i=a?.parentElement,s=i?.parentElement,o=s?.dataset?.widgetid,r=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container"),l=a.querySelectorAll(".added-widget-container");if(a?.classList?.contains("added-widget-container")){const c=a?.id;Mt(f?.staticWidgetTree,c)}else l.length&&l.forEach(c=>{const g=c?.id;Mt(f?.staticWidgetTree,g)});if(r){const c=r.id;if(a?.remove(),R.staticElement.remove(),Ct(),a?.classList?.contains("added-widget-container")){const g=Re(f?.staticWidgetTree,c),m=r.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,te(g)}else{const m=document.getElementById(c).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,te(f.selectedStaticWidgetTreeInfo.widgetTree)}ue(),q.updateActionHistories();return}i?.classList.contains("mftsccs-marking-element")&&i.children.length===1&&i?.remove(),o&&(s?.children?.length||s?.remove()),a?.remove(),R.staticElement.remove(),Ct();const d=await Ye();return f.staticWidgetTree.html=d,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},Pl(),te(f?.staticWidgetTree),ue(),q.updateActionHistories(),D.checkContent()||(D.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}async function Ho(n){return"drag"}async function qo(n){return n.dataTransfer.setData("text",n.target.id),"start drag"}async function Oo(n){console.log("dragEndWidgetElement event ->",n)}async function Fo(n){return n.preventDefault(),n.stopPropagation(),"dragOverWidgetElement"}async function Vo(n){en(n),le()}let It=null;async function mi(n,e){if(n.preventDefault(),n.stopPropagation(),!K)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let a=n.target;if(!a.classList.contains("mftsccs-marking-element")&&!a.classList.contains("fslayout-col")&&a.id!=="builder-workarea"){const l=document.getElementById("builder-workarea"),d=a.closest(".mftsccs-marking-element"),u=a.closest(".fslayout-col");a=d||u||l}if((K.contains(a)||K===a)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),a=document.getElementById("builder-workarea")),!a)return console.error("Invalid dropzone"),!1;a?.classList.remove("dragging-area");let i=Wt(n,e);if(!i.status)return alert(i.message),K=null,!1;const s=e.dataType||e.type||e.data_type,o=s==="photo"||s==="Image"||s==="img",r=s==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(o){let l,d=!1;if(K&&K.tagName&&K.tagName.toLowerCase()==="img"){if(d=!0,l=K,l.parentElement===a&&console.log("Image is already in this dropzone, just repositioning"),!(l instanceof Node))return console.error("draggedItem is not a valid DOM node:",l),K=null,!1;(!l.hasAttribute("style")||!l.style.width)&&l.setAttribute("style","width: 200px;")}else{const p=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(a.querySelectorAll(`img[src="${p}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),K=null,!1;l=document.createElement("img"),l.setAttribute("src",p),l.setAttribute("style","width: 200px;")}let u=Ee.generateUUID();l.setAttribute("element-info-id",u);const c=a.classList.contains("file-item")&&a.classList.contains("photo-file")&&a.classList.contains("dragging");let g=l;if(c){const p=document.createElement("div");p.appendChild(l),g=p}try{if(d){const p=c&&l.parentElement?.parentElement||l.parentElement,h=c?l.parentElement:l;p&&p!==a&&h&&p.removeChild(h)}N?.position==="top"&&a?.children?.length&&N?.element?a.contains(N.element)&&!g.contains(N.element)&&g!==N.element?a.insertBefore(g,N.element):(console.warn("Invalid indicator element for top position, appending to dropzone"),a.appendChild(g)):N?.position==="bottom"&&N?.element?a.contains(N.element)&&!g.contains(N.element)&&g!==N.element?N.element.insertAdjacentElement("afterend",g):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),a.appendChild(g)):a.appendChild(g)}catch(p){console.error("Error positioning element:",p.message);try{a.appendChild(g)}catch(h){return console.error("Cannot append element:",h),K=null,!1}}l.removeAttribute("element-info-id");const m=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(m){const p=m.id,h=Re(f?.staticWidgetTree,p),b=m.querySelector(".mftsccs-marking-element");return b&&(h.html=b.innerHTML,await te(h)),K=null,!1}return Ro(),K=null,!0}else if(r){let l=Wt(n,e);if(!l.status)return alert(l.message),K=null,!1;if(e.sourceElementId){const w=e.sourceElementId||e.fileId;console.log("sourceElement ->",w)}let d=e.widget_id;a.classList.remove("dragging-area");const u=document.createElement("div");u.classList.add("wb-initial-empty"),u.style.display="block",u.style.marginBottom="10px",u.setAttribute("data-widget-id",d);const c=Ee.generateUUID();u.id=`widget-${c}`;const g=await M();let m=a.classList.contains("publicWidgetRouter"),p=await re(d);if(!m){const w=await Te(d.id,g.token);p=await re(w?w.widgetId:Number(d))}p?.children?.length&&await tn(p);const h=D.clearDraggedWidget(p),b=await Se(h,u);h.wrapper=u.id;try{N?.position==="top"&&a?.children?.length&&N?.element?a.contains(N.element)&&!u.contains(N.element)&&u!==N.element?a.insertBefore(u,N.element):(console.warn("Invalid indicator element for top position, appending to dropzone"),a.appendChild(u)):N?.position==="bottom"&&N?.element&&a.contains(N.element)&&!u.contains(N.element)&&u!==N.element?N.element.insertAdjacentElement("afterend",u):a.appendChild(u)}catch(w){console.error("Error positioning widget container:",w.message);try{a.appendChild(u)}catch(y){return console.error("Cannot append widget container:",y),K=null,!1}}const E=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(E){const w=E.id;Re(f?.staticWidgetTree,w).children.push(h);const S=document.getElementById(w).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=S?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=S?.style.cssText,await te(f.selectedStaticWidgetTreeInfo.widgetTree),K=null,!1}const A=await ht();f.staticWidgetTree.html=A,f.staticWidgetTree?.children?.push(h);const T=f.widgetTree.children.indexOf(h);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[T],isChildWidget:!0,childWidgetIndex:T},await te(h,!1,b),D.enableWidgetButtons(),K=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),K=null,!1}function Ro(){document.querySelectorAll(".mftsccs-marking-element img").forEach(n=>{n.setAttribute("draggable","true"),n.addEventListener("dragstart",e=>{e.stopPropagation(),It=Date.now()}),n.addEventListener("dragend",e=>{e.stopPropagation(),setTimeout(()=>{It=null},100)})})}function Uo(){It=null,K=null,console.log("dragStartTime",It)}async function en(n,e=!1,t,a){if(!n&&e&&t&&a){const l=await re(Number(t)),d=gn(a,t,!1,null);let u=await Se(l,d);l.wrapper=d?.id;const c=await Ye();f.staticWidgetTree.html=c,f.staticWidgetTree?.children?.push(l),te(l,!0,u);return}n.preventDefault(),n.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let s=n.dataTransfer.getData("text");if((l=>{try{return JSON.parse(l),!0}catch{return!1}})(s))if(Object.keys(JSON.parse(s)).includes("widgetcodeId")){const l=JSON.parse(s);let d=Wt(n,l);const u=l.className.split(" ");if(!d.status){alert(d.message);return}const c=JSON.parse(s);if(c.sourceElementId){const S=document.getElementById(c.sourceElementId.toString());if(S){n.target.insertBefore(S,d.elementBelowDrag);return}}let g=Ks(c),m=n.target;m.classList.remove("dragging-area");const p=await M();let h=!1;u.includes("publicWidgetRouter")&&(h=!0);let b=null,E=null;if(h){b=await re(Number(g)),E=gn(m,g,!1,d.elementBelowDrag);const S=document.getElementById("widgetNameValue");S&&b?.name&&(S.value=b?.name);const v=document.getElementById("widget-builder");v&&b?.name&&(v.textContent="Widget Builder Panel: "+b?.name)}else{const S=await Te(g,p.token);b=await re(S?S.widgetId:Number(g));const v=document.getElementById("widgetNameValue");v&&b?.name&&(v.value=b?.name);const L=document.getElementById("widget-builder");L&&b?.name&&(L.textContent="Widget Builder Panel: "+b?.name),b?.children?.length&&await tn(b),E=gn(m,S?S.widgetId:g,!1,d.elementBelowDrag)}const A=D.clearDraggedWidget(b);let T=await Se(A,E);A.wrapper=E?.id;const w=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(w){const S=w.id;Re(f?.staticWidgetTree,S).children.push(A);const x=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=x?.innerHTML,te(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const y=await Ye();f.staticWidgetTree.html=y,f.staticWidgetTree?.children?.push(A);const _=f.widgetTree.children.indexOf(A);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},te(A,!1,T),D.enableWidgetButtons()}else{const l=JSON.parse(s),d=n.target;let u=Wt(n,l);if(u.status){let h=Ee.generateUUID();const b=Ml(h,l),E=document.createElement("div");E.innerHTML=b,N?.position==="top"&&d?.children?.length?d.insertBefore(E.firstChild,N?.element):N?.position==="bottom"?N?.element?.insertAdjacentElement("afterend",E.firstChild):d.appendChild(E.firstChild),n.target.classList.remove("dragging-area");let T=d.querySelector(`[element-info-id='${h}']`);l.data_type=="layout"?T.querySelectorAll(".fslayout-col").forEach(y=>{y.classList.add("wb-initial-empty")}):(T.classList.add("wb-initial-empty"),l?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))),T.removeAttribute("element-info-id"),l?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))}else alert(u.message);const c=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(c){const h=c.id,b=Re(f?.staticWidgetTree,h),E=c.querySelector(".mftsccs-marking-element");return b.html=E?.innerHTML,await te(b),n.dataTransfer.clearData(),!1}const g=document.querySelector(".content-target"),p=(await Ce(g,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=p;try{n.dataTransfer.clearData()}catch(h){console.error("error in clearing data",h.message)}return!0}else{const l=R.staticElement,d=n.target;d.classList.remove("dragging-area"),N?.position==="top"&&d?.children?.length?d.insertBefore(l,N?.element):N?.position==="bottom"?N?.element?.insertAdjacentElement("afterend",l):d.appendChild(l),Ct();const u=await Ye();f.staticWidgetTree.html=u}}function zo(n){const s=new DOMParser().parseFromString(n,"text/html").body.querySelector("div")?.id,r=document.getElementById(s)?.parentElement?.closest(".added-widget-container"),l=r?.id,d=r?.querySelectorAll(".widget_container_disabled");return d?.length&&d?.forEach(u=>{const c=Ee.generateUUID();u.id=`wdgt${c}`}),l?.toString()}async function tn(n){return Array.isArray(n.children)&&n.children.forEach(e=>{gi(e,n),e.children.length&&tn(e)}),n}function gi(n,e){const t=n.wrapper,s=new DOMParser().parseFromString(e?.html,"text/html").body,o=s.querySelector(`#${t}`);if(!o)return n;const l=`wdgtcopy${Ee.generateUUID()}`;return o.id=l,n.wrapper=l,e.html=s.innerHTML.toString(),n}const Jo=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:Xt,dragElement:Ho,dragEndWidgetElement:Oo,dragOverWidgetElement:Fo,dragStartWidgetElement:qo,dropElement:en,dropFolderElement:mi,dropWidgetElement:Vo,findChildByWrapper:Re,getChildWrapperId:zo,getChildrenWrapperId:gi,onDragEnter:Po,onDragLeave:$o,onDragOver:Bo,onDragStart:Mo,onDrop:Do,onWidgetDragStart:Io,removeChildByWrapper:Mt,removeElement:No,resetDragState:Uo,updateAllChildWidgets:tn},Symbol.toStringTag,{value:"Module"})),Go=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],Vn=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class pi{constructor(){}async getLayoutListHTML(){return Vn.map(t=>`
      ...
      `:"").join("")}}async function Te(n,e){let t=new G;t.composition=n,t.fullLinkers=["the_widget_recent","the_widget_latest"],t.inpage=100;let a=new G;a.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],a.inpage=100;const s=await we([t,a],e),r=await Pe(n,"the_widget_recent"),l=s?.data?.the_widget?.the_widget_recent||s?.data?.the_widget?.the_widget_latest||[],d=s?.data?.the_widget?.the_widget_latest||null;if(l.length){const u=l[0],c=u?.data.the_widget.the_widget_name?.[0].data.the_name,g=u?.data.the_widget.the_widget_html?.[0].data.the_html,m=u?.id,p=u?.data.the_widget.the_widget_css?.[0].data.the_css,h=u?.data.the_widget.the_widget_js?.[0].data.the_js,b=u?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,E=u?.data.the_widget.the_widget_version?.[0].data.the_version,A=u?.data.the_widget.the_widget_origin?.[0].data.the_origin|n;return{widgetName:c,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:b,widgetVersion:Number(E||d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||d.id,origin:Number(A),connectionIdLatest:r,publishedWidgetVersion:d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const D=(()=>{const n=async()=>{const w=document.getElementById("fslayout-template-container");if(w){w.innerHTML=`
        <li class="list-unstyled">
        ...
        </li>`;const _=await new pi().getTemplateLayoutsHTML();w.innerHTML=_}},e=async()=>{const w=document.getElementById("public-widget-list-container");if(w){const y=await Pn();!y||y.trim()===""?w.innerHTML=`
            <li class="list-unstyled">
          ...
          `:w.innerHTML=y||""}},a=async()=>{const w=await In();Cn.navbar.setSavedWidgets(w);const y=document.getElementById("saved-widget-list-container");y&&(!w||w.trim()===""?y.innerHTML=`
                  <li class="list-unstyled">
                    <p class="text-center my-3 text-secondary">No saved widgets</p>
                  </li>
                `:y.innerHTML=w||"")},i=async()=>{const w=await In();Cn.navbar.setSavedWidgets(w);const y=document.getElementById("folder-widget-container");y&&(!w||w.trim()===""?y.innerHTML=`
                  <li class="list-unstyled">
                    <p class="text-center my-3 text-secondary">No saved widgets</p>
                  </li>
...
`;m?.file(`${c.slug}.index.ts`,p)}e?.file("routes.ts",nn(t))},dr=async(n,e,t)=>{console.log("widgetsDir",t);const i=(await M())?.token,s=await ea(n,i,!0);let o=e?.folder("home");const r=`
...
`;o?.file("home.index.ts",r),s?.css&&o?.file("home.style.css",s?.css)},ur=async n=>{if(ge)return;ge=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new Jt;const a=await sn(t),i=a?.widgetsDir,s=a?.pagesDir;let o="";i&&s&&(o=await mr(n,s)),a?.routesDir?.file("routes.ts",nn(e)),t.generateAsync({type:"blob"}).then(function(r){let l=document.createElement("a");l.href=URL.createObjectURL(r),l.download=`${o||"page"}.zip`,l.click()}),ge=!1},mr=async(n,e)=>{const t=await M(),a=t?.entityId,i=t?.token,s=await ea(n,i,!0),o=new G;o.composition=a,o.inpage=100,o.fullLinkers=["the_entity_s_page"];const r=new G;r.inpage=100,r.composition=n,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const d=(await we([o,r],i))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==n),u=d?.[0]?.data?.the_page?.the_page_body?.[0]?.id,c=d?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    ...
    `,e){this.the_params=e,this._pageBuilderService=new yi;const a=this.the_params?.data?.the_page_title?.data?.the_title;this.component_heading=this.the_params.type?"Page Builder: "+a:"Widget Builder";const i=this.the_params?.page_id;t&&e.type==Rn.page&&(this.saveBoomButtonHTML=`
         <div class="text-end d-flex flex-row" id="widget-btn-wrapper">
...
`}before_render(){this.render()}after_render(){if(this.the_params){document.getElementById("fspage-save-button").addEventListener("click",Un);const t=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!t){Xt();return}this._pageBuilderService.LoadPageWidget(Number(t))}}getHtml(){return window.openSaveWidgetModal=Zn,window.saveWidget=Ai,window.updateWidget=Yn,window.newWidget=qe,window.previewWidget=Br,window.downloadWebsite=rr,window.moveUp=Ee.moveUp,window.moveDown=Ee.moveDown,window.copyElement=Ee.copyElement,window.editWidget=Ee.editWidget,window.openConvertModal=Nr,window.convertToWidget=jr,window.updatePage=zn,window.previewPage=br,window.undoAction=q.undoAction,window.redoAction=q.redoAction,window.saveWidgetToFolderBtn=_r,window.openPromptModal=bo,window.refineAIData=An,`
...
.custom-menu-item {
  ...
  `}async function Ir(n,e){if(n.preventDefault(),!(await _e.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const a=new FormData(n.target),i=Object.fromEntries(a);console.log(i,"update formValues");const s=await Si(a,e);await Qn("update-element-dialog");const o=await on();if(s){const r=document.getElementById("created-elements");r?!o||o.trim()===""?r.innerHTML=`
      ...
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class $r{createElemenModaltHTML;constructor(){window._dragService=Jo,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=Wr,window.cancelAttributeRow=Li,window.addAttribute=xr,window.removeSelectedAttribute=kr,window.closeElementModal=Qn,`
  ...
  `,document.querySelector("body #app")?.appendChild(e),me("save-widget-dialog"),new Promise((t,a)=>{const i=e.querySelector("#save-widget-form");i.onsubmit=async o=>{o.preventDefault();try{const r=new FormData(i),d=Object.fromEntries(r).widgetName,u=o.target;if(!d?.trim()){const c=u.querySelector("#widgetName");c?.focus(),c.style.border="2px solid red",c.style.outline="none",c.addEventListener("input",()=>{c.style.border=""});return}await Ai(o,d),be("save-widget-dialog"),t("Widget saved successfully")}catch(r){console.error("Error saving widget:",r),a("Error saving widget")}};const s=e.querySelector("button[type='button']");s.onclick=()=>{be("save-widget-dialog"),t("Widget saving canceled")}})}async function Ai(n,e){n.preventDefault();try{C.infoMessageToast("Saving Widget...",0),await je();const t=document.getElementById("save-widget-dialog"),a=t?.querySelector('button[type="submit"]');a.textContent="Saving";const i=t?.querySelector("input"),s=t?.querySelectorAll("button");s&&s.forEach(c=>{c.disabled=!0}),i&&(i.disabled=!0),await at(),R.staticElement?.removeAttribute("draggable");const o=document.querySelectorAll(".edited-widget-container");o?.length&&o.forEach(async c=>{if(c.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[c.id]){const g=await Ce(c,"div.mftsccs-marking-element");f.editedWidgets[c.id].html=g.innerHTML}});const r=await Wi();f.staticWidgetTree.html=r;const l=await f.saveWidget(e),d=await Z(l.id);be("save-widget-dialog"),Yt(),document.querySelector(".infoMessageToast")?.remove(),C.successfullToast("Widget saved successfully!"),await D.renderSavedWidgets(),Ue(n,d.id);return}catch(t){document.querySelector(".infoMessageToast")?.remove(),C.errorToast("Error in saving widget"),Gn(t,"There is an error on saving widget")}}async function Yn(n,e,t){const a=document.getElementById("update-publish-widget-btn");try{const i=document.getElementById("update-widget-btn");a&&a.classList.add("disabled"),i&&(i.classList.add("disabled"),i.textContent="Updating...",C.infoMessageToast("Updating Widget...",0)),await at(),R.staticElement?.removeAttribute("draggable");const s=document.querySelectorAll(".edited-widget-container");s?.length&&s.forEach(async d=>{if(d.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[d.id]){const u=await Ce(d,"div.mftsccs-marking-element");f.editedWidgets[d.id].html=u.innerHTML}});const o=await Hr();f.staticWidgetTree.html=o,await f.updateWidget(),Yt(),ye(),document.querySelector(".infoMessageToast")?.remove(),C.successfullToast("Widget Updated Successfully"),await D.renderSavedWidgets(),await D.renderBoomWidgets();const l=document.getElementById("widget-builder");l.textContent="Widget Builder Panel",await Ue(n,f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:e),t&&t===!0&&await f.publish();return}catch(i){document.querySelector(".infoMessageToast")?.remove();const o=document.getElementById("update-widget-btn");o&&(o.classList.remove("disabled"),o.innerHTML=`
    ...
    `}}async function Yr(n,e){const t=document.getElementById("documentation-view");await $e(J.documentation_preview_widget,t,{currentWidgetId:e})}let mt,yn="",kn,Mn;async function Xr(n,e){kn=n,e==="preview"?new Zr:new Kr;const t=new P;t.typeConnection="the_widget_documentation",t.name="documentationText",t.selectors=["the_documentation_text"];const a=new P;a.typeConnection="the_widget_s_documentation",a.name="documentationBlank",a.selectors=["the_documentation_text","the_documentation_content","the_documentation_language","the_documentation_doc_title","the_documentation_folder","the_documentation_creator_email","the_documentation_created_by","the_documentation_content","the_documentation_type","the_documentation_s_doc_url","the_documentation_s_image_url","the_documentation_s_video_link","the_documentation_auth_type","the_documentation_bearer_token","the_documentation_method","the_documentation_method_url","the_documentation_username","the_documentation_password","the_documentation_s_json_list","the_documentation_api_script","the_documentation_api_body","the_documentation_code_editor","the_documentation_return"];const i=new P;i.typeConnection="the_documentation_s_json_list",i.name="documentationJSON",i.selectors=["the_json_list_key","the_json_list_value"],a.freeschemaQueries=[i];const s=new P;s.conceptIds=[kn],s.freeschemaQueries=[t,a],s.inpage=100,s.outputFormat=de,await ce(s,"").subscribe(async o=>{const r=o?.[0]?.data?.the_widget?.the_widget_documentation?.data?.the_documentation?.the_documentation_text?.data?.the_text||"";r&&(yn=r);const l=o?.[0]?.data?.the_widget?.the_widget_s_documentation;l?.length&&(yn=l?.map(u=>{const c=u?.data?.the_documentation,g=c?.the_documentation_type?.data?.the_type,m=c?.the_documentation_content?.data?.the_content,p=c?.the_documentation_creator_email?.data?.the_creator_email,h=c?.the_documentation_doc_title?.data?.the_doc_title,b=c?.the_documentation_method?.data?.the_method,E=c?.the_documentation_method_url?.data?.the_method_url,A=c?.the_documentation_bearer_token?.data?.the_bearer_token,T=c?.the_documentation_username?.data?.the_username,w=c?.the_documentation_password?.data?.the_password,y=c?.the_documentation_auth_type?.data?.the_auth_type,_=c?.the_documentation_s_json_list,S=c?.the_documentation_api_script?.data?.the_api_script,v=c?.the_documentation_api_body?.data?.the_api_body,L=c?.the_documentation_language?.data?.the_language,x=c?.the_documentation_return?.data?.the_return,k=c?.the_documentation_code_editor?.data?.the_code_editor,I=c?.the_documentation_s_doc_url,$=c?.the_documentation_s_image_url,B=c?.the_documentation_s_video_link;let j={type:g,content:m,creatorEmail:p,title:h};if(g==="blank")j={...j};else if(g==="api"){const F=[];_?.length&&_?.forEach(X=>{F.push({key:X?.data?.the_json_list?.the_json_list_key?.data?.the_key,value:X?.data?.the_json_list?.the_json_list_value?.data?.the_value})}),j={...j,method:b,methodURL:E,authType:y,username:T,password:w,bearerToken:A,json:F,script:S,body:v}}else g==="function"&&(j={...j,language:L,return:x,codeEditor:k});const U=[],ne=[],Y=[];return $?.length&&$?.forEach(F=>{U.push(F?.data?.the_image_url)}),B?.length&&B?.forEach(F=>{ne.push(F?.data?.the_video_link)}),I?.length&&I?.forEach(F=>{Y.push(F.data?.the_doc_url)}),j={...j,imageList:U,linkList:Y,videoList:ne},j})),Mn=o?.[0]?.data?.the_widget?.the_widget_documentation?.id,e!=="preview"&&tl(r)}),e==="preview"?(await me("widget-documentation-preview-modal"),Yr(yn,n)):await me("widget-documentation-modal")}async function el(){if(mt){const n=mt.getData(),e=await z(kn),a=(await M())?.userId;if(Mn)await Xe(Mn,"the_documentation_text","text",n,a),await H.SyncDataOnline();else{const i=await V("documentation",a,{text:n});await Q(e,i,"documentation"),await H.SyncDataOnline()}C.successfullToast("Documentation is saved."),mt.setData(n)}else console.error("Editor not initialized"),C.errorToast("Documentation couldn't saved.")}function tl(n){const e=document.querySelector("#documentation-editor");e&&fs.create(e,{licenseKey:"GPL"}).then(t=>{mt=t;const a=n;mt.setData(a)}).catch(t=>{console.error("Error initializing CKEditor:",t)})}class nl{constructor(){this.init()}init(){document.getElementById("btn-take-tour")?.addEventListener("click",t=>{if(t.target.matches(".btn-tour")){const a=t.target.dataset.tourStatus;this.startTour(a)}})}startTour(e){const t=new ms.Tour({defaultStepOptions:{classes:"wico",scrollTo:!0,cancelIcon:{enabled:!0}},useModalOverlay:!0}),a=[{classes:"back-button",text:"Back",action:t.back},{classes:"next-button",text:"Next",action:t.next}];t.addStep({id:"welcome",title:"👋 Welcome to Widget Conceptualizer",text:["This short tour will walk you through the essentials. Let's begin. Start building widgets today!"],buttons:[{text:"Remind me later",classes:"back-button",action:t.complete},{text:"Next",classes:"next-button",action:()=>{t.next()}}]}),t.addStep({id:"step-create-widget",title:"Create a New Widget",text:["Start by creating a new widget."],classes:"onboarding-boomconsole",highlightClass:"highlight",attachTo:{element:".wico_header-section",on:"bottom-start"},buttons:a}),t.addStep({id:"step-widget-panel",classes:"tour-widget-panel",title:"Workspace Area",text:"This is your creative canvas. Drag and drop elements, build widgets, apps, or full pages—right in the workspace.",attachTo:{element:".content-target",on:"top"},buttons:a}),t.addStep({id:"step-builder-meu",title:"Builder Menu",text:"This menu provides essential navigation tools. Use it to manage projects, access assets, open pages, and explore saved widgets.",attachTo:{element:".sidebar-collapsed",on:"left"},buttons:a}),t.addStep({id:"step-properties",title:"Properties Panel",text:"Adjust Styling, add properties like layout, colors, fonts, and more.",attachTo:{element:()=>{const i=document.querySelector("#tab-container .tab button:nth-child(2)"),s=new Event("click",{bubbles:!0,cancelable:!0});return i.dispatchEvent(s),".right-aside"},on:"left"},buttons:a}),t.addStep({id:"step-design-code-mode",title:"Design & Code Modes",text:[`
        ...
        `).join(""):'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No Saved Assets</p></li>'}searchWidgets(e,t){t||(t=`#${e.target?.dataset?.id}`||"");const i=e.target.value.toLowerCase();document.querySelectorAll(`${t} li`).forEach(o=>{const r=(o.textContent||"").toLowerCase();o.style.display=r.includes(i)?"":"none"})}searchPublicWidgets(e){const a=e.target.value.toLowerCase();Pn(a).then(i=>{Cn.navbar.setPublicWidgets(i),this.updatePopupMenu("publicWidgets",i)})}async responsiveSidebar(){const e={mainItems:[{id:"elements",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
