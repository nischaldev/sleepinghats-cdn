...
`,c?.appendChild(g),document.querySelectorAll(".tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-tab");document.querySelectorAll(".tab-btn, .tab-content").forEach(S=>S.classList.remove("active")),y.classList.add("active"),document.getElementById(_)?.classList.add("active")})}),g.querySelectorAll(".sub-tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-subtab"),S=y.closest(".tab-content");S?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(b=>{b.classList.remove("active")}),y.classList.add("active"),S?.querySelector(`.sub-tab-content[data-subtab="${_}"]`)?.classList.add("active")})});const h=document.querySelector(".fullscreenicon"),v=document.querySelector("#widgetButtionCodeViewWrapper");h?.addEventListener("click",()=>{v.classList.contains("fullscreen")?ot.enableHeader():ot.disableHeader(),v.classList.toggle("fullscreen")});const E=document.querySelector(".close-btn");E&&E.addEventListener("click",t),document.getElementById("synchronizeWidgetBtn").addEventListener("click",()=>n("Widget Synchronized")),document.getElementById("contentTargetAndCodeViewWrapper")?.prepend(u.firstChild),setTimeout(()=>{const y=document.querySelector(".codeSplitViewButton");y&&(y.removeEventListener("click",i),y.addEventListener("click",i));const _=document.getElementById("designSplitViewButton");_&&(_.removeEventListener("click",e),_.addEventListener("click",e))},0),document.getElementById("add-service-button")?.addEventListener("click",y=>s(y))};function s(c){c.stopPropagation();try{const d="add-custom-service-dialog";document.getElementById(d)?.remove();const g=document.createElement("dialog");g.setAttribute("id",d),g.classList.add("col-md-3"),g.innerHTML=`
        <h4>New Service</h4>
        <form method="dialog" class="mt-3">
          <div class="mb-3">
...
`;o?.file("home.index.ts",l),s?.css&&o?.file("home.style.css",s?.css)},wo=async i=>{if(ue)return;ue=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],n=new Nt;const t=await Gt(n),a=t?.widgetsDir,s=t?.pagesDir;let o="";a&&s&&(o=await vo(i,s)),t?.routesDir?.file("routes.ts",zt(e)),n.generateAsync({type:"blob"}).then(function(l){let r=document.createElement("a");r.href=URL.createObjectURL(l),r.download=`${o||"page"}.zip`,r.click()}),ue=!1},vo=async(i,e)=>{const n=await I(),t=n?.entityId,a=n?.token,s=await $n(i,a,!0),o=new z;o.composition=t,o.inpage=100,o.fullLinkers=["the_entity_s_page"];const l=new z;l.inpage=100,l.composition=i,l.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const c=(await he([o,l],a))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==i),d=c?.[0]?.data?.the_page?.the_page_body?.[0]?.id,u=c?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    ...
    `}let wt;async function Wo(i,e){wt=i,console.log("selectedWidgetId -->",wt);const n=Lo(e,typeof i=="object"?0:i),t=document.createElement("div");t.innerHTML=n;const a=t.querySelector("#folder-widget-container");document.querySelector("body #app")?.appendChild(a),await de("folder-widget-container");const s=await I();if(!s)return;let o,l,c=(await Ye(wt,s.token))?.data?.the_widget?.the_widget_name?.[0]?.data?.the_name;e===!0?(o=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name"),console.log("nameInput -->",o),o&&(o.value=c),l=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")):(o=document.getElementById("folder-widget-container")?.querySelector("input#folder-name"),l=document.getElementById("folder-widget-container")?.querySelector("textarea#description"));const d=document.getElementById("widgetFolder");await De(ae.folder_widget,d,{widgetName:o.value,widgetDescription:l?.value,widgetId:wt,showCheckbox:!0,showFiles:!1})}async function Ao(i,e,n,t){i.preventDefault();try{L.infoMessageToast("Saving Widget...",0),await Be();const a=document.getElementById("folder-widget-container"),s=a?.querySelector('button[type="submit"]');s.textContent="Saving";const o=a?.querySelector("input"),l=a?.querySelectorAll("button"),r=document.getElementById("save-to-folder-name")||document.getElementById("folder-name");console.log("nameInputEl -->",r);const c=r.value;console.log("widgetNamex -->",c),l&&l.forEach(w=>{w.disabled=!0}),o&&(o.disabled=!0),await et();let d;if(!t){R.staticElement?.removeAttribute("draggable");const w=document.querySelectorAll(".edited-widget-container");w?.length&&w.forEach(async S=>{if(S.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[S.id]){const b=await Ce(S,"div.mftsccs-marking-element");f.editedWidgets[S.id].html=b.innerHTML}});const y=await Ui();f.staticWidgetTree.html=y,console.log("widgetNamex -->",c);const _=await f.saveWidget(c);d=await Y(_.id),n=d.id,console.log("Saved Widget ID:",n)}const u=await I(),g=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name")?.value||document.getElementById("folder-widget-container")?.querySelector("input#folder-name")?.value,m=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")?.value,h=new URLSearchParams(window.location.search).get("concept"),v={title:g,source_url:window.location.href,widget_id:n,short_desc:m,note:"",data_type:"widget",created_on:Date.now()};if(h){d=await Y(Number(n));const w=await Y(Number(h));if(!w)throw new Error("Selected folder concept not found!");let y={...v,boom_folder:{name:w.name||"",parent:h}};const _=await je({boomgpt:y},void 0,void 0,void 0,u.userId,4);await Gn(await Y(Number(h)),_,"the_boom_folder_s_contain"),await G(_,d,"the_refer")}else{const w=u?.userConcept;d=await Y(Number(n));let y={...v,boom_folder:{name:"",parent:w}};const _=await je({boomgpt:y},void 0,void 0,void 0,u.userId,4);await Gn(await Y(Number(w)),_,"the_boom_folder_s_contain"),await G(_,d,"the_refer")}await N.SyncDataOnline(),document.getElementById(e)?.querySelector("form")?.reset(),we("folder-widget-container"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget saved successfully!"),t||(await q.renderSavedWidgets(),Oe(i,Number(n)))}catch(a){document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Error in saving widget"),kn(a,"There is an error on saving widget")}}class qi extends mt{mainConcept=0;mainData;data=0;phonebooks=[];the_params;component_heading;saveButtonHTML;saveBoomButtonHTML;previewButtonHTML;tryAIButtonHTML="";responsiveButtonHTML="";_pageBuilderService;constructor(e){super(),this.component_heading="Widget Builder Panel",this.saveButtonHTML="",this.saveBoomButtonHTML="";const n=I();if(n&&(this.saveBoomButtonHTML=`
...
.custom-menu-item {
  ...
  `,document.body.appendChild(s);const o=s.querySelector("#pasteArea"),l=s.querySelector("#widgetThumbnail"),r=s.querySelector("#imagePreview img"),c=s.querySelector("#imagePreview"),d=s.querySelector("#pasteText");function u(p){const h=new FileReader;h.onload=v=>{r&&v.target?.result&&(r.src=v.target.result,c.classList.remove("d-none"),d.classList.add("d-none"))},h.readAsDataURL(p)}l?.addEventListener("change",p=>{const h=p.target.files?.[0];h&&u(h)});function g(p){const h=p.clipboardData?.items;if(h){for(let v=0;v<h.length;v++)if(h[v].type.indexOf("image")!==-1){const E=h[v].getAsFile();if(E&&l){const W=new DataTransfer;W.items.add(E),l.files=W.files,u(E);break}}}}o?.addEventListener("paste",p=>g(p)),s.addEventListener("paste",p=>g(p)),s.querySelector("#post-widget-form")?.addEventListener("submit",p=>{p.preventDefault(),cr(e,s)}),s.showModal()}async function cr(i,e){const n=document.querySelector(`#spinner-${i}`),t=e.querySelector('button[type="submit"]');try{t&&(t.disabled=!0,t.textContent="Posting...",L.infoMessageToast("Posting Widget to Public...",0)),n&&n.classList.remove("d-none"),await Be();const a=await I(),s=document.getElementById("widgetPublicName").value,o=document.getElementById("widgetDescription").value,l=document.getElementById("widgetThumbnail");if(console.log("File Input Debug:",{inputExists:!!l,filesExists:!!l?.files,filesLength:l?.files?.length,value:l?.value,firstFile:l?.files?.[0],description:o}),!l?.files?.length)throw console.error("File validation failed:",{inputExists:!!l,filesLength:l?.files?.length}),new Error("Please provide a thumbnail image");const r=l.files?.[0];if(console.log("Thumbnail file:",{name:r.name,type:r.type,size:r.size}),!r||!l.value)throw new Error("Please provide a thumbnail image");const c=await zi(r);if(!c.success)throw new Error("Failed to upload thumbnail");const d=await Ee(i,a.token);if(d&&(await Ie(d.widgetId,"the_public_widget_s_widget",!0)).length){document.querySelector(".infoMessageToast")?.remove(),L.infoMessageToast("Widget is already public.");return}const u=document.getElementById("postAsTemplate")?.checked;let g=null;if(d)g=await Q(d.widgetId);else{const W=await Y(i);g=await q.createWidgetCopy(W,a.userId,a.token)}const m=await te("public_name",s,!1,a.userId,4,999),p=await te("description",o,!1,a.userId,4,999),h=await te("thumbnail",c.url||"no attachment",!1,a.userId,4,999);await V(g,p,"description"),await V(g,h,"thumbnail"),await V(g,m,"public_name");const v=await te("public_widget","",!1,a.userId,4,999);if(await V(v,g,"s_widget"),u){const T=await te("template_name",s,!1,a.userId,4,999),w=await te("template_thumbnail",c.url||"no attachment",!1,a.userId,4,999);await V(g,w,"template_thumbnail"),await V(g,T,"template_name");const y=await te("template_widget","",!1,a.userId,4,999);await V(y,g,"s_widget")}await N.SyncDataOnline(),await q.renderPublicWidgets(),await q.renderSavedWidgets(),u&&await q.renderTemplateLayouts(),e.close(),document.querySelector(".infoMessageToast")?.remove(),setTimeout(()=>{L.successfullToast(`Widget Posted to Public${u?" and Templates":""}`)},300)}catch(a){console.error("Error posting widget:",a),document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Failed to post widget"),t&&(t.disabled=!1,t.textContent="Post Widget")}finally{n&&n.classList.add("d-none")}}async function fn(i=""){try{const e=await I();if(!e)return`
    ...
    `}catch(e){console.error("error",e),e?.status===401&&Ae()}}async function dr(i=""){console.log("getFolderWidgetsList called with searchTerm:",i);try{const e=await I();if(!e)return console.log("No profile data found, returning empty list"),`
      ...
      `;const t=(await Ro(i))[0]?.data?.the_folder_widget?.the_folder_widget_s_widget||[];console.log("Widgets data fetched:",t);const a=await Promise.all(t.map(async r=>{const c=r?.data?.the_widget,u=c?.the_widget_folder_name?.data?.the_folder_name||`${c?.the_widget_name?.data?.the_name} ${c?.the_widget_version?.data?.the_version>1?"v"+c?.the_widget_version?.data?.the_version:""}`,g=c?.the_widget_description?.data?.the_description,m=c?.the_widget_thumbnail?.data?.the_thumbnail,p=c?.the_widget_timestamp?.data?.the_timestamp;return{id:r?.id,name:u,timestamp:p,description:g,thumbnail:m}}));if(console.log("Processed folder widgets list:",a),!a?.length){const r=document.getElementById("folder-widget-container");if(r){console.log("No folder widgets found, rendering fallback widget"),r.style.display="block";const c=await De(ae.folder_widget,r);console.log("Fallback widget result:",c)}return`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary">No Folder widget</p>
        </li>
...
`).join("<br>"),s=`
  ...
  `,o=document.getElementById("widget-detail-modal");o&&o.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",s),de("widget-detail-modal")}window.viewPublicWidgetDetails=fr;window.openCSSEditor=dt;class Zi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let n=function(a){if(!a)return;const{wrapper:s}=a,o=s&&s!=="0"?`#${s}`:".content-target";t=t+`${o} { ${a.css} }`,a.children.forEach(l=>{n(l)})},t="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),n(f.widgetTree),this.styleElement.textContent=t}}async getWidgetHtml(e){let n=[];e.forEach(t=>{t.classList.forEach(a=>{n.push(a)})}),this.insertCSS(n)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:n,dispatch:t}=e,{selection:a}=n;return a.ranges.length===0?!1:(t({changes:{from:a.ranges[0].from,to:a.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new ie({doc:"/* Write your CSS here */",extensions:[Bt,$t,Sa(),Ht(),ie.lineWrapping,Pe.tabSize.of(2),Pe.allowMultipleSelections.of(!0),ie.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),jt.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),ie.updateListener.of(async n=>{if(n.docChanged){const t=this.editorView?.state.doc.toString()||"";this.updateCSS(t)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const n of e)if(this.editorView){const{state:t,dispatch:a}=this.editorView;a({changes:{from:0,to:t.doc.length,insert:`.${n} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const ri=async i=>{const e=new hi,n=wr(i);if(Object.keys(n).length>0){const t=await e.validateField(n),a=await yn(t),s=yn(a);return br(i,s)}},yr=async i=>{const n=await new hi().validateField(i);return Object.keys(n).length>0?{status:!1,details:yn(n)}:{status:!0}},wr=i=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},n=i?.attributes;if(Array.isArray(n))n.forEach(t=>{const a=vr(t);switch(t.name){case"name":e.fieldName=a||"";break;case"value":e.value=a||null;break;case"fieldtype":e.fieldType=a?a.trim():null;break;case"pattern":e.pattern=a||null;break;case"datatype":e.dataType=a?a.trim():null;break;case"typeconcept":e.conceptType=a||null;break;case"maxlength":e.maxLength=a?parseInt(a):null;break;case"minlength":e.minLength=a?parseInt(a):null;break;case"max":e.maxValue=a?parseInt(a):null;break;case"min":e.minValue=a?parseInt(a):null;break;case"accept":e.accept=a||null;break;case"file":e.file=a||null;break;case"required":e.required=a===!0;break;case"unique":e.isUnique=a===!0;break}});else throw console.error('attributesData["attributes"] is not an array',i.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},vr=i=>{switch(i.type){case"boolean":return i.value==="on";case"array":return i.selected||null;case"string":return i.value||null;default:return null}},yn=i=>({datatype:i.dataType,pattern:i.pattern,max:i.maxValue,min:i.minValue,minlength:i.minLength,maxlength:i.maxLength,accept:i.accept,file:i.file,required:i.required,unique:i.unique}),br=(i,e)=>(i.attributes.forEach(n=>{const t=e[n.name];n.validationStatus=t?"invalid":"valid",n.validationErrorMessage=t||""}),i),_r=i=>({fieldName:i.getAttribute("name"),value:i instanceof HTMLInputElement?i.value:null,fieldType:i.getAttribute("fieldtype"),dataType:i.getAttribute("datatype"),pattern:i.getAttribute("pattern"),conceptType:i.getAttribute("typeconcept"),maxLength:i.getAttribute("maxlength"),minLength:i.getAttribute("minlength"),minValue:i.getAttribute("min"),maxValue:i.getAttribute("max"),file:i.hasAttribute("file"),accept:i.hasAttribute("accept"),required:i.hasAttribute("required"),isUnique:i.getAttribute("unique")==="on"});async function Ki(i){let e=i.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",i.parentNode?.insertBefore(e,i.nextSibling)),e.innerHTML="";const n=_r(i),t=await yr(n);try{if(t.status)i.classList.remove("invalid"),i.classList.add("valid");else if(i.classList.remove("valid"),i.classList.add("invalid"),t.details&&typeof t.details=="object"){const a=document.createElement("span");a.className="error-message",a.style.color="red",a.style.fontSize="12px";const s=Object.values(t.details).filter(Boolean);a.innerHTML=s.join("<br>"),e.appendChild(a)}}catch(a){console.error("Validation error:",a);const s=document.createElement("span");s.className="error-message",s.style.color="red",s.textContent="Validation failed. Please try again.",e.appendChild(s)}}var ze=(i=>(i.STYLE="style",i.BOOLEAN="boolean",i.FORM="form",i.SPECIAL="special",i))(ze||{});const Er=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),Hn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],jn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],Mt=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Tr=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],kt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],me=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Sr=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Cr=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),Lr=new Set(["elementContent","className","id"]),Yi=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function Je(i){return i.toLowerCase()==="type"?!0:Yi.has(i.toLowerCase())}function vt(i,e,n){const t=i.toLowerCase();if(t==="type"){const a=n?Er.get(n.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):a}return Yi.get(t)||[]}class Zt{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=Pa}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,n){let t,a,s=document.getElementsByClassName("tabcontent");for(t=0;t<s.length;t++)s[t].style.display="none";for(a=document.getElementsByClassName("tablinks"),t=0;t<a.length;t++)a[t].className=a[t].className.replace(" active","");const o=document.getElementById(n);o.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let n=this;for(let t=0;t<e.length;t++)e[t].addEventListener("click",function(a){console.log("buttons[i] -->",e[t]);const s=e[t].getAttribute("data-tab-id");console.log("tabName -->",s),n.openTab(a,s)});e[0].click()}sortAttributes(e){return e.sort((n,t)=>{if(!n?.name||!t?.name)return 0;const a=this.findAttributeInMap(n.name),s=this.findAttributeInMap(t.name);if(a==="Other"&&s!=="Other")return 1;if(a!=="Other"&&s==="Other")return-1;if(a===s){const o=this.categoryMap[a].findIndex(r=>r.toLowerCase()===n.name.toLowerCase()),l=this.categoryMap[s].findIndex(r=>r.toLowerCase()===t.name.toLowerCase());return o-l}return 0})}getCategoryForAttribute(e){if(!e)return"General";const n=e.toLowerCase();for(const[t,a]of Object.entries(this.categoryMap))if(t!=="Other"&&a.some(s=>s.toLowerCase()===n))return t;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,n){setTimeout(()=>{const t=document.getElementById("element-attributes");if(!t){console.warn("Attribute container not found, retrying..."),this.setAttributes(e,n);return}t.innerHTML="";const a=document.createElement("div");if(a.className="row",t.appendChild(a),!e){a.innerHTML="";return}(async()=>await ri(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const o=this.sortAttributes(e.attributes),l={};o.forEach(c=>{const d=this.getCategoryForAttribute(c.name);l[d]||(l[d]=[]),l[d].push(c)});let r="";Object.entries(l).forEach(([c,d])=>{const u=d.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
            ...
            `}),a.innerHTML=r}}),Et()},0)}setAttributesForMultipleElements(e){const n=async()=>await ri(e);if(!e){const a=document.getElementById("element-attributes").querySelector(".row");a.innerHTML="";return}n().then(()=>{if(e?.attributes&&e?.attributes?.length){const t={};e.attributes.forEach(o=>{const l=this.getCategoryForAttribute(o.name);t[l]||(t[l]=[]),t[l].push(o)});let a="";Object.entries(t).forEach(([o,l])=>{if(l.length){const r=l.map(d=>{let u="";return d?.type==="string"?u=`<input type="text" class="form-control" onchange="updateMultipleElementAttribute(event)" value="${d?.value||""}">`:d?.type==="color"?u=`<input type="color" class="form-control" onchange="updateMultipleElementAttribute(event)" value="${d?.value||"#000000"}">`:d?.type==="boolean"?u=`<input type="checkbox" class="form-check-input" onchange="updateMultipleElementAttribute(event)" ${d?.value&&d?.value!=="false"?"checked":""}>`:d?.type==="array"&&(u=`
                  <select class="form-select" onchange="updateMultipleElementAttribute(event)">
                    ${d?.value?.split(",")?.map(p=>`<option value="${p}" ${p===d?.selected?"selected":""}>${p}</option>`).join("")}
                  </select>
            ...
            `}});const s=document.getElementById("element-attributes");s&&(s.innerHTML=a)}})}async getHtml(){window.updateWidgetTypeValue=ta,window.toggleDisplay=dt,window.updateElementAttribute=Kt,window.updateMultipleElementAttribute=aa,window.handlePageProperties=ia,window.updateCSSLibrary=Ve,window.updateJSLibrary=Re,window.addJSLibrary=ra,window.addCSSLibrary=oa,window.openRenameCustomFunction=st.openRenameCustomFunction,window.deleteCustomFunction=st.deleteCustomFunction,setTimeout(async()=>{st.initializeCodeBlock();const a=new Zi,s=document.getElementById("css-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor(),qn()},0),setTimeout(async()=>{await new Wi().initializeEditor()},0),setTimeout(async()=>{const a=new Ai,s=document.getElementById("js-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor()},0),setTimeout(async()=>{await new se("onmount-editor-split").initializeEditor(),await new se("onupdate-editor-split").initializeEditor(),await new se("addevents-editor-split").initializeEditor(),await new se("mountchildwidgets-editor-split").initializeEditor();const r=document.getElementById("publish-widget");r&&r.addEventListener("click",async c=>{c.preventDefault();try{await f.publish()}catch(d){console.error("error publishing widget",d),d instanceof Error&&L.errorToast(d.message)}})},0),setTimeout(()=>{this.initializeTabs()},0);const e=this.the_params?.page_id;let n="",t="";if(this.the_params){const a=this.the_params?.data?.the_page_meta_title?.data?.the_meta_title||"";a&&ve("meta_title",a);const s=this.the_params?.data?.the_page_meta_description?.data?.the_meta_description||"";s&&ve("meta_description",s);const o=this.the_params?.data?.the_page_meta_keywords?.data?.the_meta_keywords||"";o&&ve("meta_keywords",o);const l=this.the_params?.data?.the_page_width?.data?.the_width||"";l&&ve("width",l);const r=this.the_params?.data?.the_page_font_size?.data?.the_font_size;r&&ve("font_size",r);const c=this.the_params?.data?.the_page_font_family?.data?.the_font_family;c&&ve("font_family",c);const d=this.the_params?.data?.the_page_type?.data?.the_type;d&&ve("type",d);const u=()=>Array.from({length:13},(p,h)=>12+h).map(p=>{const h=r==p?"selected":"";return`<option value="${p}" ${h}>${p}</option>`}).join(""),g=()=>["Arial","Verdana","Times New Roman","Courier New","Georgia"].map(h=>{const v=c==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join(""),m=()=>["Fluid","Fixed"].map(h=>{const v=d==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join("");n=`
  ...
  `}async function Yr(i,e){if(i.preventDefault(),!(await Dt.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const t=new FormData(i.target),a=Object.fromEntries(t);console.log(a,"update formValues");const s=await ua(t,e);await Vn("update-element-dialog");const o=await Qt();if(s){const l=document.getElementById("created-elements");l?!o||o.trim()===""?l.innerHTML=`
    ...
    `}}async function de(i){document.getElementById(i).showModal()}async function we(i){const e=document.getElementById(i);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function ga(i,e){i?.stopPropagation();const n=document.getElementById(`menu-${e}`),t=n?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(s=>{s.classList.remove("show")}),n&&!t&&n.classList.add("show")}async function dl(i){new el,await de(i)}async function ul(i,e,n){i.stopPropagation(),console.log("modalId",e),ga(i,Number(n)),new Xr(n)}async function ml(i,e){ga(i,e),confirm("Are you sure you want to delete the element?")&&(await Se(e),L.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const t=await Qt(),a=document.getElementById("created-elements");a?!t||t.trim()===""?a.innerHTML=`
      ...
      `:a.innerHTML=t||"":console.error("Elements list container not found in the DOM.")}export{zi as A,el as B,Wn as C,Nr as D,Ee as E,de as F,Ue as P,f as S,tr as T,Xs as _,Bn as a,X as b,st as c,et as d,nr as e,cn as f,qi as g,Zt as h,D as i,Cn as j,Fn as k,Oe as l,ll as m,He as n,dl as o,ga as p,ul as q,Pt as r,_s as s,L as t,ml as u,Be as v,q as w,we as x,cl as y,ot as z};
