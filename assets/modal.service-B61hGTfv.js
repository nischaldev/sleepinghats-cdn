import{M as bn,m as z,n as he,o as ya,E as Jn,p as ui,G as He,J as Q,u as wa,b as mi,a as gi,D as pi,e as N,r as te,j as be,q as Gn,l as Qn,z as Y,X as j,W as fe,I as ye,O as Se,i as va,s as gt,v as hi,c as ba,y as De,g as re,K as Te,P as Me,x as Ie,A as Ne,d as G,B as ln,C as fi,F as Zn,H as yi,t as _a,k as wi}from"./mftsccs-browser-DeTC_MD3.js";import{E as ie,b as jt,o as Ht,j as vi,a as Dt,c as Ea,l as Ta,d as Sa,e as Ca,f as Pe,k as Nt,h as La,g as Wa}from"./codemirror-B3vgQINq.js";import{a as Aa,u as bi,g as I,e as ae,b as V,c as O,C as M,L as oe,f as xa,d as tt,h as Ma,A as qt}from"./index-BWpV5SOg.js";import{J as Ft,q as ka}from"./vendor-Cs_0E_Xj.js";import{z as Ia}from"./eslint4b-BLWGvIOa.js";import{l as pt,p as _n,r as En,a as Pa,b as Ba}from"./prettier-ClL2wQep.js";import{C as $a}from"./ckeditor-Cw9bcqxY.js";const ja=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return ca},get addJSLibrary(){return da},get applyPageProperties(){return Or},get applyPageProperty(){return ve},get filterChildrenByWrapper(){return sa},get getAttributeType(){return Gr},get getAttributeValue(){return ma},get getElementAttribute(){return Dr},get getElementAttributeDetails(){return Fn},get getElementData(){return ia},get getLayoutAttributeValue(){return ga},get getPropertiesByIdFromStorage(){return yt},get handleDirectContentEdit(){return Nr},get handlePageProperties(){return oa},get initializeApp(){return tn},get initializeLibrary(){return On},get listJSLibraries(){return wt},get removeCSSLibrariesFromHead(){return $t},get removeJSLibrariesFromHead(){return Vn},get setAttributeValue(){return Zr},get toggleSpacingBox(){return Rn},get updateAttribute(){return Fr},get updateCSSLibrary(){return Ve},get updateElementAttribute(){return Xt},get updateElementAttributeViaEditor(){return qr},get updateJSLibrary(){return Re},get updateMetaTag(){return mt},get updateMultipleElementAttribute(){return ra},get updateWidgetTypeValue(){return aa}},Symbol.toStringTag,{value:"Module"}));async function ul(){return"WICO"}async function Ae(){const i=await Aa();await bn(i?.id),localStorage.removeItem("profile"),localStorage.removeItem("tempwidget"),await bi("/"),setTimeout(()=>{document.body.style.overflow=""},1e3)}const ht=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],Tn=[{name:"accept",type:"string"},{name:"action",type:"string"},{name:"alt",type:"string"},{name:"autocomplete",type:"boolean",value:"on"},{name:"checked",type:"boolean"},{name:"cols",type:"string"},{name:"disabled",type:"boolean"},{name:"download",type:"string"},{name:"draggable",type:"boolean"},{name:"for",type:"string"},{name:"hidden",type:"boolean"},{name:"href",type:"string"},{name:"label",type:"string"},{name:"loading",type:"array",value:"eager,lazy",default:"eager"},{name:"max",type:"string"},{name:"maxlength",type:"string"},{name:"media",type:"string"},{name:"method",type:"array",value:"get,post,dialog"},{name:"min",type:"string"},{name:"minlength",type:"string"},{name:"multiple",type:"boolean"},{name:"muted",type:"boolean"},{name:"name",type:"string"},{name:"pattern",type:"string"},{name:"placeholder",type:"string"},{name:"readonly",type:"boolean"},{name:"rel",type:"string"},{name:"required",type:"boolean"},{name:"rows",type:"string"},{name:"selected",type:"boolean"},{name:"size",type:"string"},{name:"src",type:"string",value:""},{name:"start",type:"string"},{name:"style",type:"string"},{name:"title",type:"string"},{name:"target",type:"array",value:"_blank,_self,_parent,_top"},{name:"type",type:"array"},{name:"value",type:"string"},{name:"wrap",type:"array",value:"soft, hard"},{name:"width",type:"string",value:""}],cn=[{name:"className",type:"string",value:""},{name:"id",type:"string",value:""}],Ha=[{name:"className",type:"string",value:""},{name:"Width",type:"string",value:""},{name:"Height",type:"string",value:""},{name:"Background Color",type:"color",value:"#FFFFFF"},{name:"Color",type:"color",value:"#000000"},{name:"Margin",type:"string",value:""},{name:"Padding",type:"string",value:""}];let Kn=[],Yn=[];async function Da(i){let e="";for(const n in i)if(Object.prototype.hasOwnProperty.call(i,n)){const t=i[n];e+=` ${n}="${t}" `}return e}async function Na(i,e){const n=new z;n.composition=i,n.fullLinkers=["the_widget_html","the_widget_css","the_widget_js"];const t=await he([n],e),a=t?.data?.the_widget?.the_widget_html?.[0]?.id,s=t?.data?.the_widget?.the_widget_css?.[0]?.data.the_widgetCSS,o=t?.data?.the_widget?.the_widget_js?.[0]?.data.the_widgetJS;if(!a)return{html:"",css:"",js:""};const l=await ya(a,["contain_s"]);Kn=await Jn(l.externalConnections),Yn=await Jn(l.internalConnections);let r=await _i(a,Kn,Yn);const d=document.createElement("div");return d.innerHTML=r,{html:(d?.querySelector(".widget-wrapper")).innerHTML,css:s||"",js:o||""}}async function _i(i,e,n){try{let t="",s=Fa(e)[i];if(s!=null){let o=Oa(s);const r=(await Zi())?.map(g=>{const m=g?.id,p=g?.data?.the_element?.the_element_name?.[0]?.data?.the_name,h=g?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag,v=g?.data?.the_element?.the_element_void?.[0]?.data?.the_void,W=g?.data?.the_element?.the_element_s_attribute?.map(T=>{const w=T?.data?.the_attribute,y=w?.the_attribute_name?.[0]?.data?.the_name,_=w?.the_attribute_type?.[0]?.data?.the_type,S=w?.the_attribute_value?.[0]?.data?.the_value;return{name:y,type:_,value:S}});return{id:m,name:p,tag:h,void:v,attributes:W}}),d=[...Tn,...cn],c=(await I())?.userId;for(let g=0;g<o.length;g++){const m=o[g];if(m.ofTheConceptId==i){const p=await qa(m.toTheConceptId,n),h=Object.keys(p.data)[0],v=p.data[h],E=ht.includes(h),W=await Da(v?.attributes||[]),T=r.find(y=>y.tag===h.toLowerCase().trim()),w=v?.attributes;for(const y in w){const _=d.find(C=>y===C?.name?.toLowerCase().trim()),S=w[y],b=_?.type;T.attributes=T?.attributes?.map(C=>(C?.name==="className"&&y==="class"?C.value=S:C?.name==="elementContent"?C.value=v?.innerText:y===C?.name&&(b==="array"?C.selected=S:b==="boolean"?C.value="":C.value=S),C))}if(h!="text"){const y=await ui(p.id,c);y?.length&&await bn(y?.[0]?.id);const _={[`wdgt${p.id}`]:T},S=await He(_,null,null,null,c);console.log("elementAttributeComp ->",S),t+=`
  ...
  ondragstart="_dragService.dragStartWidgetElement(event)" data-elementid="${T?.id}">
            <${h} data-cc-id="${p.id}" `+W+`${E?"/></div>":">"}`,t+=await _i(m.toTheConceptId,e,n)}(v.contains=="false"||h=="text")&&(t+=" "+v.innerText+" "),!E&&h!="text"&&(t+=`</${h}></div>`)}}}return t}catch(t){console.error("error converting html",t)}}async function qa(i,e){var n=[],t={},a=e;n=a;for(var s=[],o=0;o<n.length;o++)s.includes(n[o].ofTheConceptId)||s.push(n[o].ofTheConceptId);var l=await Q(i);if(l.id==0&&i!=null&&i!=null){var r=await Q(i);l=r}var d=await wa(i,n,s),u=l?.type?.characterValue??"";t[u]=d;var c={};return c.data=t,c.id=i,c}function Fa(i){return i.reduce((e,n)=>{const{ofTheConceptId:t}=n;return e[t]||(e[t]=[]),e[t].push(n),e},{})}function Oa(i){const e=new Map;i.forEach(s=>{e.set(s.id,s)});const n=[],t=new Set,a=s=>{if(!t.has(s.id)){t.add(s.id),n.push(s);for(const o of i)o.orderId==s.id&&a(o)}};return i.forEach(s=>{s.orderId==1e3&&a(s)}),n}async function Va(i,e){var n=[];try{var t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),t.append("Randomizer",mi.BASE_RANDOMIZER.toString());const a=await fetch(ae.baseNodeUrl+"/api/v1/local-concepts-translate",{method:"POST",headers:t,body:JSON.stringify({id:i})});return a.ok?await a.json():(console.log("recursive search error ",a.status),n)}catch(a){console.log(a)}}async function Ei(i,e,n=1e3,t){const a=i.userId,r=await gi("contain_s",999,999,a);return await pi(i.id,e.id,r.id,n)}const Ra="the_widget";async function Ua(i,e,n){return await za(i,e,n)}async function za(i,e,n){const s=new DOMParser().parseFromString(i,"text/html").body,o=await He({[Ra]:{}});e&&await Ja(e,o),n&&await Ga(n,o);const l=await He({widgetHTML:{}});await V(o,l,"html");const r=await Ti(s.children[0],l);return await Ei(l,r),await N.SyncDataOnline(),o}async function Ja(i,e){const t=(await I())?.userId,s=await te("the_widgetCSS",i,!0,t,4,999);await V(e,s,"css")}async function Ga(i,e){const t=(await I())?.userId,s=await te("the_widgetJS",i,!0,t,4,999);await V(e,s,"js")}async function Ti(i,e){console.log("parentConcept ->",e);const n={};if(n.tagName=i?.tagName?.toLowerCase(),i?.attributes?.length>0){n.attributes={};for(let s of i.attributes)n.attributes[s.name]=s.value}i?.textContent?.trim()&&(n.text=i.textContent.trim());let t={[n.tagName?n.tagName:"text"]:{contains:i?.children?.length?"true":"false",attributes:n.attributes||"",innerText:i?.children?.length?"":n.text||""}};const a=await He(t);if(i?.childNodes?.length>0){n.children=[];let s=[],o=-1,l,r;for(let u of i.childNodes)if(!(u.nodeType===Node.TEXT_NODE&&u.textContent?.trim()==="")&&!(i.children.length===0&&u.nodeType===Node.TEXT_NODE)){if(u.nodeType===Node.TEXT_NODE){let c={text:{contains:!1,attributes:"",innerText:u.textContent?.trim()}};const g=await He(c);s.push({parentConcept:a,childConcept:g,orderId:r})}else u.nodeType===Node.ELEMENT_NODE&&(l=await Ti(u,a),s.push({parentConcept:a,childConcept:l,orderId:r}));o>=0&&(s[o]={...s[o],orderId:l?.id}),o++}let d=1e3;for(let u=0;u<s.length;u++){const c=s[u];d=(await Ei(c.parentConcept,c.childConcept,d)).id}}return a}async function Sn(){}class Qa{convertModalHTML;constructor(){this.init()}init(){this.convertModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.convertModalHTML)}getHtml(){return`
  ...
  `,e?.appendChild(n)}function Cn(){const i=document.querySelector(".content-target");i.innerHTML="",i.textContent="Widget Loading..."}function Ln(){return document.querySelectorAll(".content-target")[0]}function ni(i){const e={past:[],present:i,future:[]};return{getState(){return{current:e.present,canUndo:e.past.length>0,canRedo:e.future.length>0}},push(n){e.past.push(e.present),e.present=n,e.future=[]},undo(){if(e.past.length===0)return;const n=e.past[e.past.length-1];return e.past=e.past.slice(0,-1),e.future=[e.present,...e.future],e.present=n,n},redo(){if(e.future.length===0)return;const n=e.future[0];return e.future=e.future.slice(1),e.past=[...e.past,e.present],e.present=n,n}}}class D{static actionHistories;static renderActionButtons(){const e=document.getElementById("undo-btn"),n=document.getElementById("redo-btn");e?.addEventListener("click",D.undoAction),n?.addEventListener("click",D.redoAction)}static renderActionHistory(){D.actionHistories=ni(JSON.stringify(f?.staticWidgetTree)),ni(JSON.stringify(f?.staticWidgetTree))}static updateButtonStates(){const{canUndo:e,canRedo:n}=D.actionHistories.getState(),t=document.getElementById("undo-btn"),a=document.getElementById("redo-btn");t&&(t.disabled=!e),a&&(a.disabled=!n)}static async undoAction(){const e=D.actionHistories.undo();e!==void 0&&(li(e||""),D.updateButtonStates())}static async redoAction(){const e=D.actionHistories.redo();e!==void 0&&(li(e||""),D.updateButtonStates())}static updateActionHistories(){D.actionHistories.push(JSON.stringify(f.staticWidgetTree)),D.updateButtonStates()}}async function ps(){const i=document.getElementById("widget-prompt-modal");i&&i.remove()}async function hs(){document.getElementById("widget-prompt-modal").classList.add("d-none");const e=document.getElementById("widget-prompt-tab");e.classList.remove("d-none"),e.classList.add("d-flex")}async function fs(){document.getElementById("widget-prompt-tab").classList.add("d-none");const e=document.getElementById("widget-prompt-modal");e.classList.remove("d-none"),e.classList.add("d-flex")}function ys(){const i=document.getElementById("prompt-text");i.addEventListener("input",()=>{i.style.height="auto";const e=Math.min(i.scrollHeight-8,120);i.style.height=`${e}px`,i.style.overflowY=e===120?"auto":"hidden"})}class xi{widgetPromptHTML;assistantChatId;randomSuggestionEl;constructor(e){this.assistantChatId=e,this.randomSuggestionEl="",this.init()}init(){if(!this.assistantChatId){const n=["Newsletter signup form with email validation","Create a header section for portfolio website","Quick contact form with name, email, and message fields","Create a customer satisfaction survey form","Countdown timer for upcoming events or launches","Currency converter widget with real-time exchange rates","Task list widget with checkboxes and progress tracking"],a=((s,o=3)=>{if(s.length<o)return[];const l=new Set;for(;l.size<o;){const r=Math.floor(Math.random()*s.length);l.add(r)}return[...l]})(n,2);this.randomSuggestionEl=a?.map(s=>`<div class="suggestion-prompt">
            <button class="btn btn-outline-secondary rounded-pill py-2">${n[s]}</button>
          </div>`).join("")}this.widgetPromptHTML=this.getHtml(),document.querySelector("body #contentTargetAndCodeViewWrapper")?.insertAdjacentHTML("beforeend",this.widgetPromptHTML),ys(),setTimeout(()=>{const n=document.querySelector(".aiAssistantTabs"),t=document.querySelectorAll("#aiChatContainer, #prototypeWidget");n.querySelector("button").classList.add("active"),t[0].classList.add("active"),n.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{n.querySelectorAll("button").forEach(l=>l.classList.remove("active")),t.forEach(l=>l.classList.remove("active"));const s=a.dataset.id,o=document.getElementById(s);console.log("this is the target id and doc",s,o),a.classList.add("active"),o?.classList.add("active")})})},0)}getHtml(){return window.closeAssistant=ps,window.minimizeAssistant=hs,window.maximizeAssistant=fs,`
    ...
    `}}async function ws(i){const e=document.getElementById("widget-btn-wrapper");if(console.log("addWidgetUpdate",i),e.querySelector("#updateFsPage")||e.querySelector("#fspage-save-button"))return;e.innerHTML=`
      ...
      })();`;this.scriptElement.textContent=n,document.body.appendChild(this.scriptElement),f.selectedStaticWidgetTreeInfo?.widgetTree&&(f.selectedStaticWidgetTreeInfo.widgetTree.js=e)}async getHtml(){return window.getEditorContentJS=this.getEditorContentJS.bind(this),""}handleTab=e=>{const{state:n,dispatch:t}=e,{selection:a}=n;return a.ranges.length===0?!1:(t({changes:{from:a.ranges[0].from,to:a.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){this.editorInitialized=!0;const e=document.getElementById("editor-container-js-split");e&&(e.innerHTML="",this.editorView=new ie({doc:"/* Write your JavaScript here */",extensions:[jt,Ht,vi(),Dt(),ie.lineWrapping,Pe.tabSize.of(2),Pe.allowMultipleSelections.of(!0),ie.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),Nt.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),ie.updateListener.of(async n=>{if(n.docChanged){const t=this.editorView?.state.doc.toString()||"";this.updateJS(t)}})],parent:e}))}getEditorContentJS(){return this.editorView?this.editorView.state.doc.toString():""}}async function ii(){const i=document.getElementById("codeBlocksContainer"),e=i.querySelectorAll(".sub-tab-btn");if(!i.querySelector(".sub-tab-btn.active")){e?.[0]?.classList.add("active");const t=document.getElementById("onmount-editor-split");t&&t.classList.add("active")}}async function Ii(i){const e=i?.id,n=i?.code,t=i?.slug,a=i?.name,s=document.querySelectorAll(".custom-service-btn"),o=Array.from(s)?.filter(c=>c?.getAttribute("data-subtab")===t),l=document.getElementById("lifecycle"),r=l?.querySelector(".sub-tab-nav");if(!o.length){const c=document.createElement("button");c.classList.add("sub-tab-btn","custom-service-btn"),c.setAttribute("data-subtab",t),c.innerHTML=`
    ...
    `,r?.appendChild(c);const g=document.createElement("div");g.classList.add("sub-tab-content","custom-editor-content"),g.id=`${t}-editor-split`,g.setAttribute("data-subtab",t),l?.appendChild(g);const m=`${t}-editor-split`;_s(m)}document.getElementById("codeBlocksContainer").querySelectorAll(".sub-tab-btn").forEach(c=>{c.addEventListener("click",function(){const g=c.getAttribute("data-subtab"),m=c.closest(".tab-content");m?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(p=>{p.classList.remove("active")}),c.classList.add("active"),m?.querySelector(`.sub-tab-content[data-subtab="${g}"]`)?.classList.add("active")})}),setTimeout(async()=>{const c=document.querySelector(`#${t}-editor-split .cm-editor .cm-scroller .cm-content.cm-lineWrapping`);if(c&&(c.textContent="/* Write your code here */",n))try{const g=await pt.format(n,{parser:"babel",plugins:[_n,En],tabWidth:2,semi:!0,singleQuote:!0,bracketSpacing:!0,printWidth:80});c.textContent=g}catch(g){console.error("JS formatting error:",g),c.textContent=n}},500)}async function _s(i){await new se(i).initializeEditor()}async function Es(i,e,n){const t=e.trim().toLocaleLowerCase().split(" ").join("-"),a=f.staticWidgetTree?.custom_functions?.filter(u=>u.slug===i);a[0].name=e,a[0].slug=t,console.log("updated static widget tree",f.staticWidgetTree);const s=document.querySelector(`button[data-subtab=${i}]`);s?.setAttribute("data-subtab",t),s.innerHTML=`
  ...
  `;const o=s?.querySelector("span.service-name");o&&(o.innerText=e);const l=document.getElementById(`${i}-editor-split`);l?.setAttribute("data-subtab",t),l.id=`${t}-editor-split`,await new se(`${t}-editor-split`).initializeEditor();const d=f.staticWidgetTree?.custom_functions?.filter(u=>u.slug===t);Ii(d?.[0]),we("rename-custom-function-modal")}class Ts{renameCustomFunctionModalHTML="";currentCustomFunctionSlug;customFunctionId;constructor(e,n){this.customFunctionId=n,this.currentCustomFunctionSlug=e,this.init()}init(){this.renameCustomFunctionModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.renameCustomFunctionModalHTML);const t=document.getElementById("rename-custom-function-modal").querySelector("form");t&&t.addEventListener("submit",a=>{a.preventDefault();const s=t.customFunctionName.value.trim(),o=/^[_A-Za-z][_A-Za-z ]*$/.test(s),l=document.getElementById("service-rename-error");o?(l.textContent="",l.classList.add("d-none"),Es(this.currentCustomFunctionSlug,s,this.customFunctionId)):(l.classList.remove("d-none"),l.textContent="Invalid name. Must not start with a number or '--', and contain only letters, numbers, hyphens or underscores.")})}getHtml(){return`
...
`,d?.appendChild(g),document.querySelectorAll(".tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-tab");document.querySelectorAll(".tab-btn, .tab-content").forEach(S=>S.classList.remove("active")),y.classList.add("active"),document.getElementById(_)?.classList.add("active")})}),g.querySelectorAll(".sub-tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-subtab"),S=y.closest(".tab-content");S?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(b=>{b.classList.remove("active")}),y.classList.add("active"),S?.querySelector(`.sub-tab-content[data-subtab="${_}"]`)?.classList.add("active")})});const h=document.querySelector(".fullscreenicon"),v=document.querySelector("#widgetButtionCodeViewWrapper");h?.addEventListener("click",()=>{v.classList.contains("fullscreen")?rt.enableHeader():rt.disableHeader(),v.classList.toggle("fullscreen")});const E=document.querySelector(".close-btn");E&&E.addEventListener("click",t),document.getElementById("synchronizeWidgetBtn").addEventListener("click",()=>n("Widget Synchronized")),document.getElementById("contentTargetAndCodeViewWrapper")?.prepend(c.firstChild),setTimeout(()=>{const y=document.querySelector(".codeSplitViewButton");y&&(y.removeEventListener("click",i),y.addEventListener("click",i));const _=document.getElementById("designSplitViewButton");_&&(_.removeEventListener("click",e),_.addEventListener("click",e))},0),document.getElementById("add-service-button")?.addEventListener("click",y=>s(y))};function s(d){d.stopPropagation();try{const u="add-custom-service-dialog";document.getElementById(u)?.remove();const g=document.createElement("dialog");g.setAttribute("id",u),g.classList.add("col-md-3"),g.innerHTML=`
  ...
  `;const a=document.getElementById("widget-builder");a.textContent="Widget Builder Panel",a.setAttribute("title","Widget Builder Panel"),q.disableWidgetButtons(),await new Xi().initializeEditor(),await new ki().initializeEditor(),await new se("onmount-editor-split").initializeEditor(),await new se("onupdate-editor-split").initializeEditor(),await new se("addevents-editor-split").initializeEditor(),await new se("mountchildwidgets-editor-split").initializeEditor(),await new Mi().initializeEditor();const g=document.getElementById("widgetNameValue");g.value="";const m=document.getElementById("widgetTypeValue");m&&(m.value="");const p=document.getElementById("widgetType");p&&(p.value=""),document.getElementById("widget-version").classList.add("d-none");const v=document.getElementById("element-attributes");v.innerHTML=`
    <div class="row">
      <div class="text-center my-3 text-secondary">
        <p>Select an element to view and edit its attributes</p>
      </div>
    </div>
  `,On(),document.getElementById("widget-prompt-modal")?.remove(),document.getElementById("widget-prompt-tab")?.remove()}function As(){const i=new ba;f.widgetTree=i,ot.synchronizeWidget("Workspace Cleared")}let ke="",Ct="";async function ai(i){try{const n=(await I())?.token,t=await fetch(`${ae.aiURL}/generate-widget`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify(i)});if(!t.ok){const d=await t?.text(),u=JSON.parse(d);throw L.errorToast(u.message),console.error(`API Error (${t.status}):`,d),Lt(t.statusText,"error"),new Error(`API request failed with status ${t.status}`)}const a=t.body.getReader(),s=new TextDecoder("utf-8");let o="",l=null;for(;;){const{value:d,done:u}=await a.read();if(u)break;o+=s.decode(d,{stream:!0});const c=o.split(`

`);for(let g=0;g<c.length-1;g++){const m=c[g].trim();if(m.startsWith("data:")){const p=m?.slice(6).trim();try{const h=JSON.parse(p);if(h.status==="responding"&&await Ms(h.message_str),h.status==="success"&&(l=h),h.status==="error")throw L.errorToast(h.message?.[0]||"AI Error"),new Error(h.message?.[0])}catch(h){console.warn("Stream parse error:",h)}}}o=c[c.length-1]}return document.getElementById("response-status")?.removeAttribute("id"),console.log("finalData",l),l}catch(e){return console.error(e),null}}async function xs(i){await je(i),f.resetWidgetTree(),document.getElementById("widget-prompt-modal")?.remove(),document.getElementById("widget-prompt-tab")?.remove(),new xi("");const t=document.getElementById("prompt-text");ke="",t?.addEventListener("keydown",function(l){if(l.key==="Enter"&&!l.shiftKey){l.preventDefault();const r={text_input:t?.value,chat_id:"",widget_type:"",stream:!0};ke&&(r.tag="followup",r.chat_id=ke,r.widget_type=Ct),ct(r)}}),document.querySelector(".button-send").addEventListener("click",function(l){l.preventDefault();const r={text_input:t?.value,chat_id:"",widget_type:"",stream:!0};ke&&(r.tag="followup",r.chat_id=ke,r.widget_type=Ct),ct(r)}),document.getElementById("suggestion-prompts-container")?.querySelectorAll(".suggestion-prompt button")?.forEach(l=>{l?.addEventListener("click",function(r){r.preventDefault(),t.value=l?.innerText})}),console.log("openPromptModal staticWidgetTree",f.staticWidgetTree)}async function ct(i){if(console.log("requestPromptData ->",i),i.text_input){Pi(i.text_input),ks("Assistant is working");const e=await ai(i);if(console.log("submitPrompt response",e),Is("prompt-loader"),!e)return;ke=e?.data?.chat_id,Ct=e?.data?.widget_type;const n=e?.message;if(f.staticWidgetTree.assistant={input:e?.data?.user_prompt,id:ke,type:Ct},console.log("submitPrompt StaticWidgetClass.staticWidgetTree ->",f.staticWidgetTree),e?.status=="error")L.errorToast(n);else{if(i.widget_type!=="list"){i.widget_type==="form"&&Bi(ke),console.log("this the prototype data",e.data.data_structure_prototype);const s=new Function("tsccs",e.data.data_structure_prototype)(hi);console.log(s,"this the prototype after eval");let o=document.getElementById("prototypeWidget");De(ae.visual_prototype_widget,o,{prototype:s}).then(l=>{l.dataChange(async r=>{console.log("this is the value for data change",r);const d={text_input:f.staticWidgetTree.assistant.input,chat_id:f.staticWidgetTree.assistant.id,widget_type:"",payload:r,type:"application/JSON",stream:!0};try{const u=await ai(d);console.log("this is the response",u),await mn(u)}catch(u){throw u}})})}await Lt(n);const t=document.createElement("button");t.classList.add("clearWorkspaceButton"),t.textContent="Clear Workspace",t.classList.add("btn","btn-danger"),t.addEventListener("click",()=>{As(),t.remove()}),await Lt(t),Cn(),await mn(e)}}}async function Lt(i,e){const n=document.querySelector(".chat-content"),t=document.createElement("div");if(t.classList.add("message","message-bot"),i instanceof HTMLButtonElement){const a=document.querySelector(".clearWorkspaceButton");a&&a.remove(),t.appendChild(i)}else e==="error"&&t.classList.add("text-danger","my-0","text-center"),t.innerText=i;n?.scrollTo({top:n.scrollHeight,behavior:"smooth"}),n?.insertAdjacentElement("beforeend",t)}async function Ms(i,e){const n=document.getElementById("response-status");if(n)n.innerHTML=i;else{const t=document.querySelector(".chat-content"),a=document.createElement("div");a.id="response-status",a.classList.add("message","message-bot"),a.innerHTML=i,t?.insertAdjacentElement("beforeend",a),t?.scrollTo({top:t.scrollHeight,behavior:"smooth"})}}function Pi(i){const e=document.getElementById("default-message"),n=document.querySelector(".chat-content"),t=document.createElement("div");t.classList.add("message","message-user"),t.innerText=i,n?.insertAdjacentElement("beforeend",t),e?.remove();const a=document.getElementById("prompt-text");a.value="",a.style.height="44px"}function ks(i){Ps("prompt-form");const e=document.getElementById("prompt-content"),n=document.createElement("div");n.id="prompt-loader",n.textContent=i,e?.insertAdjacentElement("beforeend",n)}function Is(i){document.getElementById(i)?.remove(),Bs("prompt-form")}function Ps(i){const e=document.getElementById(i);for(let n of e.elements)n.disabled=!0}function Bs(i){const e=document.getElementById(i);for(let n of e.elements)n.disabled=!1}async function mn(i){const e=i?.data?.ui?.html||"",n=i?.data?.ui?.css||"",t=i?.data?.ui?.js||"",a=i?.data?.before_render||"",s=i?.data?.after_render||"",o={html:e,css:n,js:t,before_render:a,after_render:s,assistant:{id:i?.data?.chat_id,input:i?.data?.user_prompt,type:i?.data?.widget_type}};await $s(o)}async function $s(i){f.staticWidgetTree.html=i.html,f.staticWidgetTree.css=i.css,f.staticWidgetTree.js=i.js,f.staticWidgetTree.before_render=i.before_render,f.staticWidgetTree.after_render=i.after_render,f.staticWidgetTree.assistant=i.assistant;const e=f.staticWidgetTree,n=document.getElementById("builder-workarea");n.innerHTML="";const t=await Ci(e,n);f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},console.log("StaticWidgetClass ->",f.widgetTree),await X(e,!1,t),D.renderActionHistory(),D.updateActionHistories(),ce(),pe()}async function Bi(i){document.getElementById("prompt-suggestion")?.remove();const n={text_input:"create a list widget for it",chat_id:i,widget_type:"list",stream:!0},t=document.createElement("div");t.id="prompt-suggestion",t.innerHTML=`
...
${n?.css}`:n?.css;if(await Wi(s,o),le(i?.html),await Li(i?.after_render),await Ai(i?.before_render),i?.custom_functions?.length){const l=document.querySelectorAll(".custom-service-btn"),r=Array.from(l)?.map(c=>c.getAttribute("data-subtab")??""),d=i.custom_functions?.map(c=>c.slug);(r?.filter(c=>!d.includes(c))).forEach(c=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${c}"]`);g&&g.remove(),document.getElementById(`${c}-editor-split`)?.remove()}),ii(),i.custom_functions?.forEach(c=>{Ii(c)})}else document.querySelectorAll(".custom-service-btn").forEach(d=>{d.remove()}),document.querySelectorAll(".custom-editor-content").forEach(d=>{d.remove()}),ii();(t||a)&&Ot(i?.origin?i?.origin:i?.widgetId),t&&i?.assistant?.id&&js(i?.assistant)}const gn="drop-indicator";function $i(){let i=document.querySelector(`.${gn}`);return i||(i=document.createElement("div"),i.className=gn,document.body.appendChild(i)),i}function Hs(i,e){const n=$i(),t=i.getBoundingClientRect();e==="top"?n.style.top=`${t.top-5}px`:e==="bottom"&&(n.style.top=`${t.bottom-5}px`),n.style.left=`${t.left}px`,n.style.width=`${t.width}px`,n.style.opacity="1",n.style.transform="scaleY(1)"}function Ds(){document.querySelectorAll(`.${gn}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function Ns(i,e,n){if(e.length===0)return{element:n,position:"top"};const t=i.clientY;let a=e[0],s=Math.abs(a.getBoundingClientRect().top-t);Math.abs(a.getBoundingClientRect().bottom-t);for(const d of e){const u=d.getBoundingClientRect(),c=Math.abs(u.top-t);Math.abs(u.bottom-t),c<s&&(a=d,s=c)}const o=a.getBoundingClientRect(),l=o.top+o.height/2,r=t<l?"top":"bottom";return{element:a,position:r}}let J=null,H;function Ut(){const i=document.querySelector(".content-target > .mftsccs-marking-element");if(i){const e=document.querySelector(".content-target");_e.fixContentTargetHeight(e,i)}}function qs(i){J=i.target;let e={data_type:i.target.getAttribute("data-type"),data_default:i.target.getAttribute("data-default"),data_void:i.target.getAttribute("data-void"),data_text:i.target.getAttribute("data-text"),elementId:i.target.getAttribute("data-elementId"),dataId:i.target.id,imageUrl:i.target.imageUrl,displayType:i.target.displayType};i.dataTransfer.setData("text",JSON.stringify(e)),i.dataTransfer.setData("id",i.target.id),i.dataTransfer.effectAllowed="move"}async function Fs(i){i.stopPropagation();const e={widgetcodeId:i.target.getAttribute("data-widgetId"),sourceElementId:i.target.id,className:i.target.className,imageUrl:i.target.imageUrl,displayType:i.target.displayType,type:i.target.Type};console.log("widgetcodeData ->",e),i.dataTransfer.setData("text",JSON.stringify(e)),i.dataTransfer.effectAllowed="move"}function Os(i){i.preventDefault(),i.stopPropagation(),i.target.classList.add("dragging-area"),ft.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",ss()}function Vs(i){i.preventDefault(),i.stopPropagation(),i.target.classList.remove("dragging-area")}function Rs(i){i.preventDefault(),i.stopPropagation(),(!J||!(i.currentTarget instanceof HTMLElement))&&(J=i?.target);const e=i.target,n=Array.from(e.children).filter(a=>a!==J);$i();const t=Ns(i,n,e);H=t,Hs(t.element,t.position)}function Us(){q.checkContent()?q.enableWidgetButtons():q.disableWidgetButtons()}async function zs(i){const e=await zt(i);J=null,Ds(),D.updateActionHistories(),ft.collapseNavbar(),Us(),Ut(),ce(),e&&(le(),Ot(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),pe()}function Wt(i,e){return Array.isArray(i?.children)&&(i.children=i?.children.filter(n=>n?.wrapper!==e),i.children.forEach(n=>Wt(n,e))),i}function Fe(i,e){let n;return Array.isArray(i?.children)&&(n=i?.children.filter(t=>t?.wrapper===e),i.children.forEach(t=>Fe(t,e))),n?.[0]}async function Js(i){i.preventDefault(),i.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(c=>{const g=document.getElementById(`${c}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};ut(m,`${c}-content`)}});const n=document.getElementById("element-attributes");if(n&&n.style.display==="block"){const c={target:document.querySelector("#icon-attribute")};ut(c,"element-attributes")}const t=R.staticElement,a=t?.parentElement,s=a?.parentElement,o=s?.dataset?.widgetid,l=t?.parentElement?.closest(".added-widget-container")||t?.parentElement?.closest(".edited-widget-container"),r=t.querySelectorAll(".added-widget-container");if(t?.classList?.contains("added-widget-container")){const c=t?.id;Wt(f?.staticWidgetTree,c)}else r.length&&r.forEach(c=>{const g=c?.id;Wt(f?.staticWidgetTree,g)});if(l){const c=l.id;if(t?.remove(),R.staticElement.remove(),Et(),t?.classList?.contains("added-widget-container")){const g=Fe(f?.staticWidgetTree,c),m=l.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,X(g)}else{const m=document.getElementById(c).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,X(f.selectedStaticWidgetTreeInfo.widgetTree)}ce(),D.updateActionHistories();return}a?.classList.contains("mftsccs-marking-element")&&a.children.length===1&&a?.remove(),o&&(s?.children?.length||s?.remove()),t?.remove(),R.staticElement.remove(),Et();const d=await Ze();return f.staticWidgetTree.html=d,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},Br(),X(f?.staticWidgetTree),ce(),D.updateActionHistories(),q.checkContent()||(q.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}async function Gs(i){return"drag"}async function Qs(i){return i.dataTransfer.setData("text",i.target.id),"start drag"}async function Zs(i){console.log("dragEndWidgetElement event ->",i)}async function Ks(i){return i.preventDefault(),i.stopPropagation(),"dragOverWidgetElement"}async function Ys(i){zt(i),le()}let At=null;async function ji(i,e){if(i.preventDefault(),i.stopPropagation(),console.log("dropFolderElement event ->",e.widget_id),!J)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let t=i.target;if(!t.classList.contains("mftsccs-marking-element")&&!t.classList.contains("fslayout-col")&&t.id!=="builder-workarea"){const r=document.getElementById("builder-workarea"),d=t.closest(".mftsccs-marking-element"),u=t.closest(".fslayout-col");t=d||u||r}if((J.contains(t)||J===t)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),t=document.getElementById("builder-workarea")),!t)return console.error("Invalid dropzone"),!1;console.log("dropzone ->",t),t?.classList.remove("dragging-area");let a=St(i,e);if(!a.status)return alert(a.message),J=null,!1;const s=e.dataType||e.type||e.data_type,o=s==="photo"||s==="Image"||s==="img",l=s==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(o){let r,d=!1;if(J&&J.tagName&&J.tagName.toLowerCase()==="img"){if(console.log("Moving existing image element"),d=!0,r=J,r.parentElement===t&&console.log("Image is already in this dropzone, just repositioning"),!(r instanceof Node))return console.error("draggedItem is not a valid DOM node:",r),J=null,!1;(!r.hasAttribute("style")||!r.style.width)&&r.setAttribute("style","width: 200px;")}else{console.log("Creating new image element from data");const p=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(t.querySelectorAll(`img[src="${p}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),J=null,!1;r=document.createElement("img"),r.setAttribute("src",p),r.setAttribute("style","width: 200px;")}let u=_e.generateUUID();r.setAttribute("element-info-id",u);const c=t.classList.contains("file-item")&&t.classList.contains("photo-file")&&t.classList.contains("dragging");let g=r;if(c){console.log("Dropzone is photo-file container, wrapping image in div");const p=document.createElement("div");p.appendChild(r),g=p}try{if(d){console.log("Repositioning existing image element");const p=c&&r.parentElement?.parentElement||r.parentElement,h=c?r.parentElement:r;p&&p!==t&&h&&p.removeChild(h)}H?.position==="top"&&t?.children?.length&&H?.element?t.contains(H.element)&&!g.contains(H.element)&&g!==H.element?(t.insertBefore(g,H.element),console.log("Inserted element before indicator element (top position)")):(console.warn("Invalid indicator element for top position, appending to dropzone"),t.appendChild(g)):H?.position==="bottom"&&H?.element?t.contains(H.element)&&!g.contains(H.element)&&g!==H.element?(H.element.insertAdjacentElement("afterend",g),console.log("Inserted element after indicator element (bottom position)")):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),t.appendChild(g)):(console.log("Appending element to dropzone (default position)"),t.appendChild(g)),console.log("Element successfully positioned in dropzone:",t)}catch(p){console.error("Error positioning element:",p.message);try{t.appendChild(g),console.log("Fallback: Element appended to dropzone")}catch(h){return console.error("Cannot append element:",h),J=null,!1}}r.removeAttribute("element-info-id");const m=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(console.log("parentWidgetOfSelectedElement ->",m),m){const p=m.id,h=Fe(f?.staticWidgetTree,p),v=m.querySelector(".mftsccs-marking-element");return v&&(h.html=v.innerHTML,await X(h)),J=null,!1}return Xs(),J=null,!0}else if(l){let r=St(i,e);if(console.log("isDropValid ->",r),!r.status)return alert(r.message),J=null,!1;if(e.sourceElementId){const w=e.sourceElementId||e.fileId;console.log("sourceElement ->",w)}let d=e.widget_id;t.classList.remove("dragging-area");const u=document.createElement("div");u.classList.add("wb-initial-empty"),u.style.display="block",u.style.marginBottom="10px",u.setAttribute("data-widget-id",d);const c=_e.generateUUID();u.id=`widget-${c}`;const g=await I();console.log("profileData ->",g);let m=t.classList.contains("publicWidgetRouter"),p=await re(d);if(console.log("widgetTree ->",p),!m){const w=await Ee(d.id,g.token);console.log("latestVersionOfWidget ->",w),p=await re(w?w.widgetId:Number(d)),console.log("widgetTree ->",p)}p?.children?.length&&await Jt(p);const h=q.clearDraggedWidget(p),v=await Te(h,u);h.wrapper=u.id;try{H?.position==="top"&&t?.children?.length&&H?.element?t.contains(H.element)&&!u.contains(H.element)&&u!==H.element?(t.insertBefore(u,H.element),console.log("Inserted widget container before indicator element (top position)")):(console.warn("Invalid indicator element for top position, appending to dropzone"),t.appendChild(u)):H?.position==="bottom"&&H?.element?t.contains(H.element)&&!u.contains(H.element)&&u!==H.element?(H.element.insertAdjacentElement("afterend",u),console.log("Inserted widget container after indicator element (bottom position)")):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),t.appendChild(u)):(console.log("Appending widget container to dropzone (default position)"),t.appendChild(u))}catch(w){console.error("Error positioning widget container:",w.message);try{t.appendChild(u),console.log("Fallback: Widget container appended to dropzone")}catch(y){return console.error("Cannot append widget container:",y),J=null,!1}}const E=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(console.log("parentWidgetOfSelectedElement ->",E),E){const w=E.id;Fe(f?.staticWidgetTree,w).children.push(h);const S=document.getElementById(w).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=S?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=S?.style.cssText,await X(f.selectedStaticWidgetTreeInfo.widgetTree),J=null,!1}const W=await dt();console.log("widgetHTMLToUpdate ->",W),f.staticWidgetTree.html=W,f.staticWidgetTree?.children?.push(h);const T=f.widgetTree.children.indexOf(h);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[T],isChildWidget:!0,childWidgetIndex:T},await X(h,!1,v),q.enableWidgetButtons(),J=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),J=null,!1}function Xs(){document.querySelectorAll(".mftsccs-marking-element img").forEach(i=>{i.setAttribute("draggable","true"),i.addEventListener("dragstart",e=>{e.stopPropagation(),At=Date.now(),console.log("Drag started for image:",i)}),i.addEventListener("dragend",e=>{e.stopPropagation(),console.log("Drag ended for image:",i),setTimeout(()=>{At=null},100)})})}function eo(){At=null,J=null,console.log("dragStartTime",At)}async function zt(i,e=!1,n,t){if(!i&&e&&n&&t){const r=await re(Number(n)),d=nn(t,n,!1,null);let u=await Te(r,d);r.wrapper=d?.id;const c=await Ze();f.staticWidgetTree.html=c,f.staticWidgetTree?.children?.push(r),X(r,!0,u);return}i.preventDefault(),i.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let s=i.dataTransfer.getData("text");if((r=>{try{return JSON.parse(r),!0}catch{return!1}})(s))if(Object.keys(JSON.parse(s)).includes("widgetcodeId")){const r=JSON.parse(s);let d=St(i,r);const u=r.className.split(" ");if(!d.status){alert(d.message);return}const c=JSON.parse(s);if(c.sourceElementId){const S=document.getElementById(c.sourceElementId.toString());if(S){i.target.insertBefore(S,d.elementBelowDrag);return}}let g=rs(c),m=i.target;m.classList.remove("dragging-area");const p=await I();let h=!1;u.includes("publicWidgetRouter")&&(h=!0);let v=null,E=null;if(h){v=await re(Number(g)),E=nn(m,g,!1,d.elementBelowDrag);const S=document.getElementById("widgetNameValue");S&&v?.name&&(S.value=v?.name);const b=document.getElementById("widget-builder");b&&v?.name&&(b.textContent="Widget Builder Panel: "+v?.name)}else{const S=await Ee(g,p.token);v=await re(S?S.widgetId:Number(g));const b=document.getElementById("widgetNameValue");b&&v?.name&&(b.value=v?.name);const C=document.getElementById("widget-builder");C&&v?.name&&(C.textContent="Widget Builder Panel: "+v?.name),v?.children?.length&&await Jt(v),E=nn(m,S?S.widgetId:g,!1,d.elementBelowDrag),console.log("newDropzone ->",E)}const W=q.clearDraggedWidget(v);let T=await Te(W,E);W.wrapper=E?.id;const w=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(w){const S=w.id;Fe(f?.staticWidgetTree,S).children.push(W);const A=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=A?.innerHTML,X(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const y=await Ze();f.staticWidgetTree.html=y,f.staticWidgetTree?.children?.push(W);const _=f.widgetTree.children.indexOf(W);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},X(W,!1,T),q.enableWidgetButtons()}else{const r=JSON.parse(s);console.log("objData ->",r);const d=i.target;let u=St(i,r);if(u.status){let h=_e.generateUUID();const v=Ir(h,r),E=document.createElement("div");E.innerHTML=v,H?.position==="top"&&d?.children?.length?d.insertBefore(E.firstChild,H?.element):H?.position==="bottom"?H?.element?.insertAdjacentElement("afterend",E.firstChild):d.appendChild(E.firstChild),i.target.classList.remove("dragging-area");let T=d.querySelector(`[element-info-id='${h}']`);r.data_type=="layout"?T.querySelectorAll(".fslayout-col").forEach(y=>{y.classList.add("wb-initial-empty")}):(T.classList.add("wb-initial-empty"),r?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))),T.removeAttribute("element-info-id"),r?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))}else alert(u.message);const c=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(c){const h=c.id,v=Fe(f?.staticWidgetTree,h),E=c.querySelector(".mftsccs-marking-element");return v.html=E?.innerHTML,await X(v),i.dataTransfer.clearData(),!1}const g=document.querySelector(".content-target"),p=(await Ce(g,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=p;try{i.dataTransfer.clearData()}catch(h){console.error("error in clearing data",h.message)}return!0}else{const r=R.staticElement,d=i.target;d.classList.remove("dragging-area"),H?.position==="top"&&d?.children?.length?d.insertBefore(r,H?.element):H?.position==="bottom"?H?.element?.insertAdjacentElement("afterend",r):d.appendChild(r),Et();const u=await Ze();f.staticWidgetTree.html=u}}function to(i){const s=new DOMParser().parseFromString(i,"text/html").body.querySelector("div")?.id,l=document.getElementById(s)?.parentElement?.closest(".added-widget-container"),r=l?.id,d=l?.querySelectorAll(".widget_container_disabled");return d?.length&&d?.forEach(u=>{const c=_e.generateUUID();u.id=`wdgt${c}`}),r?.toString()}async function Jt(i){return Array.isArray(i.children)&&i.children.forEach(e=>{Hi(e,i),e.children.length&&Jt(e)}),i}function Hi(i,e){const n=i.wrapper,s=new DOMParser().parseFromString(e?.html,"text/html").body,o=s.querySelector(`#${n}`);if(!o)return i;const r=`wdgtcopy${_e.generateUUID()}`;return o.id=r,i.wrapper=r,e.html=s.innerHTML.toString(),i}const no=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:Ut,dragElement:Gs,dragEndWidgetElement:Zs,dragOverWidgetElement:Ks,dragStartWidgetElement:Qs,dropElement:zt,dropFolderElement:ji,dropWidgetElement:Ys,findChildByWrapper:Fe,getChildWrapperId:to,getChildrenWrapperId:Hi,onDragEnter:Os,onDragLeave:Vs,onDragOver:Rs,onDragStart:qs,onDrop:zs,onWidgetDragStart:Fs,removeChildByWrapper:Wt,removeElement:Js,resetDragState:eo,updateAllChildWidgets:Jt},Symbol.toStringTag,{value:"Module"})),io=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],An=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class Di{constructor(){}async getLayoutListHTML(){return An.map(n=>`
      ...
      `).join("")}async getTemplateLayoutsHTML(){const e=await pr();if(!e||e.length===0)return'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No templates available</p></li>';const n=await I(),t=n?.entityId===101651686||n?.entityId===101279491;return e.map(a=>a.id?`
      ...
      `:"").join("")}}async function Ee(i,e){let n=new z;n.composition=i,n.fullLinkers=["the_widget_recent","the_widget_latest"],n.inpage=100;let t=new z;t.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],t.inpage=100;const s=await he([n,t],e),l=await Ie(i,"the_widget_recent"),r=s?.data?.the_widget?.the_widget_recent||s?.data?.the_widget?.the_widget_latest||[],d=s?.data?.the_widget?.the_widget_latest||null;if(r.length){const u=r[0],c=u?.data.the_widget.the_widget_name?.[0].data.the_name,g=u?.data.the_widget.the_widget_html?.[0].data.the_html,m=u?.id,p=u?.data.the_widget.the_widget_css?.[0].data.the_css,h=u?.data.the_widget.the_widget_js?.[0].data.the_js,v=u?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,E=u?.data.the_widget.the_widget_version?.[0].data.the_version,W=u?.data.the_widget.the_widget_origin?.[0].data.the_origin|i;return{widgetName:c,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:v,widgetVersion:Number(E||d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||d.id,origin:Number(W),connectionIdLatest:l,publishedWidgetVersion:d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const q=(()=>{const i=async()=>{const w=document.getElementById("fslayout-template-container");if(w){w.innerHTML=`
        ...
        </li>`;const _=await new Di().getTemplateLayoutsHTML();w.innerHTML=_}},e=async()=>{const w=document.getElementById("public-widget-list-container");if(w){const y=await wn();!y||y.trim()===""?w.innerHTML=`
            <li class="list-unstyled">
              <p class="text-center my-3 text-secondary">No public widgets</p>
            </li>
          `:w.innerHTML=y||""}},n=async()=>{const w=document.getElementById("folder-widget-container");if(w){const y=await gr();!y||y.trim()===""?w.innerHTML=`
            <li class="list-unstyled">
...
`;m?.file(`${c.slug}.index.ts`,p)}e?.file("routes.ts",Gt(n))},bo=async(i,e,n)=>{console.log("widgetsDir",n);const a=(await I())?.token,s=await Hn(i,a,!0);let o=e?.folder("home");const l=`
...
`;o?.file("home.index.ts",l),s?.css&&o?.file("home.style.css",s?.css)},_o=async i=>{if(ue)return;ue=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],n=new Ft;const t=await Zt(n),a=t?.widgetsDir,s=t?.pagesDir;let o="";a&&s&&(o=await Eo(i,s)),t?.routesDir?.file("routes.ts",Gt(e)),n.generateAsync({type:"blob"}).then(function(l){let r=document.createElement("a");r.href=URL.createObjectURL(l),r.download=`${o||"page"}.zip`,r.click()}),ue=!1},Eo=async(i,e)=>{const n=await I(),t=n?.entityId,a=n?.token,s=await Hn(i,a,!0),o=new z;o.composition=t,o.inpage=100,o.fullLinkers=["the_entity_s_page"];const l=new z;l.inpage=100,l.composition=i,l.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const d=(await he([o,l],a))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==i),u=d?.[0]?.data?.the_page?.the_page_body?.[0]?.id,c=d?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    import * as tsccs from "mftsccs-browser";
    ...
    `;return g?.file("home.index.ts",m),s?.css&&g?.file("home.style.css",s?.css),c},To=async i=>{if(ue)return;if(!i){console.log("Project id is required");return}const a=(await new Qt().getProjectById(i))?.data?.the_project?.the_project_name?.[0]?.data?.the_name?.replace(/\s/g,"_").toLowerCase();ue=!0;let s=new Ft;const o=await Zt(s),l=o?.routesDir,r=o?.pagesDir;await So(r,l,i),s.generateAsync({type:"blob"}).then(function(d){let u=document.createElement("a");u.href=URL.createObjectURL(d),u.download=`the_${a}.zip`,u.click()}),ue=!1},So=async(i,e,n)=>{if(!i&&!e)return;let t=[];const s=(await I())?.token,o=new z;o.composition=n,o.inpage=100,o.fullLinkers=["the_project_s_page","the_project_main_page"];const l=new z;l.inpage=100,l.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const r=await he([o,l],s),d=r?.data.the_project?.the_project_main_page?.[0]?.id;if(r?.data.the_project?.the_project_s_page?.length)for(let u=0;u<r?.data.the_project?.the_project_s_page?.length;u++){const c=r.data.the_project.the_project_s_page[u];let g={page:c?.id,title:c?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:c?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:c?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:c?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:c?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:c?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!g.page)continue;const m=`${g.slug.split("-").map((v,E)=>E===0?v.charAt(0).toLowerCase()+v.slice(1):v.charAt(0).toUpperCase()+v.slice(1)).join("")}`;t.push({path:`/${g.slug}`,content:`${m}Index`,importFrom:`/${g.slug}/${g.slug}.index.ts`}),g.page==d&&t.push({path:"/",content:`${m}Index`});let p=i?.folder(g.slug);const h=`
                ...
                }`;p?.file(`${g.slug}.index.ts`,h)}e?.file("routes.ts",Gt(t))};async function Co(){const i=new se("mountchildwidgets-editor-split"),e=document.getElementById("mountchildwidgets-editor-split");e&&(e.innerHTML=""),await i.initializeEditor()}async function Lo(){const i=new se("onupdate-editor-split"),e=document.getElementById("onupdate-editor-split");e&&(e.innerHTML=""),await i.initializeEditor()}async function Ni(){await Co(),await Lo(),await us(),await ms()}function Wo(){document.getElementById("widget-lifecycle-form")?.remove(),document.createElement("div").setAttribute("id","widget-lifecycle-form")}function qi(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.add("saveWidgetDisabled")})}function pn(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.remove("saveWidgetDisabled")})}class Fi{arrowBtn=null;updateOnlyButton=null;isDroppedDown=!1;constructor(){}async LoadPageWidget(e){const t=(await I())?.token;Cn(),qi(),document.querySelector("#widget-properties #widget-type input")?.remove(),Wo(),await Ni();let s=Ln(),o=await Ee(e,t),l=await re(o?.widgetId??e);console.log("page widget tree",l);let r=await Te(l,s);this.addPageUpdate(e),pn(),f.resetWidgetTree(),f.widgetTree=l,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),X(l,!1,r,!0),q.enableWidgetButtons(),Ut(),ce(),pe()}toggleUpdate(e){this.updateOnlyButton&&this.arrowBtn&&(this.isDroppedDown&&e!==!0?(this.updateOnlyButton.classList.remove("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.updateOnlyButton.classList.add("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isDroppedDown=!this.isDroppedDown)}addPageUpdate(e){const n=document.getElementById("widget-btn-wrapper");n.innerHTML=`
        <div class="position-relative" style="z-index: 100;">
          <div class="w-100 d-flex justify-content-center">
      ...
      `,this.isDroppedDown=!1,this.arrowBtn=n.querySelector("#updateDropDownArrowPage"),this.updateOnlyButton=n.querySelector("#updateFsPage"),this.updateOnlyButton.addEventListener("click",()=>{this.toggleUpdate(!0)}),this.arrowBtn.addEventListener("click",()=>{this.toggleUpdate(!1)})}addCodeToDom(e,n){Wi(e.css,n?.css),Li(e.after_render),Ai(e.before_render),Sn()}}const si={PAGE_SAVE:"Page saved Successfully!",WIDGET_SAVE:"Widget saved Successfully!",NO_SAVED_WIDGET:"No saved widgets!",NO_WIDGET_CONTAINER:"Widget list container not found in the DOM."},oi=new Ue,Oi=new Fi;async function Mn(i){i.preventDefault();try{await Be(),await et();const e=document.getElementById("fspage-save-button"),n=Number(e?.getAttribute("data-pageid")),s="widget_"+(await oi.getPageById(n)).data?.[`the_${M.PAGE_COMP_NAME}`]?.[`the_${M.PAGE_COMP_NAME}_slug`].data.the_slug,o=document.querySelectorAll(".edited-widget-container");L.infoMessageToast("Saving page...",0),o?.length&&o.forEach(c=>{const g=c.querySelectorAll(".widget_container");g?.length&&g.forEach(m=>{m.className="widget_container_disabled"}),c.classList.remove("edited-widget-container")});const l=await Ze();f.staticWidgetTree.html=l,await f.savePageWidget(n,s),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast(si.PAGE_SAVE);const u=(await oi.getPageById(n))?.data?.the_page?.the_page_body?.id;return await Oi.LoadPageWidget(u),si.PAGE_SAVE}catch(e){Pn(e,"There is an error on saving widget")}}async function kn(i,e,n){i.preventDefault();const t=document.getElementById("updateFsPagePublish"),a=document.getElementById("updateFsPage"),s=a?.innerHTML||"";try{const o=document.getElementById("updateFsPagexx");t&&t.classList.add("disabled"),a&&(a.classList.add("disabled"),a.textContent="Updating.."),o&&(o.classList.add("disabled"),o.textContent="Updating..");const l=document.querySelectorAll(".edited-widget-container");L.infoMessageToast("Updating Page...",0),l?.length&&(L.infoMessageToast("Updating page...",0),l.forEach(c=>{const g=c.querySelectorAll(".widget_container");g?.length&&g.forEach(m=>{m.className="widget_container_disabled"}),c.classList.remove("edited-widget-container")}));const r=await Ze();f.staticWidgetTree.html=r;const d=await f.updateWidget();return console.log("updateWidgetResponse ->",d),Sn(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page Updated Successfully"),await Oi.LoadPageWidget(e),n&&n===!0&&await f.publish(),"updated widget successfully!"}catch(o){console.error("error updating page",o),o instanceof Error&&L.errorToast(o.message),document.querySelector(".infoMessageToast")?.remove()}finally{t&&t.classList.remove("disabled"),a&&(a.classList.remove("disabled"),a.innerHTML=s)}}function Ao(i){const e=new URLSearchParams(window.location.search).get("page-id");if(e){const n=`${window.location.origin}/page-preview/${e}`;window.open(n,"_blank")?.focus()}}function xo(i,e=0){return window.saveWidgetInFolders=ko,`
    ...
    `}let vt,at;async function Mo(i,e){vt=i,console.log("selectedWidgetId -->",vt);const n=xo(e,typeof i=="object"?0:i),t=document.createElement("div");t.innerHTML=n;const a=t.querySelector("#folder-widget-container");document.querySelector("body #app")?.appendChild(a),await de("folder-widget-container");const s=await I();if(!s)return;let o,l,d=(await Ye(vt,s.token))?.data?.the_widget?.the_widget_name?.[0]?.data?.the_name;e===!0?(o=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name"),console.log("nameInput -->",o),o&&(o.value=d),l=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")):(o=document.getElementById("folder-widget-container")?.querySelector("input#folder-name"),l=document.getElementById("folder-widget-container")?.querySelector("textarea#description"));const u=document.getElementById("widgetFolder");at=await De(ae.folder_widget,u,{widgetName:o.value,widgetDescription:l?.value,widgetId:vt,showCheckbox:!0,showFiles:!1})}async function ko(i,e,n,t){i.preventDefault(),console.warn("asdfads",at.selectedConceptIds);let a=[];at&&at?.selectedConceptIds?.length>0&&(a=at.selectedConceptIds||[]);try{L.infoMessageToast("Saving Widget...",0),await Be();const s=document.getElementById("folder-widget-container"),o=s?.querySelector('button[type="submit"]');o.textContent="Saving";const l=s?.querySelector("input"),r=s?.querySelectorAll("button"),d=document.getElementById("save-to-folder-name")||document.getElementById("folder-name");console.log("nameInputEl -->",d);const u=d.value;console.log("widgetNamex -->",u),r&&r.forEach(T=>{T.disabled=!0}),l&&(l.disabled=!0),await et();let c;if(!t){R.staticElement?.removeAttribute("draggable");const T=document.querySelectorAll(".edited-widget-container");T?.length&&T.forEach(async _=>{if(_.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[_.id]){const S=await Ce(_,"div.mftsccs-marking-element");f.editedWidgets[_.id].html=S.innerHTML}});const w=await Gi();f.staticWidgetTree.html=w,console.log("widgetNamex -->",u);const y=await f.saveWidget(u);c=await Y(y.id),n=c.id,console.log("Saved Widget ID:",n)}const g=await I(),m=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name")?.value||document.getElementById("folder-widget-container")?.querySelector("input#folder-name")?.value,p=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")?.value,h={title:m,source_url:window.location.href,widget_id:n,short_desc:p,note:"",data_type:"widget",created_on:Date.now()};if(a.length==0){const T=g?.userConcept;c=await Y(Number(n));let w={...h,boom_folder:{name:"",parent:T}};const y=await He({boomgpt:w},void 0,void 0,void 0,g.userId,4);await Zn(await Y(Number(T)),y,"the_boom_folder_s_contain"),await G(y,c,"the_refer")}else if(a?.length>0)for(let T=0;T<a.length;T++){const w=a[T];c=await Y(Number(n));const y=await Y(Number(w));if(!y)throw new Error("Selected folder concept not found!");let _={...h,boom_folder:{name:y.name||"",parent:w}};const S=await He({boomgpt:_},void 0,void 0,void 0,g.userId,4);await Zn(await Y(Number(w)),S,"the_boom_folder_s_contain"),await G(S,c,"the_refer")}await N.SyncDataOnline(),document.getElementById(e)?.querySelector("form")?.reset(),we("folder-widget-container"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget saved successfully!"),t||(await q.renderSavedWidgets(),Oe(i,Number(n)))}catch(s){document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Error in saving widget"),Pn(s,"There is an error on saving widget")}}class Vi extends gt{mainConcept=0;mainData;data=0;phonebooks=[];the_params;component_heading;saveButtonHTML;saveBoomButtonHTML;previewButtonHTML;tryAIButtonHTML="";responsiveButtonHTML="";_pageBuilderService;constructor(e){super(),this.component_heading="Widget Builder Panel",this.saveButtonHTML="",this.saveBoomButtonHTML="";const n=I();if(n&&(this.saveBoomButtonHTML=`
    ...
    `,e){this.the_params=e,this._pageBuilderService=new Fi;const t=this.the_params?.data?.the_page_title?.data?.the_title;this.component_heading=this.the_params.type?"Page Builder: "+t:"Widget Builder";const a=this.the_params?.page_id;n&&e.type==xn.page&&(this.saveBoomButtonHTML=`
         <div class="text-end d-flex flex-row" id="widget-btn-wrapper">
...
`}before_render(){this.render()}after_render(){if(this.the_params){document.getElementById("fspage-save-button").addEventListener("click",Mn);const n=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!n){Ut();return}this._pageBuilderService.LoadPageWidget(Number(n))}}getHtml(){return window.openSaveWidgetModal=Bn,window.saveWidget=Ji,window.updateWidget=$n,window.newWidget=je,window.previewWidget=Ho,window.downloadWebsite=yo,window.moveUp=_e.moveUp,window.moveDown=_e.moveDown,window.copyElement=_e.copyElement,window.editWidget=_e.editWidget,window.openConvertModal=qo,window.convertToWidget=Do,window.updatePage=kn,window.previewPage=Ao,window.undoAction=D.undoAction,window.redoAction=D.redoAction,window.saveWidgetToFolderBtn=Mo,window.openPromptModal=xs,window.refineAIData=mn,`
    ...
    `,e.querySelector("#closeModalBtn").addEventListener("click",this.handleClose.bind(this)),e}updateModal(){this.props.isOpen?this.modal.classList.add("open"):this.modal.classList.remove("open")}handleClose(){Ri(),this.modal.remove()}createNewPageModal(){return`
        <div class="m-body">
            <form id="fs-create-page-form">
    ...
    `}}function xt(i){new Io(i)}function ri(i){const e=document.getElementById(i);e&&e.remove()}class In{_pagesHTMLService;_pagesTSCCSService;constructor(){this._pagesHTMLService=new Si,this._pagesTSCCSService=new Ue}async initPagesSidebar(){this.closePagesSubSidebar(".fs-page-create-submenu"),this.closePagesSubSidebar(".fs-page-edit-submenu");const e=await this._pagesHTMLService.getPagesListHTML(),n=document.getElementById("saved-page-list-container");n&&(n.innerHTML="",n.insertAdjacentHTML("beforeend",e));const t=document.getElementById("fs-create-page-button");t?.removeEventListener("click",this.createButtonClickHandler),t?.addEventListener("click",this.createButtonClickHandler),document.querySelectorAll("#fs-delete-page-button").forEach(l=>{l.removeEventListener("click",this.deletePageButtonClickHandler),l.addEventListener("click",this.deletePageButtonClickHandler)}),document.querySelectorAll("#fs-rename-page-button").forEach(l=>{l.removeEventListener("click",this.editPageButtonClickHandler),l.addEventListener("click",this.editPageButtonClickHandler)}),document.querySelectorAll("#fs-duplicate-page-button").forEach(l=>{l.removeEventListener("click",this.duplicatePageButtonClickHandler),l.addEventListener("click",this.duplicatePageButtonClickHandler)})}closePagesSubSidebar(e){Array.from(document.querySelectorAll(e)).forEach(t=>t.remove())}createButtonClickHandler=()=>{xt({id:"fs-create-page-modal",isOpen:!0,headerText:"Create New Page"}),document.getElementById("fs-save-page-button")?.addEventListener("click",this.savePageButtonClickHandler);const n=document.getElementById("fs-create-page-form"),t=n?.elements.namedItem("title");if(!t){console.error("page_title not found");return}const a=async()=>{const o=await this._pagesTSCCSService.generateSlug(t.value);n.elements.namedItem("slug")?.setAttribute("value",o)};t.addEventListener("keyup",a);const s=()=>{t.removeEventListener("keyup",a),document.getElementById("fs-create-page-modal")?.removeEventListener("close",s)};document.getElementById("fs-create-page-modal")?.addEventListener("close",s)};savePageButtonClickHandler=async()=>{const n=document.getElementById("fs-create-page-form").elements;if(!n.title.value){n.title.style.borderColor="red";return}L.infoMessageToast("Creating page...",0);const t=await dn(n),a=await I();await this._pagesTSCCSService.savePage(t,a?.userId,a?.entityId),await N.SyncDataOnline(),this.initPagesSidebar(),document.querySelector(".infoMessageToast")?.remove(),ri("fs-create-page-modal"),setTimeout(()=>{L.successfullToast("Page created successfully")},300)};editPageButtonClickHandler=async e=>{const n=e.target.getAttribute("data-id"),t=e.target.closest(".dropdown-menu").dataset.title,a=e.target.closest(".dropdown-menu").dataset.slug;xt({id:"fs-edit-page-modal",isOpen:!0,headerText:"Rename Page",data:{title:t,slug:a}});const s=document.getElementById("fs-edit-page-form"),o=s?.elements.namedItem("title");if(!o){console.error("page_title not found");return}const l=async()=>{document.getElementById("fs-edit-page-button")?.removeAttribute("disabled");const c=await this._pagesTSCCSService.generateSlug(o.value);s.elements.namedItem("slug")?.setAttribute("value",c)};o.addEventListener("keyup",l);const r=()=>{o.removeEventListener("keyup",l),document.getElementById("fs-edit-page-modal")?.removeEventListener("close",r)};document.getElementById("fs-edit-page-modal")?.addEventListener("close",r),document.getElementById("fs-edit-page-button")?.addEventListener("click",()=>this.updatePageButtonClickHandler(n))};async PageInputElementChangeHandler(e,n){const t=e.target,a=t.name,s=t.value;let o=await this._pagesTSCCSService.checkSlugAvailablity(s);if(a==="slug"&&!o){document.getElementById("fs-update-page-button")?.setAttribute("disabled","true"),t.style.borderColor="red",t.insertAdjacentHTML("afterend",'<p style="color:red">Slug already exist</p>');return}await this._pagesTSCCSService.updatePageField(t.getAttribute("name"),t.value,Number(n))}updatePageButtonClickHandler=async e=>{const n=document.getElementById("fs-edit-page-form"),t=n.elements.namedItem("title");if(!t.value.trim()){t.style.borderColor="red";return}const a=n.elements;if(!a.title.value){a.title.style.borderColor="red";return}L.infoMessageToast("Renaming page...",2);const s=await dn(a),o=await I();await this._pagesTSCCSService.renamePage(s,e,o?.userId),await N.SyncDataOnline(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page renamed successfully");const r=new URLSearchParams(window.location.search).get("page-id");if(e===r){const d=document.getElementById("widget-builder");d.textContent=`Page Builder: ${s?.title}`}this.initPagesSidebar(),this.closePagesSubSidebar("#fs-page-edit-submenu"),ri("fs-edit-page-modal")};deletePageButtonClickHandler=async e=>{const n=e.target.getAttribute("data-id"),t=e.target.closest(".dropdown-menu").dataset.title,a=e.target.closest(".dropdown-menu").dataset.slug;confirm(`Are you sure you want to delete the page titled "${t}" with the slug "${a}"?`)?(L.infoMessageToast("Deleting page...",0),await this._pagesTSCCSService.deletePage(Number(n)),await N.SyncDataOnline(),bi("/"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page deleted successfully")):document.activeElement?.blur()};duplicatePageButtonClickHandler=async e=>{const t=e?.target?.getAttribute("data-id"),s=(await this._pagesTSCCSService.getPageById(Number(t)))?.data?.the_page,o=s?.the_page_title?.data?.the_title?.trim()+" copy",l=s?.the_page_slug?.data?.the_slug?.trim()+"-copy",r=s?.the_page_meta_title?.data?.the_meta_title?.trim(),d=s?.the_page_meta_description?.data?.the_meta_description?.trim(),u=s?.the_page_meta_keywords?.data?.the_meta_keywords?.trim(),c=s?.the_page_width?.data?.the_width?.trim(),g=s?.the_page_type?.data?.the_type?.trim(),m=s?.the_page_font_family?.data?.the_font_family?.trim(),p=s?.the_page_font_size?.data?.the_font_size?.trim(),h={title:o,slug:l,meta_title:r,meta_description:d,meta_keywords:u,width:c,type:g,font_family:m,font_size:p},v={};for(const[_,S]of Object.entries(h))S&&(v[_]=S);const E=s?.the_page_body?.id,W=await I(),T=await Ee(E,W?.token);let w=await re(T?T.widgetId:E);const y=await this._pagesTSCCSService.savePage(v,W?.userId,W?.entityId);await f.copyPageWidget(y,`widget_${l}`,w),this.initPagesSidebar(),L.successfullToast("Page duplicated successfully")}}async function Po(i){i?.preventDefault();const e=window.location.href,t=document.querySelector("#widget-btn-wrapper button")?.getAttribute("data-widgetid");if(await f.hasWidgetChanged(Number(t))){await _t("Do you want to save changes?")&&(e.includes("?page-id=")?t?await kn(i,Number(t)):await Mn(i):t?await $n(i,Number(t)):await Bn());const h=document.getElementById("preview-btn");h.classList.remove("active"),h.removeAttribute("data-widgetid")}f.resetWidgetTree();const s=i.target.getAttribute("data-pageId");history.pushState({},"",`?page-id=${s}`);let l=await new Ue().getPageById(Number(s));l?.error&&je();const r=document.getElementById("midContent"),d=document.getElementById("right-aside"),u={type:xn.page,data:l.data?.[`the_${M.PAGE_COMP_NAME}`],page_id:s},c=new Vi(u),g=new Yt(u);d.innerHTML=await g.getHtml(),r.innerHTML="",c.mount(r),as.resetNavigationBar()}class Ui{_projectsService;_pagesTsccsService;constructor(){this._projectsService=new Qt,this._pagesTsccsService=new Ue}async getProjectsListHTML(){try{const e=await this._projectsService.getAllProjects();return e?.length?e?.map(t=>{let s=t?.data?.[`the_${M.PROJECT_COMP_NAME}`]?.[`the_${M.PROJECT_COMP_NAME}_name`]?.data?.the_name;return`
    ...
    `,document.querySelector("body #app")?.appendChild(a),de("rename-project-dialog"),"Rename Project Modal"}async getProjectPagesListHTML(e){try{const n=await this._projectsService.getProjectById(e),t=n?.data?.the_project?.[`the_project_${oe.PROJECT_PAGE_LINKER}`],a=n?.data?.the_project?.the_project_main_page?.[0]?.id;return t?.length?t?.map(o=>{let l=o?.data?.[`the_${M.PAGE_COMP_NAME}`]?.[`the_${M.PAGE_COMP_NAME}_title`]?.[0]?.data?.the_title;const r=a==o.id,d=r?'<span class="material-symbols-outlined home-icon">home</span>':"",u=r?"":`<li class="d-flex align-items-center justify-content-between" 
      ...
      `,document.body.appendChild(n),n.showModal(),n}catch(n){return console.error("Error:",n),""}}}function Bo(i,e=[],n=[]){return`
  <style>
  .accordion-header {
  background: gray;
  color: white;
...
.custom-menu-item {
  ...
  `,document.querySelector("body #app")?.appendChild(e),de("save-widget-dialog"),new Promise((n,t)=>{const a=e.querySelector("#save-widget-form");a.onsubmit=async o=>{o.preventDefault();try{const l=new FormData(a),d=Object.fromEntries(l).widgetName,u=o.target;if(!d?.trim()){const c=u.querySelector("#widgetName");c?.focus(),c.style.border="2px solid red",c.style.outline="none",c.addEventListener("input",()=>{c.style.border=""});return}await Ji(o,d),we("save-widget-dialog"),n("Widget saved successfully")}catch(l){console.error("Error saving widget:",l),t("Error saving widget")}};const s=e.querySelector("button[type='button']");s.onclick=()=>{we("save-widget-dialog"),n("Widget saving canceled")}})}async function Ji(i,e){i.preventDefault();try{L.infoMessageToast("Saving Widget...",0),await Be();const n=document.getElementById("save-widget-dialog"),t=n?.querySelector('button[type="submit"]');t.textContent="Saving";const a=n?.querySelector("input"),s=n?.querySelectorAll("button");s&&s.forEach(c=>{c.disabled=!0}),a&&(a.disabled=!0),await et(),R.staticElement?.removeAttribute("draggable");const o=document.querySelectorAll(".edited-widget-container");o?.length&&o.forEach(async c=>{if(c.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[c.id]){const g=await Ce(c,"div.mftsccs-marking-element");f.editedWidgets[c.id].html=g.innerHTML}});const l=await Gi();f.staticWidgetTree.html=l;const r=await f.saveWidget(e),d=await Y(r.id);we("save-widget-dialog"),Rt(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget saved successfully!"),await q.renderSavedWidgets(),Oe(i,d.id);return}catch(n){document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Error in saving widget"),Pn(n,"There is an error on saving widget")}}async function $n(i,e,n){const t=document.getElementById("update-publish-widget-btn");try{const a=document.getElementById("update-widget-btn");t&&t.classList.add("disabled"),a&&(a.classList.add("disabled"),a.textContent="Updating...",L.infoMessageToast("Updating Widget...",0)),await et(),R.staticElement?.removeAttribute("draggable");const s=document.querySelectorAll(".edited-widget-container");s?.length&&s.forEach(async d=>{if(d.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[d.id]){const u=await Ce(d,"div.mftsccs-marking-element");f.editedWidgets[d.id].html=u.innerHTML}});const o=await Fo();f.staticWidgetTree.html=o,await f.updateWidget(),Rt(),pe(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Updated Successfully"),await q.renderSavedWidgets(),await q.renderBoomWidgets();const r=document.getElementById("widget-builder");r.textContent="Widget Builder Panel",await Oe(i,f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:e),n&&n===!0&&await f.publish();return}catch(a){document.querySelector(".infoMessageToast")?.remove();const o=document.getElementById("update-widget-btn");o&&(o.classList.remove("disabled"),o.innerHTML=`
    ...
    `}}class Xo{widgetDocumentationModalHTML;constructor(){this.init()}init(){this.widgetDocumentationModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.widgetDocumentationModalHTML)}getHtml(){return`
    ...
    `}}async function er(i,e){const n=document.getElementById("documentation-view");await De(ae.documentation_preview_widget,n,{currentWidgetId:e})}let lt,on="",hn,fn;async function tr(i,e){hn=i,e==="preview"?new Xo:new Yo;const n=new j;n.typeConnection="the_widget_documentation",n.name="documentationText",n.selectors=["the_documentation_text"];const t=new j;t.typeConnection="the_widget_s_documentation",t.name="documentationBlank",t.selectors=["the_documentation_text","the_documentation_content","the_documentation_language","the_documentation_doc_title","the_documentation_folder","the_documentation_creator_email","the_documentation_created_by","the_documentation_content","the_documentation_type","the_documentation_s_doc_url","the_documentation_s_image_url","the_documentation_s_video_link","the_documentation_auth_type","the_documentation_bearer_token","the_documentation_method","the_documentation_method_url","the_documentation_username","the_documentation_password","the_documentation_s_json_list","the_documentation_api_script","the_documentation_api_body","the_documentation_code_editor","the_documentation_return"];const a=new j;a.typeConnection="the_documentation_s_json_list",a.name="documentationJSON",a.selectors=["the_json_list_key","the_json_list_value"],t.freeschemaQueries=[a];const s=new j;s.conceptIds=[hn],s.freeschemaQueries=[n,t],s.inpage=100,s.outputFormat=fe,await ye(s,"").subscribe(async o=>{console.log("documentation data ->",o);const l=o?.[0]?.data?.the_widget?.the_widget_documentation?.data?.the_documentation?.the_documentation_text?.data?.the_text||"";l&&(on=l);const r=o?.[0]?.data?.the_widget?.the_widget_s_documentation;if(r?.length){const d=r?.map(u=>{const c=u?.data?.the_documentation,g=c?.the_documentation_type?.data?.the_type,m=c?.the_documentation_content?.data?.the_content,p=c?.the_documentation_creator_email?.data?.the_creator_email,h=c?.the_documentation_doc_title?.data?.the_doc_title,v=c?.the_documentation_method?.data?.the_method,E=c?.the_documentation_method_url?.data?.the_method_url,W=c?.the_documentation_bearer_token?.data?.the_bearer_token,T=c?.the_documentation_username?.data?.the_username,w=c?.the_documentation_password?.data?.the_password,y=c?.the_documentation_auth_type?.data?.the_auth_type,_=c?.the_documentation_s_json_list,S=c?.the_documentation_api_script?.data?.the_api_script,b=c?.the_documentation_api_body?.data?.the_api_body,C=c?.the_documentation_language?.data?.the_language,A=c?.the_documentation_return?.data?.the_return,x=c?.the_documentation_code_editor?.data?.the_code_editor,k=c?.the_documentation_s_doc_url,P=c?.the_documentation_s_image_url,B=c?.the_documentation_s_video_link;let $={type:g,content:m,creatorEmail:p,title:h};if(g==="blank")$={...$};else if(g==="api"){const F=[];_?.length&&_?.forEach(K=>{F.push({key:K?.data?.the_json_list?.the_json_list_key?.data?.the_key,value:K?.data?.the_json_list?.the_json_list_value?.data?.the_value})}),$={...$,method:v,methodURL:E,authType:y,username:T,password:w,bearerToken:W,json:F,script:S,body:b}}else g==="function"&&($={...$,language:C,return:A,codeEditor:x});const U=[],ee=[],Z=[];return P?.length&&P?.forEach(F=>{U.push(F?.data?.the_image_url)}),B?.length&&B?.forEach(F=>{ee.push(F?.data?.the_video_link)}),k?.length&&k?.forEach(F=>{Z.push(F.data?.the_doc_url)}),$={...$,imageList:U,linkList:Z,videoList:ee},$});console.log("documentationDataList",d),on=d}fn=o?.[0]?.data?.the_widget?.the_widget_documentation?.id,e!=="preview"&&ir(l)}),e==="preview"?(await de("widget-documentation-preview-modal"),er(on,i)):await de("widget-documentation-modal")}async function nr(){if(lt){const i=lt.getData(),e=await Q(hn),t=(await I())?.userId;if(fn)await Ke(fn,"the_documentation_text","text",i,t),await N.SyncDataOnline();else{const a=await O("documentation",t,{text:i});await G(e,a,"documentation"),await N.SyncDataOnline()}L.successfullToast("Documentation is saved."),lt.setData(i)}else console.error("Editor not initialized"),L.errorToast("Documentation couldn't saved.")}function ir(i){const e=document.querySelector("#documentation-editor");e&&$a.create(e,{licenseKey:"GPL"}).then(n=>{lt=n;const t=i;lt.setData(t)}).catch(n=>{console.error("Error initializing CKEditor:",n)})}class ar{constructor(){this.init()}init(){document.getElementById("btn-take-tour")?.addEventListener("click",n=>{if(n.target.matches(".btn-tour")){const t=n.target.dataset.tourStatus;this.startTour(t)}})}startTour(e){const n=new ka.Tour({defaultStepOptions:{classes:"wico",scrollTo:!0,cancelIcon:{enabled:!0}},useModalOverlay:!0}),t=[{classes:"back-button",text:"Back",action:n.back},{classes:"next-button",text:"Next",action:n.next}];n.addStep({id:"welcome",title:"👋 Welcome to Widget Conceptualizer",text:["This short tour will walk you through the essentials. Let's begin. Start building widgets today!"],buttons:[{text:"Remind me later",classes:"back-button",action:n.complete},{text:"Next",classes:"next-button",action:()=>{n.next()}}]}),n.addStep({id:"step-create-widget",title:"Create a New Widget",text:["Start by creating a new widget."],classes:"onboarding-boomconsole",highlightClass:"highlight",attachTo:{element:".wico_header-section",on:"bottom-start"},buttons:t}),n.addStep({id:"step-widget-panel",classes:"tour-widget-panel",title:"Workspace Area",text:"This is your creative canvas. Drag and drop elements, build widgets, apps, or full pages—right in the workspace.",attachTo:{element:".content-target",on:"top"},buttons:t}),n.addStep({id:"step-builder-meu",title:"Builder Menu",text:"This menu provides essential navigation tools. Use it to manage projects, access assets, open pages, and explore saved widgets.",attachTo:{element:".sidebar-collapsed",on:"left"},buttons:t}),n.addStep({id:"step-properties",title:"Properties Panel",text:"Adjust Styling, add properties like layout, colors, fonts, and more.",attachTo:{element:()=>{const a=document.querySelector(".accordion-widget-properties a"),s=new Event("click",{bubbles:!0,cancelable:!0});return a.dispatchEvent(s),".right-aside"},on:"left"},buttons:t}),n.addStep({id:"step-design-code-mode",title:"Design & Code Modes",text:[`
        ...
        `).join(""):'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No Saved Assets</p></li>'}searchWidgets(e,n){n||(n=`#${e.target?.dataset?.id}`||"");const a=e.target.value.toLowerCase();document.querySelectorAll(`${n} li`).forEach(o=>{const l=(o.textContent||"").toLowerCase();o.style.display=l.includes(a)?"":"none"})}searchPublicWidgets(e){const t=e.target.value.toLowerCase();wn(t).then(a=>{un.navbar.setPublicWidgets(a),this.updatePopupMenu("publicWidgets",a)})}async responsiveSidebar(){const e={mainItems:[{id:"elements",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <ul id="menu-${a}" class="dropdown-menu">
          ...
          </a>`}</li>`}).join(""):""}async function Zi(){const i=ae?.boomURL,e=[{type:"the_element",fullLinkers:["the_element_s_attribute"],inpage:100,page:1,logic:"or",filterSearches:[],selectors:["the_element_name","the_element_void","the_element_tag","the_element_default","the_element_icon","the_element_division"]},{fullLinkers:["the_attribute","the_attribute_type","the_attribute_name","the_attribute_value"],inpage:100,page:1,logic:"or",filterSearches:[]}],n=new Headers;n.append("Content-Type","application/json");const a=await(await fetch(`${i}/api/search-all-without-auth-with-linker?inpage=100&page=1`,{method:"POST",headers:n,body:JSON.stringify(e),redirect:"follow"})).json();return a?.sort((s,o)=>{s?.data?.the_element?.the_element_name?.[0]?.data?.the_name?.toLowerCase();const l=s?.data?.the_element?.the_element_name?.[0]?.data?.the_name?.toLowerCase(),r=o?.data?.the_element?.the_element_name?.[0]?.data?.the_name?.toLowerCase();return l<r?-1:l>r?1:0}),a}async function yn(){try{const i=await I();if(!i)return`
        <li class="list-unstyled">
  ...
  <div id="spinner-${p.id}" class="spinner-border spinner-border-sm text-primary position-absolute top-50 start-50 translate-middle d-none" role="status">
    <span class="visually-hidden">Loading...</span>
              ...
              `).join("");r(m)})})}catch(i){console.error("Error in getMyWidgetsList:",i),L.errorToast(i?.message||"An error occurred while fetching widgets"),i?.status===401&&Ae()}}async function et(){try{const i=document.getElementById("builder-workarea");if(!i)return;i.innerHTML="",await jn(f.widgetTree);const e=await Te(f.widgetTree,i);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree,isChildWidget:!1,childWidgetIndex:0},await X(f.widgetTree,!1,e),ce(),pe()}catch(i){throw new Error(`error loading widget with widget tree ${i.message}`)}}async function li(i){const e=i?JSON.parse(i):"";if(e)try{const n=document.getElementById("builder-workarea");n.innerHTML="";const t=await Te(e,n),a=document.getElementById("select-box");a.style.display="none";const s=document.getElementById("element-attributes");s.innerHTML=`
      <div class="row">
        <div class="text-center my-3 text-secondary">
          <p>Select an element to view and edit its attributes</p>
        </div>
      </div>
    `,await X(e,!1,t),ce(),pe()}catch(n){throw new Error(`error loading widget with widget tree ${n.message}`)}}async function Oe(i,e,n){try{if(i?.preventDefault(),i?.stopPropagation(),ft.collapseNavbar(),await Be(),await je(i),n&&typeof n!="number"||Number.isNaN(n)||e&&typeof e!="number"||Number.isNaN(e)){L.infoMessageToast("Widget id is in different format. Please check and update",4),je(i);return}history.pushState({},"",`?widget-id=${n||e}`);const t=document.getElementById("preview-btn");t&&t.setAttribute("data-widgetid",e.toString()),lr(),cr(),Cn(),qi(),await Ni();let a=Ln();a.classList.contains("fspage")&&a.classList.remove("fspage");const o=(await I())?.token;let l=null;i&&(l=await Ee(e,o),console.log("latestVersionKnown",l));let r=await re(l?l.widgetId:e);const d=document.getElementById("widgetNameValue");d&&r?.name&&(d.value=r?.name);const u=document.getElementById("widget-builder");u&&r?.name&&(u.textContent="Widget Builder Panel: "+r?.name,u.setAttribute("title",`Widget Builder Panel: ${r?.name}`)),await jn(r);const c=await Te(r,a);f.widgetTree=r,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),await X(r,!1,c,!0),await ws(l?.widgetId??e);const g=document.getElementById("preview-btn");return g.setAttribute("onclick","previewWidget(event)"),g.setAttribute("data-widgetid",`${e}`),g.removeAttribute("data-pageid"),console.log("load StaticWidgetClass.staticWidgetTree ->",f.staticWidgetTree),pn(),q.enableWidgetButtons(),q.initializeWidgetVersions(n||e,r?.version?r.version.toString():"original",r?.timestamp),D.renderActionHistory(),D.updateActionHistories(),ce(),pe(),Wn(),""}catch(t){console.error(t),L.errorToast(t?.message,4),pn(),je(i)}}function lr(){const e=document.getElementById("tab-container")?.querySelector("button[data-tab-id='wico-tab-pageInfo']");e&&(e.style.display="none");const n=document.getElementById("page-properties");n&&(n.style.display="none");const t=document.querySelector("button[data-tab-id='wico-tab-navigator']"),a=document.querySelector(`button[data-tab-id='${kt.staticTabName}']`);kt.staticTabName==="wico-tab-pageInfo"&&a.style.display==="none"?t&&t.click():a?a.click():t&&t.click()}function cr(){document.title="Widget Conceptualizer",mt("description","Widget Conceptualizer"),mt("keywords","widget conceptualizer, widget conceptualiser, widget builder, widget, conecept, connection")}async function dr(i,e){i.stopPropagation();try{const n=confirm("Do you want to delete the Widget?");if(await Be(),n){L.infoMessageToast("Deleting the widget...",0),await jo(e),await q.renderSavedWidgets();const t=new URLSearchParams(window.location.search).get("widget-id");return t&&parseInt(t)===e&&await je(i),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Deleted Successfully"),"Widget is deleted successfully!"}else return}catch(n){document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Deleted Successfully"),L.errorToast(n.message?n.message:"Failed to delete widget"),console.error("Failed to delete widget:",n)}}async function ur(i,e){i.stopPropagation();const n=document.getElementById("postWidgetModal");n&&n.remove();const t=await I(),a=t?.entityId===101651686||t?.entityId===101279491,s=document.createElement("dialog");s.id="postWidgetModal",s.className="col-md-6 a-dialog",s.innerHTML=`
    <div class="a-dialog-header d-flex justify-content-between">
...
`).join("<br>"),s=`
  ...
  `,o=document.getElementById("widget-detail-modal");o&&o.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",s),de("widget-detail-modal")}window.viewPublicWidgetDetails=vr;window.openCSSEditor=ut;class Xi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let n=function(a){if(!a)return;const{wrapper:s}=a,o=s&&s!=="0"?`#${s}`:".content-target";t=t+`${o} { ${a.css} }`,a.children.forEach(l=>{n(l)})},t="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),n(f.widgetTree),this.styleElement.textContent=t}}async getWidgetHtml(e){let n=[];e.forEach(t=>{t.classList.forEach(a=>{n.push(a)})}),this.insertCSS(n)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:n,dispatch:t}=e,{selection:a}=n;return a.ranges.length===0?!1:(t({changes:{from:a.ranges[0].from,to:a.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new ie({doc:"/* Write your CSS here */",extensions:[jt,Ht,Wa(),Dt(),ie.lineWrapping,Pe.tabSize.of(2),Pe.allowMultipleSelections.of(!0),ie.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),Nt.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),ie.updateListener.of(async n=>{if(n.docChanged){const t=this.editorView?.state.doc.toString()||"";this.updateCSS(t)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const n of e)if(this.editorView){const{state:t,dispatch:a}=this.editorView;a({changes:{from:0,to:t.doc.length,insert:`.${n} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const ci=async i=>{const e=new wi,n=_r(i);if(Object.keys(n).length>0){const t=await e.validateField(n),a=await vn(t),s=vn(a);return Tr(i,s)}},br=async i=>{const n=await new wi().validateField(i);return Object.keys(n).length>0?{status:!1,details:vn(n)}:{status:!0}},_r=i=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},n=i?.attributes;if(Array.isArray(n))n.forEach(t=>{const a=Er(t);switch(t.name){case"name":e.fieldName=a||"";break;case"value":e.value=a||null;break;case"fieldtype":e.fieldType=a?a.trim():null;break;case"pattern":e.pattern=a||null;break;case"datatype":e.dataType=a?a.trim():null;break;case"typeconcept":e.conceptType=a||null;break;case"maxlength":e.maxLength=a?parseInt(a):null;break;case"minlength":e.minLength=a?parseInt(a):null;break;case"max":e.maxValue=a?parseInt(a):null;break;case"min":e.minValue=a?parseInt(a):null;break;case"accept":e.accept=a||null;break;case"file":e.file=a||null;break;case"required":e.required=a===!0;break;case"unique":e.isUnique=a===!0;break}});else throw console.error('attributesData["attributes"] is not an array',i.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},Er=i=>{switch(i.type){case"boolean":return i.value==="on";case"array":return i.selected||null;case"string":return i.value||null;default:return null}},vn=i=>({datatype:i.dataType,pattern:i.pattern,max:i.maxValue,min:i.minValue,minlength:i.minLength,maxlength:i.maxLength,accept:i.accept,file:i.file,required:i.required,unique:i.unique}),Tr=(i,e)=>(i.attributes.forEach(n=>{const t=e[n.name];n.validationStatus=t?"invalid":"valid",n.validationErrorMessage=t||""}),i),Sr=i=>({fieldName:i.getAttribute("name"),value:i instanceof HTMLInputElement?i.value:null,fieldType:i.getAttribute("fieldtype"),dataType:i.getAttribute("datatype"),pattern:i.getAttribute("pattern"),conceptType:i.getAttribute("typeconcept"),maxLength:i.getAttribute("maxlength"),minLength:i.getAttribute("minlength"),minValue:i.getAttribute("min"),maxValue:i.getAttribute("max"),file:i.hasAttribute("file"),accept:i.hasAttribute("accept"),required:i.hasAttribute("required"),isUnique:i.getAttribute("unique")==="on"});async function ea(i){let e=i.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",i.parentNode?.insertBefore(e,i.nextSibling)),e.innerHTML="";const n=Sr(i),t=await br(n);try{if(t.status)i.classList.remove("invalid"),i.classList.add("valid");else if(i.classList.remove("valid"),i.classList.add("invalid"),t.details&&typeof t.details=="object"){const a=document.createElement("span");a.className="error-message",a.style.color="red",a.style.fontSize="12px";const s=Object.values(t.details).filter(Boolean);a.innerHTML=s.join("<br>"),e.appendChild(a)}}catch(a){console.error("Validation error:",a);const s=document.createElement("span");s.className="error-message",s.style.color="red",s.textContent="Validation failed. Please try again.",e.appendChild(s)}}var ze=(i=>(i.STYLE="style",i.BOOLEAN="boolean",i.FORM="form",i.SPECIAL="special",i))(ze||{});const Cr=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),Dn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],Nn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],It=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Lr=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Pt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],me=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Wr=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Ar=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),xr=new Set(["elementContent","className","id"]),ta=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function Je(i){return i.toLowerCase()==="type"?!0:ta.has(i.toLowerCase())}function bt(i,e,n){const t=i.toLowerCase();if(t==="type"){const a=n?Cr.get(n.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):a}return ta.get(t)||[]}class Yt{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=ja}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,n){kt.staticTabName=n;let t,a,s=document.getElementsByClassName("tabcontent");for(t=0;t<s.length;t++)s[t].style.display="none";for(a=document.getElementsByClassName("tablinks"),t=0;t<a.length;t++)a[t].className=a[t].className.replace(" active","");const o=document.getElementById(n);o.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let n=this;for(let a=0;a<e.length;a++)e[a].addEventListener("click",function(s){console.log("buttons[i] -->",e[a]);const o=e[a].getAttribute("data-tab-id");console.log("tabName -->",o),n.openTab(s,o)});const t=document.querySelector(`button[data-tab-id='${kt.staticTabName}']`);t?t.click():e[0].click()}sortAttributes(e){return e.sort((n,t)=>{if(!n?.name||!t?.name)return 0;const a=this.findAttributeInMap(n.name),s=this.findAttributeInMap(t.name);if(a==="Other"&&s!=="Other")return 1;if(a!=="Other"&&s==="Other")return-1;if(a===s){const o=this.categoryMap[a].findIndex(r=>r.toLowerCase()===n.name.toLowerCase()),l=this.categoryMap[s].findIndex(r=>r.toLowerCase()===t.name.toLowerCase());return o-l}return 0})}getCategoryForAttribute(e){if(!e)return"General";const n=e.toLowerCase();for(const[t,a]of Object.entries(this.categoryMap))if(t!=="Other"&&a.some(s=>s.toLowerCase()===n))return t;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,n){setTimeout(()=>{const t=document.getElementById("element-attributes");if(!t){console.warn("Attribute container not found, retrying..."),this.setAttributes(e,n);return}t.innerHTML="";const a=document.createElement("div");if(a.className="row",t.appendChild(a),!e){a.innerHTML="";return}(async()=>await ci(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const o=this.sortAttributes(e.attributes),l={};o.forEach(d=>{const u=this.getCategoryForAttribute(d.name);l[u]||(l[u]=[]),l[u].push(d)});let r="";Object.entries(l).forEach(([d,u])=>{const c=u.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
                ...
                `;else if(m.name==="Alignment"){const h=e?.tag?.toLowerCase();Dn.includes(h)&&(p=`
            ...
            `}});const s=document.getElementById("element-attributes");s&&(s.innerHTML=a)}})}async getHtml(){window.updateWidgetTypeValue=aa,window.toggleDisplay=ut,window.updateElementAttribute=Xt,window.updateMultipleElementAttribute=ra,window.handlePageProperties=oa,window.updateCSSLibrary=Ve,window.updateJSLibrary=Re,window.addJSLibrary=da,window.addCSSLibrary=ca,window.openRenameCustomFunction=ot.openRenameCustomFunction,window.deleteCustomFunction=ot.deleteCustomFunction,setTimeout(async()=>{ot.initializeCodeBlock();const a=new Xi,s=document.getElementById("css-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor(),On()},0),setTimeout(async()=>{await new Mi().initializeEditor()},0),setTimeout(async()=>{const a=new ki,s=document.getElementById("js-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor()},0),setTimeout(async()=>{await new se("onmount-editor-split").initializeEditor(),await new se("onupdate-editor-split").initializeEditor(),await new se("addevents-editor-split").initializeEditor(),await new se("mountchildwidgets-editor-split").initializeEditor();const r=document.getElementById("publish-widget");r&&r.addEventListener("click",async d=>{d.preventDefault();try{await f.publish()}catch(u){console.error("error publishing widget",u),u instanceof Error&&L.errorToast(u.message)}})},0),setTimeout(()=>{this.initializeTabs()},0);const e=this.the_params?.page_id;let n="",t="";if(this.the_params){const a=this.the_params?.data?.the_page_meta_title?.data?.the_meta_title||"";a&&ve("meta_title",a);const s=this.the_params?.data?.the_page_meta_description?.data?.the_meta_description||"";s&&ve("meta_description",s);const o=this.the_params?.data?.the_page_meta_keywords?.data?.the_meta_keywords||"";o&&ve("meta_keywords",o);const l=this.the_params?.data?.the_page_width?.data?.the_width||"";l&&ve("width",l);const r=this.the_params?.data?.the_page_font_size?.data?.the_font_size;r&&ve("font_size",r);const d=this.the_params?.data?.the_page_font_family?.data?.the_font_family;d&&ve("font_family",d);const u=this.the_params?.data?.the_page_type?.data?.the_type;u&&ve("type",u);const c=()=>Array.from({length:13},(p,h)=>12+h).map(p=>{const h=r==p?"selected":"";return`<option value="${p}" ${h}>${p}</option>`}).join(""),g=()=>["Arial","Verdana","Times New Roman","Courier New","Georgia"].map(h=>{const v=d==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join(""),m=()=>["Fluid","Fixed"].map(h=>{const v=u==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join("");n=`
  ...
  `}async function tl(i,e){if(i.preventDefault(),!(await qt.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const t=new FormData(i.target),a=Object.fromEntries(t);console.log(a,"update formValues");const s=await pa(t,e);await Un("update-element-dialog");const o=await Kt();if(s){const l=document.getElementById("created-elements");l?!o||o.trim()===""?l.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
      `:l.innerHTML=o||"":console.error("Widget list container not found in the DOM.")}return s}class nl{createElemenModaltHTML;singleElement;constructor(e){e&&this.init(e)}async init(e){this.getSingleElementDetails(e)}async getSingleElementDetails(e){const n=await Fn(e);this.singleElement=n,this.createElemenModaltHTML=this.getHtml(),n&&(document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML),document.getElementById("update-element-dialog").showModal(),await zn(this.singleElement.attributes))}getHtml(){return window.updateNewElement=tl,window.closeElementModal=Un,`<dialog id="update-element-dialog" class="col-md-4 a-dialog update-element-dialog">
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class il{createElemenModaltHTML;constructor(){window._dragService=no,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=Kr,window.cancelAttributeRow=ha,window.addAttribute=Yr,window.removeSelectedAttribute=Xr,window.closeElementModal=Un,`
    ...
    `}}async function de(i){document.getElementById(i).showModal()}async function we(i){const e=document.getElementById(i);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function fa(i,e){i?.stopPropagation();const n=document.getElementById(`menu-${e}`),t=n?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(s=>{s.classList.remove("show")}),n&&!t&&n.classList.add("show")}async function gl(i){new il,await de(i)}async function pl(i,e,n){i.stopPropagation(),console.log("modalId",e),fa(i,Number(n)),new nl(n)}async function hl(i,e){fa(i,e),confirm("Are you sure you want to delete the element?")&&(await Se(e),L.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const t=await Kt(),a=document.getElementById("created-elements");a?!t||t.trim()===""?a.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
      `:a.innerHTML=t||"":console.error("Elements list container not found in the DOM.")}export{Qi as A,il as B,xn as C,Or as D,Ee as E,de as F,Ue as P,f as S,ar as T,no as _,jn as a,X as b,ot as c,et as d,sr as e,un as f,Vi as g,Yt as h,D as i,Wn as j,Vn as k,Oe as l,ul as m,je as n,gl as o,fa as p,pl as q,$t as r,Ss as s,L as t,hl as u,Be as v,q as w,we as x,ml as y,rt as z};
