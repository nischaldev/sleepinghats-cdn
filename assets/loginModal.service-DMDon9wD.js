import{A as I,$ as M}from"./mftsccs-browser-MShQrN6O.js";import{B as g,L as y,H as b,N as w,A as h}from"./index--BR_FAre.js";class S{constructor(){this.init()}init(){const s=this.getHtml();document.querySelector("body #app")?.insertAdjacentHTML("afterend",s)}getHtml(){return`
