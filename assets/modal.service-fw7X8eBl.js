import{M as wn,m as z,n as he,o as pa,E as Un,p as li,G as De,J as Q,u as ha,b as ci,a as di,D as ui,e as N,r as te,j as be,q as zn,l as Jn,z as Y,X as H,W as fe,I as ye,O as Se,i as fa,s as gt,v as mi,c as ya,y as Pe,g as re,K as Te,P as Me,x as Ie,A as Ne,d as G,B as on,C as gi,F as Gn,H as pi,t as wa,k as hi}from"./mftsccs-browser-DeTC_MD3.js";import{E as ae,b as Bt,o as $t,j as fi,a as Ht,c as va,l as ba,d as _a,e as Ea,f as Be,k as jt,h as Ta,g as Sa}from"./codemirror-B3vgQINq.js";import{a as Ca,u as yi,g as I,e as ie,b as V,c as O,C as M,L as oe,f as La,d as tt,h as Wa,A as Dt}from"./index-ByT2ddPo.js";import{J as Nt,q as Aa}from"./vendor-Cs_0E_Xj.js";import{z as xa}from"./eslint4b-BLWGvIOa.js";import{l as pt,p as vn,r as bn,a as Ma,b as ka}from"./prettier-ClL2wQep.js";import{C as Ia}from"./ckeditor-Cw9bcqxY.js";const Pa=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return oa},get addJSLibrary(){return ra},get applyPageProperties(){return Nr},get applyPageProperty(){return ve},get filterChildrenByWrapper(){return na},get getAttributeType(){return Ur},get getAttributeValue(){return ca},get getElementAttribute(){return $r},get getElementAttributeDetails(){return Nn},get getElementData(){return ea},get getLayoutAttributeValue(){return da},get getPropertiesByIdFromStorage(){return yt},get handleDirectContentEdit(){return Hr},get handlePageProperties(){return ia},get initializeApp(){return Xt},get initializeLibrary(){return qn},get listJSLibraries(){return wt},get removeCSSLibrariesFromHead(){return Pt},get removeJSLibrariesFromHead(){return Fn},get setAttributeValue(){return Jr},get toggleSpacingBox(){return On},get updateAttribute(){return Dr},get updateCSSLibrary(){return Ve},get updateElementAttribute(){return Kt},get updateElementAttributeViaEditor(){return jr},get updateJSLibrary(){return Re},get updateMetaTag(){return mt},get updateMultipleElementAttribute(){return aa},get updateWidgetTypeValue(){return ta}},Symbol.toStringTag,{value:"Module"}));async function ll(){return"WICO"}async function Ae(){const i=await Ca();await wn(i?.id),localStorage.removeItem("profile"),localStorage.removeItem("tempwidget"),await yi("/"),setTimeout(()=>{document.body.style.overflow=""},1e3)}const ht=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],_n=[{name:"accept",type:"string"},{name:"action",type:"string"},{name:"alt",type:"string"},{name:"autocomplete",type:"boolean",value:"on"},{name:"checked",type:"boolean"},{name:"cols",type:"string"},{name:"disabled",type:"boolean"},{name:"download",type:"string"},{name:"draggable",type:"boolean"},{name:"for",type:"string"},{name:"hidden",type:"boolean"},{name:"href",type:"string"},{name:"label",type:"string"},{name:"loading",type:"array",value:"eager,lazy",default:"eager"},{name:"max",type:"string"},{name:"maxlength",type:"string"},{name:"media",type:"string"},{name:"method",type:"array",value:"get,post,dialog"},{name:"min",type:"string"},{name:"minlength",type:"string"},{name:"multiple",type:"boolean"},{name:"muted",type:"boolean"},{name:"name",type:"string"},{name:"pattern",type:"string"},{name:"placeholder",type:"string"},{name:"readonly",type:"boolean"},{name:"rel",type:"string"},{name:"required",type:"boolean"},{name:"rows",type:"string"},{name:"selected",type:"boolean"},{name:"size",type:"string"},{name:"src",type:"string",value:""},{name:"start",type:"string"},{name:"style",type:"string"},{name:"title",type:"string"},{name:"target",type:"array",value:"_blank,_self,_parent,_top"},{name:"type",type:"array"},{name:"value",type:"string"},{name:"wrap",type:"array",value:"soft, hard"},{name:"width",type:"string",value:""}],rn=[{name:"className",type:"string",value:""},{name:"id",type:"string",value:""}],Ba=[{name:"className",type:"string",value:""},{name:"Width",type:"string",value:""},{name:"Height",type:"string",value:""},{name:"Background Color",type:"color",value:"#FFFFFF"},{name:"Color",type:"color",value:"#000000"},{name:"Margin",type:"string",value:""},{name:"Padding",type:"string",value:""}];let Qn=[],Zn=[];async function $a(i){let e="";for(const n in i)if(Object.prototype.hasOwnProperty.call(i,n)){const t=i[n];e+=` ${n}="${t}" `}return e}async function Ha(i,e){const n=new z;n.composition=i,n.fullLinkers=["the_widget_html","the_widget_css","the_widget_js"];const t=await he([n],e),a=t?.data?.the_widget?.the_widget_html?.[0]?.id,s=t?.data?.the_widget?.the_widget_css?.[0]?.data.the_widgetCSS,o=t?.data?.the_widget?.the_widget_js?.[0]?.data.the_widgetJS;if(!a)return{html:"",css:"",js:""};const l=await pa(a,["contain_s"]);Qn=await Un(l.externalConnections),Zn=await Un(l.internalConnections);let r=await wi(a,Qn,Zn);const d=document.createElement("div");return d.innerHTML=r,{html:(d?.querySelector(".widget-wrapper")).innerHTML,css:s||"",js:o||""}}async function wi(i,e,n){try{let t="",s=Da(e)[i];if(s!=null){let o=Na(s);const r=(await Ji())?.map(g=>{const m=g?.id,p=g?.data?.the_element?.the_element_name?.[0]?.data?.the_name,h=g?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag,v=g?.data?.the_element?.the_element_void?.[0]?.data?.the_void,W=g?.data?.the_element?.the_element_s_attribute?.map(T=>{const w=T?.data?.the_attribute,y=w?.the_attribute_name?.[0]?.data?.the_name,_=w?.the_attribute_type?.[0]?.data?.the_type,S=w?.the_attribute_value?.[0]?.data?.the_value;return{name:y,type:_,value:S}});return{id:m,name:p,tag:h,void:v,attributes:W}}),d=[..._n,...rn],u=(await I())?.userId;for(let g=0;g<o.length;g++){const m=o[g];if(m.ofTheConceptId==i){const p=await ja(m.toTheConceptId,n),h=Object.keys(p.data)[0],v=p.data[h],E=ht.includes(h),W=await $a(v?.attributes||[]),T=r.find(y=>y.tag===h.toLowerCase().trim()),w=v?.attributes;for(const y in w){const _=d.find(C=>y===C?.name?.toLowerCase().trim()),S=w[y],b=_?.type;T.attributes=T?.attributes?.map(C=>(C?.name==="className"&&y==="class"?C.value=S:C?.name==="elementContent"?C.value=v?.innerText:y===C?.name&&(b==="array"?C.selected=S:b==="boolean"?C.value="":C.value=S),C))}if(h!="text"){const y=await li(p.id,u);y?.length&&await wn(y?.[0]?.id);const _={[`wdgt${p.id}`]:T},S=await De(_,null,null,null,u);console.log("elementAttributeComp ->",S),t+=`
  ...
  ondragstart="_dragService.dragStartWidgetElement(event)" data-elementid="${T?.id}">
            <${h} data-cc-id="${p.id}" `+W+`${E?"/></div>":">"}`,t+=await wi(m.toTheConceptId,e,n)}(v.contains=="false"||h=="text")&&(t+=" "+v.innerText+" "),!E&&h!="text"&&(t+=`</${h}></div>`)}}}return t}catch(t){console.error("error converting html",t)}}async function ja(i,e){var n=[],t={},a=e;n=a;for(var s=[],o=0;o<n.length;o++)s.includes(n[o].ofTheConceptId)||s.push(n[o].ofTheConceptId);var l=await Q(i);if(l.id==0&&i!=null&&i!=null){var r=await Q(i);l=r}var d=await ha(i,n,s),c=l?.type?.characterValue??"";t[c]=d;var u={};return u.data=t,u.id=i,u}function Da(i){return i.reduce((e,n)=>{const{ofTheConceptId:t}=n;return e[t]||(e[t]=[]),e[t].push(n),e},{})}function Na(i){const e=new Map;i.forEach(s=>{e.set(s.id,s)});const n=[],t=new Set,a=s=>{if(!t.has(s.id)){t.add(s.id),n.push(s);for(const o of i)o.orderId==s.id&&a(o)}};return i.forEach(s=>{s.orderId==1e3&&a(s)}),n}async function qa(i,e){var n=[];try{var t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),t.append("Randomizer",ci.BASE_RANDOMIZER.toString());const a=await fetch(ie.baseNodeUrl+"/api/v1/local-concepts-translate",{method:"POST",headers:t,body:JSON.stringify({id:i})});return a.ok?await a.json():(console.log("recursive search error ",a.status),n)}catch(a){console.log(a)}}async function vi(i,e,n=1e3,t){const a=i.userId,r=await di("contain_s",999,999,a);return await ui(i.id,e.id,r.id,n)}const Fa="the_widget";async function Oa(i,e,n){return await Va(i,e,n)}async function Va(i,e,n){const s=new DOMParser().parseFromString(i,"text/html").body,o=await De({[Fa]:{}});e&&await Ra(e,o),n&&await Ua(n,o);const l=await De({widgetHTML:{}});await V(o,l,"html");const r=await bi(s.children[0],l);return await vi(l,r),await N.SyncDataOnline(),o}async function Ra(i,e){const t=(await I())?.userId,s=await te("the_widgetCSS",i,!0,t,4,999);await V(e,s,"css")}async function Ua(i,e){const t=(await I())?.userId,s=await te("the_widgetJS",i,!0,t,4,999);await V(e,s,"js")}async function bi(i,e){console.log("parentConcept ->",e);const n={};if(n.tagName=i?.tagName?.toLowerCase(),i?.attributes?.length>0){n.attributes={};for(let s of i.attributes)n.attributes[s.name]=s.value}i?.textContent?.trim()&&(n.text=i.textContent.trim());let t={[n.tagName?n.tagName:"text"]:{contains:i?.children?.length?"true":"false",attributes:n.attributes||"",innerText:i?.children?.length?"":n.text||""}};const a=await De(t);if(i?.childNodes?.length>0){n.children=[];let s=[],o=-1,l,r;for(let c of i.childNodes)if(!(c.nodeType===Node.TEXT_NODE&&c.textContent?.trim()==="")&&!(i.children.length===0&&c.nodeType===Node.TEXT_NODE)){if(c.nodeType===Node.TEXT_NODE){let u={text:{contains:!1,attributes:"",innerText:c.textContent?.trim()}};const g=await De(u);s.push({parentConcept:a,childConcept:g,orderId:r})}else c.nodeType===Node.ELEMENT_NODE&&(l=await bi(c,a),s.push({parentConcept:a,childConcept:l,orderId:r}));o>=0&&(s[o]={...s[o],orderId:l?.id}),o++}let d=1e3;for(let c=0;c<s.length;c++){const u=s[c];d=(await vi(u.parentConcept,u.childConcept,d)).id}}return a}async function En(){}class za{convertModalHTML;constructor(){this.init()}init(){this.convertModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.convertModalHTML)}getHtml(){return`
  ...
  `,e?.appendChild(n)}function Tn(){const i=document.querySelector(".content-target");i.innerHTML="",i.textContent="Widget Loading..."}function Sn(){return document.querySelectorAll(".content-target")[0]}function ei(i){const e={past:[],present:i,future:[]};return{getState(){return{current:e.present,canUndo:e.past.length>0,canRedo:e.future.length>0}},push(n){e.past.push(e.present),e.present=n,e.future=[]},undo(){if(e.past.length===0)return;const n=e.past[e.past.length-1];return e.past=e.past.slice(0,-1),e.future=[e.present,...e.future],e.present=n,n},redo(){if(e.future.length===0)return;const n=e.future[0];return e.future=e.future.slice(1),e.past=[...e.past,e.present],e.present=n,n}}}class D{static actionHistories;static renderActionButtons(){const e=document.getElementById("undo-btn"),n=document.getElementById("redo-btn");e?.addEventListener("click",D.undoAction),n?.addEventListener("click",D.redoAction)}static renderActionHistory(){D.actionHistories=ei(JSON.stringify(f?.staticWidgetTree)),ei(JSON.stringify(f?.staticWidgetTree))}static updateButtonStates(){const{canUndo:e,canRedo:n}=D.actionHistories.getState(),t=document.getElementById("undo-btn"),a=document.getElementById("redo-btn");t&&(t.disabled=!e),a&&(a.disabled=!n)}static async undoAction(){const e=D.actionHistories.undo();e!==void 0&&(oi(e||""),D.updateButtonStates())}static async redoAction(){const e=D.actionHistories.redo();e!==void 0&&(oi(e||""),D.updateButtonStates())}static updateActionHistories(){D.actionHistories.push(JSON.stringify(f.staticWidgetTree)),D.updateButtonStates()}}async function us(){const i=document.getElementById("widget-prompt-modal");i&&i.remove()}async function ms(){document.getElementById("widget-prompt-modal").classList.add("d-none");const e=document.getElementById("widget-prompt-tab");e.classList.remove("d-none"),e.classList.add("d-flex")}async function gs(){document.getElementById("widget-prompt-tab").classList.add("d-none");const e=document.getElementById("widget-prompt-modal");e.classList.remove("d-none"),e.classList.add("d-flex")}function ps(){const i=document.getElementById("prompt-text");i.addEventListener("input",()=>{i.style.height="auto";const e=Math.min(i.scrollHeight-8,120);i.style.height=`${e}px`,i.style.overflowY=e===120?"auto":"hidden"})}class Li{widgetPromptHTML;assistantChatId;randomSuggestionEl;constructor(e){this.assistantChatId=e,this.randomSuggestionEl="",this.init()}init(){if(!this.assistantChatId){const n=["Newsletter signup form with email validation","Create a header section for portfolio website","Quick contact form with name, email, and message fields","Create a customer satisfaction survey form","Countdown timer for upcoming events or launches","Currency converter widget with real-time exchange rates","Task list widget with checkboxes and progress tracking"],a=((s,o=3)=>{if(s.length<o)return[];const l=new Set;for(;l.size<o;){const r=Math.floor(Math.random()*s.length);l.add(r)}return[...l]})(n,2);this.randomSuggestionEl=a?.map(s=>`<div class="suggestion-prompt">
            <button class="btn btn-outline-secondary rounded-pill py-2">${n[s]}</button>
          </div>`).join("")}this.widgetPromptHTML=this.getHtml(),document.querySelector("body #contentTargetAndCodeViewWrapper")?.insertAdjacentHTML("beforeend",this.widgetPromptHTML),ps(),setTimeout(()=>{const n=document.querySelector(".aiAssistantTabs"),t=document.querySelectorAll("#aiChatContainer, #prototypeWidget");n.querySelector("button").classList.add("active"),t[0].classList.add("active"),n.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{n.querySelectorAll("button").forEach(l=>l.classList.remove("active")),t.forEach(l=>l.classList.remove("active"));const s=a.dataset.id,o=document.getElementById(s);console.log("this is the target id and doc",s,o),a.classList.add("active"),o?.classList.add("active")})})},0)}getHtml(){return window.closeAssistant=us,window.minimizeAssistant=ms,window.maximizeAssistant=gs,`
    ...
    `}}async function hs(i){const e=document.getElementById("widget-btn-wrapper");if(console.log("addWidgetUpdate",i),e.querySelector("#updateFsPage")||e.querySelector("#fspage-save-button"))return;e.innerHTML=`
      ...
      })();`;this.scriptElement.textContent=n,document.body.appendChild(this.scriptElement),f.selectedStaticWidgetTreeInfo?.widgetTree&&(f.selectedStaticWidgetTreeInfo.widgetTree.js=e)}async getHtml(){return window.getEditorContentJS=this.getEditorContentJS.bind(this),""}handleTab=e=>{const{state:n,dispatch:t}=e,{selection:a}=n;return a.ranges.length===0?!1:(t({changes:{from:a.ranges[0].from,to:a.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){this.editorInitialized=!0;const e=document.getElementById("editor-container-js-split");e&&(e.innerHTML="",this.editorView=new ae({doc:"/* Write your JavaScript here */",extensions:[Bt,$t,fi(),Ht(),ae.lineWrapping,Be.tabSize.of(2),Be.allowMultipleSelections.of(!0),ae.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),jt.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),ae.updateListener.of(async n=>{if(n.docChanged){const t=this.editorView?.state.doc.toString()||"";this.updateJS(t)}})],parent:e}))}getEditorContentJS(){return this.editorView?this.editorView.state.doc.toString():""}}async function ti(){const i=document.getElementById("codeBlocksContainer"),e=i.querySelectorAll(".sub-tab-btn");if(!i.querySelector(".sub-tab-btn.active")){e?.[0]?.classList.add("active");const t=document.getElementById("onmount-editor-split");t&&t.classList.add("active")}}async function xi(i){const e=i?.id,n=i?.code,t=i?.slug,a=i?.name,s=document.querySelectorAll(".custom-service-btn"),o=Array.from(s)?.filter(u=>u?.getAttribute("data-subtab")===t),l=document.getElementById("lifecycle"),r=l?.querySelector(".sub-tab-nav");if(!o.length){const u=document.createElement("button");u.classList.add("sub-tab-btn","custom-service-btn"),u.setAttribute("data-subtab",t),u.innerHTML=`
    ...
    `,r?.appendChild(u);const g=document.createElement("div");g.classList.add("sub-tab-content","custom-editor-content"),g.id=`${t}-editor-split`,g.setAttribute("data-subtab",t),l?.appendChild(g);const m=`${t}-editor-split`;ws(m)}document.getElementById("codeBlocksContainer").querySelectorAll(".sub-tab-btn").forEach(u=>{u.addEventListener("click",function(){const g=u.getAttribute("data-subtab"),m=u.closest(".tab-content");m?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(p=>{p.classList.remove("active")}),u.classList.add("active"),m?.querySelector(`.sub-tab-content[data-subtab="${g}"]`)?.classList.add("active")})}),setTimeout(async()=>{const u=document.querySelector(`#${t}-editor-split .cm-editor .cm-scroller .cm-content.cm-lineWrapping`);if(u&&(u.textContent="/* Write your code here */",n))try{const g=await pt.format(n,{parser:"babel",plugins:[vn,bn],tabWidth:2,semi:!0,singleQuote:!0,bracketSpacing:!0,printWidth:80});u.textContent=g}catch(g){console.error("JS formatting error:",g),u.textContent=n}},500)}async function ws(i){await new se(i).initializeEditor()}async function vs(i,e,n){const t=e.trim().toLocaleLowerCase().split(" ").join("-"),a=f.staticWidgetTree?.custom_functions?.filter(c=>c.slug===i);a[0].name=e,a[0].slug=t,console.log("updated static widget tree",f.staticWidgetTree);const s=document.querySelector(`button[data-subtab=${i}]`);s?.setAttribute("data-subtab",t),s.innerHTML=`
  ...
  `;const o=s?.querySelector("span.service-name");o&&(o.innerText=e);const l=document.getElementById(`${i}-editor-split`);l?.setAttribute("data-subtab",t),l.id=`${t}-editor-split`,await new se(`${t}-editor-split`).initializeEditor();const d=f.staticWidgetTree?.custom_functions?.filter(c=>c.slug===t);xi(d?.[0]),we("rename-custom-function-modal")}class bs{renameCustomFunctionModalHTML="";currentCustomFunctionSlug;customFunctionId;constructor(e,n){this.customFunctionId=n,this.currentCustomFunctionSlug=e,this.init()}init(){this.renameCustomFunctionModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.renameCustomFunctionModalHTML);const t=document.getElementById("rename-custom-function-modal").querySelector("form");t&&t.addEventListener("submit",a=>{a.preventDefault();const s=t.customFunctionName.value.trim(),o=/^[_A-Za-z][_A-Za-z ]*$/.test(s),l=document.getElementById("service-rename-error");o?(l.textContent="",l.classList.add("d-none"),vs(this.currentCustomFunctionSlug,s,this.customFunctionId)):(l.classList.remove("d-none"),l.textContent="Invalid name. Must not start with a number or '--', and contain only letters, numbers, hyphens or underscores.")})}getHtml(){return`
    ...
    `}}const Ft="unsaved_widget";async function _s(){const i=Ts(),e={widgetTree:f.staticWidgetTree,timestamp:new Date().toISOString()},n=JSON.stringify(e),t=new Blob([n]).size,s=4.5*1024*1024-i;if(t<=s)try{localStorage.setItem(Ft,n),Cn("save-widget")}catch(o){console.error("Error saving to localStorage:",o)}else console.warn("Data too large to save in localStorage. Consider compressing or using IndexedDB."),Ot()}function Es(i){return new Blob([i]).size}function Ts(){let i=0;for(let e in localStorage){if(!localStorage.hasOwnProperty(e))continue;const n=localStorage.getItem(e);i+=Es(e+n)}return i}async function Ot(){localStorage.removeItem(Ft),at()}const tn=async i=>{i?.preventDefault();const e=localStorage.getItem(Ft);if(e){const n=JSON.parse(e);f.widgetTree=n?.widgetTree;const t=f.staticWidgetTree?.origin||f.staticWidgetTree?.widgetId,a=new URLSearchParams(window.location.search).get("widget-id");t===Number(a)?(t||q.enableWidgetButtons(),await et(),D.updateActionHistories(),L.infoMessageToast("Draft widget has been stored",3)):console.info("draft widget and load widget are different");return}},Cn=async(i="")=>{const e=document.querySelector("#widget-properties .row"),n=document.getElementById("btn-draft-widget"),t=localStorage.getItem(Ft),a=JSON.parse(t),s=a?.widgetTree?.origin||a?.widgetTree?.widgetId,o=new URLSearchParams(window.location.search).get("widget-id");if(t&&!n){if(s!==Number(o)){at();return}const l=document.createElement("div");l.id="draft-widget",l.classList.add("py-2","mb-0","d-flex","flex-column","gap-2"),l.innerHTML=`
      <label for="draft-widget" >Drafted Widget:</label>
      <button class="btn btn-primary" id="btn-draft-widget">Load Draft Widget</button>
    `,e?.appendChild(l),document.getElementById("btn-draft-widget")?.addEventListener("click",d=>tn(d)),s===0&&!i&&setTimeout(()=>{tn()},0)}else t&&n?s!==Number(o)||s===Number(o)&&!i?at():n?.addEventListener("click",l=>tn(l)):!t&&n&&at()};function at(){document.getElementById("draft-widget")?.remove()}const ot=(()=>{function i(d){const c=d.target,u=document.getElementById("codeBlocksContainer");u&&u.classList.add("visible"),document.getElementById("designSplitViewButton")?.classList.remove("selected"),c.classList.add("selected")}function e(d){const c=d.target,u=document.getElementById("codeBlocksContainer");u&&u.classList.remove("visible"),document.querySelector(".codeSplitViewButton")?.classList.remove("selected"),c.classList.add("selected")}async function n(d){q.enableWidgetButtons();try{await et(),_s(),D.updateActionHistories(),L.infoMessageToast(d)}catch(c){L.errorToast("widget synchronization failed"),console.error(c)}}const t=()=>{const d=document.querySelector(".codeSplitViewButton");document.querySelector("#widgetButtionCodeViewWrapper").classList.remove("fullscreen"),document.createElement("div").classList.remove("visible"),d.style.display="flex";const g=document.getElementById("designSplitViewButton"),m=new Event("click",{bubbles:!0,cancelable:!0});g&&g.dispatchEvent(m),rt.enableHeader()},a=()=>{const d=document.getElementById("widgetButtionCodeViewWrapper"),c=document.createElement("div");c.classList.add("codeSplitViewButton");const u=document.createElement("div");u.appendChild(c);const g=document.createElement("div");g.id="codeBlocksContainer",g.innerHTML=`
    <nav class="tab-nav">
      <div>
...
`,d?.appendChild(g),document.querySelectorAll(".tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-tab");document.querySelectorAll(".tab-btn, .tab-content").forEach(S=>S.classList.remove("active")),y.classList.add("active"),document.getElementById(_)?.classList.add("active")})}),g.querySelectorAll(".sub-tab-btn").forEach(y=>{y.addEventListener("click",function(){const _=y.getAttribute("data-subtab"),S=y.closest(".tab-content");S?.querySelectorAll(".sub-tab-btn, .sub-tab-content").forEach(b=>{b.classList.remove("active")}),y.classList.add("active"),S?.querySelector(`.sub-tab-content[data-subtab="${_}"]`)?.classList.add("active")})});const h=document.querySelector(".fullscreenicon"),v=document.querySelector("#widgetButtionCodeViewWrapper");h?.addEventListener("click",()=>{v.classList.contains("fullscreen")?rt.enableHeader():rt.disableHeader(),v.classList.toggle("fullscreen")});const E=document.querySelector(".close-btn");E&&E.addEventListener("click",t),document.getElementById("synchronizeWidgetBtn").addEventListener("click",()=>n("Widget Synchronized")),document.getElementById("contentTargetAndCodeViewWrapper")?.prepend(u.firstChild),setTimeout(()=>{const y=document.querySelector(".codeSplitViewButton");y&&(y.removeEventListener("click",i),y.addEventListener("click",i));const _=document.getElementById("designSplitViewButton");_&&(_.removeEventListener("click",e),_.addEventListener("click",e))},0),document.getElementById("add-service-button")?.addEventListener("click",y=>s(y))};function s(d){d.stopPropagation();try{const c="add-custom-service-dialog";document.getElementById(c)?.remove();const g=document.createElement("dialog");g.setAttribute("id",c),g.classList.add("col-md-3"),g.innerHTML=`
      ...
      `;const m=g.querySelector("form");return m&&m.addEventListener("submit",p=>{p.preventDefault();const h=m?.serviceName?.value.trim(),v=/^[_A-Za-z][_A-Za-z ]*$/.test(h),E=document.getElementById("service-name-error");v?(E.textContent="",E.classList.add("d-none"),r(p)):(E.classList.remove("d-none"),E.textContent="Invalid name. Must not start with a number or '--', and contain only letters, numbers, hyphens or underscores.")}),document.querySelector("body #app")?.appendChild(g),de(c),"OPENED"}catch(c){console.error("Failed to rename widget:",c)}}async function o(d,c,u){console.log("openRenameCustomFunction -->",d,c,u),new bs(c,u),await de("rename-custom-function-modal")}async function l(d,c,u){d.preventDefault(),console.log("deleteCustomFunction -->",d,c,u);try{if(confirm("Do you want to delete the Service?")){L.infoMessageToast("Deleting the service...",0),u&&await Se(Number(u));const m=`button[data-subtab=${c}]`;document.querySelector(m)?.remove(),document.getElementById(`${c}-editor-split`)?.remove(),f.staticWidgetTree.custom_functions=f.staticWidgetTree.custom_functions.filter(_=>_.slug!==c),console.log("after deleteCustomFunction staticWidgetTree",f.staticWidgetTree);const v=document.getElementById("codeBlocksContainer");return v?.querySelector(".sub-tab-btn.active")?.classList.remove("active"),v?.querySelectorAll(".sub-tab-btn")?.[0]?.classList.add("active"),v?.querySelector(".sub-tab-content.active")?.classList.remove("active"),v?.querySelectorAll(".sub-tab-content")?.[0]?.classList.add("active"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Service is deleted successfully"),"Service is deleted successfully!"}else return}catch(g){L.errorToast("Failed to delete widget"),console.error("Failed to delete widget:",g)}}async function r(d){d.preventDefault();const c=d.target,g=new FormData(c).get("serviceName");let m=g?.toLowerCase();m.includes(" ")&&(m=m.split(" ").join("-"));const p=document.getElementById("lifecycle"),h=p?.querySelector("div.sub-tab-nav"),v=document.getElementById("codeBlocksContainer");v?.querySelector(".sub-tab-btn.active")?.classList.remove("active"),v?.querySelector(".sub-tab-content.active")?.classList.remove("active");const T=document.createElement("button");T.classList.add("sub-tab-btn","custom-service-btn","active"),T.setAttribute("data-subtab",m),T.innerHTML=`
  ...
  `;const a=document.getElementById("widget-builder");a.textContent="Widget Builder Panel",a.setAttribute("title","Widget Builder Panel"),q.disableWidgetButtons(),await new Zi().initializeEditor(),await new Ai().initializeEditor(),await new se("onmount-editor-split").initializeEditor(),await new se("onupdate-editor-split").initializeEditor(),await new se("addevents-editor-split").initializeEditor(),await new se("mountchildwidgets-editor-split").initializeEditor(),await new Wi().initializeEditor();const g=document.getElementById("widgetNameValue");g.value="";const m=document.getElementById("widgetTypeValue");m&&(m.value="");const p=document.getElementById("widgetType");p&&(p.value=""),document.getElementById("widget-version").classList.add("d-none");const v=document.getElementById("element-attributes");v.innerHTML=`
    <div class="row">
      <div class="text-center my-3 text-secondary">
        <p>Select an element to view and edit its attributes</p>
      </div>
    </div>
  `,qn(),document.getElementById("widget-prompt-modal")?.remove(),document.getElementById("widget-prompt-tab")?.remove()}function Cs(){const i=new ya;f.widgetTree=i,ot.synchronizeWidget("Workspace Cleared")}let ke="",St="";async function ni(i){try{const n=(await I())?.token,t=await fetch(`${ie.aiURL}/generate-widget`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify(i)});if(!t.ok){const d=await t?.text(),c=JSON.parse(d);throw L.errorToast(c.message),console.error(`API Error (${t.status}):`,d),Ct(t.statusText,"error"),new Error(`API request failed with status ${t.status}`)}const a=t.body.getReader(),s=new TextDecoder("utf-8");let o="",l=null;for(;;){const{value:d,done:c}=await a.read();if(c)break;o+=s.decode(d,{stream:!0});const u=o.split(`

`);for(let g=0;g<u.length-1;g++){const m=u[g].trim();if(m.startsWith("data:")){const p=m?.slice(6).trim();try{const h=JSON.parse(p);if(h.status==="responding"&&await Ws(h.message_str),h.status==="success"&&(l=h),h.status==="error")throw L.errorToast(h.message?.[0]||"AI Error"),new Error(h.message?.[0])}catch(h){console.warn("Stream parse error:",h)}}}o=u[u.length-1]}return document.getElementById("response-status")?.removeAttribute("id"),console.log("finalData",l),l}catch(e){return console.error(e),null}}async function Ls(i){await je(i),f.resetWidgetTree(),document.getElementById("widget-prompt-modal")?.remove(),document.getElementById("widget-prompt-tab")?.remove(),new Li("");const t=document.getElementById("prompt-text");ke="",t?.addEventListener("keydown",function(l){if(l.key==="Enter"&&!l.shiftKey){l.preventDefault();const r={text_input:t?.value,chat_id:"",widget_type:"",stream:!0};ke&&(r.tag="followup",r.chat_id=ke,r.widget_type=St),ct(r)}}),document.querySelector(".button-send").addEventListener("click",function(l){l.preventDefault();const r={text_input:t?.value,chat_id:"",widget_type:"",stream:!0};ke&&(r.tag="followup",r.chat_id=ke,r.widget_type=St),ct(r)}),document.getElementById("suggestion-prompts-container")?.querySelectorAll(".suggestion-prompt button")?.forEach(l=>{l?.addEventListener("click",function(r){r.preventDefault(),t.value=l?.innerText})}),console.log("openPromptModal staticWidgetTree",f.staticWidgetTree)}async function ct(i){if(console.log("requestPromptData ->",i),i.text_input){Mi(i.text_input),As("Assistant is working");const e=await ni(i);if(console.log("submitPrompt response",e),xs("prompt-loader"),!e)return;ke=e?.data?.chat_id,St=e?.data?.widget_type;const n=e?.message;if(f.staticWidgetTree.assistant={input:e?.data?.user_prompt,id:ke,type:St},console.log("submitPrompt StaticWidgetClass.staticWidgetTree ->",f.staticWidgetTree),e?.status=="error")L.errorToast(n);else{if(i.widget_type!=="list"){i.widget_type==="form"&&ki(ke),console.log("this the prototype data",e.data.data_structure_prototype);const s=new Function("tsccs",e.data.data_structure_prototype)(mi);console.log(s,"this the prototype after eval");let o=document.getElementById("prototypeWidget");Pe(ie.visual_prototype_widget,o,{prototype:s}).then(l=>{l.dataChange(async r=>{console.log("this is the value for data change",r);const d={text_input:f.staticWidgetTree.assistant.input,chat_id:f.staticWidgetTree.assistant.id,widget_type:"",payload:r,type:"application/JSON",stream:!0};try{const c=await ni(d);console.log("this is the response",c),await dn(c)}catch(c){throw c}})})}await Ct(n);const t=document.createElement("button");t.classList.add("clearWorkspaceButton"),t.textContent="Clear Workspace",t.classList.add("btn","btn-danger"),t.addEventListener("click",()=>{Cs(),t.remove()}),await Ct(t),Tn(),await dn(e)}}}async function Ct(i,e){const n=document.querySelector(".chat-content"),t=document.createElement("div");if(t.classList.add("message","message-bot"),i instanceof HTMLButtonElement){const a=document.querySelector(".clearWorkspaceButton");a&&a.remove(),t.appendChild(i)}else e==="error"&&t.classList.add("text-danger","my-0","text-center"),t.innerText=i;n?.scrollTo({top:n.scrollHeight,behavior:"smooth"}),n?.insertAdjacentElement("beforeend",t)}async function Ws(i,e){const n=document.getElementById("response-status");if(n)n.innerHTML=i;else{const t=document.querySelector(".chat-content"),a=document.createElement("div");a.id="response-status",a.classList.add("message","message-bot"),a.innerHTML=i,t?.insertAdjacentElement("beforeend",a),t?.scrollTo({top:t.scrollHeight,behavior:"smooth"})}}function Mi(i){const e=document.getElementById("default-message"),n=document.querySelector(".chat-content"),t=document.createElement("div");t.classList.add("message","message-user"),t.innerText=i,n?.insertAdjacentElement("beforeend",t),e?.remove();const a=document.getElementById("prompt-text");a.value="",a.style.height="44px"}function As(i){Ms("prompt-form");const e=document.getElementById("prompt-content"),n=document.createElement("div");n.id="prompt-loader",n.textContent=i,e?.insertAdjacentElement("beforeend",n)}function xs(i){document.getElementById(i)?.remove(),ks("prompt-form")}function Ms(i){const e=document.getElementById(i);for(let n of e.elements)n.disabled=!0}function ks(i){const e=document.getElementById(i);for(let n of e.elements)n.disabled=!1}async function dn(i){const e=i?.data?.ui?.html||"",n=i?.data?.ui?.css||"",t=i?.data?.ui?.js||"",a=i?.data?.before_render||"",s=i?.data?.after_render||"",o={html:e,css:n,js:t,before_render:a,after_render:s,assistant:{id:i?.data?.chat_id,input:i?.data?.user_prompt,type:i?.data?.widget_type}};await Is(o)}async function Is(i){f.staticWidgetTree.html=i.html,f.staticWidgetTree.css=i.css,f.staticWidgetTree.js=i.js,f.staticWidgetTree.before_render=i.before_render,f.staticWidgetTree.after_render=i.after_render,f.staticWidgetTree.assistant=i.assistant;const e=f.staticWidgetTree,n=document.getElementById("builder-workarea");n.innerHTML="";const t=await Ei(e,n);f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},console.log("StaticWidgetClass ->",f.widgetTree),await X(e,!1,t),D.renderActionHistory(),D.updateActionHistories(),ce(),pe()}async function ki(i){document.getElementById("prompt-suggestion")?.remove();const n={text_input:"create a list widget for it",chat_id:i,widget_type:"list",stream:!0},t=document.createElement("div");t.id="prompt-suggestion",t.innerHTML=`
  ...
  `,document.getElementById("prompt-content")?.insertAdjacentElement("afterend",t),document.getElementById("request-list-widget").addEventListener("click",async o=>{o.preventDefault(),ct(n),fs(),ys()})}async function Ps(i){new Li(i?.id),Mi(i?.input),await Ct("Widget Generated Successfully!!"),i.type==="form"&&ki(i?.id);const e=document.getElementById("prompt-text"),n={text_input:e?.value,chat_id:i?.id||"",widget_type:i?.type||"",tag:i?.id?"followup":"",stream:!0};e?.addEventListener("keydown",function(a){a.key==="Enter"&&(a.shiftKey||(a.preventDefault(),n.text_input=e?.value,ct(n)))}),document.querySelector(".button-send").addEventListener("click",function(a){a.preventDefault(),n.text_input=e?.value,ct(n)})}async function X(i,e,n,t,a){ds(i?.type);const s=e?"":i?.css,o=e?`div[data-widgetid="${i.id}"] {${i.css}}
${n?.css}`:n?.css;if(await Si(s,o),le(i?.html),await Ti(i?.after_render),await Ci(i?.before_render),i?.custom_functions?.length){const l=document.querySelectorAll(".custom-service-btn"),r=Array.from(l)?.map(u=>u.getAttribute("data-subtab")??""),d=i.custom_functions?.map(u=>u.slug);(r?.filter(u=>!d.includes(u))).forEach(u=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${u}"]`);g&&g.remove(),document.getElementById(`${u}-editor-split`)?.remove()}),ti(),i.custom_functions?.forEach(u=>{xi(u)})}else document.querySelectorAll(".custom-service-btn").forEach(d=>{d.remove()}),document.querySelectorAll(".custom-editor-content").forEach(d=>{d.remove()}),ti();(t||a)&&qt(i?.origin?i?.origin:i?.widgetId),t&&i?.assistant?.id&&Ps(i?.assistant)}const un="drop-indicator";function Ii(){let i=document.querySelector(`.${un}`);return i||(i=document.createElement("div"),i.className=un,document.body.appendChild(i)),i}function Bs(i,e){const n=Ii(),t=i.getBoundingClientRect();e==="top"?n.style.top=`${t.top-5}px`:e==="bottom"&&(n.style.top=`${t.bottom-5}px`),n.style.left=`${t.left}px`,n.style.width=`${t.width}px`,n.style.opacity="1",n.style.transform="scaleY(1)"}function $s(){document.querySelectorAll(`.${un}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function Hs(i,e,n){if(e.length===0)return{element:n,position:"top"};const t=i.clientY;let a=e[0],s=Math.abs(a.getBoundingClientRect().top-t);Math.abs(a.getBoundingClientRect().bottom-t);for(const d of e){const c=d.getBoundingClientRect(),u=Math.abs(c.top-t);Math.abs(c.bottom-t),u<s&&(a=d,s=u)}const o=a.getBoundingClientRect(),l=o.top+o.height/2,r=t<l?"top":"bottom";return{element:a,position:r}}let J=null,j;function Vt(){const i=document.querySelector(".content-target > .mftsccs-marking-element");if(i){const e=document.querySelector(".content-target");_e.fixContentTargetHeight(e,i)}}function js(i){J=i.target;let e={data_type:i.target.getAttribute("data-type"),data_default:i.target.getAttribute("data-default"),data_void:i.target.getAttribute("data-void"),data_text:i.target.getAttribute("data-text"),elementId:i.target.getAttribute("data-elementId"),dataId:i.target.id,imageUrl:i.target.imageUrl,displayType:i.target.displayType};i.dataTransfer.setData("text",JSON.stringify(e)),i.dataTransfer.setData("id",i.target.id),i.dataTransfer.effectAllowed="move"}async function Ds(i){i.stopPropagation();const e={widgetcodeId:i.target.getAttribute("data-widgetId"),sourceElementId:i.target.id,className:i.target.className,imageUrl:i.target.imageUrl,displayType:i.target.displayType,type:i.target.Type};console.log("widgetcodeData ->",e),i.dataTransfer.setData("text",JSON.stringify(e)),i.dataTransfer.effectAllowed="move"}function Ns(i){i.preventDefault(),i.stopPropagation(),i.target.classList.add("dragging-area"),ft.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",ns()}function qs(i){i.preventDefault(),i.stopPropagation(),i.target.classList.remove("dragging-area")}function Fs(i){i.preventDefault(),i.stopPropagation(),(!J||!(i.currentTarget instanceof HTMLElement))&&(J=i?.target);const e=i.target,n=Array.from(e.children).filter(a=>a!==J);Ii();const t=Hs(i,n,e);j=t,Bs(t.element,t.position)}function Os(){q.checkContent()?q.enableWidgetButtons():q.disableWidgetButtons()}async function Vs(i){const e=await Rt(i);J=null,$s(),D.updateActionHistories(),ft.collapseNavbar(),Os(),Vt(),ce(),e&&(le(),qt(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),pe()}function Lt(i,e){return Array.isArray(i?.children)&&(i.children=i?.children.filter(n=>n?.wrapper!==e),i.children.forEach(n=>Lt(n,e))),i}function Fe(i,e){let n;return Array.isArray(i?.children)&&(n=i?.children.filter(t=>t?.wrapper===e),i.children.forEach(t=>Fe(t,e))),n?.[0]}async function Rs(i){i.preventDefault(),i.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(u=>{const g=document.getElementById(`${u}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};ut(m,`${u}-content`)}});const n=document.getElementById("element-attributes");if(n&&n.style.display==="block"){const u={target:document.querySelector("#icon-attribute")};ut(u,"element-attributes")}const t=R.staticElement,a=t?.parentElement,s=a?.parentElement,o=s?.dataset?.widgetid,l=t?.parentElement?.closest(".added-widget-container")||t?.parentElement?.closest(".edited-widget-container"),r=t.querySelectorAll(".added-widget-container");if(t?.classList?.contains("added-widget-container")){const u=t?.id;Lt(f?.staticWidgetTree,u)}else r.length&&r.forEach(u=>{const g=u?.id;Lt(f?.staticWidgetTree,g)});if(l){const u=l.id;if(t?.remove(),R.staticElement.remove(),_t(),t?.classList?.contains("added-widget-container")){const g=Fe(f?.staticWidgetTree,u),m=l.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,X(g)}else{const m=document.getElementById(u).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,X(f.selectedStaticWidgetTreeInfo.widgetTree)}ce(),D.updateActionHistories();return}a?.classList.contains("mftsccs-marking-element")&&a.children.length===1&&a?.remove(),o&&(s?.children?.length||s?.remove()),t?.remove(),R.staticElement.remove(),_t();const d=await Ze();return f.staticWidgetTree.html=d,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},kr(),X(f?.staticWidgetTree),ce(),D.updateActionHistories(),q.checkContent()||(q.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}async function Us(i){return"drag"}async function zs(i){return i.dataTransfer.setData("text",i.target.id),"start drag"}async function Js(i){console.log("dragEndWidgetElement event ->",i)}async function Gs(i){return i.preventDefault(),i.stopPropagation(),"dragOverWidgetElement"}async function Qs(i){Rt(i),le()}let Wt=null;async function Pi(i,e){if(i.preventDefault(),i.stopPropagation(),console.log("dropFolderElement event ->",e.widget_id),!J)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let t=i.target;if(!t.classList.contains("mftsccs-marking-element")&&!t.classList.contains("fslayout-col")&&t.id!=="builder-workarea"){const r=document.getElementById("builder-workarea"),d=t.closest(".mftsccs-marking-element"),c=t.closest(".fslayout-col");t=d||c||r}if((J.contains(t)||J===t)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),t=document.getElementById("builder-workarea")),!t)return console.error("Invalid dropzone"),!1;console.log("dropzone ->",t),t?.classList.remove("dragging-area");let a=Tt(i,e);if(!a.status)return alert(a.message),J=null,!1;const s=e.dataType||e.type||e.data_type,o=s==="photo"||s==="Image"||s==="img",l=s==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(o){let r,d=!1;if(J&&J.tagName&&J.tagName.toLowerCase()==="img"){if(console.log("Moving existing image element"),d=!0,r=J,r.parentElement===t&&console.log("Image is already in this dropzone, just repositioning"),!(r instanceof Node))return console.error("draggedItem is not a valid DOM node:",r),J=null,!1;(!r.hasAttribute("style")||!r.style.width)&&r.setAttribute("style","width: 200px;")}else{console.log("Creating new image element from data");const p=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(t.querySelectorAll(`img[src="${p}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),J=null,!1;r=document.createElement("img"),r.setAttribute("src",p),r.setAttribute("style","width: 200px;")}let c=_e.generateUUID();r.setAttribute("element-info-id",c);const u=t.classList.contains("file-item")&&t.classList.contains("photo-file")&&t.classList.contains("dragging");let g=r;if(u){console.log("Dropzone is photo-file container, wrapping image in div");const p=document.createElement("div");p.appendChild(r),g=p}try{if(d){console.log("Repositioning existing image element");const p=u&&r.parentElement?.parentElement||r.parentElement,h=u?r.parentElement:r;p&&p!==t&&h&&p.removeChild(h)}j?.position==="top"&&t?.children?.length&&j?.element?t.contains(j.element)&&!g.contains(j.element)&&g!==j.element?(t.insertBefore(g,j.element),console.log("Inserted element before indicator element (top position)")):(console.warn("Invalid indicator element for top position, appending to dropzone"),t.appendChild(g)):j?.position==="bottom"&&j?.element?t.contains(j.element)&&!g.contains(j.element)&&g!==j.element?(j.element.insertAdjacentElement("afterend",g),console.log("Inserted element after indicator element (bottom position)")):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),t.appendChild(g)):(console.log("Appending element to dropzone (default position)"),t.appendChild(g)),console.log("Element successfully positioned in dropzone:",t)}catch(p){console.error("Error positioning element:",p.message);try{t.appendChild(g),console.log("Fallback: Element appended to dropzone")}catch(h){return console.error("Cannot append element:",h),J=null,!1}}r.removeAttribute("element-info-id");const m=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(console.log("parentWidgetOfSelectedElement ->",m),m){const p=m.id,h=Fe(f?.staticWidgetTree,p),v=m.querySelector(".mftsccs-marking-element");return v&&(h.html=v.innerHTML,await X(h)),J=null,!1}return Zs(),J=null,!0}else if(l){let r=Tt(i,e);if(console.log("isDropValid ->",r),!r.status)return alert(r.message),J=null,!1;if(e.sourceElementId){const w=e.sourceElementId||e.fileId;console.log("sourceElement ->",w)}let d=e.widget_id;t.classList.remove("dragging-area");const c=document.createElement("div");c.classList.add("wb-initial-empty"),c.style.display="block",c.style.marginBottom="10px",c.setAttribute("data-widget-id",d);const u=_e.generateUUID();c.id=`widget-${u}`;const g=await I();console.log("profileData ->",g);let m=t.classList.contains("publicWidgetRouter"),p=await re(d);if(console.log("widgetTree ->",p),!m){const w=await Ee(d.id,g.token);console.log("latestVersionOfWidget ->",w),p=await re(w?w.widgetId:Number(d)),console.log("widgetTree ->",p)}p?.children?.length&&await Ut(p);const h=q.clearDraggedWidget(p),v=await Te(h,c);h.wrapper=c.id;try{j?.position==="top"&&t?.children?.length&&j?.element?t.contains(j.element)&&!c.contains(j.element)&&c!==j.element?(t.insertBefore(c,j.element),console.log("Inserted widget container before indicator element (top position)")):(console.warn("Invalid indicator element for top position, appending to dropzone"),t.appendChild(c)):j?.position==="bottom"&&j?.element?t.contains(j.element)&&!c.contains(j.element)&&c!==j.element?(j.element.insertAdjacentElement("afterend",c),console.log("Inserted widget container after indicator element (bottom position)")):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),t.appendChild(c)):(console.log("Appending widget container to dropzone (default position)"),t.appendChild(c))}catch(w){console.error("Error positioning widget container:",w.message);try{t.appendChild(c),console.log("Fallback: Widget container appended to dropzone")}catch(y){return console.error("Cannot append widget container:",y),J=null,!1}}const E=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(console.log("parentWidgetOfSelectedElement ->",E),E){const w=E.id;Fe(f?.staticWidgetTree,w).children.push(h);const S=document.getElementById(w).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=S?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=S?.style.cssText,await X(f.selectedStaticWidgetTreeInfo.widgetTree),J=null,!1}const W=await dt();console.log("widgetHTMLToUpdate ->",W),f.staticWidgetTree.html=W,f.staticWidgetTree?.children?.push(h);const T=f.widgetTree.children.indexOf(h);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[T],isChildWidget:!0,childWidgetIndex:T},await X(h,!1,v),q.enableWidgetButtons(),J=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),J=null,!1}function Zs(){document.querySelectorAll(".mftsccs-marking-element img").forEach(i=>{i.setAttribute("draggable","true"),i.addEventListener("dragstart",e=>{e.stopPropagation(),Wt=Date.now(),console.log("Drag started for image:",i)}),i.addEventListener("dragend",e=>{e.stopPropagation(),console.log("Drag ended for image:",i),setTimeout(()=>{Wt=null},100)})})}function Ks(){Wt=null,J=null,console.log("dragStartTime",Wt)}async function Rt(i,e=!1,n,t){if(!i&&e&&n&&t){const r=await re(Number(n)),d=en(t,n,!1,null);let c=await Te(r,d);r.wrapper=d?.id;const u=await Ze();f.staticWidgetTree.html=u,f.staticWidgetTree?.children?.push(r),X(r,!0,c);return}i.preventDefault(),i.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let s=i.dataTransfer.getData("text");if((r=>{try{return JSON.parse(r),!0}catch{return!1}})(s))if(Object.keys(JSON.parse(s)).includes("widgetcodeId")){const r=JSON.parse(s);let d=Tt(i,r);const c=r.className.split(" ");if(!d.status){alert(d.message);return}const u=JSON.parse(s);if(u.sourceElementId){const S=document.getElementById(u.sourceElementId.toString());if(S){i.target.insertBefore(S,d.elementBelowDrag);return}}let g=as(u),m=i.target;m.classList.remove("dragging-area");const p=await I();let h=!1;c.includes("publicWidgetRouter")&&(h=!0);let v=null,E=null;if(h){v=await re(Number(g)),E=en(m,g,!1,d.elementBelowDrag);const S=document.getElementById("widgetNameValue");S&&v?.name&&(S.value=v?.name);const b=document.getElementById("widget-builder");b&&v?.name&&(b.textContent="Widget Builder Panel: "+v?.name)}else{const S=await Ee(g,p.token);v=await re(S?S.widgetId:Number(g));const b=document.getElementById("widgetNameValue");b&&v?.name&&(b.value=v?.name);const C=document.getElementById("widget-builder");C&&v?.name&&(C.textContent="Widget Builder Panel: "+v?.name),v?.children?.length&&await Ut(v),E=en(m,S?S.widgetId:g,!1,d.elementBelowDrag),console.log("newDropzone ->",E)}const W=q.clearDraggedWidget(v);let T=await Te(W,E);W.wrapper=E?.id;const w=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(w){const S=w.id;Fe(f?.staticWidgetTree,S).children.push(W);const A=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=A?.innerHTML,X(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const y=await Ze();f.staticWidgetTree.html=y,f.staticWidgetTree?.children?.push(W);const _=f.widgetTree.children.indexOf(W);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},X(W,!1,T),q.enableWidgetButtons()}else{const r=JSON.parse(s);console.log("objData ->",r);const d=i.target;let c=Tt(i,r);if(c.status){let h=_e.generateUUID();const v=xr(h,r),E=document.createElement("div");E.innerHTML=v,j?.position==="top"&&d?.children?.length?d.insertBefore(E.firstChild,j?.element):j?.position==="bottom"?j?.element?.insertAdjacentElement("afterend",E.firstChild):d.appendChild(E.firstChild),i.target.classList.remove("dragging-area");let T=d.querySelector(`[element-info-id='${h}']`);r.data_type=="layout"?T.querySelectorAll(".fslayout-col").forEach(y=>{y.classList.add("wb-initial-empty")}):(T.classList.add("wb-initial-empty"),r?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))),T.removeAttribute("element-info-id"),r?.data_type==="img"&&(T?.setAttribute("src","/images/img-placeholder.jpg"),T?.setAttribute("style","width: 200px;"))}else alert(c.message);const u=i.target?.parentElement?.closest(".added-widget-container")||i.target?.parentElement?.closest(".edited-widget-container");if(u){const h=u.id,v=Fe(f?.staticWidgetTree,h),E=u.querySelector(".mftsccs-marking-element");return v.html=E?.innerHTML,await X(v),i.dataTransfer.clearData(),!1}const g=document.querySelector(".content-target"),p=(await Ce(g,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=p;try{i.dataTransfer.clearData()}catch(h){console.error("error in clearing data",h.message)}return!0}else{const r=R.staticElement,d=i.target;d.classList.remove("dragging-area"),j?.position==="top"&&d?.children?.length?d.insertBefore(r,j?.element):j?.position==="bottom"?j?.element?.insertAdjacentElement("afterend",r):d.appendChild(r),_t();const c=await Ze();f.staticWidgetTree.html=c}}function Ys(i){const s=new DOMParser().parseFromString(i,"text/html").body.querySelector("div")?.id,l=document.getElementById(s)?.parentElement?.closest(".added-widget-container"),r=l?.id,d=l?.querySelectorAll(".widget_container_disabled");return d?.length&&d?.forEach(c=>{const u=_e.generateUUID();c.id=`wdgt${u}`}),r?.toString()}async function Ut(i){return Array.isArray(i.children)&&i.children.forEach(e=>{Bi(e,i),e.children.length&&Ut(e)}),i}function Bi(i,e){const n=i.wrapper,s=new DOMParser().parseFromString(e?.html,"text/html").body,o=s.querySelector(`#${n}`);if(!o)return i;const r=`wdgtcopy${_e.generateUUID()}`;return o.id=r,i.wrapper=r,e.html=s.innerHTML.toString(),i}const Xs=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:Vt,dragElement:Us,dragEndWidgetElement:Js,dragOverWidgetElement:Gs,dragStartWidgetElement:zs,dropElement:Rt,dropFolderElement:Pi,dropWidgetElement:Qs,findChildByWrapper:Fe,getChildWrapperId:Ys,getChildrenWrapperId:Bi,onDragEnter:Ns,onDragLeave:qs,onDragOver:Fs,onDragStart:js,onDrop:Vs,onWidgetDragStart:Ds,removeChildByWrapper:Lt,removeElement:Rs,resetDragState:Ks,updateAllChildWidgets:Ut},Symbol.toStringTag,{value:"Module"})),eo=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],Ln=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class $i{constructor(){}async getLayoutListHTML(){return Ln.map(n=>`
      ...
      `).join("")}async getTemplateLayoutsHTML(){const e=await ur();if(!e||e.length===0)return'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No templates available</p></li>';const n=await I(),t=n?.entityId===101651686||n?.entityId===101279491;return e.map(a=>a.id?`
      ...
      `:"").join("")}}async function Ee(i,e){let n=new z;n.composition=i,n.fullLinkers=["the_widget_recent","the_widget_latest"],n.inpage=100;let t=new z;t.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],t.inpage=100;const s=await he([n,t],e),l=await Ie(i,"the_widget_recent"),r=s?.data?.the_widget?.the_widget_recent||s?.data?.the_widget?.the_widget_latest||[],d=s?.data?.the_widget?.the_widget_latest||null;if(r.length){const c=r[0],u=c?.data.the_widget.the_widget_name?.[0].data.the_name,g=c?.data.the_widget.the_widget_html?.[0].data.the_html,m=c?.id,p=c?.data.the_widget.the_widget_css?.[0].data.the_css,h=c?.data.the_widget.the_widget_js?.[0].data.the_js,v=c?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,E=c?.data.the_widget.the_widget_version?.[0].data.the_version,W=c?.data.the_widget.the_widget_origin?.[0].data.the_origin|i;return{widgetName:u,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:v,widgetVersion:Number(E||d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||d.id,origin:Number(W),connectionIdLatest:l,publishedWidgetVersion:d?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const q=(()=>{const i=async()=>{const w=document.getElementById("fslayout-template-container");if(w){w.innerHTML=`
        ...
        </li>`;const _=await new $i().getTemplateLayoutsHTML();w.innerHTML=_}},e=async()=>{const w=document.getElementById("public-widget-list-container");if(w){const y=await fn();!y||y.trim()===""?w.innerHTML=`
            <li class="list-unstyled">
              <p class="text-center my-3 text-secondary">No public widgets</p>
            </li>
          `:w.innerHTML=y||""}},n=async()=>{const w=document.getElementById("folder-widget-container");if(w){const y=await dr();!y||y.trim()===""?w.innerHTML=`
            <li class="list-unstyled">
...
`;m?.file(`${u.slug}.index.ts`,p)}e?.file("routes.ts",zt(n))},yo=async(i,e,n)=>{console.log("widgetsDir",n);const a=(await I())?.token,s=await $n(i,a,!0);let o=e?.folder("home");const l=`
...
`;o?.file("home.index.ts",l),s?.css&&o?.file("home.style.css",s?.css)},wo=async i=>{if(ue)return;ue=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],n=new Nt;const t=await Gt(n),a=t?.widgetsDir,s=t?.pagesDir;let o="";a&&s&&(o=await vo(i,s)),t?.routesDir?.file("routes.ts",zt(e)),n.generateAsync({type:"blob"}).then(function(l){let r=document.createElement("a");r.href=URL.createObjectURL(l),r.download=`${o||"page"}.zip`,r.click()}),ue=!1},vo=async(i,e)=>{const n=await I(),t=n?.entityId,a=n?.token,s=await $n(i,a,!0),o=new z;o.composition=t,o.inpage=100,o.fullLinkers=["the_entity_s_page"];const l=new z;l.inpage=100,l.composition=i,l.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const d=(await he([o,l],a))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==i),c=d?.[0]?.data?.the_page?.the_page_body?.[0]?.id,u=d?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    import * as tsccs from "mftsccs-browser";
    ...
    `;return g?.file("home.index.ts",m),s?.css&&g?.file("home.style.css",s?.css),u},bo=async i=>{if(ue)return;if(!i){console.log("Project id is required");return}const a=(await new Jt().getProjectById(i))?.data?.the_project?.the_project_name?.[0]?.data?.the_name?.replace(/\s/g,"_").toLowerCase();ue=!0;let s=new Nt;const o=await Gt(s),l=o?.routesDir,r=o?.pagesDir;await _o(r,l,i),s.generateAsync({type:"blob"}).then(function(d){let c=document.createElement("a");c.href=URL.createObjectURL(d),c.download=`the_${a}.zip`,c.click()}),ue=!1},_o=async(i,e,n)=>{if(!i&&!e)return;let t=[];const s=(await I())?.token,o=new z;o.composition=n,o.inpage=100,o.fullLinkers=["the_project_s_page","the_project_main_page"];const l=new z;l.inpage=100,l.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const r=await he([o,l],s),d=r?.data.the_project?.the_project_main_page?.[0]?.id;if(r?.data.the_project?.the_project_s_page?.length)for(let c=0;c<r?.data.the_project?.the_project_s_page?.length;c++){const u=r.data.the_project.the_project_s_page[c];let g={page:u?.id,title:u?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:u?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:u?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:u?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:u?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:u?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!g.page)continue;const m=`${g.slug.split("-").map((v,E)=>E===0?v.charAt(0).toLowerCase()+v.slice(1):v.charAt(0).toUpperCase()+v.slice(1)).join("")}`;t.push({path:`/${g.slug}`,content:`${m}Index`,importFrom:`/${g.slug}/${g.slug}.index.ts`}),g.page==d&&t.push({path:"/",content:`${m}Index`});let p=i?.folder(g.slug);const h=`
                ...
                }`;p?.file(`${g.slug}.index.ts`,h)}e?.file("routes.ts",zt(t))};async function Eo(){const i=new se("mountchildwidgets-editor-split"),e=document.getElementById("mountchildwidgets-editor-split");e&&(e.innerHTML=""),await i.initializeEditor()}async function To(){const i=new se("onupdate-editor-split"),e=document.getElementById("onupdate-editor-split");e&&(e.innerHTML=""),await i.initializeEditor()}async function Hi(){await Eo(),await To(),await ls(),await cs()}function So(){document.getElementById("widget-lifecycle-form")?.remove(),document.createElement("div").setAttribute("id","widget-lifecycle-form")}function ji(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.add("saveWidgetDisabled")})}function mn(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.remove("saveWidgetDisabled")})}class Di{arrowBtn=null;updateOnlyButton=null;isDroppedDown=!1;constructor(){}async LoadPageWidget(e){const t=(await I())?.token;Tn(),ji(),document.querySelector("#widget-properties #widget-type input")?.remove(),So(),await Hi();let s=Sn(),o=await Ee(e,t),l=await re(o?.widgetId??e);console.log("page widget tree",l);let r=await Te(l,s);this.addPageUpdate(e),mn(),f.resetWidgetTree(),f.widgetTree=l,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),X(l,!1,r,!0),q.enableWidgetButtons(),Vt(),ce(),pe()}toggleUpdate(e){this.updateOnlyButton&&this.arrowBtn&&(this.isDroppedDown&&e!==!0?(this.updateOnlyButton.classList.remove("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.updateOnlyButton.classList.add("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isDroppedDown=!this.isDroppedDown)}addPageUpdate(e){const n=document.getElementById("widget-btn-wrapper");n.innerHTML=`
        <div class="position-relative" style="z-index: 100;">
          <div class="w-100 d-flex justify-content-center">
      ...
      `,this.isDroppedDown=!1,this.arrowBtn=n.querySelector("#updateDropDownArrowPage"),this.updateOnlyButton=n.querySelector("#updateFsPage"),this.updateOnlyButton.addEventListener("click",()=>{this.toggleUpdate(!0)}),this.arrowBtn.addEventListener("click",()=>{this.toggleUpdate(!1)})}addCodeToDom(e,n){Si(e.css,n?.css),Ti(e.after_render),Ci(e.before_render),En()}}const ii={PAGE_SAVE:"Page saved Successfully!",WIDGET_SAVE:"Widget saved Successfully!",NO_SAVED_WIDGET:"No saved widgets!",NO_WIDGET_CONTAINER:"Widget list container not found in the DOM."},ai=new Ue,Ni=new Di;async function An(i){i.preventDefault();try{await $e(),await et();const e=document.getElementById("fspage-save-button"),n=Number(e?.getAttribute("data-pageid")),s="widget_"+(await ai.getPageById(n)).data?.[`the_${M.PAGE_COMP_NAME}`]?.[`the_${M.PAGE_COMP_NAME}_slug`].data.the_slug,o=document.querySelectorAll(".edited-widget-container");L.infoMessageToast("Saving page...",0),o?.length&&o.forEach(u=>{const g=u.querySelectorAll(".widget_container");g?.length&&g.forEach(m=>{m.className="widget_container_disabled"}),u.classList.remove("edited-widget-container")});const l=await Ze();f.staticWidgetTree.html=l,await f.savePageWidget(n,s),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast(ii.PAGE_SAVE);const c=(await ai.getPageById(n))?.data?.the_page?.the_page_body?.id;return await Ni.LoadPageWidget(c),ii.PAGE_SAVE}catch(e){kn(e,"There is an error on saving widget")}}async function xn(i,e,n){i.preventDefault();const t=document.getElementById("updateFsPagePublish"),a=document.getElementById("updateFsPage"),s=a?.innerHTML||"";try{const o=document.getElementById("updateFsPagexx");t&&t.classList.add("disabled"),a&&(a.classList.add("disabled"),a.textContent="Updating.."),o&&(o.classList.add("disabled"),o.textContent="Updating..");const l=document.querySelectorAll(".edited-widget-container");L.infoMessageToast("Updating Page...",0),l?.length&&(L.infoMessageToast("Updating page...",0),l.forEach(u=>{const g=u.querySelectorAll(".widget_container");g?.length&&g.forEach(m=>{m.className="widget_container_disabled"}),u.classList.remove("edited-widget-container")}));const r=await Ze();f.staticWidgetTree.html=r;const d=await f.updateWidget();return console.log("updateWidgetResponse ->",d),En(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page Updated Successfully"),await Ni.LoadPageWidget(e),n&&n===!0&&await f.publish(),"updated widget successfully!"}catch(o){console.error("error updating page",o),o instanceof Error&&L.errorToast(o.message),document.querySelector(".infoMessageToast")?.remove()}finally{t&&t.classList.remove("disabled"),a&&(a.classList.remove("disabled"),a.innerHTML=s)}}function Co(i){const e=new URLSearchParams(window.location.search).get("page-id");if(e){const n=`${window.location.origin}/page-preview/${e}`;window.open(n,"_blank")?.focus()}}function Lo(i,e=0){return window.saveWidgetInFolders=Ao,`
    ...
    `}let nt;async function Wo(i,e){nt=i,console.log("selectedWidgetId -->",nt);const n=Lo(e,typeof i=="object"?0:i),t=document.createElement("div");t.innerHTML=n;const a=t.querySelector("#folder-widget-container");document.querySelector("body #app")?.appendChild(a),await de("folder-widget-container");const s=await I();if(!s)return;let o,l,d=(await Ye(nt,s.token))?.data?.the_widget?.the_widget_name?.[0]?.data?.the_name;e===!0?(o=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name"),console.log("nameInput -->",o),o&&(o.value=d),l=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")):(o=document.getElementById("folder-widget-container")?.querySelector("input#folder-name"),l=document.getElementById("folder-widget-container")?.querySelector("textarea#description")),console.log("nameInput -->",o);const c=document.getElementById("widgetFolder");console.log("xyzEl -->",c),e===!0?await Pe(ie.folder_widget,c,{widgetName:o.value,widgetDescription:l?.value,widgetId:nt}):(console.log("nameInput.value -->",o.value),await Pe(ie.folder_widget,c,{widgetName:o.value,widgetDescription:l?.value,widgetId:nt}))}async function Ao(i,e,n,t){i.preventDefault();try{L.infoMessageToast("Saving Widget...",0),await $e();const a=document.getElementById("folder-widget-container"),s=a?.querySelector('button[type="submit"]');s.textContent="Saving";const o=a?.querySelector("input"),l=a?.querySelectorAll("button"),r=document.getElementById("save-to-folder-name")||document.getElementById("folder-name");console.log("nameInputEl -->",r);const d=r.value;console.log("widgetNamex -->",d),l&&l.forEach(w=>{w.disabled=!0}),o&&(o.disabled=!0),await et();let c;if(!t){R.staticElement?.removeAttribute("draggable");const w=document.querySelectorAll(".edited-widget-container");w?.length&&w.forEach(async S=>{if(S.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[S.id]){const b=await Ce(S,"div.mftsccs-marking-element");f.editedWidgets[S.id].html=b.innerHTML}});const y=await Ui();f.staticWidgetTree.html=y,console.log("widgetNamex -->",d);const _=await f.saveWidget(d);c=await Y(_.id),n=c.id,console.log("Saved Widget ID:",n)}const u=await I(),g=document.getElementById("folder-widget-container")?.querySelector("input#save-to-folder-name")?.value||document.getElementById("folder-widget-container")?.querySelector("input#folder-name")?.value,m=document.getElementById("folder-widget-container")?.querySelector("textarea#save-to-folder-description")?.value,h=new URLSearchParams(window.location.search).get("concept"),v={title:g,source_url:window.location.href,widget_id:n,short_desc:m,note:"",data_type:"widget",created_on:Date.now()};if(h){c=await Y(Number(n));const w=await Y(Number(h));if(!w)throw new Error("Selected folder concept not found!");let y={...v,boom_folder:{name:w.name||"",parent:h}};const _=await De({boomgpt:y},void 0,void 0,void 0,u.userId,4);await Gn(await Y(Number(h)),_,"the_boom_folder_s_contain"),await G(_,c,"the_refer")}else{const w=u?.userConcept;c=await Y(Number(n));let y={...v,boom_folder:{name:"",parent:w}};const _=await De({boomgpt:y},void 0,void 0,void 0,u.userId,4);await Gn(await Y(Number(w)),_,"the_boom_folder_s_contain"),await G(_,c,"the_refer")}await N.SyncDataOnline(),document.getElementById(e)?.querySelector("form")?.reset(),we("folder-widget-container"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget saved successfully!"),t||(await q.renderSavedWidgets(),Oe(i,Number(n)))}catch(a){document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Error in saving widget"),kn(a,"There is an error on saving widget")}}class qi extends gt{mainConcept=0;mainData;data=0;phonebooks=[];the_params;component_heading;saveButtonHTML;saveBoomButtonHTML;previewButtonHTML;tryAIButtonHTML="";responsiveButtonHTML="";_pageBuilderService;constructor(e){super(),this.component_heading="Widget Builder Panel",this.saveButtonHTML="",this.saveBoomButtonHTML="";const n=I();if(n&&(this.saveBoomButtonHTML=`
    ...
    `,e){this.the_params=e,this._pageBuilderService=new Di;const t=this.the_params?.data?.the_page_title?.data?.the_title;this.component_heading=this.the_params.type?"Page Builder: "+t:"Widget Builder";const a=this.the_params?.page_id;n&&e.type==Wn.page&&(this.saveBoomButtonHTML=`
         <div class="text-end d-flex flex-row" id="widget-btn-wrapper">
...
`}before_render(){this.render()}after_render(){if(this.the_params){document.getElementById("fspage-save-button").addEventListener("click",An);const n=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!n){Vt();return}this._pageBuilderService.LoadPageWidget(Number(n))}}getHtml(){return window.openSaveWidgetModal=In,window.saveWidget=Ri,window.updateWidget=Pn,window.newWidget=je,window.previewWidget=Bo,window.downloadWebsite=po,window.moveUp=_e.moveUp,window.moveDown=_e.moveDown,window.copyElement=_e.copyElement,window.editWidget=_e.editWidget,window.openConvertModal=jo,window.convertToWidget=$o,window.updatePage=xn,window.previewPage=Co,window.undoAction=D.undoAction,window.redoAction=D.redoAction,window.saveWidgetToFolderBtn=Wo,window.openPromptModal=Ls,window.refineAIData=dn,`
    ...
    `,e.querySelector("#closeModalBtn").addEventListener("click",this.handleClose.bind(this)),e}updateModal(){this.props.isOpen?this.modal.classList.add("open"):this.modal.classList.remove("open")}handleClose(){Fi(),this.modal.remove()}createNewPageModal(){return`
        <div class="m-body">
            <form id="fs-create-page-form">
    ...
    `}}function At(i){new xo(i)}function si(i){const e=document.getElementById(i);e&&e.remove()}class Mn{_pagesHTMLService;_pagesTSCCSService;constructor(){this._pagesHTMLService=new _i,this._pagesTSCCSService=new Ue}async initPagesSidebar(){this.closePagesSubSidebar(".fs-page-create-submenu"),this.closePagesSubSidebar(".fs-page-edit-submenu");const e=await this._pagesHTMLService.getPagesListHTML(),n=document.getElementById("saved-page-list-container");n&&(n.innerHTML="",n.insertAdjacentHTML("beforeend",e));const t=document.getElementById("fs-create-page-button");t?.removeEventListener("click",this.createButtonClickHandler),t?.addEventListener("click",this.createButtonClickHandler),document.querySelectorAll("#fs-delete-page-button").forEach(l=>{l.removeEventListener("click",this.deletePageButtonClickHandler),l.addEventListener("click",this.deletePageButtonClickHandler)}),document.querySelectorAll("#fs-rename-page-button").forEach(l=>{l.removeEventListener("click",this.editPageButtonClickHandler),l.addEventListener("click",this.editPageButtonClickHandler)}),document.querySelectorAll("#fs-duplicate-page-button").forEach(l=>{l.removeEventListener("click",this.duplicatePageButtonClickHandler),l.addEventListener("click",this.duplicatePageButtonClickHandler)})}closePagesSubSidebar(e){Array.from(document.querySelectorAll(e)).forEach(t=>t.remove())}createButtonClickHandler=()=>{At({id:"fs-create-page-modal",isOpen:!0,headerText:"Create New Page"}),document.getElementById("fs-save-page-button")?.addEventListener("click",this.savePageButtonClickHandler);const n=document.getElementById("fs-create-page-form"),t=n?.elements.namedItem("title");if(!t){console.error("page_title not found");return}const a=async()=>{const o=await this._pagesTSCCSService.generateSlug(t.value);n.elements.namedItem("slug")?.setAttribute("value",o)};t.addEventListener("keyup",a);const s=()=>{t.removeEventListener("keyup",a),document.getElementById("fs-create-page-modal")?.removeEventListener("close",s)};document.getElementById("fs-create-page-modal")?.addEventListener("close",s)};savePageButtonClickHandler=async()=>{const n=document.getElementById("fs-create-page-form").elements;if(!n.title.value){n.title.style.borderColor="red";return}L.infoMessageToast("Creating page...",0);const t=await ln(n),a=await I();await this._pagesTSCCSService.savePage(t,a?.userId,a?.entityId),await N.SyncDataOnline(),this.initPagesSidebar(),document.querySelector(".infoMessageToast")?.remove(),si("fs-create-page-modal"),setTimeout(()=>{L.successfullToast("Page created successfully")},300)};editPageButtonClickHandler=async e=>{const n=e.target.getAttribute("data-id"),t=e.target.closest(".dropdown-menu").dataset.title,a=e.target.closest(".dropdown-menu").dataset.slug;At({id:"fs-edit-page-modal",isOpen:!0,headerText:"Rename Page",data:{title:t,slug:a}});const s=document.getElementById("fs-edit-page-form"),o=s?.elements.namedItem("title");if(!o){console.error("page_title not found");return}const l=async()=>{document.getElementById("fs-edit-page-button")?.removeAttribute("disabled");const u=await this._pagesTSCCSService.generateSlug(o.value);s.elements.namedItem("slug")?.setAttribute("value",u)};o.addEventListener("keyup",l);const r=()=>{o.removeEventListener("keyup",l),document.getElementById("fs-edit-page-modal")?.removeEventListener("close",r)};document.getElementById("fs-edit-page-modal")?.addEventListener("close",r),document.getElementById("fs-edit-page-button")?.addEventListener("click",()=>this.updatePageButtonClickHandler(n))};async PageInputElementChangeHandler(e,n){const t=e.target,a=t.name,s=t.value;let o=await this._pagesTSCCSService.checkSlugAvailablity(s);if(a==="slug"&&!o){document.getElementById("fs-update-page-button")?.setAttribute("disabled","true"),t.style.borderColor="red",t.insertAdjacentHTML("afterend",'<p style="color:red">Slug already exist</p>');return}await this._pagesTSCCSService.updatePageField(t.getAttribute("name"),t.value,Number(n))}updatePageButtonClickHandler=async e=>{const n=document.getElementById("fs-edit-page-form"),t=n.elements.namedItem("title");if(!t.value.trim()){t.style.borderColor="red";return}const a=n.elements;if(!a.title.value){a.title.style.borderColor="red";return}L.infoMessageToast("Renaming page...",2);const s=await ln(a),o=await I();await this._pagesTSCCSService.renamePage(s,e,o?.userId),await N.SyncDataOnline(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page renamed successfully");const r=new URLSearchParams(window.location.search).get("page-id");if(e===r){const d=document.getElementById("widget-builder");d.textContent=`Page Builder: ${s?.title}`}this.initPagesSidebar(),this.closePagesSubSidebar("#fs-page-edit-submenu"),si("fs-edit-page-modal")};deletePageButtonClickHandler=async e=>{const n=e.target.getAttribute("data-id"),t=e.target.closest(".dropdown-menu").dataset.title,a=e.target.closest(".dropdown-menu").dataset.slug;confirm(`Are you sure you want to delete the page titled "${t}" with the slug "${a}"?`)?(L.infoMessageToast("Deleting page...",0),await this._pagesTSCCSService.deletePage(Number(n)),await N.SyncDataOnline(),yi("/"),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Page deleted successfully")):document.activeElement?.blur()};duplicatePageButtonClickHandler=async e=>{const t=e?.target?.getAttribute("data-id"),s=(await this._pagesTSCCSService.getPageById(Number(t)))?.data?.the_page,o=s?.the_page_title?.data?.the_title?.trim()+" copy",l=s?.the_page_slug?.data?.the_slug?.trim()+"-copy",r=s?.the_page_meta_title?.data?.the_meta_title?.trim(),d=s?.the_page_meta_description?.data?.the_meta_description?.trim(),c=s?.the_page_meta_keywords?.data?.the_meta_keywords?.trim(),u=s?.the_page_width?.data?.the_width?.trim(),g=s?.the_page_type?.data?.the_type?.trim(),m=s?.the_page_font_family?.data?.the_font_family?.trim(),p=s?.the_page_font_size?.data?.the_font_size?.trim(),h={title:o,slug:l,meta_title:r,meta_description:d,meta_keywords:c,width:u,type:g,font_family:m,font_size:p},v={};for(const[_,S]of Object.entries(h))S&&(v[_]=S);const E=s?.the_page_body?.id,W=await I(),T=await Ee(E,W?.token);let w=await re(T?T.widgetId:E);const y=await this._pagesTSCCSService.savePage(v,W?.userId,W?.entityId);await f.copyPageWidget(y,`widget_${l}`,w),this.initPagesSidebar(),L.successfullToast("Page duplicated successfully")}}async function Mo(i){i?.preventDefault();const e=window.location.href,t=document.querySelector("#widget-btn-wrapper button")?.getAttribute("data-widgetid");if(await f.hasWidgetChanged(Number(t))){await bt("Do you want to save changes?")&&(e.includes("?page-id=")?t?await xn(i,Number(t)):await An(i):t?await Pn(i,Number(t)):await In());const h=document.getElementById("preview-btn");h.classList.remove("active"),h.removeAttribute("data-widgetid")}f.resetWidgetTree();const s=i.target.getAttribute("data-pageId");history.pushState({},"",`?page-id=${s}`);let l=await new Ue().getPageById(Number(s));l?.error&&je();const r=document.getElementById("midContent"),d=document.getElementById("right-aside"),c={type:Wn.page,data:l.data?.[`the_${M.PAGE_COMP_NAME}`],page_id:s},u=new qi(c),g=new Zt(c);d.innerHTML=await g.getHtml(),r.innerHTML="",u.mount(r),ts.resetNavigationBar()}class Oi{_projectsService;_pagesTsccsService;constructor(){this._projectsService=new Jt,this._pagesTsccsService=new Ue}async getProjectsListHTML(){try{const e=await this._projectsService.getAllProjects();return e?.length?e?.map(t=>{let s=t?.data?.[`the_${M.PROJECT_COMP_NAME}`]?.[`the_${M.PROJECT_COMP_NAME}_name`]?.data?.the_name;return`
    ...
    `,document.querySelector("body #app")?.appendChild(a),de("rename-project-dialog"),"Rename Project Modal"}async getProjectPagesListHTML(e){try{const n=await this._projectsService.getProjectById(e),t=n?.data?.the_project?.[`the_project_${oe.PROJECT_PAGE_LINKER}`],a=n?.data?.the_project?.the_project_main_page?.[0]?.id;return t?.length?t?.map(o=>{let l=o?.data?.[`the_${M.PAGE_COMP_NAME}`]?.[`the_${M.PAGE_COMP_NAME}_title`]?.[0]?.data?.the_title;const r=a==o.id,d=r?'<span class="material-symbols-outlined home-icon">home</span>':"",c=r?"":`<li class="d-flex align-items-center justify-content-between" 
      ...
      `,document.body.appendChild(n),n.showModal(),n}catch(n){return console.error("Error:",n),""}}}function ko(i,e=[],n=[]){return`
  <style>
  .accordion-header {
  background: gray;
  color: white;
...
.custom-menu-item {
  ...
  <div>
    ...
    `}const Io=async i=>{if(!i){console.log("Project id is required");return}const e=new Jt;let[n,t]=await Promise.all([e.getProjectById(i),La(i)]);console.log("project detail",n),console.log("abc menus ",t);const a=n?.data?.the_project?.the_project_main_page?.[0]?.id??0,s=n?.data?.the_project?.the_project_s_page?.map(d=>({id:d.id,name:d?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:d?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,home:d?.id==a}))??[];console.log("pages",s),document.getElementById("project-setting-dialog")?.remove();const l=document.createElement("dialog");l.setAttribute("id","project-setting-dialog"),l.classList.add("col-md-8"),l.style.flexDirection="column",l.innerHTML=ko(i,s),document.querySelector("body #app")?.appendChild(l),await de("project-setting-dialog"),document.querySelectorAll(".accordion-header").forEach(d=>{d.addEventListener("click",async()=>{d.classList.toggle("active");const c=d.getAttribute("id");if(d.classList.contains("active"))switch(c){case"domain-viewer-btn":const u=document.getElementById("custom-domain-view-holder"),g=await gi(i,"the_project_custom_url");u&&Pe(102462726,u,{projectId:i,storeUrl:`https://preview-${i}.develop.freeschema.com`,customUrl:g?.[0]?.data?.the_custom_url||""});break}else switch(c){case"domain-viewer-btn":const u=document.getElementById("custom-domain-view-holder");u&&(u.innerHTML="");break}})}),tt(t);const r=document.getElementById("save-menu-items");r?.addEventListener("click",async d=>{r&&(r.disabled=!0),console.log("menus save",t),t=t.map(u=>(delete u.edit,u)),console.log("menus filtered save",t),d.target.disable=!0;const c=await Wa(i,t);console.log("menu created",c),d.target.disable=!1,tt(t),alert("Updated Menu"),r&&(r.disabled=!1)}),document.getElementById("add-custom-menu-item")?.addEventListener("click",d=>{const c=d.target.closest(".custom-menu-item"),u=c?.querySelector("#nameElem"),g=c?.querySelector("#linkElem"),m=c?.querySelector("#actionElem"),p=c?.querySelector("#authElem");if(!u.value){alert("Menu Name is required");return}if(!g.value&&!m.value){alert("Link or Action is required");return}t.push({name:u.value??"",link:g.value??"",action:m.value??"",page:"",order:t.length,auth:!!p.checked,menus:[]}),u.value="",g.value="",m.value="",p.checked=!1,tt(t)}),window.handleMenuAction=(d,c,u,g)=>{if(c=="remove")if(g){const m=document.getElementsByClassName("selected-menu-page");for(let p=0;p<m.length;p++){const h=m[p];Number(h.getAttribute("data-page-id"))==g&&h?.checked&&h.click()}}else t.splice(u,1)[0];else if(c=="edit")t[u].edit=!0;else if(c=="cancel")t[u].edit=!1;else if(c=="update"){t[u].edit=!1;const m=d?.target?.closest("li"),p=m?.querySelector("#menuName").value??"",h=m?.querySelector("#menuLink").value??"",v=m?.querySelector("#menuAction").value??"",E=!!m?.querySelector("#menuAuth").checked;t[u].name=p,t[u].link=h,t[u].action=v,t[u].auth=E}else if(c=="up"){const m=t.splice(u,1)[0];t.splice(u-1,0,m),t=t.map((p,h)=>({...p,order:h}))}else if(c=="down"){const m=t.splice(u,1)[0];t.splice(u+1,0,m),t=t.map((p,h)=>({...p,order:h}))}else console.warn("unacceptable action ",c);tt(t)},document.querySelectorAll(".selected-menu-page").forEach(d=>{d.addEventListener("change",c=>{console.log("e.target.changed",c.currentTarget.checked);const u=parseInt(c.currentTarget.getAttribute("data-page-id"));if(c.currentTarget.checked){const g=s.find(m=>m.id==u);console.log("pages",g,s),t.push({name:g.name??"",link:g.slug??"",action:"",page:g.id??"",order:t.length,auth:!1,menus:[]})}else{const g=(m,p)=>{for(let h=0;h<m.length;h++){const v=m[h];v.menus&&v.menus.length>0&&(v.menus=g(v.menus,p))}return m.filter(h=>h.page!=p)};t=g(t,u)}tt(t)})})};class Vi{_projectsHTMLService;_projectsTSCCSService;_pagesTSCCSService;constructor(){this._projectsHTMLService=new Oi,this._projectsTSCCSService=new Jt,this._pagesTSCCSService=new Ue}async initProjectsSidebar(){try{const e=await this._projectsHTMLService.getProjectsListHTML(),n=document.getElementById("saved-project-list-container");n&&(n.innerHTML="",n.insertAdjacentHTML("beforeend",e));const t=document.getElementById("fs-create-project-button");t?.removeEventListener("click",this.createProjectHandler),t?.addEventListener("click",this.createProjectHandler),document.querySelectorAll(".project-item").forEach(l=>{l.removeEventListener("click",this.getProjectPagesListHandler),l.addEventListener("click",this.getProjectPagesListHandler)}),document.querySelectorAll(".add-icon").forEach(l=>{l.removeEventListener("click",this.addPageToProjectHandler),l.addEventListener("click",this.addPageToProjectHandler)}),document.querySelectorAll(".delete-project").forEach(l=>{l.removeEventListener("click",this.deleteProjectHandler),l.addEventListener("click",this.deleteProjectHandler)}),window.createProjectHandler=this.createProjectHandler,window.setMainPageHandler=this.setMainPageHandler,window.deletePageFromProjectHandler=this.deletePageFromProjectHandler,window.downloadProject=bo,window.showProjectSetting=Io,window.renameProjectModal=this._projectsHTMLService.renameProjectModal,window.renameProjectHandler=this.renameProjectHandler}catch(e){console.error("Failed to initialize projects sidebar:",e)}}createProjectHandler=async()=>{At({id:"create-project-modal",headerText:"Create New Project:",isOpen:!0});try{const e=document.getElementById("create-project-modal");await this.addPageToProject(e,!0),this.initProjectsSidebar()}catch(e){console.error("Failed to create project:",e)}};renameProjectHandler=async(e,n)=>{try{const s=document.getElementById("rename-project-form").elements.namedItem("name").value;await this._projectsTSCCSService.updateProjectField("name",s,n),await N.SyncDataOnline(),this.initProjectsSidebar()}catch(t){console.error("Failed to rename project:",t)}};getProjectPagesListHandler=async e=>{const n=e.target.dataset.projectid,t=e.target.parentElement.querySelector(".project-pages-list");if(t){if(!t.classList.contains("d-none")){t.classList.add("d-none");return}t.innerHTML=`
        <li class="list-unstyled">
          <div class="d-flex justify-content-center align-items-center py-2">
  ...
  `,document.querySelector("body #app")?.appendChild(e),de("save-widget-dialog"),new Promise((n,t)=>{const a=e.querySelector("#save-widget-form");a.onsubmit=async o=>{o.preventDefault();try{const l=new FormData(a),d=Object.fromEntries(l).widgetName,c=o.target;if(!d?.trim()){const u=c.querySelector("#widgetName");u?.focus(),u.style.border="2px solid red",u.style.outline="none",u.addEventListener("input",()=>{u.style.border=""});return}await Ri(o,d),we("save-widget-dialog"),n("Widget saved successfully")}catch(l){console.error("Error saving widget:",l),t("Error saving widget")}};const s=e.querySelector("button[type='button']");s.onclick=()=>{we("save-widget-dialog"),n("Widget saving canceled")}})}async function Ri(i,e){i.preventDefault();try{L.infoMessageToast("Saving Widget...",0),await $e();const n=document.getElementById("save-widget-dialog"),t=n?.querySelector('button[type="submit"]');t.textContent="Saving";const a=n?.querySelector("input"),s=n?.querySelectorAll("button");s&&s.forEach(u=>{u.disabled=!0}),a&&(a.disabled=!0),await et(),R.staticElement?.removeAttribute("draggable");const o=document.querySelectorAll(".edited-widget-container");o?.length&&o.forEach(async u=>{if(u.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[u.id]){const g=await Ce(u,"div.mftsccs-marking-element");f.editedWidgets[u.id].html=g.innerHTML}});const l=await Ui();f.staticWidgetTree.html=l;const r=await f.saveWidget(e),d=await Y(r.id);we("save-widget-dialog"),Ot(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget saved successfully!"),await q.renderSavedWidgets(),Oe(i,d.id);return}catch(n){document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Error in saving widget"),kn(n,"There is an error on saving widget")}}async function Pn(i,e,n){const t=document.getElementById("update-publish-widget-btn");try{const a=document.getElementById("update-widget-btn");t&&t.classList.add("disabled"),a&&(a.classList.add("disabled"),a.textContent="Updating...",L.infoMessageToast("Updating Widget...",0)),await et(),R.staticElement?.removeAttribute("draggable");const s=document.querySelectorAll(".edited-widget-container");s?.length&&s.forEach(async d=>{if(d.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[d.id]){const c=await Ce(d,"div.mftsccs-marking-element");f.editedWidgets[d.id].html=c.innerHTML}});const o=await Do();f.staticWidgetTree.html=o,await f.updateWidget(),Ot(),pe(),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Updated Successfully"),await q.renderSavedWidgets(),await q.renderBoomWidgets();const r=document.getElementById("widget-builder");r.textContent="Widget Builder Panel",await Oe(i,f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:e),n&&n===!0&&await f.publish();return}catch(a){document.querySelector(".infoMessageToast")?.remove();const o=document.getElementById("update-widget-btn");o&&(o.classList.remove("disabled"),o.innerHTML=`
      <span class="material-symbols-outlined"></span>
      Update`),a instanceof Error&&L.errorToast(a.message)}finally{t&&t.classList.remove("disabled")}}async function je(i,e){const n=document.querySelector(".widgetStyle");n.textContent="",document.querySelectorAll(".child-widget-css")?.forEach(d=>{d.textContent=""});const a=document.getElementById("publish-widget");a&&(a.style.display="none",a.disabled=!0);const s=document.querySelector(".content-target"),o=window.location.href,r=document.querySelector("#widget-btn-wrapper button")?.getAttribute("data-widgetid");if(s){let d=!1;d=await f.hasWidgetChanged(Number(r));const u=document.getElementById("preview-btn").classList.value.includes("active");if((i?.target?.id==="preview-btn"||i?.target?.id==="save-widget-form"||i?.target?.id==="update-widget-btn"||i?.target?.id==="form-folder-modal"||i?.target?.id==="data-file-id")&&(d=!1),u&&(d=!1),d&&!e){await bt("Do you want to save changes?")&&(o.includes("?page-id=")?r?await xn(i,Number(r)):await An(i):r?await Pn(i,Number(r)):await In()),Ot();const p=document.getElementById("preview-btn");p.classList.remove("active"),p.removeAttribute("data-widgetid")}await Ss()}s.innerHTML="",Fi(),i&&!e&&window.history.pushState({},"","/")}let nn="";async function Bo(i){const e=document.getElementById("preview-btn"),n=e.classList.value.includes("active");let t=i.target.getAttribute("data-widgetid");t&&history.pushState({},"",`?widget-id=${t}`);const a=document.querySelector(".content-target"),s=document.querySelector(".midContent .content"),o={...f.widgetTree},l=document.getElementById("undo-btn"),r=document.getElementById("redo-btn"),d=document.getElementById("ai-prompt-btn"),c=document.getElementById("widget-prompt-modal"),u=document.getElementById("widget-prompt-tab"),g=document.querySelector(".dropdown-wrapper"),m=document.getElementById("widgetButtionCodeViewWrapper");if(n){e.innerHTML=`
        <span class="material-symbols-outlined"> visibility </span> Preview
      `,d.style.display="flex",nn&&nn!=="none"?(u.classList.add("d-none"),c.classList.remove("d-none"),c.classList.add("d-flex")):(u?.classList.remove("d-none"),c&&c.classList.add("d-none")),e.classList.remove("active"),l.classList.remove("d-none"),r.classList.remove("d-none"),m&&(m.style.display="block"),g&&(g.style.display="none"),a&&(a.style.width="100%",a.style.maxWidth="",a.style.margin="0 auto",a.classList.remove("mode-desktop","mode-tablet","mode-mobileL","mode-mobile"),a.classList.add("mode-desktop"));const p=Sn(),h=await Te(f.widgetTree,p,!0,void 0,!0);X(f.widgetTree,!1,h,!1,!0),document.getElementById("column-left").classList.remove("d-none"),document.getElementById("column-right").classList.remove("d-none"),document.getElementById("widget-btn-wrapper").classList.remove("d-none"),s.classList.remove("preview"),ce(),pe(),rt.enableHeader()}else{e.innerHTML=`
        <span class="material-symbols-outlined">design_services</span> Develop
      `,d.style.display="none",c&&(nn=window.getComputedStyle(c).display,c.classList.add("d-none")),u&&u.classList.add("d-none");const p=document.getElementById("select-box"),h=document.getElementById("element-info");p.style.display="none",h.style.display="none",l.classList.add("d-none"),r.classList.add("d-none"),e.classList.add("active"),m&&(m.style.display="none");const v=await Te(f.widgetTree,a,!0,void 0,!1);X(o,!1,v),document.getElementById("column-left").classList.add("d-none");const W=document.createElement("script");W.setAttribute("type","text/javascript"),W.innerHTML=o?.js,a.appendChild(W),document.getElementById("column-right").classList.add("d-none"),document.getElementById("widget-btn-wrapper").classList.add("d-none"),rt.disableHeader(),ot.closeCodeView(),s.classList.add("preview");const y=document.querySelector("header.wico_top-header");y.style.display="none"}return"PREVIEW WIDGET"}async function Ce(i,e){return i.querySelectorAll(e).forEach(t=>{for(;t.firstChild;)t.parentNode.insertBefore(t.firstChild,t);t.remove()}),i}async function $o(i,e){i.preventDefault();try{const n=new FormData(i.target),a=document.getElementById("convert-dialog")?.querySelector('button[type="submit"]');a.textContent="Converting...";const s=i.target;for(let o=0,l=s.length;o<l;++o)s[o].disabled=!0;await Ho(n);for(let o=0,l=s.length;o<l;++o)s[o].disabled=!1;return await we(e),"completed conversion"}catch{L.errorToast("html conversion failed"),await we(e)}}async function Ho(i){const e=Object.fromEntries(i),n=`
      <div class="widget-wrapper">
        ${e.htmlCode}
      </div>
    `,t=await Oa(n,e?.cssCode?.toString(),e?.jsCode.toString()),s=(await I())?.token,l=(await qa(t?.id,s))?.id,{html:r,css:d,js:c}=await Ha(l,s);await wn(l);const u=document.querySelector(".content-target");u.innerHTML=r;const g=document.querySelector('.cm-content[data-language="css"]');g.textContent=d;const m=document.querySelector('.editor-container .cm-content[data-language="javascript"]');return m.textContent=c,En(),"converted widget"}async function jo(i){return new za().init(),de(i),"opened convert HTML to Widget!"}async function Ye(i,e){return new Promise(async(n,t)=>{try{let a=new z;a.composition=i,a.fullLinkers=["the_widget","the_widget_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_type","the_widget_after_render","the_widget_before_render","the_widget_update","the_widget_mount_child","the_widget_clean","the_widget_s_child","the_widget_version","the_widget_origin","the_widget_s_css_library","the_widget_s_js_library","the_widget_assistant","the_widget_s_custom_function"],a.inpage=100;let s=new z;s.fullLinkers=["the_child_widget","the_child_widget_type","the_child_widget_parent","the_child_widget_wrapper","the_child_widget_info","the_css_library_order","the_css_library_url","the_js_library_order","the_js_library_url","the_assistant_id","the_assistant_input","the_assistant_type","the_custom_function_slug","the_custom_function_code","the_custom_function_name"],s.inpage=100;const l=await he([a,s],e);n(l)}catch(a){console.error("error",a),a?.status===401&&Ae(),t(a)}})}async function Do(){R.staticElement?.removeAttribute("draggable");const i=document.querySelector(".content-target"),e=i.querySelectorAll(".edited-widget-container");e?.length&&e.forEach(o=>{o.classList.replace("edited-widget-container","added-widget-container")});const n=await Ce(i,"div.mftsccs-marking-element");return i?.querySelector("#widget-details")?.remove(),(i?.querySelectorAll(".mftsccs-marking-rendered")).forEach(o=>{o.remove()}),n.innerHTML.trim()}async function Ui(){R.staticElement?.removeAttribute("draggable");const i=document.querySelector(".content-target"),e=await Ce(i,"div.mftsccs-marking-element");return i?.querySelector(".widget_selected")?.classList.remove("widget_selected"),i?.querySelector("#widget-details")?.remove(),e.innerHTML.trim()}async function Ze(){const i=document.querySelector(".content-target");i?.querySelector("#widget-details")?.remove();const n=await Ce(i,"div.mftsccs-marking-element");return i?.querySelector(".widget_selected")?.classList.remove("widget_selected"),n.innerHTML.trim()}async function dt(){R.staticElement?.removeAttribute("draggable");const i=document.querySelector(".content-target")?.cloneNode(!0);i?.querySelector("#widget-details")?.remove();const t=(await Ce(i,"div.mftsccs-marking-element")).innerHTML.trim();return R.staticElement?.setAttribute("draggable","true"),t}async function xt(i){R.staticElement?.removeAttribute("draggable");const e=document.getElementById(i)?.cloneNode(!0);e?.querySelector("#widget-details")?.remove();const a=(await Ce(e,"div.mftsccs-marking-element")).innerHTML.trim();return R.staticElement?.setAttribute("draggable","true"),a}const No=["image/jpeg","image/jpg","image/png","image/webp"],qo=["application/msword","application/vnd.ms-excel","application/vnd.ms-powerpoint","text/plain","application/pdf"],zi=async i=>{try{const e=new FormData;let n;if(qo.includes(i.type))e.append("file",i,i.name),n=await Oo(e);else if(No.includes(i.type))e.append("image",i,i.name),n=await Fo(e);else return{message:"Invalid File Format",success:!1};return n?.data?{message:"Upload Success",success:!0,url:n.data}:(alert("File Upload Failed"),{message:"File Upload Failed",success:!1})}catch(e){throw console.error(e),e}},Fo=async(i,e="")=>{try{const n=await fetch(ie.boomURL+"/api/Image/UploadImage",{method:"POST",body:i,headers:{Authorization:`Bearer ${e}`}});if(!n.ok){const t=n.headers.get("content-type");t&&t.includes("text/plain")&&console.info(n?.text());const a=await n?.text();return console.error(`${n.status} ${a}`),null}return await n.json()}catch(n){return console.error(n),null}},Oo=async(i,e="")=>{try{const n=await fetch(ie.boomURL+"/api/Image/UploadFile",{method:"POST",body:i,headers:{Authorization:`Bearer ${e}`}});if(!n.ok){const t=n.headers.get("content-type");t&&t.includes("text/plain")&&console.info(n.text());const a=await n.text();return console.error(`${n.status} ${a}`),null}return await n.json()}catch(n){return console.error(n),null}};async function Vo(i=""){try{const e=await I();if(!e)return`
      <li class="list-unstyled">
        <p class="text-center my-3 text-secondary">No Public widget</p>
      </li>
    `;const n=await pi("public_widget","",!1,e.userId,4,999);let t=new H;t.typeConnection="the_widget_public_name",t.name="widgetPName";let a=new H;a.typeConnection="the_widget_name",a.name="widgetName";let s=new H;s.typeConnection="the_widget_description",s.name="widgetDescription";let o=new H;o.typeConnection="the_widget_thumbnail",o.name="widgetThumbnail";let l=new H;l.typeConnection="the_public_widget_s_widget",l.selectors=["the_widget_timestamp","the_widget_version"],l.name="widgetLevel",l.inpage=10,l.limit=!0,l.freeschemaQueries=[t,a,s,o];let r=new H;if(r.conceptIds=[n.id],r.outputFormat=fe,r.name="top",r.freeschemaQueries=[l],i!=""){let d=new Ne;d.name="filterName",d.search=i,d.type="the_name",d.operateon="widgetName",d.logicoperator="like";let c=new Ne;c.name="filterPublicName",c.search=i,c.type="the_public_name",c.operateon="widgetPName",c.logicoperator="like",r.filters=[d,c],r.filterLogic="( filterName OR filterPublicName )"}return new Promise(d=>{ye(r,"").subscribe(c=>{d(c)})})}catch(e){throw e}}async function Ro(i=""){try{const e=await I();if(!e)return`
      <li class="list-unstyled">
        <p class="text-center my-3 text-secondary">No Folder widget</p>
      </li>
    `;const n=await pi("folder_widget","",!1,e.userId,4,999);let t=new H;t.typeConnection="the_widget_folder_name",t.name="widgetPName";let a=new H;a.typeConnection="the_widget_name",a.name="widgetName";let s=new H;s.typeConnection="the_widget_description",s.name="widgetDescription";let o=new H;o.typeConnection="the_widget_thumbnail",o.name="widgetThumbnail";let l=new H;l.typeConnection="the_folder_s_widget",l.selectors=["the_widget_timestamp","the_widget_version"],l.name="widgetLevel",l.inpage=10,l.limit=!0,l.freeschemaQueries=[t,a,s,o];let r=new H;if(r.conceptIds=[n.id],r.outputFormat=fe,r.name="top",r.freeschemaQueries=[l],i!=""){let d=new Ne;d.name="filterName",d.search=i,d.type="the_name",d.operateon="widgetName",d.logicoperator="like";let c=new Ne;c.name="filterFolderName",c.search=i,c.type="the_folder_name",c.operateon="widgetPName",c.logicoperator="like",r.filters=[d,c],r.filterLogic="( filterName OR filterPublicName )"}return new Promise(d=>{ye(r,"").subscribe(c=>{d(c)})})}catch(e){throw e}}class Xe{static staticElementList}async function Uo(i,e){const n=i?.target?.value,t=await I(),a=t?.userId,s=t?.token,o=await Y(e),d=(await Ye(e,s))?.data?.the_widget?.the_widget_before_render?.[0]?.id;d&&await Se(d);const c=await te("before_render",n,!1,a,4,999);await V(o,c,"before_render"),await N.SyncDataOnline(),new qi().before_render()}async function zo(i,e){console.log("updateWidgetUpdate event",i),console.log("widgetId",e)}async function Jo(i,e){const n=i?.target?.value,t=await I(),a=t?.userId,s=t?.token,o=await Y(e),d=(await Ye(e,s))?.data?.the_widget?.the_widget_after_render?.[0]?.id;d&&await Se(d);const c=await te("after_render",n,!1,a,4,999);await V(o,c,"after_render"),await N.SyncDataOnline();const g=document.getElementById("mountInput")?.value,p=document.getElementById("mountChildWidgetsInput")?.value,h=new gt;h.componentDidMountFunction=g,h.addEventFunction=n,h.mountChildWidgetsFunction=p;const v=document.querySelector(".content-target"),E=await h.mount(v);console.log("appContentHTML",E)}async function Go(i,e){const n=i?.target?.value,t=await I(),a=t?.userId,s=t?.token,o=await Y(e),d=(await Ye(e,s))?.data?.the_widget?.the_widget_mount_child?.[0]?.id;d&&await Se(d);const c=await te("mount_child",n,!1,a,4,999);await V(o,c,"mount_child"),await N.SyncDataOnline()}class Qo{widgetDocumentationModalHTML;constructor(){this.init()}init(){this.widgetDocumentationModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.widgetDocumentationModalHTML)}getHtml(){return window.saveWidgetDocumentationEditor=Xo,`
    ...
    `}}class Zo{widgetDocumentationModalHTML;constructor(){this.init()}init(){this.widgetDocumentationModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.widgetDocumentationModalHTML)}getHtml(){return`
    ...
    `}}async function Ko(i,e){const n=document.getElementById("documentation-view");await Pe(ie.documentation_preview_widget,n,{currentWidgetId:e})}let lt,an="",gn,pn;async function Yo(i,e){gn=i,e==="preview"?new Zo:new Qo;const n=new H;n.typeConnection="the_widget_documentation",n.name="documentationText",n.selectors=["the_documentation_text"];const t=new H;t.typeConnection="the_widget_s_documentation",t.name="documentationBlank",t.selectors=["the_documentation_text","the_documentation_content","the_documentation_language","the_documentation_doc_title","the_documentation_folder","the_documentation_creator_email","the_documentation_created_by","the_documentation_content","the_documentation_type","the_documentation_s_doc_url","the_documentation_s_image_url","the_documentation_s_video_link","the_documentation_auth_type","the_documentation_bearer_token","the_documentation_method","the_documentation_method_url","the_documentation_username","the_documentation_password","the_documentation_s_json_list","the_documentation_api_script","the_documentation_api_body","the_documentation_code_editor","the_documentation_return"];const a=new H;a.typeConnection="the_documentation_s_json_list",a.name="documentationJSON",a.selectors=["the_json_list_key","the_json_list_value"],t.freeschemaQueries=[a];const s=new H;s.conceptIds=[gn],s.freeschemaQueries=[n,t],s.inpage=100,s.outputFormat=fe,await ye(s,"").subscribe(async o=>{console.log("documentation data ->",o);const l=o?.[0]?.data?.the_widget?.the_widget_documentation?.data?.the_documentation?.the_documentation_text?.data?.the_text||"";l&&(an=l);const r=o?.[0]?.data?.the_widget?.the_widget_s_documentation;if(r?.length){const d=r?.map(c=>{const u=c?.data?.the_documentation,g=u?.the_documentation_type?.data?.the_type,m=u?.the_documentation_content?.data?.the_content,p=u?.the_documentation_creator_email?.data?.the_creator_email,h=u?.the_documentation_doc_title?.data?.the_doc_title,v=u?.the_documentation_method?.data?.the_method,E=u?.the_documentation_method_url?.data?.the_method_url,W=u?.the_documentation_bearer_token?.data?.the_bearer_token,T=u?.the_documentation_username?.data?.the_username,w=u?.the_documentation_password?.data?.the_password,y=u?.the_documentation_auth_type?.data?.the_auth_type,_=u?.the_documentation_s_json_list,S=u?.the_documentation_api_script?.data?.the_api_script,b=u?.the_documentation_api_body?.data?.the_api_body,C=u?.the_documentation_language?.data?.the_language,A=u?.the_documentation_return?.data?.the_return,x=u?.the_documentation_code_editor?.data?.the_code_editor,k=u?.the_documentation_s_doc_url,P=u?.the_documentation_s_image_url,B=u?.the_documentation_s_video_link;let $={type:g,content:m,creatorEmail:p,title:h};if(g==="blank")$={...$};else if(g==="api"){const F=[];_?.length&&_?.forEach(K=>{F.push({key:K?.data?.the_json_list?.the_json_list_key?.data?.the_key,value:K?.data?.the_json_list?.the_json_list_value?.data?.the_value})}),$={...$,method:v,methodURL:E,authType:y,username:T,password:w,bearerToken:W,json:F,script:S,body:b}}else g==="function"&&($={...$,language:C,return:A,codeEditor:x});const U=[],ee=[],Z=[];return P?.length&&P?.forEach(F=>{U.push(F?.data?.the_image_url)}),B?.length&&B?.forEach(F=>{ee.push(F?.data?.the_video_link)}),k?.length&&k?.forEach(F=>{Z.push(F.data?.the_doc_url)}),$={...$,imageList:U,linkList:Z,videoList:ee},$});console.log("documentationDataList",d),an=d}pn=o?.[0]?.data?.the_widget?.the_widget_documentation?.id,e!=="preview"&&er(l)}),e==="preview"?(await de("widget-documentation-preview-modal"),Ko(an,i)):await de("widget-documentation-modal")}async function Xo(){if(lt){const i=lt.getData(),e=await Q(gn),t=(await I())?.userId;if(pn)await Ke(pn,"the_documentation_text","text",i,t),await N.SyncDataOnline();else{const a=await O("documentation",t,{text:i});await G(e,a,"documentation"),await N.SyncDataOnline()}L.successfullToast("Documentation is saved."),lt.setData(i)}else console.error("Editor not initialized"),L.errorToast("Documentation couldn't saved.")}function er(i){const e=document.querySelector("#documentation-editor");e&&Ia.create(e,{licenseKey:"GPL"}).then(n=>{lt=n;const t=i;lt.setData(t)}).catch(n=>{console.error("Error initializing CKEditor:",n)})}class tr{constructor(){this.init()}init(){document.getElementById("btn-take-tour")?.addEventListener("click",n=>{if(n.target.matches(".btn-tour")){const t=n.target.dataset.tourStatus;this.startTour(t)}})}startTour(e){const n=new Aa.Tour({defaultStepOptions:{classes:"wico",scrollTo:!0,cancelIcon:{enabled:!0}},useModalOverlay:!0}),t=[{classes:"back-button",text:"Back",action:n.back},{classes:"next-button",text:"Next",action:n.next}];n.addStep({id:"welcome",title:"👋 Welcome to Widget Conceptualizer",text:["This short tour will walk you through the essentials. Let's begin. Start building widgets today!"],buttons:[{text:"Remind me later",classes:"back-button",action:n.complete},{text:"Next",classes:"next-button",action:()=>{n.next()}}]}),n.addStep({id:"step-create-widget",title:"Create a New Widget",text:["Start by creating a new widget."],classes:"onboarding-boomconsole",highlightClass:"highlight",attachTo:{element:".wico_header-section",on:"bottom-start"},buttons:t}),n.addStep({id:"step-widget-panel",classes:"tour-widget-panel",title:"Workspace Area",text:"This is your creative canvas. Drag and drop elements, build widgets, apps, or full pages—right in the workspace.",attachTo:{element:".content-target",on:"top"},buttons:t}),n.addStep({id:"step-builder-meu",title:"Builder Menu",text:"This menu provides essential navigation tools. Use it to manage projects, access assets, open pages, and explore saved widgets.",attachTo:{element:".sidebar-collapsed",on:"left"},buttons:t}),n.addStep({id:"step-properties",title:"Properties Panel",text:"Adjust Styling, add properties like layout, colors, fonts, and more.",attachTo:{element:()=>{const a=document.querySelector(".accordion-widget-properties a"),s=new Event("click",{bubbles:!0,cancelable:!0});return a.dispatchEvent(s),".right-aside"},on:"left"},buttons:t}),n.addStep({id:"step-design-code-mode",title:"Design & Code Modes",text:[`
        ...
        `).join(""):'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No Saved Assets</p></li>'}searchWidgets(e,n){n||(n=`#${e.target?.dataset?.id}`||"");const a=e.target.value.toLowerCase();document.querySelectorAll(`${n} li`).forEach(o=>{const l=(o.textContent||"").toLowerCase();o.style.display=l.includes(a)?"":"none"})}searchPublicWidgets(e){const t=e.target.value.toLowerCase();fn(t).then(a=>{cn.navbar.setPublicWidgets(a),this.updatePopupMenu("publicWidgets",a)})}async responsiveSidebar(){const e={mainItems:[{id:"elements",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            `,n.onclick=()=>{new tr().startTour(this._loginDetailObject?.tourStatus)}):e?.link?n.innerHTML=`
            ...
            <span class="nav-icon" title="${e.text}">${e.icon}</span>
            <span class="nav-text">${e.text}</span>
        `),n}createSection(e){const n=document.createElement("div");return n.className="sidebar-section",n.innerHTML=`<hr /><span class="section-title">${e}</span>`,n}async handleNavItemClick(e){console.log("handleNavItemClick");const n=document.querySelector(".sidebar"),t=n?.classList.contains("sidebar-collapsed"),a=e.target.closest(".nav-item"),s=a?.id,o=a?.classList.contains("active"),l=a?.querySelector(".nav-icon")?.getAttribute("title")||"";if(!s||o){this.removeSubSidebar();return}if(t){this.removeSubSidebar(),a?.classList.add("active");const r=await this.createSubSidebarMenu(s,l);if(document.querySelector("#column-left")?.appendChild(r),s==="folderWidgets"){const d=await I(),c=document.getElementById("folder-widget-container");console.log("containerEl",c);const u=await Pe(ie.folder_widget,c).then(g=>{g.dataChange(async m=>{if(console.log("dataChange",m),m.displayType==="photo"||m.type==="Image"||m.displayType==="widget"||m.type==="widget"){let p=await Pi(e,m);console.log("asdff",p)}else{let p=await Ee(Number(m),d.token),h=await re(p?p.widgetId:Number(m));console.log("widgetTree",h),await Oe(null,h.id)}}),console.log("output",g)});console.log("xyz",u)}if(s==="assets"){const d=document.getElementById("default-list-container");await Pe(ie.assets_widget,d)}}else n?.classList.add("sidebar-collapsed"),this.handleNavItemClick(e)}async updatePopupMenu(e,n){if(e=="publicWidgets"){let t=document.querySelector("#public-widget-list-container");t&&(t.innerHTML=n)}if(e=="folderWidgets"){let t=document.querySelector("#folder-widget-container");t&&(t.innerHTML=n)}}async createSubSidebarMenu(e,n){const t=document.createElement("section");if(t.className="sub-sidebar",e==="layout")t.innerHTML=`
  ...
  <div id="spinner-${p.id}" class="spinner-border spinner-border-sm text-primary position-absolute top-50 start-50 translate-middle d-none" role="status">
    <span class="visually-hidden">Loading...</span>
              ...
              `).join("");r(m)})})}catch(i){console.error("Error in getMyWidgetsList:",i),L.errorToast(i?.message||"An error occurred while fetching widgets"),i?.status===401&&Ae()}}async function et(){try{const i=document.getElementById("builder-workarea");if(!i)return;i.innerHTML="",await Bn(f.widgetTree);const e=await Te(f.widgetTree,i);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree,isChildWidget:!1,childWidgetIndex:0},await X(f.widgetTree,!1,e),ce(),pe()}catch(i){throw new Error(`error loading widget with widget tree ${i.message}`)}}async function oi(i){const e=i?JSON.parse(i):"";if(e)try{const n=document.getElementById("builder-workarea");n.innerHTML="";const t=await Te(e,n),a=document.getElementById("select-box");a.style.display="none";const s=document.getElementById("element-attributes");s.innerHTML=`
      <div class="row">
        <div class="text-center my-3 text-secondary">
          <p>Select an element to view and edit its attributes</p>
        </div>
      </div>
    `,await X(e,!1,t),ce(),pe()}catch(n){throw new Error(`error loading widget with widget tree ${n.message}`)}}async function Oe(i,e,n){try{if(i?.preventDefault(),i?.stopPropagation(),ft.collapseNavbar(),await $e(),await je(i),n&&typeof n!="number"||Number.isNaN(n)||e&&typeof e!="number"||Number.isNaN(e)){L.infoMessageToast("Widget id is in different format. Please check and update",4),je(i);return}history.pushState({},"",`?widget-id=${n||e}`);const t=document.getElementById("preview-btn");t&&t.setAttribute("data-widgetid",e.toString()),sr(),or(),Tn(),ji(),await Hi();let a=Sn();a.classList.contains("fspage")&&a.classList.remove("fspage");const o=(await I())?.token;let l=null;i&&(l=await Ee(e,o),console.log("latestVersionKnown",l));let r=await re(l?l.widgetId:e);const d=document.getElementById("widgetNameValue");d&&r?.name&&(d.value=r?.name);const c=document.getElementById("widget-builder");c&&r?.name&&(c.textContent="Widget Builder Panel: "+r?.name,c.setAttribute("title",`Widget Builder Panel: ${r?.name}`)),await Bn(r);const u=await Te(r,a);f.widgetTree=r,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),await X(r,!1,u,!0),await hs(l?.widgetId??e);const g=document.getElementById("preview-btn");return g.setAttribute("onclick","previewWidget(event)"),g.setAttribute("data-widgetid",`${e}`),g.removeAttribute("data-pageid"),console.log("load StaticWidgetClass.staticWidgetTree ->",f.staticWidgetTree),mn(),q.enableWidgetButtons(),q.initializeWidgetVersions(n||e,r?.version?r.version.toString():"original",r?.timestamp),D.renderActionHistory(),D.updateActionHistories(),ce(),pe(),Cn(),""}catch(t){console.error(t),L.errorToast(t?.message,4),mn(),je(i)}}function sr(){const e=document.getElementById("tab-container")?.querySelector("button[data-tab-id='wico-tab-pageInfo']");e&&(e.style.display="none");const n=document.getElementById("page-properties");n&&(n.style.display="none");const t=document.querySelector("button[data-tab-id='wico-tab-navigator']");t&&t.click()}function or(){document.title="Widget Conceptualizer",mt("description","Widget Conceptualizer"),mt("keywords","widget conceptualizer, widget conceptualiser, widget builder, widget, conecept, connection")}async function rr(i,e){i.stopPropagation();try{const n=confirm("Do you want to delete the Widget?");if(await $e(),n){L.infoMessageToast("Deleting the widget...",0),await Po(e),await q.renderSavedWidgets();const t=new URLSearchParams(window.location.search).get("widget-id");return t&&parseInt(t)===e&&await je(i),document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Deleted Successfully"),"Widget is deleted successfully!"}else return}catch(n){document.querySelector(".infoMessageToast")?.remove(),L.successfullToast("Widget Deleted Successfully"),L.errorToast(n.message?n.message:"Failed to delete widget"),console.error("Failed to delete widget:",n)}}async function lr(i,e){i.stopPropagation();const n=document.getElementById("postWidgetModal");n&&n.remove();const t=await I(),a=t?.entityId===101651686||t?.entityId===101279491,s=document.createElement("dialog");s.id="postWidgetModal",s.className="col-md-6 a-dialog",s.innerHTML=`
    <div class="a-dialog-header d-flex justify-content-between">
  ...
  `,document.body.appendChild(s);const o=s.querySelector("#pasteArea"),l=s.querySelector("#widgetThumbnail"),r=s.querySelector("#imagePreview img"),d=s.querySelector("#imagePreview"),c=s.querySelector("#pasteText");function u(p){const h=new FileReader;h.onload=v=>{r&&v.target?.result&&(r.src=v.target.result,d.classList.remove("d-none"),c.classList.add("d-none"))},h.readAsDataURL(p)}l?.addEventListener("change",p=>{const h=p.target.files?.[0];h&&u(h)});function g(p){const h=p.clipboardData?.items;if(h){for(let v=0;v<h.length;v++)if(h[v].type.indexOf("image")!==-1){const E=h[v].getAsFile();if(E&&l){const W=new DataTransfer;W.items.add(E),l.files=W.files,u(E);break}}}}o?.addEventListener("paste",p=>g(p)),s.addEventListener("paste",p=>g(p)),s.querySelector("#post-widget-form")?.addEventListener("submit",p=>{p.preventDefault(),cr(e,s)}),s.showModal()}async function cr(i,e){const n=document.querySelector(`#spinner-${i}`),t=e.querySelector('button[type="submit"]');try{t&&(t.disabled=!0,t.textContent="Posting...",L.infoMessageToast("Posting Widget to Public...",0)),n&&n.classList.remove("d-none"),await $e();const a=await I(),s=document.getElementById("widgetPublicName").value,o=document.getElementById("widgetDescription").value,l=document.getElementById("widgetThumbnail");if(console.log("File Input Debug:",{inputExists:!!l,filesExists:!!l?.files,filesLength:l?.files?.length,value:l?.value,firstFile:l?.files?.[0],description:o}),!l?.files?.length)throw console.error("File validation failed:",{inputExists:!!l,filesLength:l?.files?.length}),new Error("Please provide a thumbnail image");const r=l.files?.[0];if(console.log("Thumbnail file:",{name:r.name,type:r.type,size:r.size}),!r||!l.value)throw new Error("Please provide a thumbnail image");const d=await zi(r);if(!d.success)throw new Error("Failed to upload thumbnail");const c=await Ee(i,a.token);if(c&&(await Ie(c.widgetId,"the_public_widget_s_widget",!0)).length){document.querySelector(".infoMessageToast")?.remove(),L.infoMessageToast("Widget is already public.");return}const u=document.getElementById("postAsTemplate")?.checked;let g=null;if(c)g=await Q(c.widgetId);else{const W=await Y(i);g=await q.createWidgetCopy(W,a.userId,a.token)}const m=await te("public_name",s,!1,a.userId,4,999),p=await te("description",o,!1,a.userId,4,999),h=await te("thumbnail",d.url||"no attachment",!1,a.userId,4,999);await V(g,p,"description"),await V(g,h,"thumbnail"),await V(g,m,"public_name");const v=await te("public_widget","",!1,a.userId,4,999);if(await V(v,g,"s_widget"),u){const T=await te("template_name",s,!1,a.userId,4,999),w=await te("template_thumbnail",d.url||"no attachment",!1,a.userId,4,999);await V(g,w,"template_thumbnail"),await V(g,T,"template_name");const y=await te("template_widget","",!1,a.userId,4,999);await V(y,g,"s_widget")}await N.SyncDataOnline(),await q.renderPublicWidgets(),await q.renderSavedWidgets(),u&&await q.renderTemplateLayouts(),e.close(),document.querySelector(".infoMessageToast")?.remove(),setTimeout(()=>{L.successfullToast(`Widget Posted to Public${u?" and Templates":""}`)},300)}catch(a){console.error("Error posting widget:",a),document.querySelector(".infoMessageToast")?.remove(),L.errorToast("Failed to post widget"),t&&(t.disabled=!1,t.textContent="Post Widget")}finally{n&&n.classList.add("d-none")}}async function fn(i=""){try{const e=await I();if(!e)return`
    ...
    `}catch(e){console.error("error",e),e?.status===401&&Ae()}}async function dr(i=""){console.log("getFolderWidgetsList called with searchTerm:",i);try{const e=await I();if(!e)return console.log("No profile data found, returning empty list"),`

        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary">No Folder widget</p>
        </li>
      `;const t=(await Ro(i))[0]?.data?.the_folder_widget?.the_folder_widget_s_widget||[];console.log("Widgets data fetched:",t);const a=await Promise.all(t.map(async r=>{const d=r?.data?.the_widget,u=d?.the_widget_folder_name?.data?.the_folder_name||`${d?.the_widget_name?.data?.the_name} ${d?.the_widget_version?.data?.the_version>1?"v"+d?.the_widget_version?.data?.the_version:""}`,g=d?.the_widget_description?.data?.the_description,m=d?.the_widget_thumbnail?.data?.the_thumbnail,p=d?.the_widget_timestamp?.data?.the_timestamp;return{id:r?.id,name:u,timestamp:p,description:g,thumbnail:m}}));if(console.log("Processed folder widgets list:",a),!a?.length){const r=document.getElementById("folder-widget-container");if(r){console.log("No folder widgets found, rendering fallback widget"),r.style.display="block";const d=await Pe(ie.folder_widget,r);console.log("Fallback widget result:",d)}return`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary">No Folder widget</p>
        </li>
      `}const o=(await Promise.all(a?.map(async r=>{const c=(await Y(r.id)).userId===e.userId,u=r.description?r.description.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\t/g,"\\t").replace(/\f/g,"\\f").replace(/\v/g,"\\v"):"";return`
          <li class="public-widget-item">
        ...
        `})||[])).join("");console.log("Returning folderWidgetsListHTMLString:",o);const l=document.getElementById("folder-widget-container");return l&&(l.style.display="block",l.innerHTML=o),o}catch(e){console.error("error",e),e?.status===401&&Ae()}}async function ur(){try{const i=await I();if(!i)return[];const e=await te("template_widget","",!1,i.userId,4,999);let n=new H;n.typeConnection="the_widget_template_name",n.name="widgetPName";let t=new H;t.typeConnection="the_widget_template_thumbnail",t.name="widgetThumbnail";let a=new H;a.typeConnection="the_template_widget_s_widget",a.name="widgetLevel",a.inpage=10,a.limit=!0,a.freeschemaQueries=[n,t];let s=new H;return s.conceptIds=[e.id],s.outputFormat=fe,s.name="top",s.freeschemaQueries=[a],new Promise(o=>{ye(s,"").subscribe(l=>{console.log("Template widgets list:",l);const r=[];if(l&&l.length>0){const d=l[0]?.data?.the_template_widget?.the_template_widget_s_widget||[];for(const c of d)if(c?.data?.the_widget&&typeof c.data.the_widget=="object"){const u=c.data.the_widget?.the_widget_template_name?.data?.the_template_name,g=c.data.the_widget?.the_widget_template_thumbnail?.data?.the_template_thumbnail;(u||g)&&r.push({id:c.id||"",name:u||"Unnamed Template",thumbnail:g||""})}}o(r)})})}catch(i){return console.error("Error fetching templates:",i),[]}}async function mr(i,e){i.stopPropagation();try{document.getElementById("rename-widget-dialog")?.remove();const t=document.createElement("dialog");t.setAttribute("id","rename-widget-dialog"),t.classList.add("col-md-3"),t.innerHTML=`
          <h4>Rename Widget</h4>
          <form method="dialog" class="mt-3">
            <div class="mb-3">
        ...
        `;const a=t.querySelector("form");return a&&a.addEventListener("submit",s=>Gi(s,"",e)),document.querySelector("body #app")?.appendChild(t),de("rename-widget-dialog"),"OPENED"}catch(n){console.error("Failed to rename widget:",n)}}async function Gi(i,e="",n){i.preventDefault();let t="";if(e)t=e;else{const r=new FormData(i?.target);if(t=Object.fromEntries(r)?.widgetName,!t?.trim()){const c=i.target.querySelector("#widgetName");c?.focus(),c.style.border="2px solid red",c.style.outline="none",c.addEventListener("input",()=>{c.style.border=""});return}}const s=(await I())?.userId,o=document.getElementById("rename-widget-dialog"),l=o?.querySelector('button[type="submit"]');l.textContent="Saving";try{await $e();const r=await Ke(n,"the_widget_name","name",t,s);await N.SyncDataOnline();const d=o?.querySelector("input"),c=o?.querySelectorAll("button");if(c&&c.forEach(u=>{u.disabled=!0}),d&&(d.disabled=!0),r){q.renderSavedWidgets(),we("rename-widget-dialog"),L.successfullToast("Widget Renamed Successfully");const u=new URLSearchParams(window.location.search).get("widget-id");if(n===Number(u)){const g=document.getElementById("widget-builder");g.textContent=`Widget Builder Panel: ${t}`}return"widget Renamed successfully"}}catch(r){L.errorToast("Widget Rename Failed"),console.error("An error occurred during the rename operation:",r)}}const $n=async(i,e,n=!1)=>{const t=await Ye(i,e),a=t?.data?.the_widget,s=a?.the_widget_name?.[0]?.data?.the_name,o=a?.the_widget_html?.[0]?.data?.the_html,l=a?.the_widget_clean?.[0]?.data?.the_clean,r=a?.the_widget_css?.[0]?.data?.the_css,d=a?.the_widget_js?.[0]?.data?.the_js,c=a?.the_widget_timestamp?.[0]?.data?.the_timestamp,u=a?.the_widget_widget?.[0].id,g=a?.the_widget_type?.[0]?.data?.the_type,m=a?.the_widget_after_render?.[0]?.data?.the_after_render,p=a?.the_widget_before_render?.[0]?.data?.the_bthe_widget_before_render,h=a?.the_widget_update?.[0]?.data?.the_update,v=a?.the_widget_mount_child?.[0]?.data?.the_mount_child;let E=[];const W=a?.the_widget_s_child;return W?.length&&(E=await Promise.all(W?.map(async w=>{const y=w?.data?.the_child_widget,_=y?.the_child_widget_type?.[0]?.data?.the_type,S=y?.the_child_widget_wrapper?.[0]?.data?.the_wrapper,b=y?.the_child_widget_info?.[0]?.data?.id?y?.the_child_widget_info?.[0]?.data?.id:y?.the_child_widget_parent?.[0]?.data?.the_parent,C=await $n(Number(b),e,n);return{id:w?.id,type:_,parent:b,wrapper:S,widget:C}}))),{id:t?.id,name:s,html:o,cleanHtml:l,css:r,js:d,timestamp:c,widgetId:u,typeValue:g,addEvent:m,onMount:p,onUpdate:h,mountChildWidgets:v,childs:E}},gr=async i=>{document.getElementById("assets-upload-loader")?.classList.remove("d-none");const e=await I(),n=e?.entityId,t=e?.userId,a=await Y(n);try{if(i.target?.files?.length>0){const s=[];for(let r=0;r<i.target?.files?.length;r++){const d=i.target?.files[r];if(d.size>2*1024*1024){alert("Max Allowed Size is 2MB");continue}s.push(zi(d))}const o=await Promise.all(s);for(let r=0;r<o.length;r++){const d=o[r];d.success||alert("Some file failed: "+d.message);const c=await te("the_asset",d.url||"",!1,t,4);await V(a,c,"s_asset")}await N.SyncDataOnline(),L.successfullToast(`Asset${o.length>1?"s":""} uploaded successfully`),new nr().setupAssetListener()}else{alert("No file found");return}}catch(s){throw console.error(s),s}document.getElementById("assets-upload-loader")?.classList.add("d-none")},pr=async(i,e)=>{if(confirm("Are you sure you want to delete this asset?"))try{i.target.closest(".asset-item").remove(),await Se(e),L.successfullToast("Asset deleted successfully")}catch(t){console.error("Error deleting asset:",t),L.errorToast("Failed to delete asset")}};function hr(i){const e=document.getElementById(i);if(e){e.value="";const n=new Event("keyup");e.dispatchEvent(n),Qi(i)}}function Qi(i){const e=document.getElementById(i),n=document.getElementById(`${i}-clear`);e&&n&&(n.style.display=e.value?"block":"none",n.style.cursor=e.value?"default":"")}async function fr(i,e,n,t){i.preventDefault(),i.stopPropagation();const a=t.replace(/\\n/g,`
`).split(`
`).join("<br>"),s=`
  ...
  `,o=document.getElementById("widget-detail-modal");o&&o.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",s),de("widget-detail-modal")}window.viewPublicWidgetDetails=fr;window.openCSSEditor=ut;class Zi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let n=function(a){if(!a)return;const{wrapper:s}=a,o=s&&s!=="0"?`#${s}`:".content-target";t=t+`${o} { ${a.css} }`,a.children.forEach(l=>{n(l)})},t="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),n(f.widgetTree),this.styleElement.textContent=t}}async getWidgetHtml(e){let n=[];e.forEach(t=>{t.classList.forEach(a=>{n.push(a)})}),this.insertCSS(n)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:n,dispatch:t}=e,{selection:a}=n;return a.ranges.length===0?!1:(t({changes:{from:a.ranges[0].from,to:a.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new ae({doc:"/* Write your CSS here */",extensions:[Bt,$t,Sa(),Ht(),ae.lineWrapping,Be.tabSize.of(2),Be.allowMultipleSelections.of(!0),ae.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),jt.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),ae.updateListener.of(async n=>{if(n.docChanged){const t=this.editorView?.state.doc.toString()||"";this.updateCSS(t)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const n of e)if(this.editorView){const{state:t,dispatch:a}=this.editorView;a({changes:{from:0,to:t.doc.length,insert:`.${n} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const ri=async i=>{const e=new hi,n=wr(i);if(Object.keys(n).length>0){const t=await e.validateField(n),a=await yn(t),s=yn(a);return br(i,s)}},yr=async i=>{const n=await new hi().validateField(i);return Object.keys(n).length>0?{status:!1,details:yn(n)}:{status:!0}},wr=i=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},n=i?.attributes;if(Array.isArray(n))n.forEach(t=>{const a=vr(t);switch(t.name){case"name":e.fieldName=a||"";break;case"value":e.value=a||null;break;case"fieldtype":e.fieldType=a?a.trim():null;break;case"pattern":e.pattern=a||null;break;case"datatype":e.dataType=a?a.trim():null;break;case"typeconcept":e.conceptType=a||null;break;case"maxlength":e.maxLength=a?parseInt(a):null;break;case"minlength":e.minLength=a?parseInt(a):null;break;case"max":e.maxValue=a?parseInt(a):null;break;case"min":e.minValue=a?parseInt(a):null;break;case"accept":e.accept=a||null;break;case"file":e.file=a||null;break;case"required":e.required=a===!0;break;case"unique":e.isUnique=a===!0;break}});else throw console.error('attributesData["attributes"] is not an array',i.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},vr=i=>{switch(i.type){case"boolean":return i.value==="on";case"array":return i.selected||null;case"string":return i.value||null;default:return null}},yn=i=>({datatype:i.dataType,pattern:i.pattern,max:i.maxValue,min:i.minValue,minlength:i.minLength,maxlength:i.maxLength,accept:i.accept,file:i.file,required:i.required,unique:i.unique}),br=(i,e)=>(i.attributes.forEach(n=>{const t=e[n.name];n.validationStatus=t?"invalid":"valid",n.validationErrorMessage=t||""}),i),_r=i=>({fieldName:i.getAttribute("name"),value:i instanceof HTMLInputElement?i.value:null,fieldType:i.getAttribute("fieldtype"),dataType:i.getAttribute("datatype"),pattern:i.getAttribute("pattern"),conceptType:i.getAttribute("typeconcept"),maxLength:i.getAttribute("maxlength"),minLength:i.getAttribute("minlength"),minValue:i.getAttribute("min"),maxValue:i.getAttribute("max"),file:i.hasAttribute("file"),accept:i.hasAttribute("accept"),required:i.hasAttribute("required"),isUnique:i.getAttribute("unique")==="on"});async function Ki(i){let e=i.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",i.parentNode?.insertBefore(e,i.nextSibling)),e.innerHTML="";const n=_r(i),t=await yr(n);try{if(t.status)i.classList.remove("invalid"),i.classList.add("valid");else if(i.classList.remove("valid"),i.classList.add("invalid"),t.details&&typeof t.details=="object"){const a=document.createElement("span");a.className="error-message",a.style.color="red",a.style.fontSize="12px";const s=Object.values(t.details).filter(Boolean);a.innerHTML=s.join("<br>"),e.appendChild(a)}}catch(a){console.error("Validation error:",a);const s=document.createElement("span");s.className="error-message",s.style.color="red",s.textContent="Validation failed. Please try again.",e.appendChild(s)}}var ze=(i=>(i.STYLE="style",i.BOOLEAN="boolean",i.FORM="form",i.SPECIAL="special",i))(ze||{});const Er=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),Hn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],jn=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],Mt=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Tr=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],kt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],me=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Sr=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Cr=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),Lr=new Set(["elementContent","className","id"]),Yi=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function Je(i){return i.toLowerCase()==="type"?!0:Yi.has(i.toLowerCase())}function vt(i,e,n){const t=i.toLowerCase();if(t==="type"){const a=n?Er.get(n.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):a}return Yi.get(t)||[]}class Zt{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=Pa}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,n){let t,a,s=document.getElementsByClassName("tabcontent");for(t=0;t<s.length;t++)s[t].style.display="none";for(a=document.getElementsByClassName("tablinks"),t=0;t<a.length;t++)a[t].className=a[t].className.replace(" active","");const o=document.getElementById(n);o.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let n=this;for(let t=0;t<e.length;t++)e[t].addEventListener("click",function(a){console.log("buttons[i] -->",e[t]);const s=e[t].getAttribute("data-tab-id");console.log("tabName -->",s),n.openTab(a,s)});e[0].click()}sortAttributes(e){return e.sort((n,t)=>{if(!n?.name||!t?.name)return 0;const a=this.findAttributeInMap(n.name),s=this.findAttributeInMap(t.name);if(a==="Other"&&s!=="Other")return 1;if(a!=="Other"&&s==="Other")return-1;if(a===s){const o=this.categoryMap[a].findIndex(r=>r.toLowerCase()===n.name.toLowerCase()),l=this.categoryMap[s].findIndex(r=>r.toLowerCase()===t.name.toLowerCase());return o-l}return 0})}getCategoryForAttribute(e){if(!e)return"General";const n=e.toLowerCase();for(const[t,a]of Object.entries(this.categoryMap))if(t!=="Other"&&a.some(s=>s.toLowerCase()===n))return t;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,n){setTimeout(()=>{const t=document.getElementById("element-attributes");if(!t){console.warn("Attribute container not found, retrying..."),this.setAttributes(e,n);return}t.innerHTML="";const a=document.createElement("div");if(a.className="row",t.appendChild(a),!e){a.innerHTML="";return}(async()=>await ri(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const o=this.sortAttributes(e.attributes),l={};o.forEach(d=>{const c=this.getCategoryForAttribute(d.name);l[c]||(l[c]=[]),l[c].push(d)});let r="";Object.entries(l).forEach(([d,c])=>{const u=c.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
                ...
                `;else if(m.name==="Alignment"){const h=e?.tag?.toLowerCase();Hn.includes(h)&&(p=`
                  ...
                  <div class="col-12 my-1 hidden">
                    ...
                    >${m?.value||""}</textarea>`;else if(Je(m.name)){console.log("Dropdown attribute detected:",m.name);const h=vt(m.name,m.value,e?.tag);console.log("Options:",h);const v=h.map(E=>`<option value="${E}" ${E===m?.value?"selected":""}>${E}</option>`).join("");p=`
                    <select class="form-select" onchange="updateElementAttribute(event, '${n}', ${e?.id})">
                      <option value="">Select ${m.name}</option>
                      ${v}
                    </select>
            ...
            `}),a.innerHTML=r}}),Et()},0)}setAttributesForMultipleElements(e){const n=async()=>await ri(e);if(!e){const a=document.getElementById("element-attributes").querySelector(".row");a.innerHTML="";return}n().then(()=>{if(e?.attributes&&e?.attributes?.length){const t={};e.attributes.forEach(o=>{const l=this.getCategoryForAttribute(o.name);t[l]||(t[l]=[]),t[l].push(o)});let a="";Object.entries(t).forEach(([o,l])=>{if(l.length){const r=l.map(c=>{let u="";return c?.type==="string"?u=`<input type="text" class="form-control" onchange="updateMultipleElementAttribute(event)" value="${c?.value||""}">`:c?.type==="color"?u=`<input type="color" class="form-control" onchange="updateMultipleElementAttribute(event)" value="${c?.value||"#000000"}">`:c?.type==="boolean"?u=`<input type="checkbox" class="form-check-input" onchange="updateMultipleElementAttribute(event)" ${c?.value&&c?.value!=="false"?"checked":""}>`:c?.type==="array"&&(u=`
            ...
            `}});const s=document.getElementById("element-attributes");s&&(s.innerHTML=a)}})}async getHtml(){window.updateWidgetTypeValue=ta,window.toggleDisplay=ut,window.updateElementAttribute=Kt,window.updateMultipleElementAttribute=aa,window.handlePageProperties=ia,window.updateCSSLibrary=Ve,window.updateJSLibrary=Re,window.addJSLibrary=ra,window.addCSSLibrary=oa,window.openRenameCustomFunction=ot.openRenameCustomFunction,window.deleteCustomFunction=ot.deleteCustomFunction,setTimeout(async()=>{ot.initializeCodeBlock();const a=new Zi,s=document.getElementById("css-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor(),qn()},0),setTimeout(async()=>{await new Wi().initializeEditor()},0),setTimeout(async()=>{const a=new Ai,s=document.getElementById("js-editor-container");s.innerHTML=await a.getHtml(),await a.initializeEditor()},0),setTimeout(async()=>{await new se("onmount-editor-split").initializeEditor(),await new se("onupdate-editor-split").initializeEditor(),await new se("addevents-editor-split").initializeEditor(),await new se("mountchildwidgets-editor-split").initializeEditor();const r=document.getElementById("publish-widget");r&&r.addEventListener("click",async d=>{d.preventDefault();try{await f.publish()}catch(c){console.error("error publishing widget",c),c instanceof Error&&L.errorToast(c.message)}})},0),setTimeout(()=>{this.initializeTabs()},0);const e=this.the_params?.page_id;let n="",t="";if(this.the_params){const a=this.the_params?.data?.the_page_meta_title?.data?.the_meta_title||"";a&&ve("meta_title",a);const s=this.the_params?.data?.the_page_meta_description?.data?.the_meta_description||"";s&&ve("meta_description",s);const o=this.the_params?.data?.the_page_meta_keywords?.data?.the_meta_keywords||"";o&&ve("meta_keywords",o);const l=this.the_params?.data?.the_page_width?.data?.the_width||"";l&&ve("width",l);const r=this.the_params?.data?.the_page_font_size?.data?.the_font_size;r&&ve("font_size",r);const d=this.the_params?.data?.the_page_font_family?.data?.the_font_family;d&&ve("font_family",d);const c=this.the_params?.data?.the_page_type?.data?.the_type;c&&ve("type",c);const u=()=>Array.from({length:13},(p,h)=>12+h).map(p=>{const h=r==p?"selected":"";return`<option value="${p}" ${h}>${p}</option>`}).join(""),g=()=>["Arial","Verdana","Times New Roman","Courier New","Georgia"].map(h=>{const v=d==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join(""),m=()=>["Fluid","Fixed"].map(h=>{const v=c==h.toLowerCase()?"selected":"";return`<option value="${h.toLowerCase()}" ${v}>${h}</option>`}).join("");n=`
    ...
    `}}async function Dn(i){let e=Ln.filter(t=>t.id==i)[0];return!i||i==="null"?void 0:{id:i,attributes:eo,tag:"div",name:`Layout: ${e?.name}`}}async function Wr(){return{id:1,name:"Global",tag:"div",attributes:Ba}}class sn{static editor}function Ar(i,e,n){const t=n?.id,a=document.getElementById("editor");a?.setAttribute("wrapper-id",e),a?.setAttribute("element-id",t),a?.setAttribute("element-clicked","true"),sn.editor&&n?.void?sn.editor.setData(i):n?.void||sn.editor?.setData("")}window.showdWidgetProperties=Mr;window.widgetSelected=Pr;function xr(i,e){let n;if(e.data_type=="layout"){const t=Ln.filter(r=>r.name==e.data_text)[0],l=new DOMParser().parseFromString(t?.html,"text/html").body.querySelector("div");l.setAttribute("element-info-id",i),n=l.outerHTML}else e?.data_void&&e?.data_void!=="undefined"?n=`<${e?.data_type} element-info-id="${i}">${e?.data_default}</${e?.data_type}>`:n=`<${e?.data_type} element-info-id="${i}">`;return`${n}`}async function Mr(i,e){const n=i.target.closest(".added-widget-container"),t=n.id,a=n.getAttribute("data-widgetid");if(a){const T=(await I())?.token,y=(await Ye(Number(a),T))?.data?.the_widget?.the_widget_name?.[0]?.data?.the_name||"";await new Zt().initializeView();const S=document.getElementById("widgetNameValue");S&&(S.value=y)}const o=(await I())?.userId,l=await li(t,o);console.warn("savedWidgetProperties on widget Selected ->",l);let r="";l?.length&&(l?.length>1&&l?.sort((w,y)=>{const _=new Date(w?.created_at).getTime();return new Date(y?.created_at).getTime()-_}),r=l?.[0]?.data?.[t]?.properties?.filter(w=>w.name==="widget-type")?.[0]?.value);const d=document.getElementById("widgetTypeValue");d.setAttribute("data-widgetcontainerid",t),d.setAttribute("data-mainwidgetid",`${e}`),d.value=r;const u=document.querySelector('#onmount-editor .cm-content[data-language="javascript"]')?.textContent,m=document.querySelector('#addevents-editor .cm-content[data-language="javascript"]')?.textContent,h=document.querySelector('#mountchildwidgets-editor .cm-content[data-language="javascript"]')?.textContent,v=document.querySelector(".content-target"),E=new gt;r&&await E.getTypeValueList(r),E.componentDidMountFunction=u,E.addEventFunction=m,E.mountChildWidgetsFunction=h,await E.mount(v)}function kr(){['#onmount-editor .cm-content[data-language="javascript"]','#onupdate-editor .cm-content[data-language="javascript"]','#addevents-editor .cm-content[data-language="javascript"]','#mountchildwidgets-editor .cm-content[data-language="javascript"]'].forEach(t=>{const a=document.querySelector(t);a&&(a.textContent="/* Write your code here */")});const e=document.querySelector('.cm-content[data-language="css"]');e.textContent="/* Write your CSS here */";const n=document.querySelector('.editor-container .cm-content[data-language="javascript"]');n.textContent="/* Write your JavaScript here */"}const Qe=async()=>{const i=document.getElementById("element-info");i.style.display="none"},st=async i=>{const e=i?.target;let n=e?.tagName;const t=e?.classList?.contains("fslayout-row"),a=document.getElementById("element-info");if(!e?.closest(".edited-widget-container")&&e?.closest(".added-widget-container")||e?.classList.contains("added-widget-container"))n="WIDGET",a.classList.add("widget-marker");else if(t)n="Layout Element",a.classList.remove("widget-marker");else if(e?.closest("#widget-details")){n="",a.classList.remove("widget-marker");return}else a.classList.remove("widget-marker");const s=e.getBoundingClientRect(),o=s.left,l=s.top;a.style.display="block",new ResizeObserver(()=>{a.style.width=e.offsetWidth+"px",a.style.height=e.offsetHeight+"px",a.style.top=`calc(${l}px)`,a.style.left=`calc(${o}px)`}).observe(e);const d=document.getElementById("element-info_details");d.innerHTML=`<span>${n}</span>`;const c=document.getElementById("select-box"),u=document.getElementById("builder-workarea");u.addEventListener("scroll",Yn),u.addEventListener("scrollend",()=>{const m=document.getElementById("preview-btn")?.classList.contains("active");c.style.transition="0.2s ease all";const p=document.getElementById("element-info");m||(p.style.display="block"),p.style.height="0",p.style.width="0"}),u.addEventListener("resize",Yn)},Ge=async i=>{i.preventDefault();const e=i.target;ar("navigator-container"),Le.publish("page:elementClick",e);const n=f.selectedStaticWidgetTreeInfo?.widgetTree?f.selectedStaticWidgetTreeInfo?.widgetTree:null;if(e.classList.contains("fslayout-col")||e.classList.contains("mftsccs-marking-element")||e.closest("#widget-details")){console.log("Skipping column selection");return}const t=e.classList.contains("fslayout-row")?e:e.closest(".fslayout-row");console.log("Layout container found:",t);const a=e;console.log("Element to select:",a),R?.previousSelectedStaticElement?.removeAttribute("draggable"),R.staticElement=a,R.previousSelectedStaticElement=R.staticElement,R.staticElement.setAttribute("draggable","true");const s=a.getBoundingClientRect();Ir(e)&&(e.addEventListener("dblclick",()=>{e.contentEditable="true",e.focus()}),e.addEventListener("blur",async()=>{e.contentEditable="false",e.removeAttribute("contentEditable"),R.staticElement=e;const y=e?.tagName.toLowerCase(),b=Xe.staticElementList?.filter(C=>{const A=C?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag;return y===A})?.[0]?.id;Kt(i,"",b)}));const l=s.left,r=s.top;ft.resetNavigationBar();const d=e;let c;e.closest(".added-widget-container")&&!e.closest(".edited-widget-container")?c=e.closest(".added-widget-container"):e.closest(".edited-widget-container")&&(c=e.closest(".edited-widget-container"));const u=e.classList.contains("added-widget-container");if(c||u){let y="";u?y=e?.id:c&&(y=c?.id);const _=[];let S=0;async function b(A,x){return A.reduce((k,P,B)=>(P.wrapper===x&&(k.push(P),S=B),P.children&&P.children.length>0&&b(P.children,x),k),_)}const C=await b(f?.staticWidgetTree?.children,y);f.selectedStaticWidgetTreeInfo={widgetTree:C[0],isChildWidget:!0,childWidgetIndex:S},await X(C[0],!1)}else f.selectedStaticWidgetTreeInfo={widgetTree:f?.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},X(f?.staticWidgetTree,!1);if(d?.id&&(f.updatedWidgets[d.id]=f.selectedStaticWidgetTreeInfo.widgetTree),f.selectedStaticWidgetTreeInfo?.widgetTree?.type){const y=document.getElementById("widgetType");y&&(y.value=f.selectedStaticWidgetTreeInfo?.widgetTree?.type)}const g=document.getElementById("element-attributes"),m=document.querySelector("#icon-attribute span");g&&(!g?.style?.display||g?.style?.display==="none")&&m&&(g.style.display="block",m.textContent="expand_less"),document.querySelectorAll(".tag-name").forEach(y=>y.remove());let h=!1;if(i instanceof KeyboardEvent&&i.ctrlKey){if(d?.classList.contains("added-widget-container")){L.infoMessageToast("Widget can't be selected");return}d?.classList.toggle("widget_selected"),document.querySelectorAll(".widget_selected > *").forEach(_=>{const S=_.parentElement?.classList,b=_?.classList,C=_.firstChild?.classList,A=S&&S.contains("added-widget-container");let k=b&&b.contains("fslayout-row")||C&&C.contains("fslayout-row")?"Layout":_.tagName;if(A||h){h=!0;return}const P=document.createElement("div");P?.classList.add("tag-name"),P.innerHTML=`
        <span class="widget-toolbar" title="tag name">
          ${k}
        </span>
      `,_?.parentElement?.appendChild(P)}),h?(L.infoMessageToast("Widget can't be selected"),d?.classList.toggle("widget_selected"),d?.querySelector(".tag-name")?.remove()):(document.querySelector(".element-options")?.remove(),await Xi());return}const v=document.getElementById("widgetNameValue");if(f?.selectedStaticWidgetTreeInfo?.isChildWidget){const y=f?.selectedStaticWidgetTreeInfo?.widgetTree?.name;v&&y&&(v.value=y)}else v&&(v.value=f?.staticWidgetTree.name);const E=document.getElementById("select-box");E.style.display="block";const W=new ResizeObserver(()=>{E.style.width=e.offsetWidth+"px",E.style.height=e.offsetHeight+"px",E.style.top=`calc(${r}px)`,E.style.left=`calc(${l}px)`}),T=document.getElementById("publishWidgetBtnContainer");if(T){f.widgetTree===f.selectedStaticWidgetTreeInfo.widgetTree?(T.classList.remove("d-none"),T.classList.add("d-flex")):(T.classList.remove("d-flex"),T.classList.add("d-none")),console.log("prev selected widget",n,"now",f.selectedStaticWidgetTreeInfo.widgetTree);try{const y=f.selectedStaticWidgetTreeInfo?.widgetTree||f.widgetTree,_=y.origin||y.id,S=y.version?y.version.toString():"original";typeof q.initializeWidgetVersions=="function"&&q.initializeWidgetVersions(_,S,y?.timestamp)}catch(y){console.error("Error showing widget versions:",y)}}W.observe(e);const w=document.getElementById("edit-widget");if(f?.selectedStaticWidgetTreeInfo?.isChildWidget&&!e.closest(".edited-widget-container")||e.classList.contains("added-widget-container")?w.style.display="block":w.style.display="none",(c||u)&&!e.closest(".edited-widget-container")){const _=document.getElementById("element-attributes").querySelector(".row");_.innerHTML="",qt(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId);return}await It(d)};function Ir(i){return typeof i.contentEditable<"u"&&os.includes(i.tagName.toLowerCase())}async function Pr(i){i.preventDefault(),i.stopPropagation()}async function It(i){let e;if(i?.dataset?.widgetid)return;const n=i?.tagName.toLowerCase(),a=Xe.staticElementList?.filter(u=>{const g=u?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag;return n===g}),s=a?.[0]?.id,o=i.classList.contains("fslayout-row"),l=i?.firstChild?.classList?.contains("fslayout-row");if(o||l)e=await Dn(s),e?.attributes?.length&&(e.attributes=e?.attributes.map(u=>({...u,selected:"",value:u.name==="class"?"":u.value})));else if(s)e=await yt(a);else if(qe.includes(n)||ht.includes(n)){const u=ss.map(g=>{const m=g.name.toLowerCase(),p=me.get(m)||me.get(g.name);return p?{...g,value:i.style[p.property]||""}:{...g,value:m==="classname"?i.className||"":m==="id"&&i.id||""}});n==="iframe"&&u.push({name:"src",type:"string",value:i.getAttribute("src")||""}),qe.includes(n)&&u.push({name:"elementContent",type:"string",value:i.textContent||""}),e={tag:n,attributes:u}}e.attributes=e?.attributes?.map(u=>u?.name?(u.value=ca(i,u.name),u):(console.warn("Found attribute without name:",u),u)).filter(Boolean);let r="";const d=e?.attributes;d?.length&&(r=d?.filter(g=>g?.name==="elementContent")?.[0]?.value,Ar(r,i?.id,e),qt(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),new Zt()?.setAttributes(e,i?.id)}async function Xi(){let i;i=await Wr(),i?.attributes?.length&&(i.attributes=i?.attributes.map(n=>({...n,value:""}))),new Zt()?.setAttributesForMultipleElements(i)}const Br=new Ue;async function $r(i){return new Promise(async e=>{const n=await ea(i);e(n)})}async function ea(i){return new Promise(async e=>{let n=new z;n.composition=i,n.fullLinkers=["the_element","the_element_name","the_element_void","the_element_tag","the_element_s_attribute"],n.inpage=100;let t=new z;t.fullLinkers=["the_attribute","the_attribute_type","the_attribute_name","the_attribute_value"],t.inpage=100;const l=(await he([n,t],""))?.data?.the_element?.the_element_s_attribute?.map(u=>{const g=u?.data?.the_attribute,m=g?.the_attribute_name?.[0]?.data?.the_name,p=g?.the_attribute_type?.[0]?.data?.the_type,h=g?.the_attribute_value?.[0]?.data?.the_value;return{name:m,type:p,value:h}}),r=l?.map(u=>{let g;return u?.type==="string"?g='<input type="text" class="form-control" onchange="updateAttribute(event)">':u?.type==="boolean"?g='<input type="checkbox" class="form-check-input" onchange="updateAttribute(event)">':u?.type==="array"&&(g=`
  ...
  `}async function Yr(i,e){if(i.preventDefault(),!(await Dt.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const t=new FormData(i.target),a=Object.fromEntries(t);console.log(a,"update formValues");const s=await ua(t,e);await Vn("update-element-dialog");const o=await Qt();if(s){const l=document.getElementById("created-elements");l?!o||o.trim()===""?l.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
      `:l.innerHTML=o||"":console.error("Widget list container not found in the DOM.")}return s}class Xr{createElemenModaltHTML;singleElement;constructor(e){e&&this.init(e)}async init(e){this.getSingleElementDetails(e)}async getSingleElementDetails(e){const n=await Nn(e);this.singleElement=n,this.createElemenModaltHTML=this.getHtml(),n&&(document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML),document.getElementById("update-element-dialog").showModal(),await Rn(this.singleElement.attributes))}getHtml(){return window.updateNewElement=Yr,window.closeElementModal=Vn,`<dialog id="update-element-dialog" class="col-md-4 a-dialog update-element-dialog">
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class el{createElemenModaltHTML;constructor(){window._dragService=Xs,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=Gr,window.cancelAttributeRow=ma,window.addAttribute=Qr,window.removeSelectedAttribute=Zr,window.closeElementModal=Vn,`
    ...
    `}}async function de(i){document.getElementById(i).showModal()}async function we(i){const e=document.getElementById(i);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function ga(i,e){i?.stopPropagation();const n=document.getElementById(`menu-${e}`),t=n?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(s=>{s.classList.remove("show")}),n&&!t&&n.classList.add("show")}async function dl(i){new el,await de(i)}async function ul(i,e,n){i.stopPropagation(),console.log("modalId",e),ga(i,Number(n)),new Xr(n)}async function ml(i,e){ga(i,e),confirm("Are you sure you want to delete the element?")&&(await Se(e),L.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const t=await Qt(),a=document.getElementById("created-elements");a?!t||t.trim()===""?a.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
      `:a.innerHTML=t||"":console.error("Elements list container not found in the DOM.")}export{zi as A,el as B,Wn as C,Nr as D,Ee as E,de as F,Ue as P,f as S,tr as T,Xs as _,Bn as a,X as b,ot as c,et as d,nr as e,cn as f,qi as g,Zt as h,D as i,Cn as j,Fn as k,Oe as l,ll as m,je as n,dl as o,ga as p,ul as q,Pt as r,_s as s,L as t,ml as u,$e as v,q as w,we as x,cl as y,rt as z};
