...
import{p as Z,v as Yn,G as Kn,P as Xa,K as M,g as kn,E as ge,a as j,V as Xt,_ as xe,b as St,H as oe,F as z,R as we,N as Eo,c as Aa,d as ei,O as ze,k as To,l as ti,e as D,f as Wa,h as Y,i as se,M as Ae,J as So,j as Ct,t as ni,o as Co,m as De,n as de,q as Ce,U as Lo,r as $e,s as Ne,u as J,D as Mn,Y as ai,w as xo,I as Nt,x as ii,y as wt,z as oi,A as Ao,Q as Zn,T as Wo}from"./mftsccs-browser-Cdhx4EvW.js";import{E as te,b as at,o as it,j as en,a as tn,c as Io,l as Xn,d as ea,e as ko,f as Le,k as nn,h as Mo,g as Po}from"./codemirror-D1H9tReK.js";import{J as an,n as $o}from"./vendor-DEYWGvhS.js";import{z as Bo}from"./eslint4b-BLWGvIOa.js";import{l as ot,p as on,r as sn,a as No,b as jo}from"./prettier-ClL2wQep.js";import{C as Do}from"./ckeditor-Cw9bcqxY.js";const Ho=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return so},get addJSLibrary(){return ro},get applyPageProperties(){return Qn},get applyPageProperty(){return Ee},get filterChildrenByWrapper(){return no},get getAttributeType(){return gc},get getAttributeValue(){return co},get getElementAttribute(){return ic},get getElementAttributeDetails(){return Ea},get getElementData(){return eo},get getLayoutAttributeValue(){return uo},get getPropertiesByIdFromStorage(){return It},get handleDirectContentEdit(){return oc},get handlePageProperties(){return ao},get initializeApp(){return vn},get initializeLibrary(){return Ta},get listJSLibraries(){return kt},get removeCSSLibrariesFromHead(){return Yt},get removeJSLibrariesFromHead(){return Sa},get setAttributeValue(){return hc},get toggleSpacingBox(){return Ca},get updateAttribute(){return rc},get updateCSSLibrary(){return Qe},get updateElementAttribute(){return yn},get updateElementAttributeViaEditor(){return sc},get updateJSLibrary(){return Ye},get updateMetaTag(){return Tt},get updateMultipleElementAttribute(){return io},get updateWidgetTypeValue(){return to}},Symbol.toStringTag,{value:"Module"}));(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const U={baseURL:"https://boomconsole.com/api/v1",baseNodeUrl:"https://boomconsole.com",boomURL:"https://boomconsole.com",aiURL:"https://www.ai.freeschema.com/api",deployURL:"https://deploy.freeschema.com",agentURL:"https://wico-ai.freeschema.com",CLIENT_ID:"636550695311-ctc09991hhu6iav4kkhnp1ge537nec2i.apps.googleusercontent.com",logserver:"https://logger.freeschema.com",enableSW:!1,discussion_community:101765915,ai_widget:101934087,visual_prototype_widget:101938499,video_tutorial_widget:102040172,subscriptionId:102121109,documentation_preview_widget:102097744,folder_widget:102400016,assets_widget:102410590,VITE_DEV_BASE:"http://localhost:5173",VITE_CDN_BASE:"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master"},Oo=U?.boomURL;async function q(n,e,t){const a=await Z(`the_${n}`,"",!0,e,4,999);for(const[i,o]of Object.entries(t)){let s=i;const r=await Z(`${s}`,`${o}`,!1,e,4,999);await H(a,r,s)}return a}async function H(n,e,t){const a=n.userId,i=999,o=999,s=n.type?.characterValue,r=t,l=s+"_"+r,u=await Yn(l,i,o,a);await Kn(n.id,e.id,u.id,1e3)}async function qo(n,e){try{const t=new Headers;return t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),await(await fetch(`${Oo}/api/get-entity-from-user?userConceptId=${n}`,{method:"GET",headers:t,redirect:"follow"})).json()}catch(t){throw console.error(t),t}}async function Yc(n){const e=await qo(n?.data?.userConcept,n?.data?.token);let t={token:n?.data?.token,refreshToken:n?.data?.refreshtoken,email:n?.data?.email,userId:n?.data?.entity?.[0]?.userId,userConcept:n?.data?.userConcept,entityId:e?.entity,amcode:btoa(JSON.stringify(n?.data?.roles))};return Xa(t.token),localStorage.setItem("profile",JSON.stringify(t)),!0}async function k(){return new Promise(n=>{let e=localStorage?.getItem("profile")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}async function si(){return new Promise(n=>{let e=localStorage?.getItem("tempwidget")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}const Fo=U?.baseNodeUrl;class Te{static instance;static getInstance(){return Te.instance||(Te.instance=new Te),Te.instance}async getLoginInfo(){const e=await k(),t=await this.checkIfUserIsAdmin(e?.userConcept);let a="",i=!1,o=!1;if(e?.token){i=!0;let s="",r="";if(e?.entityId){let l=new M;l.typeConnection="the_entity_firstname",l.name="entity_firstname";let u=new M;u.typeConnection="the_entity_lastname",u.name="entity_lastname";let c=new M;c.typeConnection="the_entity_tour_status",c.name="entity_tour_status";let d=new M;d.type="the_entity",d.name="top",d.conceptIds=[e.entityId],d.freeschemaQueries=[l,u,c],d.outputFormat=kn;let g;await ge(d,"").subscribe(m=>{g=m}),s=g?.[0]?.the_entity?.the_entity_firstname?.the_firstname||"",r=g?.[0]?.the_entity?.the_entity_lastname?.the_lastname||"",o=g?.[0]?.the_entity?.the_entity_tour_status?.the_tour_status==="true"}a=`
      ...
      `;return{loginInfoHTML:a,isLoggedIn:i,isAdmin:t,tourStatus:o}}async checkIfUserIsAdmin(e){try{return(await j(e))?.accessId===3}catch(t){return console.error("Error fetching user concept:",t),!1}}async logout(){const e=await si();await Xt(e?.id),localStorage.removeItem("profile"),localStorage.removeItem("tempwidget"),location.reload()}async checkAndUpdateToken(){try{const e=await k();if(!e?.token){console.warn("No token found in local storage.");return}const t=e.token,a=e.refreshToken,i=new Headers;i.append("Content-Type","application/json");const o={accessToken:t,refreshToken:a},r=await(await fetch(`${Fo}/api/Auth/refresh`,{method:"POST",headers:i,body:JSON.stringify(o)})).json();if(r.success&&r.data){const{accessToken:l,refreshToken:u}=r.data;e.token=l,e.refreshToken=u,localStorage.removeItem("profile"),localStorage.setItem("profile",JSON.stringify(e))}else this.logout()}catch(e){console.error("Error refreshing token:",e)}}}const Vo=Te.getInstance();(function(){const e=window.fetch;window.fetch=async(...t)=>{const a=t[1]||{};try{const i=await e(...t);if(i.status===401){console.warn("401 Unauthorized - Refreshing token"),await Vo.checkAndUpdateToken();const o=await k();if(!o?.token)return console.error("Token refresh failed. User not logged in."),i;if(a.headers){const s=new Headers(a.headers);s.set("Authorization",`Bearer ${o.token}`),s.has("Content-Type")||s.set("Content-Type","application/json"),a.headers=s}return e(t[0],a)}return i}catch(i){throw console.error("Intercepted Fetch Error:",i),i}}})();const Ro="modulepreload",Uo=function(n){return"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master/"+n},Ia={},pe=function(e,t,a){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=s?.nonce||s?.getAttribute("nonce");i=Promise.allSettled(t.map(l=>{if(l=Uo(l),l in Ia)return;Ia[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":Ro,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((g,m)=>{d.addEventListener("load",g),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return i.then(s=>{for(const r of s||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function Pn(n,e=0){let t=`<ul style="list-style: none; margin: 10px 0px; ${e==0?" padding-left: 0px; ":""}" id="sortable-list">`;for(let a=0;a<n.length;a++){const i=n[a];i.edit?t+=`
            ...
            `:t+=`
                ...
                <li>${i.menus?`${Pn(i.menus,e+1)}`:""}</li>
            `}return t+="</ul>",t}function lt(n){console.log("menus",n);const e=Pn(n),t=document.getElementById("menu-items");t&&(t.innerHTML=e);let a=null;document.querySelectorAll("#sortable-list li").forEach(i=>{i.addEventListener("dragstart",o=>{a=i,o.dataTransfer.effectAllowed="move"}),i.addEventListener("dragover",o=>{o.preventDefault(),i.classList.add("drag-over")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-over")}),i.addEventListener("drop",o=>{o.preventDefault(),i.classList.remove("drag-over"),a!==i&&!i.contains(a)&&i?.parentNode?.insertBefore(a,i.nextSibling)}),i.addEventListener("dragend",()=>{document.querySelectorAll(".drag-over").forEach(o=>o.classList.remove("drag-over"))})})}async function ri(n){console.log("projectId",n);let e;if(n||(e=di()),!n&&!e?.projectId)return console.log("Project Id not found"),[];if(!n&&e.projectId&&(n=e?.projectId),console.log("projectId 2",n),!n)return[];const t=["the_item_menu_name","the_item_menu_link","the_item_menu_action","the_item_menu_auth","the_item_menu_order","the_item_menu_page"],a=new M;a.typeConnection="the_menu_s_item",a.selectors=t;function i(c,d=5){if(d==5)return;const g=new M;g.typeConnection="the_menu_s_item",g.selectors=t,c.name=d.toString(),c.freeschemaQueries=[g];const m=d+1;i(g,m)}const o=new M;o.conceptIds=[n],i(o,1);const s=await xe(o,"");console.log("valllu",s);const r=s?.[0]?.the_project?.the_menu_s_item||[],l=(c=[])=>{let d=[];for(let g=0;g<c.length;g++){const m=c[g];d.push({name:m?.the_item_menu?.the_item_menu_name?.the_name??"",link:m?.the_item_menu?.the_item_menu_link?.the_link??"",action:m?.the_item_menu?.the_item_menu_action?.the_action??"",page:m?.the_item_menu?.the_item_menu_page?.the_page?Number(m?.the_item_menu?.the_item_menu_page?.the_page):"",order:m?.the_item_menu?.the_item_menu_order?.the_order?Number(m?.the_item_menu?.the_item_menu_order?.the_order):0,auth:m?.the_item_menu?.the_item_menu_auth?.the_auth=="true",menus:l(m?.the_item_menu?.the_menu_s_item)??[]})}return d.sort((g,m)=>g.order-m.order)};return l(r)}async function zo(n,e=[]){console.log("menus",e);const t=await new St;try{await t.initialize();const a=await j(n);await oe(n,"the_menu_s_item"),await li(a,e,t),await t.commitTransaction(),console.log("output concept",n)}catch(a){console.error(a),await t.rollbackTransaction()}}async function li(n,e=[],t){for(let a=0;a<e.length;a++){const i=e[a],o=await t.MakeTheInstanceConceptLocal("the_item_menu","",!0,999,4);await t.CreateConnection(n,o,"the_menu_s_item");for(let[s,r]of Object.entries(i))if(console.log("key",s,r),!!["name","link","action","auth","order","page","menus"].includes(s)&&!(s=="menus"&&!Array.isArray(r)))if(s=="menus")await li(o,r,t);else{const u=await t.MakeTheInstanceConceptLocal("the_"+s,r,!0,999,4);await t.CreateConnection(o,u,"the_item_menu_"+s)}}}const Jo=async()=>{const n=U.enableSW;"serviceWorker"in navigator&&n&&await new Promise((e,t)=>{navigator.serviceWorker.register("/sw.js").then(a=>{a.addEventListener("updatefound",()=>{const i=a.installing;i?.addEventListener("statechange",()=>{i.state==="installed"&&navigator.serviceWorker.controller&&(i.postMessage("skipWaiting"),setTimeout(()=>{confirm("A reload is required to update to latest")&&window.location.reload()},500))})}),e(void 0)}).catch(a=>{console.error("Service Worker Init error",a),t(a)}),setTimeout(()=>{t()},3e4)})},ci="wico_site";function di(){const n=atob(localStorage.getItem(ci)||"");return n?JSON.parse(n):{}}function ui(n,e){const t=di();t[n]=e,localStorage.setItem(ci,btoa(JSON.stringify(t)))}function mi(){window.wico={fetchMenus:ri}}async function Go(){await Jo()}const I={PAGE_COMP_NAME:"page",WIDGET_COMP_NAME:"widget",PROJECT_COMP_NAME:"project"},ie={ENTITY_PAGE_LINKER:"s_page",PAGE_WIDGET_LINKER:"body",ENTITY_PROJECT_LINKER:"s_project",PROJECT_PAGE_LINKER:"s_page"},Lt=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],ta=[{name:"accept",type:"string"},{name:"action",type:"string"},{name:"alt",type:"string"},{name:"autocomplete",type:"boolean",value:"on"},{name:"checked",type:"boolean"},{name:"cols",type:"string"},{name:"disabled",type:"boolean"},{name:"download",type:"string"},{name:"draggable",type:"boolean"},{name:"for",type:"string"},{name:"hidden",type:"boolean"},{name:"href",type:"string"},{name:"label",type:"string"},{name:"loading",type:"array",value:"eager,lazy",default:"eager"},{name:"max",type:"string"},{name:"maxlength",type:"string"},{name:"media",type:"string"},{name:"method",type:"array",value:"get,post,dialog"},{name:"min",type:"string"},{name:"minlength",type:"string"},{name:"multiple",type:"boolean"},{name:"muted",type:"boolean"},{name:"name",type:"string"},{name:"pattern",type:"string"},{name:"placeholder",type:"string"},{name:"readonly",type:"boolean"},{name:"rel",type:"string"},{name:"required",type:"boolean"},{name:"rows",type:"string"},{name:"selected",type:"boolean"},{name:"size",type:"string"},{name:"src",type:"string",value:""},{name:"start",type:"string"},{name:"style",type:"string"},{name:"title",type:"string"},{name:"target",type:"array",value:"_blank,_self,_parent,_top"},{name:"type",type:"array"},{name:"value",type:"string"},{name:"wrap",type:"array",value:"soft, hard"},{name:"width",type:"string",value:""}],$n=[{name:"className",type:"string",value:""},{name:"id",type:"string",value:""}],Qo=[{name:"className",type:"string",value:""},{name:"Width",type:"string",value:""},{name:"Height",type:"string",value:""},{name:"Background Color",type:"color",value:"#FFFFFF"},{name:"Color",type:"color",value:"#000000"},{name:"Margin",type:"string",value:""},{name:"Padding",type:"string",value:""}];let ka=[],Ma=[];async function Yo(n){let e="";for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t)){const a=n[t];e+=` ${t}="${a}" `}return e}async function Ko(n,e){const t=new z;t.composition=n,t.fullLinkers=["the_widget_html","the_widget_css","the_widget_js"];const a=await we([t],e),i=a?.data?.the_widget?.the_widget_html?.[0]?.id,o=a?.data?.the_widget?.the_widget_css?.[0]?.data.the_widgetCSS,s=a?.data?.the_widget?.the_widget_js?.[0]?.data.the_widgetJS;if(!i)return{html:"",css:"",js:""};const r=await Eo(i,["contain_s"]);ka=await Aa(r.externalConnections),Ma=await Aa(r.internalConnections);let l=await gi(i,ka,Ma);const u=document.createElement("div");return u.innerHTML=l,{html:(u?.querySelector(".widget-wrapper")).innerHTML,css:o||"",js:s||""}}async function gi(n,e,t){try{let a="",o=Xo(e)[n];if(o!=null){let s=es(o);const l=(await Ji())?.map(g=>{const m=g?.id,p=g?.data?.the_element?.the_element_name?.[0]?.data?.the_name,h=g?.data?.the_element?.the_element_tag?.[0]?.data?.the_tag,w=g?.data?.the_element?.the_element_void?.[0]?.data?.the_void,C=g?.data?.the_element?.the_element_s_attribute?.map(T=>{const v=T?.data?.the_attribute,y=v?.the_attribute_name?.[0]?.data?.the_name,E=v?.the_attribute_type?.[0]?.data?.the_type,L=v?.the_attribute_value?.[0]?.data?.the_value;return{name:y,type:E,value:L}});return{id:m,name:p,tag:h,void:w,attributes:C}}),u=[...ta,...$n],d=(await k())?.userId;for(let g=0;g<s.length;g++){const m=s[g];if(m.ofTheConceptId==n){const p=await Zo(m.toTheConceptId,t),h=Object.keys(p.data)[0],w=p.data[h],b=Lt.includes(h),C=await Yo(w?.attributes||[]),T=l.find(y=>y.tag===h.toLowerCase().trim()),v=w?.attributes;for(const y in v){const E=u.find(S=>y===S?.name?.toLowerCase().trim()),L=v[y],_=E?.type;T.attributes=T?.attributes?.map(S=>(S?.name==="className"&&y==="class"?S.value=L:S?.name==="elementContent"?S.value=w?.innerText:y===S?.name&&(_==="array"?S.selected=L:_==="boolean"?S.value="":S.value=L),S))}if(h!="text"){const y=await ei(p.id,d);y?.length&&await Xt(y?.[0]?.id);const E={[`wdgt${p.id}`]:T},L=await ze(E,null,null,null,d);console.log("elementAttributeComp ->",L),a+=`
  ...
  ondragstart="_dragService.dragStartWidgetElement(event)" data-elementid="${T?.id}">
          ...
          `}catch(e){return console.error("error",e),e?.status===401&&Pe(),`
            <li class="list-unstyled">
...
`;m?.file(`${d.slug}.index.ts`,p)}e?.file("routes.ts",mn(t))},Wr=async(n,e,t)=>{console.log("widgetsDir",t);const i=(await k())?.token,o=await wa(n,i,!0);let s=e?.folder("home");const r=`
...
`;s?.file("home.index.ts",r),o?.css&&s?.file("home.style.css",o?.css)},Ir=async n=>{if(ue)return;ue=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new an;const a=await pn(t),i=a?.widgetsDir,o=a?.pagesDir;let s="";i&&o&&(s=await kr(n,o)),a?.routesDir?.file("routes.ts",mn(e)),t.generateAsync({type:"blob"}).then(function(r){let l=document.createElement("a");l.href=URL.createObjectURL(r),l.download=`${s||"page"}.zip`,l.click()}),ue=!1},kr=async(n,e)=>{const t=await k(),a=t?.entityId,i=t?.token,o=await wa(n,i,!0),s=new z;s.composition=a,s.inpage=100,s.fullLinkers=["the_entity_s_page"];const r=new z;r.inpage=100,r.composition=n,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const u=(await we([s,r],i))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==n),c=u?.[0]?.data?.the_page?.the_page_body?.[0]?.id,d=u?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    ...
    `;return g?.file("home.index.ts",m),o?.css&&g?.file("home.style.css",o?.css),d},Mr=async n=>{if(ue)return;if(!n){console.log("Project id is required");return}const i=(await new gn().getProjectById(n))?.data?.the_project?.the_project_name?.[0]?.data?.the_name?.replace(/\s/g,"_").toLowerCase();ue=!0;let o=new an;const s=await pn(o),r=s?.routesDir,l=s?.pagesDir;await Pr(l,r,n),o.generateAsync({type:"blob"}).then(function(u){let c=document.createElement("a");c.href=URL.createObjectURL(u),c.download=`the_${i}.zip`,c.click()}),ue=!1},Pr=async(n,e,t)=>{if(!n&&!e)return;let a=[];const o=(await k())?.token,s=new z;s.composition=t,s.inpage=100,s.fullLinkers=["the_project_s_page","the_project_main_page"];const r=new z;r.inpage=100,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const l=await we([s,r],o),u=l?.data.the_project?.the_project_main_page?.[0]?.id;if(l?.data.the_project?.the_project_s_page?.length)for(let c=0;c<l?.data.the_project?.the_project_s_page?.length;c++){const d=l.data.the_project.the_project_s_page[c];let g={page:d?.id,title:d?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:d?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:d?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:d?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:d?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:d?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!g.page)continue;const m=`${g.slug.split("-").map((w,b)=>b===0?w.charAt(0).toLowerCase()+w.slice(1):w.charAt(0).toUpperCase()+w.slice(1)).join("")}`;a.push({path:`/${g.slug}`,content:`${m}Index`,importFrom:`/${g.slug}/${g.slug}.index.ts`}),g.page==u&&a.push({path:"/",content:`${m}Index`});let p=n?.folder(g.slug);const h=`
                ...
                }`;p?.file(`${g.slug}.index.ts`,h)}e?.file("routes.ts",mn(a))};async function $r(){const n=new ae("mountchildwidgets-editor-split"),e=document.getElementById("mountchildwidgets-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Br(){const n=new ae("onupdate-editor-split"),e=document.getElementById("onupdate-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Mi(){await $r(),await Br(),await Es(),await Ts()}function Nr(){document.getElementById("widget-lifecycle-form")?.remove(),document.createElement("div").setAttribute("id","widget-lifecycle-form")}function Pi(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.add("saveWidgetDisabled")})}function Vn(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.remove("saveWidgetDisabled")})}class $i{arrowBtn=null;updateOnlyButton=null;isDroppedDown=!1;constructor(){}async LoadPageWidget(e){const a=(await k())?.token;na(),Pi(),document.querySelector("#widget-properties #widget-type input")?.remove(),Nr(),await Mi();let o=aa(),s=await ke(e,a),r=await de(s?.widgetId??e),l=await Ce(r,o);this.addPageUpdate(e),Vn(),f.resetWidgetTree(),f.widgetTree=r,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),ee(r,!1,l,!0),$.enableWidgetButtons(),cn(),me(),ye()}toggleUpdate(e){this.updateOnlyButton&&this.arrowBtn&&(this.isDroppedDown&&e!==!0?(this.updateOnlyButton.classList.remove("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.updateOnlyButton.classList.add("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isDroppedDown=!this.isDroppedDown)}addPageUpdate(e){const t=document.getElementById("widget-btn-wrapper");t.innerHTML=`
        <div class="position-relative" style="z-index: 100;">
          <div class="w-100 d-flex justify-content-center">
    ...
    `,e){this.the_params=e,this._pageBuilderService=new $i;const a=this.the_params?.data?.the_page_title?.data?.the_title;this.component_heading=this.the_params.type?"Page Builder: "+a:"Widget Builder";const i=this.the_params?.page_id;t&&e.type==la.page&&(this.saveBoomButtonHTML=`
         <div class="text-end d-flex flex-row" id="widget-btn-wrapper">
...
`}before_render(){this.render()}after_render(){if(this.the_params){document.getElementById("fspage-save-button").addEventListener("click",ca);const t=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!t){cn();return}this._pageBuilderService.LoadPageWidget(Number(t))}}getHtml(){return window.openSaveWidgetModal=fa,window.saveWidget=Ri,window.updateWidget=ya,window.newWidget=Ue,window.previewWidget=nl,window.downloadWebsite=Lr,window.moveUp=Se.moveUp,window.moveDown=Se.moveDown,window.copyElement=Se.copyElement,window.editWidget=Se.editWidget,window.openConvertModal=ol,window.convertToWidget=al,window.updatePage=da,window.previewPage=Dr,window.undoAction=N.undoAction,window.redoAction=N.redoAction,window.saveWidgetToFolderBtn=Or,window.openPromptModal=Hs,window.openAIModal=Ci,window.refineAIData=qn,`
    ...
    `,document.querySelector("body #app")?.appendChild(i),re("rename-project-dialog"),"Rename Project Modal"}async getProjectPagesListHTML(e){try{const t=await this._projectsService.getProjectById(e),a=t?.data?.the_project?.[`the_project_${ie.PROJECT_PAGE_LINKER}`],i=t?.data?.the_project?.the_project_main_page?.[0]?.id;return a?.length?a?.map(s=>{let r=s?.data?.[`the_${I.PAGE_COMP_NAME}`]?.[`the_${I.PAGE_COMP_NAME}_title`]?.[0]?.data?.the_title;const l=i==s.id,u=l?'<span class="material-symbols-outlined home-icon">home</span>':"",c=l?"":`<li class="d-flex align-items-center justify-content-between" 
          ...
          `}catch(t){return console.error("error",t),t?.status===401&&Pe(),`
            <li class="list-unstyled">
              <p class="text-center my-3 text-secondary">Sorry, couldn't connect to server.</p>
            </li>
...
.custom-menu-item {
  ...
  `}async function Xr(n,e){if(n.preventDefault(),!(await Te.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const a=new FormData(n.target),i=Object.fromEntries(a);console.log(i,"update formValues");const o=await qi(a,e);await pa("update-element-dialog");const s=await hn();if(o){const r=document.getElementById("created-elements");r?!s||s.trim()===""?r.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
      `:r.innerHTML=s||"":console.error("Widget list container not found in the DOM.")}return o}class el{createElemenModaltHTML;singleElement;constructor(e){e&&this.init(e)}async init(e){this.getSingleElementDetails(e)}async getSingleElementDetails(e){const t=await Ea(e);this.singleElement=t,this.createElemenModaltHTML=this.getHtml(),t&&(document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML),document.getElementById("update-element-dialog").showModal(),await ha(this.singleElement.attributes))}getHtml(){return window.updateNewElement=Xr,window.closeElementModal=pa,`<dialog id="update-element-dialog" class="col-md-4 a-dialog update-element-dialog">
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class tl{createElemenModaltHTML;constructor(){window._dragService=dr,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=Qr,window.cancelAttributeRow=Fi,window.addAttribute=Yr,window.removeSelectedAttribute=Kr,window.closeElementModal=pa,`
    ...
    `}}async function re(n){document.getElementById(n).showModal()}async function ve(n){const e=document.getElementById(n);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function Vi(n,e){n?.stopPropagation();const t=document.getElementById(`menu-${e}`),a=t?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(o=>{o.classList.remove("show")}),t&&!a&&t.classList.add("show")}async function Xc(n){new tl,await re(n)}async function ed(n,e,t){n.stopPropagation(),console.log("modalId",e),Vi(n,Number(t)),new el(t)}async function td(n,e){Vi(n,e),confirm("Are you sure you want to delete the element?")&&(await Ae(e),A.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const a=await hn(),i=document.getElementById("created-elements");i?!a||a.trim()===""?i.innerHTML=`
      ...
      `:i.innerHTML=a||"":console.error("Elements list container not found in the DOM.")}async function fa(){Dt(),document.getElementById("save-widget-dialog")?.remove();const e=document.createElement("dialog");return e.setAttribute("id","save-widget-dialog"),e.classList.add("col-md-3"),e.innerHTML=`
  ...
  `,document.body.appendChild(o);const s=o.querySelector("#pasteArea"),r=o.querySelector("#widgetThumbnail"),l=o.querySelector("#imagePreview img"),u=o.querySelector("#imagePreview"),c=o.querySelector("#pasteText");function d(p){const h=new FileReader;h.onload=w=>{l&&w.target?.result&&(l.src=w.target.result,u.classList.remove("d-none"),c.classList.add("d-none"))},h.readAsDataURL(p)}r?.addEventListener("change",p=>{const h=p.target.files?.[0];h&&d(h)});function g(p){const h=p.clipboardData?.items;if(h){for(let w=0;w<h.length;w++)if(h[w].type.indexOf("image")!==-1){const b=h[w].getAsFile();if(b&&r){const C=new DataTransfer;C.items.add(b),r.files=C.files,d(b);break}}}}s?.addEventListener("paste",p=>g(p)),o.addEventListener("paste",p=>g(p)),o.querySelector("#post-widget-form")?.addEventListener("submit",p=>{p.preventDefault(),Ml(e,o)}),o.showModal()}async function Ml(n,e){const t=document.querySelector(`#spinner-${n}`),a=e.querySelector('button[type="submit"]');try{a&&(a.disabled=!0,a.textContent="Posting...",A.infoMessageToast("Posting Widget to Public...",0)),t&&t.classList.remove("d-none"),await qe();const i=await k(),o=document.getElementById("widgetPublicName").value,s=document.getElementById("widgetDescription").value,r=document.getElementById("widgetThumbnail");if(!r?.files?.length)throw console.error("File validation failed:",{inputExists:!!r,filesLength:r?.files?.length}),new Error("Please provide a thumbnail image");const l=r.files?.[0];if(!l||!r.value)throw new Error("Please provide a thumbnail image");const u=await zi(l);if(!u.success)throw new Error("Failed to upload thumbnail");const c=await ke(n,i.token);if(c&&(await Ne(c.widgetId,"the_public_widget_s_widget",!0)).length){document.querySelector(".infoMessageToast")?.remove(),A.infoMessageToast("Widget is already public.");return}const d=document.getElementById("postAsTemplate")?.checked;let g=null;if(c)g=await j(c.widgetId);else{const C=await Y(n);g=await $.createWidgetCopy(C,i.userId,i.token)}const m=await Z("public_name",o,!1,i.userId,4,999),p=await Z("description",s,!1,i.userId,4,999),h=await Z("thumbnail",u.url||"no attachment",!1,i.userId,4,999);await H(g,p,"description"),await H(g,h,"thumbnail"),await H(g,m,"public_name");const w=await Z("public_widget","",!1,i.userId,4,999);if(await H(w,g,"s_widget"),d){const T=await Z("template_name",o,!1,i.userId,4,999),v=await Z("template_thumbnail",u.url||"no attachment",!1,i.userId,4,999);await H(g,v,"template_thumbnail"),await H(g,T,"template_name");const y=await Z("template_widget","",!1,i.userId,4,999);await H(y,g,"s_widget")}await D.SyncDataOnline(),await $.renderPublicWidgets(),await $.renderSavedWidgets(),d&&await $.renderTemplateLayouts(),e.close(),document.querySelector(".infoMessageToast")?.remove(),setTimeout(()=>{A.successfullToast(`Widget Posted to Public${d?" and Templates":""}`)},300)}catch(i){console.error("Error posting widget:",i),document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Failed to post widget"),a&&(a.disabled=!1,a.textContent="Post Widget")}finally{t&&t.classList.add("d-none")}}async function Jn(n=""){try{const e=await k();if(!e)return`
    ...
    `}catch(e){console.error("error",e),e?.status===401&&Pe()}}async function Pl(n=""){try{const e=await k();if(!e)return`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary">No Folder widget</p>
        </li>
...
`).join("<br>"),o=`
  ...
  `,s=document.getElementById("widget-detail-modal");s&&s.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",o),re("widget-detail-modal")}window.viewPublicWidgetDetails=Hl;window.openCSSEditor=Et;class Yi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let t=function(i){if(!i)return;const{wrapper:o}=i,s=o&&o!=="0"?`#${o}`:".content-target";a=a+`${s} { ${i.css} }`,i.children.forEach(r=>{t(r)})},a="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),t(f.widgetTree),this.styleElement.textContent=a}}async getWidgetHtml(e){let t=[];e.forEach(a=>{a.classList.forEach(i=>{t.push(i)})}),this.insertCSS(t)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:t,dispatch:a}=e,{selection:i}=t;return i.ranges.length===0?!1:(a({changes:{from:i.ranges[0].from,to:i.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new te({doc:"/* Write your CSS here */",extensions:[at,it,Po(),tn(),te.lineWrapping,Le.tabSize.of(2),Le.allowMultipleSelections.of(!0),te.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),nn.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),te.updateListener.of(async t=>{if(t.docChanged){const a=this.editorView?.state.doc.toString()||"";this.updateCSS(a)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const t of e)if(this.editorView){const{state:a,dispatch:i}=this.editorView;i({changes:{from:0,to:a.doc.length,insert:`.${t} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const Ra=async n=>{const e=new oi,t=ql(n);if(Object.keys(t).length>0){const a=await e.validateField(t),i=await Gn(a),o=Gn(i);return Vl(n,o)}},Ol=async n=>{const t=await new oi().validateField(n);return Object.keys(t).length>0?{status:!1,details:Gn(t)}:{status:!0}},ql=n=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},t=n?.attributes;if(Array.isArray(t))t.forEach(a=>{const i=Fl(a);switch(a.name){case"name":e.fieldName=i||"";break;case"value":e.value=i||null;break;case"fieldtype":e.fieldType=i?i.trim():null;break;case"pattern":e.pattern=i||null;break;case"datatype":e.dataType=i?i.trim():null;break;case"typeconcept":e.conceptType=i||null;break;case"maxlength":e.maxLength=i?parseInt(i):null;break;case"minlength":e.minLength=i?parseInt(i):null;break;case"max":e.maxValue=i?parseInt(i):null;break;case"min":e.minValue=i?parseInt(i):null;break;case"accept":e.accept=i||null;break;case"file":e.file=i||null;break;case"required":e.required=i===!0;break;case"unique":e.isUnique=i===!0;break}});else throw console.error('attributesData["attributes"] is not an array',n.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},Fl=n=>{switch(n.type){case"boolean":return n.value==="on";case"array":return n.selected||null;case"string":return n.value||null;default:return null}},Gn=n=>({datatype:n.dataType,pattern:n.pattern,max:n.maxValue,min:n.minValue,minlength:n.minLength,maxlength:n.maxLength,accept:n.accept,file:n.file,required:n.required,unique:n.unique}),Vl=(n,e)=>(n.attributes.forEach(t=>{const a=e[t.name];t.validationStatus=a?"invalid":"valid",t.validationErrorMessage=a||""}),n),Rl=n=>({fieldName:n.getAttribute("name"),value:n instanceof HTMLInputElement?n.value:null,fieldType:n.getAttribute("fieldtype"),dataType:n.getAttribute("datatype"),pattern:n.getAttribute("pattern"),conceptType:n.getAttribute("typeconcept"),maxLength:n.getAttribute("maxlength"),minLength:n.getAttribute("minlength"),minValue:n.getAttribute("min"),maxValue:n.getAttribute("max"),file:n.hasAttribute("file"),accept:n.hasAttribute("accept"),required:n.hasAttribute("required"),isUnique:n.getAttribute("unique")==="on"});async function Ki(n){let e=n.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",n.parentNode?.insertBefore(e,n.nextSibling)),e.innerHTML="";const t=Rl(n),a=await Ol(t);try{if(a.status)n.classList.remove("invalid"),n.classList.add("valid");else if(n.classList.remove("valid"),n.classList.add("invalid"),a.details&&typeof a.details=="object"){const i=document.createElement("span");i.className="error-message",i.style.color="red",i.style.fontSize="12px";const o=Object.values(a.details).filter(Boolean);i.innerHTML=o.join("<br>"),e.appendChild(i)}}catch(i){console.error("Validation error:",i);const o=document.createElement("span");o.className="error-message",o.style.color="red",o.textContent="Validation failed. Please try again.",e.appendChild(o)}}var Ze=(n=>(n.STYLE="style",n.BOOLEAN="boolean",n.FORM="form",n.SPECIAL="special",n))(Ze||{});const Ul=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),va=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],ba=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],Jt=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],zl=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Gt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],fe=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Jl=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Gl=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),Ql=new Set(["elementContent","className","id"]),Zi=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function mt(n){return n.toLowerCase()==="type"?!0:Zi.has(n.toLowerCase())}function Pt(n,e,t){const a=n.toLowerCase();if(a==="type"){const i=t?Ul.get(t.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):i}return Zi.get(a)||[]}class fn{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=Ho}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,t){zt.staticTabName=t;let a,i,o=document.getElementsByClassName("tabcontent");for(a=0;a<o.length;a++)o[a].style.display="none";for(i=document.getElementsByClassName("tablinks"),a=0;a<i.length;a++)i[a].className=i[a].className.replace(" active","");const s=document.getElementById(t);s.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let t=this;for(let i=0;i<e.length;i++)e[i].addEventListener("click",function(o){const s=e[i].getAttribute("data-tab-id");t.openTab(o,s)});const a=document.querySelector(`button[data-tab-id='${zt.staticTabName}']`);a?a.click():e[0].click()}sortAttributes(e){return e.sort((t,a)=>{if(!t?.name||!a?.name)return 0;const i=this.findAttributeInMap(t.name),o=this.findAttributeInMap(a.name);if(i==="Other"&&o!=="Other")return 1;if(i!=="Other"&&o==="Other")return-1;if(i===o){const s=this.categoryMap[i].findIndex(l=>l.toLowerCase()===t.name.toLowerCase()),r=this.categoryMap[o].findIndex(l=>l.toLowerCase()===a.name.toLowerCase());return s-r}return 0})}getCategoryForAttribute(e){if(!e)return"General";const t=e.toLowerCase();for(const[a,i]of Object.entries(this.categoryMap))if(a!=="Other"&&i.some(o=>o.toLowerCase()===t))return a;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,t){setTimeout(()=>{const a=document.getElementById("element-attributes");if(!a){this.setAttributes(e,t);return}a.innerHTML="";const i=document.createElement("div");if(i.className="row",a.appendChild(i),!e){i.innerHTML="";return}(async()=>await Ra(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const s=this.sortAttributes(e.attributes),r={};s.forEach(u=>{const c=this.getCategoryForAttribute(u.name);r[c]||(r[c]=[]),r[c].push(u)});let l="";Object.entries(r).forEach(([u,c])=>{const d=c.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
                ...
                `;else if(m.name==="Alignment"){const h=e?.tag?.toLowerCase();va.includes(h)&&(p=`
                  ...
                  `)}else if(m.name==="Font Family"){const h=e?.tag?.toLowerCase();if(ba.includes(h)&&mt(m.name)){const b=Pt(m.name,m.value,e?.tag).map(C=>{const T=C.toLowerCase()===(m?.value||"").replace(/"/g,"").trim().toLowerCase();return`<option value="${C}" ${T?"selected":""}>${C}</option>`}).join("");p=`
