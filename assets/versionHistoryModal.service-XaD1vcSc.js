import{g as D,d$ as N,u as F,dV as $}from"./mftsccs-browser-H83tvbKv.js";import{S as M,g as B,o as W,R as O,U as P,W as I,t as k,l as J}from"./index-DzL6aS5b.js";import{r as R,u as U}from"./vendor-vUhUC0ZM.js";import"./codemirror-B6qdlLvx.js";import"./eslint4b-BLWGvIOa.js";import"./prettier-ClL2wQep.js";import"./ckeditor-Cw9bcqxY.js";const z=["html","css","js","after_render","before_render","update","mount_child"],_=(s,n)=>z.map(e=>{const i=s?.[e]||"",t=n?.[e]||"",r=R(i,t);return{field:e,changed:r.some(o=>o.added||o.removed),changes:r}});async function K(s,n,e){M.staticWidgetTree={...M.staticWidgetTree,...e};const i=await M.updateWidget(n);if(!i)throw new Error("Failed to save the merged version.");const t=await B(),r=await D("merged_from",String(s),!1,t?.userId,4,999);return await N(i,r,"merged_from"),await F.SyncDataOnline(),i}const Q=["html","css","js","after_render","before_render","update","mount_child"],X=["library","assistant","custom_functions","children","type","dependency"],C=s=>s.slice(1);function Y(s,n,e,i,t){const r=U(n,e,s);let o=!1;const f=[],d=m=>m.startsWith("\\"),c=m=>m.startsWith("-");for(const m of r.hunks)for(const l of m.lines)if(typeof l=="string"){if(c(l)||d(l))continue;f.push(C(l))}else if(l?.conflict){o=!0;const g=l.mine.filter(a=>!c(a)&&!d(a)).map(C),u=l.theirs.filter(a=>!c(a)&&!d(a)).map(C);f.push(`<<<<<<< current (v${i})`,...g,"=======",...u,`>>>>>>> incoming (v${t})`)}return{text:f.join(`
...
`)}if(Array.isArray(n)&&Array.isArray(e)){const i=o=>o?.id??o?.slug??o?.url??JSON.stringify(o),t=new Set,r=[];for(const o of[...n,...e]){const f=String(i(o));t.has(f)||(t.add(f),r.push(o))}return r}return n&&e&&typeof n=="object"&&typeof e=="object"&&!Array.isArray(n)?"css"in n||"js"in n?{css:q({...s,currentValue:n.css||[],sourceValue:e.css||[]}),js:q({...s,currentValue:n.js||[],sourceValue:e.js||[]})}:{...n,...e}:e??n}const x=(s,n)=>{if(s===n)return!0;try{return JSON.stringify(s??null)===JSON.stringify(n??null)}catch{return!1}};async function Z(s,n,e="current",i="incoming"){const t=await G(s,n);if(t==null)throw new Error("Could not find a common ancestor between these versions.");if(t===n)return{status:"up-to-date",merged:{},conflicts:[],ancestorId:t};const[r,o,f]=await Promise.all([$(t),$(s),$(n)]),d={},c=[];for(const l of Q){const g=r?.[l]||"",u=o?.[l]||"",a=f?.[l]||"",h=u!==g;if(!(a!==g))d[l]=u;else if(!h)d[l]=a;else if(u===a)d[l]=u;else{const y=Y(g,u,a,e,i);y.hasConflict?c.push({field:l,kind:"text",currentValue:u,sourceValue:a,lineMergedPreview:y.text}):d[l]=y.text}}for(const l of X){const g=r?.[l],u=o?.[l],a=f?.[l],h=!x(u,g);!x(a,g)?h?x(u,a)?d[l]=u:c.push({field:l,kind:"opaque",currentValue:u,sourceValue:a}):d[l]=a:d[l]=u}return{status:t===s?"fast-forward":c.length?"conflict":"merged",merged:d,conflicts:c,ancestorId:t}}function ee(){return window.toggleVersionSelection=ne,window.compareSelectedVersions=se,window.openMergePanel=re,window.closeMergePanel=ce,window.scrollToVersion=te,`
  ...
  `}let w=[],S=new Map;async function we(){const s=M.staticWidgetTree,n=s.origin||s.id;w=[];const e=ee(),i=document.createElement("div");i.innerHTML=e;const t=i.querySelector("#version-history-container");document.querySelector("body #app")?.appendChild(t),await W("version-history-container"),await j(n,s.id)}async function j(s,n){const e=document.getElementById("version-history-list");if(e)try{const i=await O(s),t=Array.from(i.values()).sort((r,o)=>Number(o.widgetVersion||0)-Number(r.widgetVersion||0));if(S=new Map(t.map(r=>[r.widgetId,r])),!t.length){e.innerHTML=`
      ...
      `;return}const m=c.conflicts.length>0,l=await $(o),g=_(l,c.merged).filter(a=>a.changed&&Object.prototype.hasOwnProperty.call(c.merged,a.field));let u="";m?(u+=`
