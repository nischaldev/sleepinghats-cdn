import{m as M}from"./mainView.class-C4NLGCWW.js";import{f as q,N as T,F as f,o as C,g as I,t as x,A as B,H as D,O as R}from"./index-olvssgtg.js";import{L as E,s as O,r as k,S as A,a as F}from"./loginModal.service-Z7ESDWCV.js";class _{constructor(){this.init()}init(){const r=this.getHtml();document.querySelector("body #app")?.insertAdjacentHTML("afterend",r);const e=document.getElementById("change-password-dialog");e&&e.querySelectorAll(".password-toggle").forEach(t=>{t.addEventListener("click",()=>{const i=t.getAttribute("data-target"),s=e.querySelector(`#${i}`);s&&(s.type==="password"?(s.type="text",t.textContent="visibility"):(s.type="password",t.textContent="visibility_off"))})})}getHtml(){return`
