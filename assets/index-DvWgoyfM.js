const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home.index-B6q1jDiH.js","assets/mainView.class-C4NLGCWW.js","assets/navbar.component-Df7SX9Gf.js","assets/loginModal.service-C1fbHyIC.js","assets/mftsccs-browser-nXWLCvq0.js","assets/loginModal-DGhNYttL.css","assets/vendor-DEYWGvhS.js","assets/ckeditor-Cw9bcqxY.js","assets/vendor-TRZluGMH.css","assets/codemirror-D1H9tReK.js","assets/eslint4b-BLWGvIOa.js","assets/prettier-ClL2wQep.js","assets/home-YrckE8O1.css","assets/preview.index-CStG-CXK.js","assets/page-preview.index-DZnkG0mO.js","assets/page-preview-BJCVd99J.css","assets/documentation.index-B5bSrTn0.js","assets/highlight-CFrhCzdo.js","assets/highlight-ZgkIHsf0.css","assets/documentation-CtKxHXjz.css","assets/subscription.index-CFd6zL9f.js","assets/subscription-Dc24vCVe.css","assets/video-tutorial.index-D_XmZqye.js","assets/video-tutorial-Dg46rKRD.css","assets/community.index-BDc19LWC.js","assets/community-CARjtQbC.css","assets/initialLoadWICO-D7Rw3Xb1.js"])))=>i.map(i=>d[i]);
import{p as K,v as Yn,G as Kn,P as Xa,K as M,g as kn,E as me,a as H,V as Xt,_ as xe,b as Ct,H as le,F as J,R as be,N as Eo,c as Aa,d as ei,O as Ue,k as To,l as ti,e as O,f as Wa,h as Y,i as se,M as Ae,J as So,j as Lt,t as ni,o as Co,m as De,n as ue,q as Ce,r as $e,s as Ne,Y as ze,u as G,D as Mn,w as ai,x as Lo,I as Nt,y as ii,z as oi,A as xo,Q as Zn,T as Ao}from"./mftsccs-browser-nXWLCvq0.js";import{E as te,b as it,o as ot,j as en,a as tn,c as Wo,l as Xn,d as ea,e as Io,f as Le,k as nn,h as ko,g as Mo}from"./codemirror-D1H9tReK.js";import{J as an,n as Po}from"./vendor-DEYWGvhS.js";import{z as $o}from"./eslint4b-BLWGvIOa.js";import{l as st,p as on,r as sn,a as Bo,b as No}from"./prettier-ClL2wQep.js";import{C as jo}from"./ckeditor-Cw9bcqxY.js";const Do=Object.freeze(Object.defineProperty({__proto__:null,get addCSSLibrary(){return so},get addJSLibrary(){return ro},get applyPageProperties(){return Qn},get applyPageProperty(){return Ee},get filterChildrenByWrapper(){return no},get getAttributeType(){return dc},get getAttributeValue(){return co},get getElementAttribute(){return tc},get getElementAttributeDetails(){return Ea},get getElementData(){return eo},get getLayoutAttributeValue(){return uo},get getPropertiesByIdFromStorage(){return It},get handleDirectContentEdit(){return nc},get handlePageProperties(){return ao},get initializeApp(){return vn},get initializeLibrary(){return Ta},get listJSLibraries(){return kt},get removeCSSLibrariesFromHead(){return Yt},get removeJSLibrariesFromHead(){return Sa},get setAttributeValue(){return mc},get toggleSpacingBox(){return Ca},get updateAttribute(){return ic},get updateCSSLibrary(){return Qe},get updateElementAttribute(){return yn},get updateElementAttributeViaEditor(){return ac},get updateJSLibrary(){return Ye},get updateMetaTag(){return St},get updateMultipleElementAttribute(){return io},get updateWidgetTypeValue(){return to}},Symbol.toStringTag,{value:"Module"}));(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const U={baseURL:"https://boomconsole.com/api/v1",baseNodeUrl:"https://boomconsole.com",boomURL:"https://boomconsole.com",aiURL:"https://www.ai.freeschema.com/api",deployURL:"https://deploy.freeschema.com",agentURL:"https://wico-ai.freeschema.com",CLIENT_ID:"636550695311-ctc09991hhu6iav4kkhnp1ge537nec2i.apps.googleusercontent.com",logserver:"https://logger.freeschema.com",enableSW:!1,discussion_community:101765915,ai_widget:101934087,visual_prototype_widget:101938499,video_tutorial_widget:102040172,subscriptionId:102121109,documentation_preview_widget:102097744,folder_widget:102400016,assets_widget:102410590,VITE_DEV_BASE:"http://localhost:5173",VITE_CDN_BASE:"https://cdn.jsdelivr.net/gh/nischaldev/sleepinghats-cdn@master"},Ho=U?.boomURL;async function F(n,e,t){const a=await K(`the_${n}`,"",!0,e,4,999);for(const[i,o]of Object.entries(t)){let s=i;const r=await K(`${s}`,`${o}`,!1,e,4,999);await q(a,r,s)}return a}async function q(n,e,t){const a=n.userId,i=999,o=999,s=n.type?.characterValue,r=t,l=s+"_"+r,u=await Yn(l,i,o,a);await Kn(n.id,e.id,u.id,1e3)}async function Oo(n,e){try{const t=new Headers;return t.append("Content-Type","application/json"),t.append("Authorization",`Bearer ${e}`),await(await fetch(`${Ho}/api/get-entity-from-user?userConceptId=${n}`,{method:"GET",headers:t,redirect:"follow"})).json()}catch(t){throw console.error(t),t}}async function Jc(n){const e=await Oo(n?.data?.userConcept,n?.data?.token);let t={token:n?.data?.token,refreshToken:n?.data?.refreshtoken,email:n?.data?.email,userId:n?.data?.entity?.[0]?.userId,userConcept:n?.data?.userConcept,entityId:e?.entity,amcode:btoa(JSON.stringify(n?.data?.roles))};return Xa(t.token),localStorage.setItem("profile",JSON.stringify(t)),!0}async function k(){return new Promise(n=>{let e=localStorage?.getItem("profile")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}async function si(){return new Promise(n=>{let e=localStorage?.getItem("tempwidget")||"";if(e){const t=JSON.parse(e);n(t)}else n()})}const qo=U?.baseNodeUrl;class Te{static instance;static getInstance(){return Te.instance||(Te.instance=new Te),Te.instance}async getLoginInfo(){const e=await k(),t=await this.checkIfUserIsAdmin(e?.userConcept);let a="",i=!1,o=!1;if(e?.token){i=!0;let s="",r="";if(e?.entityId){let l=new M;l.typeConnection="the_entity_firstname",l.name="entity_firstname";let u=new M;u.typeConnection="the_entity_lastname",u.name="entity_lastname";let c=new M;c.typeConnection="the_entity_tour_status",c.name="entity_tour_status";let d=new M;d.type="the_entity",d.name="top",d.conceptIds=[e.entityId],d.freeschemaQueries=[l,u,c],d.outputFormat=kn;let g;await me(d,"").subscribe(m=>{g=m}),s=g?.[0]?.the_entity?.the_entity_firstname?.the_firstname||"",r=g?.[0]?.the_entity?.the_entity_lastname?.the_lastname||"",o=g?.[0]?.the_entity?.the_entity_tour_status?.the_tour_status==="true"}a=`
  ...
  ondragstart="_dragService.dragStartWidgetElement(event)" data-elementid="${T?.id}">
            <${h} data-cc-id="${p.id}" `+C+`${b?"/></div>":">"}`,a+=await gi(m.toTheConceptId,e,t)}(w.contains=="false"||h=="text")&&(a+=" "+w.innerText+" "),!b&&h!="text"&&(a+=`</${h}></div>`)}}}return a}catch(a){console.error("error converting html",a)}}async function Ko(n,e){var t=[],a={},i=e;t=i;for(var o=[],s=0;s<t.length;s++)o.includes(t[s].ofTheConceptId)||o.push(t[s].ofTheConceptId);var r=await H(n);if(r.id==0&&n!=null&&n!=null){var l=await H(n);r=l}var u=await To(n,t,o),c=r?.type?.characterValue??"";a[c]=u;var d={};return d.data=a,d.id=n,d}function Zo(n){return n.reduce((e,t)=>{const{ofTheConceptId:a}=t;return e[a]||(e[a]=[]),e[a].push(t),e},{})}function Xo(n){const e=new Map;n.forEach(o=>{e.set(o.id,o)});const t=[],a=new Set,i=o=>{if(!a.has(o.id)){a.add(o.id),t.push(o);for(const s of n)s.orderId==o.id&&i(s)}};return n.forEach(o=>{o.orderId==1e3&&i(o)}),t}async function Gc(){return"WICO"}async function Pe(){const n=await si();await Xt(n?.id),localStorage.removeItem("profile"),localStorage.removeItem("tempwidget"),await bo("/"),setTimeout(()=>{document.body.style.overflow=""},1e3)}async function es(n,e){var t=[];try{var a=new Headers;a.append("Content-Type","application/json"),a.append("Authorization",`Bearer ${e}`),a.append("Randomizer",ti.BASE_RANDOMIZER.toString());const i=await fetch(U.baseNodeUrl+"/api/v1/local-concepts-translate",{method:"POST",headers:a,body:JSON.stringify({id:n})});return i.ok?await i.json():(console.log("recursive search error ",i.status),t)}catch(i){console.log(i)}}async function pi(n,e,t=1e3,a){const i=n.userId,l=await Yn("contain_s",999,999,i);return await Kn(n.id,e.id,l.id,t)}const ts="the_widget";async function ns(n,e,t){return await as(n,e,t)}async function as(n,e,t){const o=new DOMParser().parseFromString(n,"text/html").body,s=await Ue({[ts]:{}});e&&await is(e,s),t&&await os(t,s);const r=await Ue({widgetHTML:{}});await q(s,r,"html");const l=await hi(o.children[0],r);return await pi(r,l),await O.SyncDataOnline(),s}async function is(n,e){const a=(await k())?.userId,o=await K("the_widgetCSS",n,!0,a,4,999);await q(e,o,"css")}async function os(n,e){const a=(await k())?.userId,o=await K("the_widgetJS",n,!0,a,4,999);await q(e,o,"js")}async function hi(n,e){console.log("parentConcept ->",e);const t={};if(t.tagName=n?.tagName?.toLowerCase(),n?.attributes?.length>0){t.attributes={};for(let o of n.attributes)t.attributes[o.name]=o.value}n?.textContent?.trim()&&(t.text=n.textContent.trim());let a={[t.tagName?t.tagName:"text"]:{contains:n?.children?.length?"true":"false",attributes:t.attributes||"",innerText:n?.children?.length?"":t.text||""}};const i=await Ue(a);if(n?.childNodes?.length>0){t.children=[];let o=[],s=-1,r,l;for(let c of n.childNodes)if(!(c.nodeType===Node.TEXT_NODE&&c.textContent?.trim()==="")&&!(n.children.length===0&&c.nodeType===Node.TEXT_NODE)){if(c.nodeType===Node.TEXT_NODE){let d={text:{contains:!1,attributes:"",innerText:c.textContent?.trim()}};const g=await Ue(d);o.push({parentConcept:i,childConcept:g,orderId:l})}else c.nodeType===Node.ELEMENT_NODE&&(r=await hi(c,i),o.push({parentConcept:i,childConcept:r,orderId:l}));s>=0&&(o[s]={...o[s],orderId:r?.id}),s++}let u=1e3;for(let c=0;c<o.length;c++){const d=o[c];u=(await pi(d.parentConcept,d.childConcept,u)).id}}return i}const ss="widget-conceptualizer",rs="0.0.0",ls="module",cs={dev:"vite --config vite.config.js --force",build:"tsc && vite build --config vite.config.prod.js",preview:"vite preview"},ds={"@types/codemirror":"^5.60.15",codemirror:"^6.0.1",typescript:"^5.2.2",vite:"^5.3.1","vite-plugin-commonjs":"^0.10.4","vite-plugin-compression":"^0.5.1"},us={"@ckeditor/ckeditor5-build-classic":"^44.0.0","@codemirror/autocomplete":"^6.18.0","@codemirror/lang-css":"^6.3.1","@codemirror/lang-html":"^6.4.9","@codemirror/lang-javascript":"^6.2.3","@codemirror/lint":"^6.8.4","@codemirror/state":"^6.5.2","@codemirror/theme-one-dark":"^6.1.2","@codemirror/view":"^6.36.3","@react-oauth/google":"^0.12.1","eslint4b-prebuilt":"^6.7.2","highlight.js":"^11.11.1",jszip:"^3.10.1",marked:"^15.0.6","marked-highlight":"^2.2.1","mftsccs-browser":"^2.1.179-beta",prettier:"^3.3.3","shepherd.js":"^14.5.0"},Pa={name:ss,private:!0,version:rs,type:ls,scripts:cs,devDependencies:ds,dependencies:us};function ms(n,e,t,a){switch(t){case"int":n=n.sort(function(i,o){return parseInt(i[e])>parseInt(o[e])?1:parseInt(i[e])<parseInt(o[e])?-1:0});break;default:n=n.sort(function(i,o){return i[e].toLowerCase()>o[e].toLowerCase()?1:i[e].toLowerCase()<o[e].toLowerCase()?-1:0})}}function Bn(n){let e={};for(let t=0;t<n.length;t++){const a=n[t];a?.type&&a?.type!=="submit"&&(e[a.name]=a?.value)}return e}function gs(n){const e=Pa.dependencies||{},t=Pa.devDependencies||{};return e[n]||t[n]||null}async function nt(n,e,t,a,i){await le(n,e);const o=await K(t,a,!1,i,4,999);let s=await Yn(e,999,999,i);return await Kn(n,o?.id,s.id,1e3,s.characterValue,i),"Delete and update completed"}class Ke{async generateSlug(e){const t=await k();let a=new J;a.composition=t?.entityId,a.fullLinkers=["the_entity_s_page"],a.inpage=100;let i=new J;i.fullLinkers=["the_page_slug"],i.inpage=100;const o=[a,i];let s=e.toLowerCase().replace(/ /g,"-").replace(/[^a-zA-Z0-9-]/g,"");return await Wa(o,"",kn).subscribe(r=>{const l=r?.the_entity?.the_entity_s_page?.map(d=>d?.the_page?.the_page_slug?.[0]?.the_page_slug)||[];let u=s,c=s.match(/^(.*?)(?:-(\d+))?$/);if(c){u=c[1];let g=(c[2]?parseInt(c[2],10):0)+1;for(;l.includes(s);)s=`${u}-${g++}`}}),s}async checkSlugAvailablity(e){const t=await k();let a=new J;a.composition=t?.entityId,a.fullLinkers=["the_entity_s_page"],a.inpage=100;let i=new J;i.fullLinkers=["the_page_slug"],i.inpage=100;const o=[a,i];let s=!0;return await Wa(o,"",kn).subscribe(r=>{(r?.the_entity?.the_entity_s_page?.map(u=>u?.the_page?.the_page_slug?.[0]?.the_page_slug)||[]).includes(e)&&(s=!1)}),s}async savePage(e,t,a){const i=await F(I.PAGE_COMP_NAME,t,e),o=await Y(a);return await q(o,i,re.ENTITY_PAGE_LINKER),i}async renamePage(e,t,a){return await nt(Number(t),"the_page_title","title",e?.title,a),await nt(Number(t),"the_page_slug","slug",e?.slug,a),"renamed"}async getAllPages(e){const t=await k(),a=t?.token;let i=new J;e?i.composition=e:i.composition=t.entityId,i.fullLinkers=[`the_entity_${re.ENTITY_PAGE_LINKER}`],i.inpage=100;let o=new J;return o.fullLinkers=[`the_${I.PAGE_COMP_NAME}_title`,`the_${I.PAGE_COMP_NAME}_slug`,`the_${I.PAGE_COMP_NAME}_body`],o.inpage=100,(await be([i,o],a))?.data?.the_entity?.[`the_entity_${re.ENTITY_PAGE_LINKER}`]}async _getPageById(e){const t=await k();if(!t?.token)return null;const a=t?.token;let i=new J;i.composition=e,i.fullLinkers=[`the_${I.PAGE_COMP_NAME}_title`,`the_${I.PAGE_COMP_NAME}_slug`,`the_${I.PAGE_COMP_NAME}_meta_title`,`the_${I.PAGE_COMP_NAME}_meta_description`,`the_${I.PAGE_COMP_NAME}_meta_keywords`,`the_${I.PAGE_COMP_NAME}_width`,`the_${I.PAGE_COMP_NAME}_type`,`the_${I.PAGE_COMP_NAME}_font_family`,`the_${I.PAGE_COMP_NAME}_font_size`,`the_${I.PAGE_COMP_NAME}_body`],i.inpage=100;let o=new J;return o.fullLinkers=[`the_${I.WIDGET_COMP_NAME}_clean`],o.inpage=100,await be([i,o],a)}async isPageTemplate(e){const t=new M;t.name="template",t.typeConnection="the_website_template_page",t.reverse=!0;const a=new M;return a.name="page",a.conceptIds=[e],a.freeschemaQueries=[t],a.outputFormat=se,((await xe(a,""))?.[0]?.data?.the_website_template_page_count||0)>0}async getPageById(e){return new Promise(async t=>{const i=(await k())?.token||"";let o=new M;o.conceptIds=[e],o.outputFormat=se,o.selectors=[`the_${I.PAGE_COMP_NAME}_title`,`the_${I.PAGE_COMP_NAME}_slug`,`the_${I.PAGE_COMP_NAME}_meta_title`,`the_${I.PAGE_COMP_NAME}_meta_description`,`the_${I.PAGE_COMP_NAME}_meta_keywords`,`the_${I.PAGE_COMP_NAME}_width`,`the_${I.PAGE_COMP_NAME}_type`,`the_${I.PAGE_COMP_NAME}_font_family`,`the_${I.PAGE_COMP_NAME}_font_size`,`the_${I.PAGE_COMP_NAME}_body`,`the_${I.WIDGET_COMP_NAME}_clean`],o.inpage=100,me(o,i).subscribe(async s=>{if(s.length)t(s?.[0]);else if(!Array.isArray(s)&&s?.data==null){const r="There is no data.";A.infoMessageToast(r,4),t({error:!0,message:r})}}).catch(s=>{const r=s?.message;A.errorToast(`${r}`,4),t({error:!0,message:r})})})}async updatePageField(e,t,a){const i=await k(),o=`the_${I.PAGE_COMP_NAME}_${e}`;await le(a,o);const s=await H(a),r=await K(`${e}`,`${t}`,!1,i.userId,4,999);await q(s,r,e),await O.SyncDataOnline()}async deletePage(e){await Ae(e)}}class fi{_pagesService;constructor(){this._pagesService=new Ke}async getPagesListHTML(){window.pageHandler=Or;try{let e=await this._pagesService.getAllPages();return e?.length?e?.map(a=>{let i=a?.data?.[`the_${I.PAGE_COMP_NAME}`],o=i?.[`the_${I.PAGE_COMP_NAME}_title`]?.[0]?.data?.the_title,s=i?.[`the_${I.PAGE_COMP_NAME}_slug`]?.[0].data?.the_slug;return`
            <li class="page-item">
...
${t?.css}`:t?.css;if(await vi(o,s),pe(n?.html),await wi(n?.after_render),await bi(n?.before_render),n?.custom_functions?.length){const r=document.querySelectorAll(".custom-service-btn"),l=Array.from(r)?.map(d=>d.getAttribute("data-subtab")??""),u=n.custom_functions?.map(d=>d.slug);(l?.filter(d=>!u.includes(d))).forEach(d=>{const g=document.querySelector(`.custom-service-btn[data-subtab="${d}"]`);g&&g.remove(),document.getElementById(`${d}-editor-split`)?.remove()}),ja(),n.custom_functions?.forEach(d=>{Si(d)})}else document.querySelectorAll(".custom-service-btn").forEach(u=>{u.remove()}),document.querySelectorAll(".custom-editor-content").forEach(u=>{u.remove()}),ja();(a||i)&&rn(n?.origin?n?.origin:n?.widgetId),a&&n?.assistant?.id&&Vs(n?.assistant)}const Fn="drop-indicator";function xi(){let n=document.querySelector(`.${Fn}`);return n||(n=document.createElement("div"),n.className=Fn,document.body.appendChild(n)),n}function Us(n,e){const t=xi(),a=n.getBoundingClientRect();e==="top"?t.style.top=`${a.top-5}px`:e==="bottom"&&(t.style.top=`${a.bottom-5}px`),t.style.left=`${a.left}px`,t.style.width=`${a.width}px`,t.style.opacity="1",t.style.transform="scaleY(1)"}function Ai(){document.querySelectorAll(`.${Fn}`).forEach(e=>{e.classList.add("hiding"),setTimeout(()=>{e.remove()},100)})}function zs(n,e,t){if(e.length===0)return{element:t,position:"top"};const a=n.clientY;let i=e[0],o=Math.abs(i.getBoundingClientRect().top-a);Math.abs(i.getBoundingClientRect().bottom-a);for(const u of e){const c=u.getBoundingClientRect(),d=Math.abs(c.top-a);Math.abs(c.bottom-a),d<o&&(i=u,o=d)}const s=i.getBoundingClientRect(),r=s.top+s.height/2,l=a<r?"top":"bottom";return{element:i,position:l}}async function je(n){const e=document.querySelectorAll("link.vde-css");e?.length&&e?.forEach(a=>{a.remove()});const t=document.querySelectorAll("script.vde-js");if(t?.length&&t?.forEach(a=>{a.remove()}),await vn(n),n?.children?.length)for(const a of n?.children){const i=a?.library;i?.css?.length&&i?.css?.forEach(o=>{const s=o?.url,r=document.createElement("link");r.classList.add("vde-css"),r.setAttribute("rel","stylesheet"),r.setAttribute("href",s),document.head.appendChild(r)}),i?.js.length&&i?.js?.forEach(async o=>{await new Promise((s,r)=>{const l=o?.url,u=document.createElement("script");u.classList.add("vde-js"),u.setAttribute("type","text/javascript"),u.setAttribute("src",l),u.setAttribute("crossorigin","anonymous"),u.onload=()=>{s()},u.onerror=c=>{console.error("Failed to load script:",l,c),r(new Error(`Failed to load script: ${l}`))},document.body.appendChild(u)})})}}let Q=null,ie;function cn(){const n=document.querySelector(".content-target > .mftsccs-marking-element");if(n){const e=document.querySelector(".content-target");Se.fixContentTargetHeight(e,n)}}function Js(n){Q=n.target;const e=n.target;let t={data_type:n.target.getAttribute("data-type"),data_default:n.target.getAttribute("data-default"),data_void:n.target.getAttribute("data-void"),data_text:n.target.getAttribute("data-text"),elementId:n.target.getAttribute("data-elementId"),dataId:n.target.id,imageUrl:e.imageUrl,displayType:e.displayType};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.setData("id",n.target.id),n.dataTransfer.effectAllowed="move"}async function Gs(n){n.stopPropagation();const e=n.target,t={widgetcodeId:n.target.getAttribute("data-widgetId"),sourceElementId:n.target.id,className:n.target.className,imageUrl:e.imageUrl,displayType:e.displayType,type:e.Type};n.dataTransfer.setData("text",JSON.stringify(t)),n.dataTransfer.effectAllowed="move"}function Qs(n){n.preventDefault(),n.stopPropagation(),n.target.classList.add("dragging-area"),Wt.collapseNavbar();const e=document.getElementById("select-box");e.style.display="none",hs()}function Ys(n){n.preventDefault(),n.stopPropagation(),n.target.classList.remove("dragging-area")}function Ks(n){n.preventDefault(),n.stopPropagation(),(!Q||!(n.currentTarget instanceof HTMLElement))&&(Q=n?.target);const e=n.target,t=Array.from(e.children).filter(i=>i!==Q);xi();const a=zs(n,t,e);ie=a,Us(a.element,a.position)}function Zs(){j.checkContent()?j.enableWidgetButtons():j.disableWidgetButtons()}async function Xs(n){const e=await dn(n);Q=null,Ai(),D.updateActionHistories(),Wt.collapseNavbar(),Zs(),cn(),ge(),e&&(pe(),rn(f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:f.staticWidgetTree?.widgetId)),ve()}function Ft(n,e){return Array.isArray(n?.children)&&(n.children=n?.children.filter(t=>t?.wrapper!==e),n.children.forEach(t=>Ft(t,e))),n}function Ge(n,e){let t;return Array.isArray(n?.children)&&(t=n?.children.filter(a=>a?.wrapper===e),n.children.forEach(a=>Ge(a,e))),t?.[0]}async function er(n){n.preventDefault(),n.stopPropagation(),["general","size","spacing","display","typography","borders","colors"].forEach(d=>{const g=document.getElementById(`${d}-content`);if(g&&g.style.display==="block"){const m={target:g.previousElementSibling};Tt(m,`${d}-content`)}});const t=document.getElementById("element-attributes");if(t&&t.style.display==="block"){const d={target:document.querySelector("#icon-attribute")};Tt(d,"element-attributes")}const a=V.staticElement,i=a?.parentElement,o=i?.parentElement,s=o?.dataset?.widgetid,r=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container"),l=a.querySelectorAll(".added-widget-container");if(a?.classList?.contains("added-widget-container")){const d=a?.id;Ft(f?.staticWidgetTree,d)}else l.length&&l.forEach(d=>{const g=d?.id;Ft(f?.staticWidgetTree,g)});if(r){const d=r.id;if(a?.remove(),V.staticElement.remove(),Dt(),a?.classList?.contains("added-widget-container")){const g=Ge(f?.staticWidgetTree,d);if(g){const m=r.querySelector(".mftsccs-marking-element");g.html=m?.innerHTML,Z(g)}}else{const m=document.getElementById(d).querySelector(".mftsccs-marking-element");f.selectedStaticWidgetTreeInfo.widgetTree.html=m?.innerHTML,Z(f.selectedStaticWidgetTreeInfo.widgetTree)}ge(),D.updateActionHistories();return}i?.classList.contains("mftsccs-marking-element")&&i.children.length===1&&i?.remove(),s&&(o?.children?.length||o?.remove()),a?.remove(),V.staticElement.remove(),Dt();const u=await tt();return f.staticWidgetTree.html=u,f.selectedStaticWidgetTreeInfo={widgetTree:f?.widgetTree,isChildWidget:!1,childWidgetIndex:0},Kl(),Z(f?.staticWidgetTree),ge(),D.updateActionHistories(),j.checkContent()||(j.disableWidgetButtons(),document.querySelector(".content-target")?.removeAttribute("style")),"Removed Element"}function tr(n){return"drag"}function nr(n){return n.dataTransfer.setData("text",n.target.id),"start drag"}function ar(n){console.log("dragEndWidgetElement event ->",n)}function ir(n){return n.preventDefault(),n.stopPropagation(),"dragOverWidgetElement"}async function or(n){await dn(n),pe()}let Vt=null;async function Wi(n,e){if(!n)return console.error("dropFolderElement called without event"),!1;(c=>"dataTransfer"in c&&c.dataTransfer!==null)(n)&&(n.preventDefault(),n.stopPropagation());const a=n.target instanceof HTMLElement?n.target:null;if(!Q)return console.log("No dragged item found, skipping drop"),!1;document.querySelector(".file-description.dragging-area")?.classList.remove("dragging-area");let o=n.target;if(!o.classList.contains("mftsccs-marking-element")&&!o.classList.contains("fslayout-col")&&o.id!=="builder-workarea"){const c=document.getElementById("builder-workarea"),d=o.closest(".mftsccs-marking-element"),g=o.closest(".fslayout-col");o=d||g||c}if((Q.contains(o)||Q===o)&&(console.warn("Dropzone is the dragged item or its descendant, falling back to builder-workarea"),o=document.getElementById("builder-workarea")),!o)return console.error("Invalid dropzone"),!1;o?.classList.remove("dragging-area");let s=jn(n,e);if(!s.status)return alert(s.message),Q=null,!1;const r=e.dataType||e.type||e.data_type,l=r==="photo"||r==="Image"||r==="img",u=r==="widget"||e.type==="widget"||e.fileId||e.sourceElementId;if(l){let c,d=!1;if(Q&&Q.tagName&&Q.tagName.toLowerCase()==="img"){if(d=!0,c=Q,c.parentElement===o&&console.log("Image is already in this dropzone, just repositioning"),!(c instanceof Node))return console.error("draggedItem is not a valid DOM node:",c),Q=null,!1;(!c.hasAttribute("style")||!c.style.width)&&c.setAttribute("style","width: 200px;")}else{const w=e?.imageUrl||e?.src||e?.url||"/images/img-placeholder.jpg";if(o.querySelectorAll(`img[src="${w}"]`).length>0)return console.log("Image already exists in dropzone, preventing duplicate"),Q=null,!1;c=document.createElement("img"),c.setAttribute("src",w),c.setAttribute("style","width: 200px;")}let g=Se.generateUUID();c.setAttribute("element-info-id",g);const m=o.classList.contains("file-item")&&o.classList.contains("photo-file")&&o.classList.contains("dragging");let p=c;if(m){const w=document.createElement("div");w.appendChild(c),p=w}try{if(d){const w=m&&c.parentElement?.parentElement||c.parentElement,b=m?c.parentElement:c;w&&w!==o&&b&&w.removeChild(b)}ie?.position==="top"&&o?.children?.length&&ie?.element?o.contains(ie.element)&&!p.contains(ie.element)&&p!==ie.element?o.insertBefore(p,ie.element):(console.warn("Invalid indicator element for top position, appending to dropzone"),o.appendChild(p)):ie?.position==="bottom"&&ie?.element?o.contains(ie.element)&&!p.contains(ie.element)&&p!==ie.element?ie.element.insertAdjacentElement("afterend",p):(console.warn("Invalid indicator element for bottom position, appending to dropzone"),o.appendChild(p)):o.appendChild(p)}catch(w){console.error("Error positioning element:",w instanceof Error?w.message:w);try{o.appendChild(p)}catch(b){return console.error("Cannot append element:",b),Q=null,!1}}c.removeAttribute("element-info-id");const h=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(h){const w=h.id,b=Ge(f?.staticWidgetTree,w);if(b){const C=h.querySelector(".mftsccs-marking-element");C&&(b.html=C.innerHTML,await Z(b))}return Q=null,!1}return sr(),Q=null,!0}else if(u){if(!s.status)return alert(s.message),Q=null,!1;if(e.sourceElementId){const S=e.sourceElementId||e.fileId;console.log("sourceElement ->",S)}let c=e.widget_id;if(!c)return console.error("Widget ID is missing from data"),Q=null,!1;o.classList.remove("dragging-area");const d=document.createElement("div");d.classList.add("wb-initial-empty"),d.style.display="block",d.style.marginBottom="10px",d.setAttribute("data-widget-id",c.toString());const g=Se.generateUUID();d.id=`widget-${g}`;const m=await k();let p=o.classList.contains("publicWidgetRouter"),h=await ue(Number(c));const w=n.clientY,b=o.getBoundingClientRect(),C=_t(b,w);let T;if(!p){const S=await ke(Number(c),m.token);h=await ue(S?S.widgetId:Number(c)),h?.children?.length&&await un(h),T=$t(o,S?S.widgetId:c,!1,s.elementBelowDrag,C,n)}const v=j.clearDraggedWidget(h),y=await Ce(v,T);v.wrapper=T?.id,Ai();const E=a?.parentElement?.closest(".added-widget-container")||a?.parentElement?.closest(".edited-widget-container");if(E){const S=E.id,x=Ge(f?.staticWidgetTree,S);x&&x.children.push(v);const P=document.getElementById(S).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=P?.innerHTML,f.selectedStaticWidgetTreeInfo.widgetTree.css=P?.style.cssText,await Z(f.selectedStaticWidgetTreeInfo.widgetTree),Q=null,!1}const L=await Et();f.staticWidgetTree.html=L,f.staticWidgetTree?.children?.push(v);const _=f.widgetTree.children.indexOf(v);return f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[_],isChildWidget:!0,childWidgetIndex:_},await je(v),await Z(v,!1,y),j.enableWidgetButtons(),Q=null,!0}else return console.error("Unsupported data type, skipping drop. Data:",JSON.stringify(e,null,2)),Q=null,!1}function sr(){document.querySelectorAll(".mftsccs-marking-element img").forEach(n=>{n.setAttribute("draggable","true"),n.addEventListener("dragstart",e=>{e.stopPropagation(),Vt=Date.now()}),n.addEventListener("dragend",e=>{e.stopPropagation(),setTimeout(()=>{Vt=null},100)})})}function rr(){Vt=null,Q=null,console.log("dragStartTime",Vt)}async function dn(n,e=!1,t,a){if(!n&&e&&t&&a){const l=await ue(Number(t)),u=$t(a,t,!1,null,"below",n),c=j.clearDraggedWidget(l);let d=await Ce(c,u);c.wrapper=u?.id;const g=await tt();f.staticWidgetTree.html=g,f.staticWidgetTree?.children?.push(c);const m=f.widgetTree.children.indexOf(c);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[m],isChildWidget:!0,childWidgetIndex:m},await je(c),Z(c,!1,d),j.enableWidgetButtons();return}if(!n){console.error("dropElement called without event");return}n.preventDefault(),n.stopPropagation(),document.querySelector(".content-target")?.classList.remove("dragging-area");let o=n.dataTransfer.getData("text");if((l=>{try{return JSON.parse(l),!0}catch{return!1}})(o))if(Object.keys(JSON.parse(o)).includes("widgetcodeId")){const l=JSON.parse(o);let u=jn(n,l);const c=l.className.split(" ");if(!u.status){alert(u.message);return}const d=JSON.parse(o);if(d.sourceElementId){const x=document.getElementById(d.sourceElementId.toString());if(x){n.target.insertBefore(x,u.elementBelowDrag??null);return}}let g=ys(d),m=u?.dropzoneEl;m.classList.remove("dragging-area");const p=await k();let h=!1;c.includes("publicWidgetRouter")&&(h=!0);let w=null,b=null;const C=n.clientY,T=m.getBoundingClientRect(),v=_t(T,C);if(h){w=await ue(Number(g)),b=$t(m,g,!1,u.elementBelowDrag,v,n);const x=document.getElementById("widgetNameValue");x&&w?.name&&(x.value=w?.name);const W=document.getElementById("widget-builder");W&&w?.name&&(W.textContent="Widget Builder Panel: "+w?.name)}else{const x=await ke(g,p.token);w=await ue(x?x.widgetId:Number(g));const W=document.getElementById("widgetNameValue");W&&w?.name&&(W.value=w?.name);const P=document.getElementById("widget-builder");P&&w?.name&&(P.textContent="Widget Builder Panel: "+w?.name),w?.children?.length&&await un(w),b=$t(m,x?x.widgetId:g,!1,u.elementBelowDrag,v,n)}const y=j.clearDraggedWidget(w);let E=await Ce(y,b);y.wrapper=b?.id;const L=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(L){const x=L.id,W=Ge(f?.staticWidgetTree,x);W&&W.children.push(y);const $=document.getElementById(x).querySelector(".mftsccs-marking-element");return f.selectedStaticWidgetTreeInfo.widgetTree.html=$?.innerHTML,await je(f.selectedStaticWidgetTreeInfo.widgetTree),Z(f.selectedStaticWidgetTreeInfo.widgetTree),!1}const _=await tt();f.staticWidgetTree.html=_,f.staticWidgetTree?.children?.push(y);const S=f.widgetTree.children.indexOf(y);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree.children[S],isChildWidget:!0,childWidgetIndex:S},await je(y),Z(y,!1,E),j.enableWidgetButtons()}else{let l=function(w,b){document.getElementById("builder-workarea")===w&&(b="inside");let T=Se.generateUUID();const v=Ql(T,u),y=document.createElement("div");y.innerHTML=v;const E=y.firstChild,L=w.parentElement;if(b==="above")L.insertBefore(E,w);else if(b==="below"){const S=w.nextElementSibling;S?L.insertBefore(E,S):L.appendChild(E)}else if(b==="inside"){const S=sa(w,n.clientY);S==null?w.appendChild(E):w.insertBefore(E,S)}n.target.classList.remove("dragging-area");let _=E;u.data_type=="layout"?_.querySelectorAll(".fslayout-col").forEach(x=>{x.classList.add("wb-initial-empty")}):(_.classList.add("wb-initial-empty"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))),_.removeAttribute("element-info-id"),u?.data_type==="img"&&(_?.setAttribute("src","/images/img-placeholder.jpg"),_?.setAttribute("style","width: 200px;"))};const u=JSON.parse(o);let c=jn(n,u);const d=c?.dropzoneEl;if(c.status){const w=n.clientY,b=d.getBoundingClientRect(),C=_t(b,w);l(d,C)}else alert(c.message);const g=n.target?.parentElement?.closest(".added-widget-container")||n.target?.parentElement?.closest(".edited-widget-container");if(g){const w=g.id,b=Ge(f?.staticWidgetTree,w);if(b){const C=g.querySelector(".mftsccs-marking-element");b.html=C?.innerHTML,await Z(b)}return n.dataTransfer.clearData(),!1}const m=document.querySelector(".content-target"),h=(await We(m,"div.mftsccs-marking-element")).innerHTML.trim();f.widgetTree.html=h;try{n.dataTransfer.clearData()}catch(w){console.error("error in clearing data",w instanceof Error?w.message:String(w))}return!0}else{const l=V.staticElement,u=n.target;u.classList.remove("dragging-area"),ie?.position==="top"&&u?.children?.length?u.insertBefore(l,ie?.element):ie?.position==="bottom"?ie?.element?.insertAdjacentElement("afterend",l):u.appendChild(l),Dt();const c=await tt();f.staticWidgetTree.html=c}}function sa(n,e){return Array.from(n.children)?.reduce((a,i)=>{const o=i.getBoundingClientRect(),s=e-o.top-o.height/2;return s<0&&s>a.offset?{offset:s,element:i}:a},{offset:Number.NEGATIVE_INFINITY,element:null}).element}function _t(n,e){const t=n.height,a=e-n.top;return a<t*.25?"above":a>t*.75?"below":"inside"}function lr(n){const o=new DOMParser().parseFromString(n,"text/html").body.querySelector("div")?.id,r=document.getElementById(o)?.parentElement?.closest(".added-widget-container"),l=r?.id,u=r?.querySelectorAll(".widget_container_disabled");return u?.length&&u?.forEach(c=>{const d=Se.generateUUID();c.id=`wdgt${d}`}),l?.toString()}async function un(n){return Array.isArray(n.children)&&n.children.forEach(e=>{Ii(e,n),e.children.length&&un(e)}),n}function Ii(n,e){const t=n.wrapper,o=new DOMParser().parseFromString(e?.html,"text/html").body,s=o.querySelector(`#${t}`);if(!s)return n;const l=`wdgtcopy${Se.generateUUID()}`;return s.id=l,n.wrapper=l,e.html=o.innerHTML.toString(),n}const cr=Object.freeze(Object.defineProperty({__proto__:null,checkWrapper:cn,dragElement:tr,dragEndWidgetElement:ar,dragOverWidgetElement:ir,dragStartWidgetElement:nr,dropElement:dn,dropFolderElement:Wi,dropWidgetElement:or,findChildByWrapper:Ge,getChildWrapperId:lr,getChildrenWrapperId:Ii,getDragAfterElement:sa,getDropType:_t,onDragEnter:Qs,onDragLeave:Ys,onDragOver:Ks,onDragStart:Js,onDrop:Xs,onWidgetDragStart:Gs,removeChildByWrapper:Ft,removeElement:er,resetDragState:rr,updateAllChildWidgets:un},Symbol.toStringTag,{value:"Module"})),dr=[{name:"align-items",type:"array",value:"start, center, end",ref:"Align Items"},{name:"text-align",value:"left, right, center",type:"array",validationErrorMessage:"",validationStatus:"valid",ref:"Text Align"},{name:"class",value:"",type:"string",validationErrorMessage:"",validationStatus:"valid",ref:"Class"}],ra=[{id:1,name:"1",type:"layout",icon:"1.png",html:'<div class="row fslayout-row fslayout-row-1"><div class="fslayout-col col col-md-12"></div></div>'},{id:2,name:"1-1",type:"layout",icon:"1-1.png",html:'<div class="row fslayout-row fslayout-row-2"><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-6"></div></div>'},{id:3,name:"1-2",type:"layout",icon:"1-2.png",html:'<div class="row fslayout-row fslayout-row-3"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-8"></div></div>'},{id:4,name:"2-1",type:"layout",icon:"2-1.png",html:'<div class="row fslayout-row fslayout-row-4"><div class="fslayout-col col col-md-8"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:5,name:"1-1-1",type:"layout",icon:"1-1-1.png",html:'<div class="row fslayout-row fslayout-row-5"><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div><div class="fslayout-col col col-md-4"></div></div>'},{id:6,name:"1-2-1",type:"layout",icon:"1-2-1.png",html:'<div class="row fslayout-row fslayout-row-6"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-6"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:7,name:"1-1-1-1",type:"layout",icon:"1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-7"><div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div> <div class="fslayout-col col col-md-3"></div><div class="fslayout-col col col-md-3"></div></div>'},{id:8,name:"1-1-1-1-1",type:"layout",icon:"1-1-1-1-1.png",html:'<div class="row fslayout-row fslayout-row-8"><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div><div class="fslayout-col col"></div></div>'}];class ki{constructor(){}async getLayoutListHTML(){return ra.map(t=>`
      ...
      `).join("")}async getTemplateLayoutsHTML(){const e=await kl();if(!e||e.length===0)return'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No templates available</p></li>';const t=await k(),a=t?.entityId===101651686||t?.entityId===101279491;return e.map(i=>i.id?`
      ...
      `:"").join("")}}async function ke(n,e){let t=new J;t.composition=n,t.fullLinkers=["the_widget_recent","the_widget_latest"],t.inpage=100;let a=new J;a.fullLinkers=["the_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_version","the_widget_origin"],a.inpage=100;const o=await be([t,a],e),r=await Ne(n,"the_widget_recent"),l=o?.data?.the_widget?.the_widget_recent||o?.data?.the_widget?.the_widget_latest||[],u=o?.data?.the_widget?.the_widget_latest||null;if(l.length){const c=l[0],d=c?.data.the_widget.the_widget_name?.[0].data.the_name,g=c?.data.the_widget.the_widget_html?.[0].data.the_html,m=c?.id,p=c?.data.the_widget.the_widget_css?.[0].data.the_css,h=c?.data.the_widget.the_widget_js?.[0].data.the_js,w=c?.data.the_widget.the_widget_timestamp?.[0].data.the_timestamp,b=c?.data.the_widget.the_widget_version?.[0].data.the_version,C=c?.data.the_widget.the_widget_origin?.[0].data.the_origin|n;return{widgetName:d,widgetHTML:g,widgetCSS:p,widgetJS:h,widgetTimestamp:w,widgetVersion:Number(b||u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version),widgetId:m||u.id,origin:Number(C),connectionIdLatest:r,publishedWidgetVersion:u?.[0]?.data?.the_widget?.the_widget_version?.[0]?.data?.the_version}}else return null}const j=(()=>{const n=async()=>{const v=document.getElementById("fslayout-template-container");if(v){v.innerHTML=`
        <li class="list-unstyled">
          ...
          `:v.innerHTML=y||""}},t=async()=>{const v=document.getElementById("folder-widget-container");if(v){const y=await Il();!y||y.trim()===""?v.innerHTML=`
            <li class="list-unstyled">
...
`;class gn{async createProject(e,t,a){const i=await F(I.PROJECT_COMP_NAME,t,e),o=await Y(a);return await q(o,i,re.ENTITY_PROJECT_LINKER),i}async getAllProjects(e){return new Promise(async(t,a)=>{const i=await k(),o=new M;o.typeConnection=`the_entity_${re.ENTITY_PROJECT_LINKER}`,o.selectors=[`the_${I.PROJECT_COMP_NAME}_name`],o.name="first",o.inpage=100;const s=new M;s.conceptIds=[e||i.entityId],s.name="second",s.inpage=100,s.freeschemaQueries=[o],s.outputFormat=se,await me(s,"").subscribe(async r=>{const l=r?.[0]?.data?.the_entity?.[`the_entity_${re.ENTITY_PROJECT_LINKER}`];t(l)}).catch(r=>{console.error(r);const l=r?.message;A.errorToast(`${l}`,4),a({error:!0,message:l})})})}async getProjectById(e){const a=(await k())?.token;let i=new J;i.composition=e,i.fullLinkers=[`the_${I.PROJECT_COMP_NAME}_name`,`the_${I.PROJECT_COMP_NAME}_main_page`,`the_${I.PROJECT_COMP_NAME}_${re.PROJECT_PAGE_LINKER}`],i.inpage=100;let o=new J;return o.fullLinkers=[`the_${I.PAGE_COMP_NAME}_title`,`the_${I.PAGE_COMP_NAME}_slug`,`the_${I.PAGE_COMP_NAME}_body`],o.inpage=100,await be([i,o],a)}async updateProjectField(e,t,a){const i=await k(),o=`the_${I.PROJECT_COMP_NAME}_${e}`;await le(a,o);const s=await H(a),r=await K(`${e}`,`${t}`,!1,i.userId,4,999);await q(s,r,e)}async deleteProject(e){try{return await Ae(e),!0}catch(t){return console.error("Failed to delete project:",t),!1}}async addPagesToProject(e,t){try{const a=await H(e);if(!a){console.error("Project not found");return}await le(e,`the_project_${re.PROJECT_PAGE_LINKER}`);for(const i of t){const o=await H(i);if(!o){console.error("Page not found");return}await q(a,o,re.PROJECT_PAGE_LINKER)}await O.SyncDataOnline()}catch(a){console.error("Failed to add page to project:",a)}}async deletePageFromProject(e,t){try{const a=await H(e);if(!a){console.error("Project not found");return}const i=await H(t);if(!i){console.error("Page not found");return}const o=await Mn(a,i,"",`the_project_${re.PROJECT_PAGE_LINKER}`);if(!o){console.error("Connection not found");return}await $e(o?.[0]?.id),await O.SyncDataOnline()}catch(a){console.error("Failed to delete page from project:",a)}}async setMainPage(e,t){try{const a=await H(e);if(!a){console.error("Project not found");return}const i=await H(t);if(!i){console.error("Page not found");return}await le(e,"the_project_main_page"),await q(a,i,"main_page"),await O.SyncDataOnline()}catch(a){console.error("Failed to set main page:",a)}}}let he=!1;const Tr=async()=>{if(he)return;he=!0;let n=new an;const e=await pn(n),t=e?.routesDir,a=e?.pagesDir;await Cr(a,t),n.generateAsync({type:"blob"}).then(function(i){let o=document.createElement("a");o.href=URL.createObjectURL(i),o.download="my_files.zip",o.click()}),he=!1},Sr=async n=>{if(he)return;he=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new an;const a=await pn(t),i=a?.widgetsDir,o=a?.pagesDir;i&&o&&await Lr(n,o,i),a?.routesDir?.file("routes.ts",mn(e)),t.generateAsync({type:"blob"}).then(function(s){let r=document.createElement("a");r.href=URL.createObjectURL(s),r.download="my_files.zip",r.click()}),he=!1},pn=async n=>{n.file("index.html",hr),n.file("vite.config.js",mr),n.file(".gitignore",gr),n.file("package.json",pr),n.file("tsconfig.json",yr);let e=n.folder("public");if(!e){console.log("unable to create public folder");return}let t=n.folder("src");if(!t){console.log("unable to create src folder");return}t?.file("app.ts",fr),t?.file("style.css","");let a=t?.folder("environments");if(!a){console.log("unable to create environments folder");return}a?.file("environment.dev.ts",wr);let i=t?.folder("widgets");if(!i){console.log("unable to create widgets folder");return}let o=t?.folder("pages");if(!o){console.log("unable to create pages folder");return}let s=t?.folder("services");if(!s){console.log("unable to create services folder");return}s?.file("widget.service.ts",br),s?.file("drop.service.ts",_r),s?.file("validator.service.ts",Er);let r=t?.folder("routes");if(!r){console.log("unable to create routes folder");return}return r?.file("renderRoute.service.ts",vr),{srcDir:t,pagesDir:o,servicesDir:s,publicDir:e,environmentsDir:a,widgetsDir:i,routesDir:r}},Cr=async(n,e)=>{if(!n&&!e)return;let t=[];const a=await k(),i=a?.entityId,o=a?.token,s=new J;s.composition=i,s.inpage=100,s.fullLinkers=["the_entity_s_page"];const r=new J;r.inpage=100,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const l=await be([s,r],o);if(l?.data.the_entity?.the_entity_s_page?.length)for(let u=0;u<l?.data.the_entity?.the_entity_s_page?.length;u++){const c=l.data.the_entity.the_entity_s_page[u];let d={page:c?.data?.the_page?.the_page_body?.[0]?.id,title:c?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:c?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:c?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:c?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:c?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:c?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!d.page)continue;const g=`${d.slug.split("-").map((h,w)=>w===0?h.charAt(0).toLowerCase()+h.slice(1):h.charAt(0).toUpperCase()+h.slice(1)).join("")}`;t.push({path:`/${d.slug}`,content:`${g}Index`,importFrom:`/${d.slug}/${d.slug}.index.ts`});let m=n?.folder(d.slug);const p=`
...
`;m?.file(`${d.slug}.index.ts`,p)}e?.file("routes.ts",mn(t))},Lr=async(n,e,t)=>{console.log("widgetsDir",t);const i=(await k())?.token,o=await wa(n,i,!0);let s=e?.folder("home");const r=`
...
`;s?.file("home.index.ts",r),o?.css&&s?.file("home.style.css",o?.css)},xr=async n=>{if(he)return;he=!0;let e=[{path:"/",linkLabel:"Home",content:"homeIndex",importFrom:"/home/home.index.ts"}],t=new an;const a=await pn(t),i=a?.widgetsDir,o=a?.pagesDir;let s="";i&&o&&(s=await Ar(n,o)),a?.routesDir?.file("routes.ts",mn(e)),t.generateAsync({type:"blob"}).then(function(r){let l=document.createElement("a");l.href=URL.createObjectURL(r),l.download=`${s||"page"}.zip`,l.click()}),he=!1},Ar=async(n,e)=>{const t=await k(),a=t?.entityId,i=t?.token,o=await wa(n,i,!0),s=new J;s.composition=a,s.inpage=100,s.fullLinkers=["the_entity_s_page"];const r=new J;r.inpage=100,r.composition=n,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const u=(await be([s,r],i))?.data?.the_entity?.the_entity_s_page?.filter(p=>p?.id==n),c=u?.[0]?.data?.the_page?.the_page_body?.[0]?.id,d=u?.[0]?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug;let g=e?.folder("home");const m=`
    import * as tsccs from "mftsccs-browser";
    ...
    `;return g?.file("home.index.ts",m),o?.css&&g?.file("home.style.css",o?.css),d},Wr=async n=>{if(he)return;if(!n){console.log("Project id is required");return}const i=(await new gn().getProjectById(n))?.data?.the_project?.the_project_name?.[0]?.data?.the_name?.replace(/\s/g,"_").toLowerCase();he=!0;let o=new an;const s=await pn(o),r=s?.routesDir,l=s?.pagesDir;await Ir(l,r,n),o.generateAsync({type:"blob"}).then(function(u){let c=document.createElement("a");c.href=URL.createObjectURL(u),c.download=`the_${i}.zip`,c.click()}),he=!1},Ir=async(n,e,t)=>{if(!n&&!e)return;let a=[];const o=(await k())?.token,s=new J;s.composition=t,s.inpage=100,s.fullLinkers=["the_project_s_page","the_project_main_page"];const r=new J;r.inpage=100,r.fullLinkers=["the_page_body","the_page_title","the_page_slug","the_page_font_family","the_page_font_size","the_page_width","the_page_type"];const l=await be([s,r],o),u=l?.data.the_project?.the_project_main_page?.[0]?.id;if(l?.data.the_project?.the_project_s_page?.length)for(let c=0;c<l?.data.the_project?.the_project_s_page?.length;c++){const d=l.data.the_project.the_project_s_page[c];let g={page:d?.id,title:d?.data?.the_page?.the_page_title?.[0]?.data?.the_title,slug:d?.data?.the_page?.the_page_slug?.[0]?.data?.the_slug,font_family:d?.data?.the_page?.the_page_font_family?.[0]?.data?.the_font_family,font_size:d?.data?.the_page?.the_page_font_size?.[0]?.data?.the_font_size,width:d?.data?.the_page?.the_page_width?.[0]?.data?.the_width,type:d?.data?.the_page?.the_page_type?.[0]?.data?.the_type};if(!g.page)continue;const m=`${g.slug.split("-").map((w,b)=>b===0?w.charAt(0).toLowerCase()+w.slice(1):w.charAt(0).toUpperCase()+w.slice(1)).join("")}`;a.push({path:`/${g.slug}`,content:`${m}Index`,importFrom:`/${g.slug}/${g.slug}.index.ts`}),g.page==u&&a.push({path:"/",content:`${m}Index`});let p=n?.folder(g.slug);const h=`
                ...
                }`;p?.file(`${g.slug}.index.ts`,h)}e?.file("routes.ts",mn(a))};async function kr(){const n=new oe("mountchildwidgets-editor-split"),e=document.getElementById("mountchildwidgets-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Mr(){const n=new oe("onupdate-editor-split"),e=document.getElementById("onupdate-editor-split");e&&(e.innerHTML=""),await n.initializeEditor()}async function Mi(){await kr(),await Mr(),await _s(),await Es()}function Pr(){document.getElementById("widget-lifecycle-form")?.remove(),document.createElement("div").setAttribute("id","widget-lifecycle-form")}function Pi(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.add("saveWidgetDisabled")})}function Vn(){Array.from(document.querySelectorAll(".widget-item")).forEach(e=>{e.classList.remove("saveWidgetDisabled")})}class $i{arrowBtn=null;updateOnlyButton=null;isDroppedDown=!1;constructor(){}async LoadPageWidget(e){const a=(await k())?.token;na(),Pi(),document.querySelector("#widget-properties #widget-type input")?.remove(),Pr(),await Mi();let o=aa(),s=await ke(e,a),r=await ue(s?.widgetId??e),l=await Ce(r,o);this.addPageUpdate(e),Vn(),f.resetWidgetTree(),f.widgetTree=r,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),Z(r,!1,l,!0),j.enableWidgetButtons(),cn(),ge(),ve()}toggleUpdate(e){this.updateOnlyButton&&this.arrowBtn&&(this.isDroppedDown&&e!==!0?(this.updateOnlyButton.classList.remove("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_up</span>'):(this.updateOnlyButton.classList.add("d-none"),this.arrowBtn.innerHTML='<span class="material-symbols-outlined">arrow_drop_down</span>'),this.isDroppedDown=!this.isDroppedDown)}addPageUpdate(e){const t=document.getElementById("widget-btn-wrapper");t.innerHTML=`
        <div class="position-relative" style="z-index: 100;">
          <div class="w-100 d-flex justify-content-center">
...
`}before_render(){this.render()}after_render(){if(this.the_params){document.getElementById("fspage-save-button").addEventListener("click",ca);const t=this.the_params.data?.the_page_body?.id;if(document.querySelector(".content-target").classList.add("fspage"),!t){cn();return}this._pageBuilderService.LoadPageWidget(Number(t))}}getHtml(){return window.openSaveWidgetModal=fa,window.saveWidget=Ri,window.updateWidget=ya,window.newWidget=Re,window.previewWidget=Xr,window.downloadWebsite=Tr,window.moveUp=Se.moveUp,window.moveDown=Se.moveDown,window.copyElement=Se.copyElement,window.editWidget=Se.editWidget,window.openConvertModal=nl,window.convertToWidget=el,window.updatePage=da,window.previewPage=Br,window.undoAction=D.undoAction,window.redoAction=D.redoAction,window.saveWidgetToFolderBtn=jr,window.openPromptModal=Ds,window.openAIModal=Ci,window.refineAIData=qn,`
  ...
  `,document.querySelector("body #app")?.appendChild(l),await ce(s);const u=document.getElementById("environment-editor-container");if(!u)return;const c=ea(p=>{const h=[],w=p.state.doc.toString();try{JSON.parse(w)}catch(b){const C=b,T=C.message.match(/position (\d+)/),v=T?parseInt(T[1]):0;h.push({from:Math.max(0,v-1),to:Math.min(w.length,v+1),severity:"error",message:C.message})}return h});let d=null;d=new te({doc:JSON.stringify(t,null,2),extensions:[it,ot,en(),Xn(),c,te.lineWrapping,Le.tabSize.of(2)],parent:u}),document.getElementById("format-json-btn")?.addEventListener("click",()=>{try{const p=d?.state.doc.toString()||"{}",h=JSON.parse(p),w=JSON.stringify(h,null,2);d?.dispatch({changes:{from:0,to:d.state.doc.length,insert:w}}),alert("JSON formatted successfully!")}catch(p){alert("Invalid JSON: "+p.message)}});const m=document.getElementById("save-environment-btn");m?.addEventListener("click",async()=>{try{m.disabled=!0,m.textContent="Saving...";const h=document.getElementById("environment-name-input")?.value?.trim()||"default";if(!h){alert("Environment name is required"),m.disabled=!1,m.textContent="Save";return}const w=document.getElementById("save-to-entity-checkbox"),b=n?w?.checked||!1:!0,C=d?.state.doc.toString()||"{}";let T;try{T=JSON.parse(C)}catch(S){alert("Invalid JSON: "+S.message),m.disabled=!1,m.textContent="Save";return}const v=await new Ct;await v.initialize();let y;a?(console.log("Editing existing environment:",a),y=await H(a),i&&await le(a,"the_environment_name"),o&&await le(a,"the_environment_value")):(console.log("Creating new environment"),y=await v.MakeTheInstanceConceptLocal("the_environment","",!0,999,4));const E=await v.MakeTheInstanceConceptLocal("the_name",h,!0,999,4),L=await v.MakeTheInstanceConceptLocal("the_environment_value",JSON.stringify(T),!0,999,4);if(await v.CreateConnection(y,E,"the_environment_name"),await v.CreateConnection(y,L,"the_environment_value"),n&&!a){const S=await H(n);await v.CreateConnection(S,y,"the_project_environment")}if(b)try{const x=(await k())?.entityId;if(x){const W=await H(x);await v.CreateConnection(W,y,"the_entity_s_environment"),console.log(`Environment saved to entity ${x}`)}else console.warn("Entity ID not found in profile data. Environment not saved to entity.")}catch(S){console.error("Error saving to entity:",S)}await v.commitTransaction();try{const{refreshEnvironmentDropdown:S}=await fe(async()=>{const{refreshEnvironmentDropdown:x}=await Promise.resolve().then(()=>wo);return{refreshEnvironmentDropdown:x}},void 0);await S()}catch(S){console.log("Could not refresh environment dropdown:",S)}let _="Environment variables saved successfully!";n?b&&(_+=" (Also saved to your entity)"):_+=" (Saved to your entity)",alert(_),m.disabled=!1,m.textContent="Save",window.closeModal(s)}catch(p){console.error("Error saving environment:",p),alert("Failed to save environment variables: "+p),m.disabled=!1,m.textContent="Save"}})},qr=async(n,e,t,a,i)=>{const o="environment-editor-modal";document.getElementById(o)?.remove();const r=document.createElement("dialog");r.setAttribute("id",o),r.classList.add("col-md-8"),r.style.maxWidth="800px",r.innerHTML=`
    <style>
      #${o} {
        border-radius: 8px;
        border: none;
  ...
  `,document.querySelector("body #app")?.appendChild(r),await ce(o);const l=document.getElementById("environment-editor-container");if(!l)return;const u=ea(m=>{const p=[],h=m.state.doc.toString();try{JSON.parse(h)}catch(w){const b=w,C=b.message.match(/position (\d+)/),T=C?parseInt(C[1]):0;p.push({from:Math.max(0,T-1),to:Math.min(h.length,T+1),severity:"error",message:b.message})}return p});let c=null;c=new te({doc:JSON.stringify(e,null,2),extensions:[it,ot,en(),Xn(),u,te.lineWrapping,Le.tabSize.of(2)],parent:l}),document.getElementById("format-json-btn")?.addEventListener("click",()=>{try{const m=c?.state.doc.toString()||"{}",p=JSON.parse(m),h=JSON.stringify(p,null,2);c?.dispatch({changes:{from:0,to:c.state.doc.length,insert:h}}),alert("JSON formatted successfully!")}catch(m){alert("Invalid JSON: "+m.message)}});const g=document.getElementById("save-environment-btn");g?.addEventListener("click",async()=>{try{g.disabled=!0,g.textContent="Saving...";const p=document.getElementById("environment-name-input")?.value?.trim()||"default";if(!p){alert("Environment name is required"),g.disabled=!1,g.textContent="Save Changes";return}const h=c?.state.doc.toString()||"{}";let w;try{w=JSON.parse(h)}catch(y){alert("Invalid JSON: "+y.message),g.disabled=!1,g.textContent="Save Changes";return}const b=await new Ct;await b.initialize();let C;t?(console.log("Editing existing environment:",t),C=await H(t),a&&await le(t,"the_environment_name"),i&&await le(t,"the_environment_value")):(console.log("Creating new environment"),C=await b.MakeTheInstanceConceptLocal("the_environment","",!0,999,4));const T=await b.MakeTheInstanceConceptLocal("the_name",p,!0,999,4),v=await b.MakeTheInstanceConceptLocal("the_environment_value",JSON.stringify(w),!0,999,4);if(await b.CreateConnection(C,T,"the_environment_name"),await b.CreateConnection(C,v,"the_environment_value"),!t){const E=(await k())?.entityId;if(E){const L=await H(E);await b.CreateConnection(L,C,"the_entity_s_environment")}}await b.commitTransaction();try{const{refreshEnvironmentDropdown:y,saveEnvironmentToStorage:E}=await fe(async()=>{const{refreshEnvironmentDropdown:L,saveEnvironmentToStorage:_}=await Promise.resolve().then(()=>wo);return{refreshEnvironmentDropdown:L,saveEnvironmentToStorage:_}},void 0);if(await y(),t){const _=(window.__allEnvironments||[]).findIndex(S=>S.id===t);_!==-1&&(E(w,_),console.log(`Updated environment "${p}" in RAM and localStorage`))}}catch(y){console.log("Could not refresh environment dropdown:",y)}alert("Environment variables updated successfully!"),g.disabled=!1,g.textContent="Save Changes",window.closeModal(o)}catch(m){console.error("Error saving environment:",m),alert("Failed to save environment variables: "+m),g.disabled=!1,g.textContent="Save Changes"}})},Fr=Object.freeze(Object.defineProperty({__proto__:null,createEnvironmentEditor:ma,createEnvironmentEditorWithData:qr},Symbol.toStringTag,{value:"Module"}));function Vr(n,e=[],t=[]){return`
  <style>
  .accordion-header {
  background: gray;
  color: white;
...
.custom-menu-item {
  ...
  `}async function Yr(n,e){if(n.preventDefault(),!(await Te.getInstance().getLoginInfo()).isAdmin)return"Sorry You Do Not Have Access To Create Element";const a=new FormData(n.target),i=Object.fromEntries(a);console.log(i,"update formValues");const o=await qi(a,e);await pa("update-element-dialog");const s=await hn();if(o){const r=document.getElementById("created-elements");r?!s||s.trim()===""?r.innerHTML=`
      ...
      `:r.innerHTML=s||"":console.error("Widget list container not found in the DOM.")}return o}class Kr{createElemenModaltHTML;singleElement;constructor(e){e&&this.init(e)}async init(e){this.getSingleElementDetails(e)}async getSingleElementDetails(e){const t=await Ea(e);this.singleElement=t,this.createElemenModaltHTML=this.getHtml(),t&&(document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML),document.getElementById("update-element-dialog").showModal(),await ha(this.singleElement.attributes))}getHtml(){return window.updateNewElement=Yr,window.closeElementModal=pa,`<dialog id="update-element-dialog" class="col-md-4 a-dialog update-element-dialog">
      <!-- START .a-dialog-header  -->
        ...
        <!-- END .a-dialog-body  -->
      </dialog>`}}class Zr{createElemenModaltHTML;constructor(){window._dragService=cr,this.init()}init(){this.createElemenModaltHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.createElemenModaltHTML)}getHtml(){return window.addNewAttribute=zr,window.cancelAttributeRow=Fi,window.addAttribute=Jr,window.removeSelectedAttribute=Gr,window.closeElementModal=pa,`
    ...
    `}}async function ce(n){document.getElementById(n).showModal()}async function _e(n){const e=document.getElementById(n);e?.querySelector("form")?.reset(),e?.close(),e?.remove()}async function Vi(n,e){n?.stopPropagation();const t=document.getElementById(`menu-${e}`),a=t?.classList.contains("show");document.querySelectorAll(".dropdown-menu").forEach(o=>{o.classList.remove("show")}),t&&!a&&t.classList.add("show")}async function Yc(n){new Zr,await ce(n)}async function Kc(n,e,t){n.stopPropagation(),console.log("modalId",e),Vi(n,Number(t)),new Kr(t)}async function Zc(n,e){Vi(n,e),confirm("Are you sure you want to delete the element?")&&(await Ae(e),A.successfullToast("The element deleted successfully")),console.warn("element Deleted sucessfully");const a=await hn(),i=document.getElementById("created-elements");i?!a||a.trim()===""?i.innerHTML=`
        <li class="list-unstyled">
          <p class="text-center my-3 text-secondary" >No Elements</p>
        </li>
  ...
  `,document.querySelector("body #app")?.appendChild(e),ce("save-widget-dialog"),new Promise((t,a)=>{const i=e.querySelector("#save-widget-form");i.onsubmit=async s=>{s.preventDefault();try{const r=new FormData(i),u=Object.fromEntries(r).widgetName,c=s.target;if(!u?.trim()){const d=c.querySelector("#widgetName");d?.focus(),d.style.border="2px solid red",d.style.outline="none",d.addEventListener("input",()=>{d.style.border=""});return}await Ri(s,u),_e("save-widget-dialog"),t("Widget saved successfully")}catch(r){console.error("Error saving widget:",r),a("Error saving widget")}};const o=e.querySelector("button[type='button']");o.onclick=()=>{_e("save-widget-dialog"),t("Widget saving canceled")}})}async function Ri(n,e){n.preventDefault();try{A.infoMessageToast("Saving Widget...",0),await qe();const t=document.getElementById("save-widget-dialog"),a=t?.querySelector('button[type="submit"]');a.textContent="Saving";const i=t?.querySelector("input"),o=t?.querySelectorAll("button");o&&o.forEach(d=>{d.disabled=!0}),i&&(i.disabled=!0),await He(),V.staticElement?.removeAttribute("draggable");const s=document.querySelectorAll(".edited-widget-container");s?.length&&s.forEach(async d=>{if(d.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[d.id]){const g=await We(d,"div.mftsccs-marking-element");f.editedWidgets[d.id].html=g.innerHTML}});const r=await Ui();f.staticWidgetTree.html=r;const l=await f.saveWidget(e),u=await Y(l.id);_e("save-widget-dialog"),At(),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget saved successfully!"),await j.renderSavedWidgets(),at(n,u.id);return}catch(t){document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Error in saving widget"),ga(t,"There is an error on saving widget")}}async function ya(n,e,t){const a=document.getElementById("update-publish-widget-btn");try{const i=document.getElementById("update-widget-btn");a&&a.classList.add("disabled"),i&&(i.classList.add("disabled"),i.textContent="Updating...",A.infoMessageToast("Updating Widget...",0)),await He(),V.staticElement?.removeAttribute("draggable");const o=document.querySelectorAll(".edited-widget-container");o?.length&&o.forEach(async u=>{if(u.classList.replace("edited-widget-container","added-widget-container"),f.editedWidgets[u.id]){const c=await We(u,"div.mftsccs-marking-element");f.editedWidgets[u.id].html=c.innerHTML}});const s=await al();f.staticWidgetTree.html=s,await f.updateWidget(),At(),ve(),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget Updated Successfully"),await j.renderSavedWidgets(),await j.renderBoomWidgets();const l=document.getElementById("widget-builder");l.textContent="Widget Builder Panel",await at(n,f.staticWidgetTree?.origin?f.staticWidgetTree?.origin:e),t&&t===!0&&await f.publish();return}catch(i){document.querySelector(".infoMessageToast")?.remove();const s=document.getElementById("update-widget-btn");s&&(s.classList.remove("disabled"),s.innerHTML=`
      <span class="material-symbols-outlined"></span>
      Update`),i instanceof Error&&A.errorToast(i.message)}finally{a&&a.classList.remove("disabled")}}async function Re(n,e){const t=document.querySelector(".widgetStyle");t.textContent="",document.querySelectorAll(".child-widget-css")?.forEach(u=>{u.textContent=""});const i=document.getElementById("publish-widget");i&&(i.style.display="none",i.disabled=!0);const o=document.querySelector(".content-target"),s=window.location.href,l=document.querySelector("#widget-btn-wrapper button")?.getAttribute("data-widgetid");if(o){let u=!1;u=await f.hasWidgetChanged(Number(l));const d=document.getElementById("preview-btn").classList.value.includes("active");if((n?.target?.id==="preview-btn"||n?.target?.id==="save-widget-form"||n?.target?.id==="update-widget-btn"||n?.target?.id==="form-folder-modal"||n?.target?.id==="data-file-id")&&(u=!1),d&&(u=!1),u&&!e){await jt("Do you want to save changes?")&&(s.includes("?page-id=")?l?await da(n,Number(l)):await ca(n):l?await ya(n,Number(l)):await fa()),At();const p=document.getElementById("preview-btn");p.classList.remove("active"),p.removeAttribute("data-widgetid")}await Ns()}o.innerHTML="",ji(),n&&!e&&Mt("/")}let Ln="";async function Xr(n){const e=document.getElementById("preview-btn"),t=e.classList.value.includes("active");let a=n.target.getAttribute("data-widgetid");a&&Mt(`?widget-id=${a}`);const i=document.querySelector(".content-target"),o=document.querySelector(".midContent .content"),s={...f.widgetTree},r=document.getElementById("undo-btn"),l=document.getElementById("redo-btn"),u=document.getElementById("ai-prompt-btn"),c=document.getElementById("widget-prompt-modal"),d=document.getElementById("widget-prompt-tab"),g=document.querySelector(".dropdown-wrapper"),m=document.getElementById("widgetButtionCodeViewWrapper");if(t){e.innerHTML=`
        <span class="material-symbols-outlined"> visibility </span> Preview
      `,u.style.display="flex",Ln&&Ln!=="none"?(d.classList.add("d-none"),c.classList.remove("d-none"),c.classList.add("d-flex")):(d?.classList.remove("d-none"),c&&c.classList.add("d-none")),e.classList.remove("active"),r.classList.remove("d-none"),l.classList.remove("d-none"),m&&(m.style.display="block"),g&&(g.style.display="none"),i&&(i.style.width="100%",i.style.maxWidth="",i.style.margin="0 auto",i.classList.remove("mode-desktop","mode-tablet","mode-mobileL","mode-mobile"),i.classList.add("mode-desktop"));const p=aa(),h=await Ce(f.widgetTree,p,!0,void 0,!0);Z(f.widgetTree,!1,h,!1,!0),document.getElementById("column-left").classList.remove("d-none"),document.getElementById("column-right").classList.remove("d-none"),document.getElementById("widget-btn-wrapper").classList.remove("d-none"),o.classList.remove("preview"),ge(),ve(),yt.enableHeader()}else{e.innerHTML=`
        <span class="material-symbols-outlined">design_services</span> Develop
      `,u.style.display="none",c&&(Ln=window.getComputedStyle(c).display,c.classList.add("d-none")),d&&d.classList.add("d-none");const p=document.getElementById("select-box"),h=document.getElementById("element-info");p.style.display="none",h.style.display="none",r.classList.add("d-none"),l.classList.add("d-none"),e.classList.add("active"),m&&(m.style.display="none");const w=await Ce(f.widgetTree,i,!0,void 0,!1);Z(s,!1,w),document.getElementById("column-left").classList.add("d-none");const C=document.createElement("script");C.setAttribute("type","text/javascript"),C.innerHTML=s?.js,i.appendChild(C),document.getElementById("column-right").classList.add("d-none"),document.getElementById("widget-btn-wrapper").classList.add("d-none"),yt.disableHeader(),ft.closeCodeView(),o.classList.add("preview");const y=document.querySelector("header.wico_top-header");y.style.display="none"}return"PREVIEW WIDGET"}async function We(n,e){return n.querySelectorAll(e).forEach(a=>{for(;a.firstChild;)a.parentNode.insertBefore(a.firstChild,a);a.remove()}),n}async function el(n,e){n.preventDefault();try{const t=new FormData(n.target),i=document.getElementById("convert-dialog")?.querySelector('button[type="submit"]');i.textContent="Converting...";const o=n.target;for(let s=0,r=o.length;s<r;++s)o[s].disabled=!0;await tl(t);for(let s=0,r=o.length;s<r;++s)o[s].disabled=!1;return await _e(e),"completed conversion"}catch{A.errorToast("html conversion failed"),await _e(e)}}async function tl(n){const e=Object.fromEntries(n),t=`
      <div class="widget-wrapper">
        ${e.htmlCode}
      </div>
    `,a=await ns(t,e?.cssCode?.toString(),e?.jsCode.toString()),o=(await k())?.token,r=(await es(a?.id,o))?.id,{html:l,css:u,js:c}=await Yo(r,o);await Xt(r);const d=document.querySelector(".content-target");d.innerHTML=l;const g=document.querySelector('.cm-content[data-language="css"]');g.textContent=u;const m=document.querySelector('.editor-container .cm-content[data-language="javascript"]');return m.textContent=c,"converted widget"}async function nl(n){return new $r().init(),ce(n),"opened convert HTML to Widget!"}async function rt(n,e){return new Promise(async(t,a)=>{try{let i=new J;i.composition=n,i.fullLinkers=["the_widget","the_widget_widget","the_widget_name","the_widget_html","the_widget_css","the_widget_js","the_widget_timestamp","the_widget_type","the_widget_after_render","the_widget_before_render","the_widget_update","the_widget_mount_child","the_widget_clean","the_widget_s_child","the_widget_version","the_widget_origin","the_widget_s_css_library","the_widget_s_js_library","the_widget_assistant","the_widget_s_custom_function","the_widget_dependency"],i.inpage=100;let o=new J;o.fullLinkers=["the_child_widget","the_child_widget_type","the_child_widget_parent","the_child_widget_wrapper","the_child_widget_info","the_css_library_order","the_css_library_url","the_js_library_order","the_js_library_url","the_assistant_id","the_assistant_input","the_assistant_type","the_custom_function_slug","the_custom_function_code","the_custom_function_name"],o.inpage=100;const r=await be([i,o],e);t(r)}catch(i){console.error("error",i),i?.status===401&&Pe(),a(i)}})}async function al(){V.staticElement?.removeAttribute("draggable");const n=document.querySelector(".content-target"),e=n.querySelectorAll(".edited-widget-container");e?.length&&e.forEach(s=>{s.classList.replace("edited-widget-container","added-widget-container")});const t=await We(n,"div.mftsccs-marking-element");return n?.querySelector("#widget-details")?.remove(),(n?.querySelectorAll(".mftsccs-marking-rendered")).forEach(s=>{s.remove()}),t.innerHTML.trim()}async function Ui(){V.staticElement?.removeAttribute("draggable");const n=document.querySelector(".content-target"),e=await We(n,"div.mftsccs-marking-element");return n?.querySelector(".widget_selected")?.classList.remove("widget_selected"),n?.querySelector("#widget-details")?.remove(),e.innerHTML.trim()}async function tt(){const n=document.querySelector(".content-target");n?.querySelector("#widget-details")?.remove();const t=await We(n,"div.mftsccs-marking-element");return n?.querySelector(".widget_selected")?.classList.remove("widget_selected"),t.innerHTML.trim()}async function Et(){V.staticElement?.removeAttribute("draggable");const n=document.querySelector(".content-target")?.cloneNode(!0);n?.querySelector("#widget-details")?.remove();const a=(await We(n,"div.mftsccs-marking-element")).innerHTML.trim();return V.staticElement?.setAttribute("draggable","true"),a}async function Ut(n){V.staticElement?.removeAttribute("draggable");const e=document.getElementById(n)?.cloneNode(!0);e?.querySelector("#widget-details")?.remove();const i=(await We(e,"div.mftsccs-marking-element")).innerHTML.trim();return V.staticElement?.setAttribute("draggable","true"),i}const il=["image/jpeg","image/jpg","image/png","image/webp"],ol=["application/msword","application/vnd.ms-excel","application/vnd.ms-powerpoint","text/plain","application/pdf"],zi=async n=>{try{const e=new FormData;let t;if(ol.includes(n.type))e.append("file",n,n.name),t=await rl(e);else if(il.includes(n.type))e.append("image",n,n.name),t=await sl(e);else return{message:"Invalid File Format",success:!1};return t?.data?{message:"Upload Success",success:!0,url:t.data}:(alert("File Upload Failed"),{message:"File Upload Failed",success:!1})}catch(e){throw console.error(e),e}},sl=async(n,e="")=>{try{const t=await fetch(U.boomURL+"/api/Image/UploadImage",{method:"POST",body:n,headers:{Authorization:`Bearer ${e}`}});if(!t.ok){const a=t.headers.get("content-type");a&&a.includes("text/plain")&&console.info(t?.text());const i=await t?.text();return console.error(`${t.status} ${i}`),null}return await t.json()}catch(t){return console.error(t),null}},rl=async(n,e="")=>{try{const t=await fetch(U.boomURL+"/api/Image/UploadFile",{method:"POST",body:n,headers:{Authorization:`Bearer ${e}`}});if(!t.ok){const a=t.headers.get("content-type");a&&a.includes("text/plain")&&console.info(t.text());const i=await t.text();return console.error(`${t.status} ${i}`),null}return await t.json()}catch(t){return console.error(t),null}};async function ll(n=""){try{const e=await k();if(!e)return`
      <li class="list-unstyled">
        <p class="text-center my-3 text-secondary">No Public widget</p>
      </li>
    `;const t=await ii("public_widget","",!1,e.userId,4,999);let a=new M;a.typeConnection="the_widget_public_name",a.name="widgetPName";let i=new M;i.typeConnection="the_widget_name",i.name="widgetName";let o=new M;o.typeConnection="the_widget_description",o.name="widgetDescription";let s=new M;s.typeConnection="the_widget_thumbnail",s.name="widgetThumbnail";let r=new M;r.typeConnection="the_public_widget_s_widget",r.selectors=["the_widget_timestamp","the_widget_version"],r.name="widgetLevel",r.inpage=10,r.limit=!0,r.freeschemaQueries=[a,i,o,s];let l=new M;if(l.conceptIds=[t.id],l.outputFormat=se,l.name="top",l.freeschemaQueries=[r],n!=""){let u=new ze;u.name="filterName",u.search=n,u.type="the_name",u.operateon="widgetName",u.logicoperator="like";let c=new ze;c.name="filterPublicName",c.search=n,c.type="the_public_name",c.operateon="widgetPName",c.logicoperator="like",l.filters=[u,c],l.filterLogic="( filterName OR filterPublicName )"}return new Promise(u=>{me(l,"").subscribe(c=>{u(c)})})}catch(e){throw e}}async function cl(n=""){try{const e=await k();if(!e)return`
      <li class="list-unstyled">
        <p class="text-center my-3 text-secondary">No Folder widget</p>
      </li>
    `;const t=await ii("folder_widget","",!1,e.userId,4,999);let a=new M;a.typeConnection="the_widget_folder_name",a.name="widgetPName";let i=new M;i.typeConnection="the_widget_name",i.name="widgetName";let o=new M;o.typeConnection="the_widget_description",o.name="widgetDescription";let s=new M;s.typeConnection="the_widget_thumbnail",s.name="widgetThumbnail";let r=new M;r.typeConnection="the_folder_s_widget",r.selectors=["the_widget_timestamp","the_widget_version"],r.name="widgetLevel",r.inpage=10,r.limit=!0,r.freeschemaQueries=[a,i,o,s];let l=new M;if(l.conceptIds=[t.id],l.outputFormat=se,l.name="top",l.freeschemaQueries=[r],n!=""){let u=new ze;u.name="filterName",u.search=n,u.type="the_name",u.operateon="widgetName",u.logicoperator="like";let c=new ze;c.name="filterFolderName",c.search=n,c.type="the_folder_name",c.operateon="widgetPName",c.logicoperator="like",l.filters=[u,c],l.filterLogic="( filterName OR filterPublicName )"}return new Promise(u=>{me(l,"").subscribe(c=>{u(c)})})}catch(e){throw e}}class lt{static staticElementList}async function dl(n,e){const t=n?.target?.value,a=await k(),i=a?.userId,o=a?.token,s=await Y(e),u=(await rt(e,o))?.data?.the_widget?.the_widget_before_render?.[0]?.id;u&&await Ae(u);const c=await K("before_render",t,!1,i,4,999);await q(s,c,"before_render"),await O.SyncDataOnline(),new Ni().before_render()}async function ul(n,e){console.log("updateWidgetUpdate event",n),console.log("widgetId",e)}async function ml(n,e){const t=n?.target?.value,a=await k(),i=a?.userId,o=a?.token,s=await Y(e),u=(await rt(e,o))?.data?.the_widget?.the_widget_after_render?.[0]?.id;u&&await Ae(u);const c=await K("after_render",t,!1,i,4,999);await q(s,c,"after_render"),await O.SyncDataOnline();const g=document.getElementById("mountInput")?.value,p=document.getElementById("mountChildWidgetsInput")?.value,h=new Lt;h.componentDidMountFunction=g,h.addEventFunction=t,h.mountChildWidgetsFunction=p;const w=document.querySelector(".content-target"),b=await h.mount(w);console.log("appContentHTML",b)}async function gl(n,e){const t=n?.target?.value,a=await k(),i=a?.userId,o=a?.token,s=await Y(e),u=(await rt(e,o))?.data?.the_widget?.the_widget_mount_child?.[0]?.id;u&&await Ae(u);const c=await K("mount_child",t,!1,i,4,999);await q(s,c,"mount_child"),await O.SyncDataOnline()}class pl{widgetDocumentationModalHTML;constructor(){this.init()}init(){this.widgetDocumentationModalHTML=this.getHtml(),document.querySelector("body #app")?.insertAdjacentHTML("afterend",this.widgetDocumentationModalHTML)}getHtml(){return window.saveWidgetDocumentationEditor=wl,`
    ...
    `}}async function fl(n,e){const t=document.getElementById("documentation-view");await De(U.documentation_preview_widget,t,{currentWidgetId:e})}let wt,xn="",Rn,Un;async function yl(n,e){Rn=n,e==="preview"?new hl:new pl;const t=new M;t.typeConnection="the_widget_documentation",t.name="documentationText",t.selectors=["the_documentation_text"];const a=new M;a.typeConnection="the_widget_s_documentation",a.name="documentationBlank",a.selectors=["the_documentation_text","the_documentation_content","the_documentation_language","the_documentation_doc_title","the_documentation_folder","the_documentation_creator_email","the_documentation_created_by","the_documentation_content","the_documentation_type","the_documentation_s_doc_url","the_documentation_s_image_url","the_documentation_s_video_link","the_documentation_auth_type","the_documentation_bearer_token","the_documentation_method","the_documentation_method_url","the_documentation_username","the_documentation_password","the_documentation_s_json_list","the_documentation_api_script","the_documentation_api_body","the_documentation_code_editor","the_documentation_return"];const i=new M;i.typeConnection="the_documentation_s_json_list",i.name="documentationJSON",i.selectors=["the_json_list_key","the_json_list_value"],a.freeschemaQueries=[i];const o=new M;o.conceptIds=[Rn],o.freeschemaQueries=[t,a],o.inpage=100,o.outputFormat=se,await me(o,"").subscribe(async s=>{const r=s?.[0]?.data?.the_widget?.the_widget_documentation?.data?.the_documentation?.the_documentation_text?.data?.the_text||"";r&&(xn=r);const l=s?.[0]?.data?.the_widget?.the_widget_s_documentation;l?.length&&(xn=l?.map(c=>{const d=c?.data?.the_documentation,g=d?.the_documentation_type?.data?.the_type,m=d?.the_documentation_content?.data?.the_content,p=d?.the_documentation_creator_email?.data?.the_creator_email,h=d?.the_documentation_doc_title?.data?.the_doc_title,w=d?.the_documentation_method?.data?.the_method,b=d?.the_documentation_method_url?.data?.the_method_url,C=d?.the_documentation_bearer_token?.data?.the_bearer_token,T=d?.the_documentation_username?.data?.the_username,v=d?.the_documentation_password?.data?.the_password,y=d?.the_documentation_auth_type?.data?.the_auth_type,E=d?.the_documentation_s_json_list,L=d?.the_documentation_api_script?.data?.the_api_script,_=d?.the_documentation_api_body?.data?.the_api_body,S=d?.the_documentation_language?.data?.the_language,x=d?.the_documentation_return?.data?.the_return,W=d?.the_documentation_code_editor?.data?.the_code_editor,P=d?.the_documentation_s_doc_url,$=d?.the_documentation_s_image_url,B=d?.the_documentation_s_video_link;let N={type:g,content:m,creatorEmail:p,title:h};if(g==="blank")N={...N};else if(g==="api"){const ae=[];E?.length&&E?.forEach(X=>{ae.push({key:X?.data?.the_json_list?.the_json_list_key?.data?.the_key,value:X?.data?.the_json_list?.the_json_list_value?.data?.the_value})}),N={...N,method:w,methodURL:b,authType:y,username:T,password:v,bearerToken:C,json:ae,script:L,body:_}}else g==="function"&&(N={...N,language:S,return:x,codeEditor:W});const R=[],ne=[],de=[];return $?.length&&$?.forEach(ae=>{R.push(ae?.data?.the_image_url)}),B?.length&&B?.forEach(ae=>{ne.push(ae?.data?.the_video_link)}),P?.length&&P?.forEach(ae=>{de.push(ae.data?.the_doc_url)}),N={...N,imageList:R,linkList:de,videoList:ne},N})),Un=s?.[0]?.data?.the_widget?.the_widget_documentation?.id,e!=="preview"&&vl(r)}),e==="preview"?(await ce("widget-documentation-preview-modal"),fl(xn,n)):await ce("widget-documentation-modal")}async function wl(){if(wt){const n=wt.getData(),e=await H(Rn),a=(await k())?.userId;if(Un)await nt(Un,"the_documentation_text","text",n,a),await O.SyncDataOnline();else{const i=await F("documentation",a,{text:n});await G(e,i,"documentation"),await O.SyncDataOnline()}A.successfullToast("Documentation is saved."),wt.setData(n)}else console.error("Editor not initialized"),A.errorToast("Documentation couldn't saved.")}function vl(n){const e=document.querySelector("#documentation-editor");e&&jo.create(e,{licenseKey:"GPL"}).then(t=>{wt=t;const a=n;wt.setData(a)}).catch(t=>{console.error("Error initializing CKEditor:",t)})}class bl{constructor(){this.init()}init(){document.getElementById("btn-take-tour")?.addEventListener("click",t=>{if(t.target.matches(".btn-tour")){const a=t.target.dataset.tourStatus;this.startTour(a)}})}startTour(e){const t=new Po.Tour({defaultStepOptions:{classes:"wico",scrollTo:!0,cancelIcon:{enabled:!0}},useModalOverlay:!0}),a=[{classes:"back-button",text:"Back",action:t.back},{classes:"next-button",text:"Next",action:t.next}];t.addStep({id:"welcome",title:"👋 Welcome to Widget Conceptualizer",text:["This short tour will walk you through the essentials. Let's begin. Start building widgets today!"],buttons:[{text:"Remind me later",classes:"back-button",action:t.complete},{text:"Next",classes:"next-button",action:()=>{t.next()}}]}),t.addStep({id:"step-create-widget",title:"Create a New Widget",text:["Start by creating a new widget."],classes:"onboarding-boomconsole",highlightClass:"highlight",attachTo:{element:".wico_header-section",on:"bottom-start"},buttons:a}),t.addStep({id:"step-widget-panel",classes:"tour-widget-panel",title:"Workspace Area",text:"This is your creative canvas. Drag and drop elements, build widgets, apps, or full pages—right in the workspace.",attachTo:{element:".content-target",on:"top"},buttons:a}),t.addStep({id:"step-builder-meu",title:"Builder Menu",text:"This menu provides essential navigation tools. Use it to manage projects, access assets, open pages, and explore saved widgets.",attachTo:{element:".sidebar-collapsed",on:"left"},buttons:a}),t.addStep({id:"step-properties",title:"Properties Panel",text:"Adjust Styling, add properties like layout, colors, fonts, and more.",attachTo:{element:()=>{const i=document.querySelector("#tab-container .tab button:nth-child(2)"),o=new Event("click",{bubbles:!0,cancelable:!0});return i.dispatchEvent(o),".right-aside"},on:"left"},buttons:a}),t.addStep({id:"step-design-code-mode",title:"Design & Code Modes",text:[`
        ...
        `).join(""):'<li class="list-unstyled"><p class="text-center my-3 text-secondary">No Saved Assets</p></li>'}searchWidgets(e,t){t||(t=`#${e.target?.dataset?.id}`||"");const i=e.target.value.toLowerCase();document.querySelectorAll(`${t} li`).forEach(s=>{const r=(s.textContent||"").toLowerCase();s.style.display=r.includes(i)?"":"none"})}searchPublicWidgets(e){const a=e.target.value.toLowerCase();Jn(a).then(i=>{Nn.navbar.setPublicWidgets(i),this.updatePopupMenu("publicWidgets",i)})}async responsiveSidebar(){const e={mainItems:[{id:"elements",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            `,t.onclick=()=>{new bl().startTour(this._loginDetailObject?.tourStatus)}):e?.link?t.innerHTML=`
      ...
      `;const e=n?.entityId;await qe();const t=new ze;t.type="the_public_widget",t.search="",t.operateon="public",t.name="publicfilter",t.logicoperator="=";const a=new M;a.typeConnection="the_public_widget_s_widget",a.freeschemaQueries=[],a.name="public",a.reverse=!0;const i=new M;i.typeConnection="the_widget_recent",i.name="copywidgets",i.selectors=["the_widget","the_widget_name","the_widget_timestamp","the_widget_version","the_widget_origin"],i.freeschemaQueries=[a];const o=new M;o.typeConnection="the_entity_s_widget",o.name="mywidgets",o.selectors=["the_widget","the_widget_name","the_widget_timestamp","the_widget_recent"],o.freeschemaQueries=[i];const s=new M;return s.conceptIds=[e],s.freeschemaQueries=[o],s.inpage=100,s.outputFormat=se,await new Promise((l,u)=>{me(s,"").subscribe(async c=>{console.log("widget data pub",c);const d=c?.[0]?.data?.the_entity?.the_entity_s_widget||[];if(!d.length)return l(`
              <li class="list-unstyled">
                <p class="text-center my-3 text-secondary">No saved widget</p>
              </li>
  ...
  <div id="spinner-${p.id}" class="spinner-border spinner-border-sm text-primary position-absolute top-50 start-50 translate-middle d-none" role="status">
    <span class="visually-hidden">Loading...</span>
              ...
              `).join("");l(m)})})}catch(n){console.error("Error in getMyWidgetsList:",n),A.errorToast(n?.message||"An error occurred while fetching widgets"),n?.status===401&&Pe()}}async function He(){try{const n=document.getElementById("builder-workarea");if(!n)return;n.innerHTML="",await je(f.widgetTree);const e=await Ce(f.widgetTree,n);f.selectedStaticWidgetTreeInfo={widgetTree:f.widgetTree,isChildWidget:!1,childWidgetIndex:0},await Z(f.widgetTree,!1,e),ge(),ve()}catch(n){throw new Error(`error loading widget with widget tree ${n.message}`)}}async function Va(n){const e=n?JSON.parse(n):"";if(e)try{const t=document.getElementById("builder-workarea");t.innerHTML="";const a=await Ce(e,t),i=document.getElementById("select-box");i.style.display="none";const o=document.getElementById("element-attributes");o.innerHTML=`
      <div class="row">
        <div class="text-center my-3 text-secondary">
          <p>Select an element to view and edit its attributes</p>
        </div>
      </div>
    `,await Z(e,!1,a),ge(),ve()}catch(t){throw new Error(`error loading widget with widget tree ${t.message}`)}}async function at(n,e,t){try{if(n?.preventDefault(),n?.stopPropagation(),Wt.collapseNavbar(),await qe(),await Re(n),t&&typeof t!="number"||Number.isNaN(t)||e&&typeof e!="number"||Number.isNaN(e)){A.infoMessageToast("Widget id is in different format. Please check and update",4),Re(n);return}Mt(`?widget-id=${t||e}`);const a=document.getElementById("preview-btn");a&&a.setAttribute("data-widgetid",e.toString()),Cl(),Ll(),na(),Pi(),await Mi();let i=aa();i.classList.contains("fspage")&&i.classList.remove("fspage");const s=(await k())?.token;let r=null;n&&(r=await ke(e,s));let l=await ue(r?r.widgetId:e);const u=document.getElementById("widgetNameValue");u&&l?.name&&(u.value=l?.name);const c=document.getElementById("widget-builder");c&&l?.name&&(c.textContent="Widget Builder Panel: "+l?.name,c.setAttribute("title",`Widget Builder Panel: ${l?.name}`)),await je(l);const d=await Ce(l,i);f.widgetTree=l,f.selectedStaticWidgetTreeInfo={widgetTree:f.staticWidgetTree,isChildWidget:!1,childWidgetIndex:0},await f.updatePublishedStatus(),await Z(l,!1,d,!0),await As(r?.widgetId??e);const g=document.getElementById("preview-btn");return g.setAttribute("onclick","previewWidget(event)"),g.setAttribute("data-widgetid",`${e}`),g.removeAttribute("data-pageid"),console.log("load StaticWidgetClass.staticWidgetTree ->",f.staticWidgetTree),Vn(),j.enableWidgetButtons(),j.initializeWidgetVersions(t||e,l?.version?l.version.toString():"original",l?.timestamp),D.renderActionHistory(),D.updateActionHistories(),ge(),ve(),ia(),""}catch(a){console.error(a),A.errorToast(a?.message,4),Vn(),Re(n)}}function Cl(){const e=document.getElementById("tab-container")?.querySelector("button[data-tab-id='wico-tab-pageInfo']");e&&(e.style.display="none");const t=document.getElementById("page-properties");t&&(t.style.display="none");const a=document.querySelector("button[data-tab-id='wico-tab-navigator']"),i=document.querySelector(`button[data-tab-id='${zt.staticTabName}']`);zt.staticTabName==="wico-tab-pageInfo"&&i.style.display==="none"?a&&a.click():i?i.click():a&&a.click()}function Ll(){document.title="Widget Conceptualizer",St("description","Widget Conceptualizer"),St("keywords","widget conceptualizer, widget conceptualiser, widget builder, widget, conecept, connection")}async function xl(n,e){n.stopPropagation();try{const t=confirm("Do you want to delete the Widget?");if(await qe(),t){A.infoMessageToast("Deleting the widget...",0),await Ur(e),await j.renderSavedWidgets();const a=new URLSearchParams(window.location.search).get("widget-id");return a&&parseInt(a)===e&&await Re(n),document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget Deleted Successfully"),"Widget is deleted successfully!"}else return}catch(t){document.querySelector(".infoMessageToast")?.remove(),A.successfullToast("Widget Deleted Successfully"),A.errorToast(t.message?t.message:"Failed to delete widget"),console.error("Failed to delete widget:",t)}}async function Al(n,e){n.stopPropagation();const t=document.getElementById("postWidgetModal");t&&t.remove();const a=await k(),i=a?.entityId===101651686||a?.entityId===101279491,o=document.createElement("dialog");o.id="postWidgetModal",o.className="col-md-6 a-dialog",o.innerHTML=`
    <div class="a-dialog-header d-flex justify-content-between">
  ...
  `,document.body.appendChild(o);const s=o.querySelector("#pasteArea"),r=o.querySelector("#widgetThumbnail"),l=o.querySelector("#imagePreview img"),u=o.querySelector("#imagePreview"),c=o.querySelector("#pasteText");function d(p){const h=new FileReader;h.onload=w=>{l&&w.target?.result&&(l.src=w.target.result,u.classList.remove("d-none"),c.classList.add("d-none"))},h.readAsDataURL(p)}r?.addEventListener("change",p=>{const h=p.target.files?.[0];h&&d(h)});function g(p){const h=p.clipboardData?.items;if(h){for(let w=0;w<h.length;w++)if(h[w].type.indexOf("image")!==-1){const b=h[w].getAsFile();if(b&&r){const C=new DataTransfer;C.items.add(b),r.files=C.files,d(b);break}}}}s?.addEventListener("paste",p=>g(p)),o.addEventListener("paste",p=>g(p)),o.querySelector("#post-widget-form")?.addEventListener("submit",p=>{p.preventDefault(),Wl(e,o)}),o.showModal()}async function Wl(n,e){const t=document.querySelector(`#spinner-${n}`),a=e.querySelector('button[type="submit"]');try{a&&(a.disabled=!0,a.textContent="Posting...",A.infoMessageToast("Posting Widget to Public...",0)),t&&t.classList.remove("d-none"),await qe();const i=await k(),o=document.getElementById("widgetPublicName").value,s=document.getElementById("widgetDescription").value,r=document.getElementById("widgetThumbnail");if(!r?.files?.length)throw console.error("File validation failed:",{inputExists:!!r,filesLength:r?.files?.length}),new Error("Please provide a thumbnail image");const l=r.files?.[0];if(!l||!r.value)throw new Error("Please provide a thumbnail image");const u=await zi(l);if(!u.success)throw new Error("Failed to upload thumbnail");const c=await ke(n,i.token);if(c&&(await Ne(c.widgetId,"the_public_widget_s_widget",!0)).length){document.querySelector(".infoMessageToast")?.remove(),A.infoMessageToast("Widget is already public.");return}const d=document.getElementById("postAsTemplate")?.checked;let g=null;if(c)g=await H(c.widgetId);else{const C=await Y(n);g=await j.createWidgetCopy(C,i.userId,i.token)}const m=await K("public_name",o,!1,i.userId,4,999),p=await K("description",s,!1,i.userId,4,999),h=await K("thumbnail",u.url||"no attachment",!1,i.userId,4,999);await q(g,p,"description"),await q(g,h,"thumbnail"),await q(g,m,"public_name");const w=await K("public_widget","",!1,i.userId,4,999);if(await q(w,g,"s_widget"),d){const T=await K("template_name",o,!1,i.userId,4,999),v=await K("template_thumbnail",u.url||"no attachment",!1,i.userId,4,999);await q(g,v,"template_thumbnail"),await q(g,T,"template_name");const y=await K("template_widget","",!1,i.userId,4,999);await q(y,g,"s_widget")}await O.SyncDataOnline(),await j.renderPublicWidgets(),await j.renderSavedWidgets(),d&&await j.renderTemplateLayouts(),e.close(),document.querySelector(".infoMessageToast")?.remove(),setTimeout(()=>{A.successfullToast(`Widget Posted to Public${d?" and Templates":""}`)},300)}catch(i){console.error("Error posting widget:",i),document.querySelector(".infoMessageToast")?.remove(),A.errorToast("Failed to post widget"),a&&(a.disabled=!1,a.textContent="Post Widget")}finally{t&&t.classList.add("d-none")}}async function Jn(n=""){try{const e=await k();if(!e)return`
    ...
    `}catch(e){console.error("error",e),e?.status===401&&Pe()}}async function Il(n=""){try{const e=await k();if(!e)return`
      ...
      `}const s=(await Promise.all(i?.map(async l=>{const c=(await Y(l.id)).userId===e.userId,d=l.description?l.description.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\t/g,"\\t").replace(/\f/g,"\\f").replace(/\v/g,"\\v"):"";return`
        ...
        `;const i=a.querySelector("form");return i&&i.addEventListener("submit",o=>Gi(o,"",e)),document.querySelector("body #app")?.appendChild(a),ce("rename-widget-dialog"),"OPENED"}catch(t){console.error("Failed to rename widget:",t)}}async function Gi(n,e="",t){n.preventDefault();let a="";if(e)a=e;else{const l=new FormData(n?.target);if(a=Object.fromEntries(l)?.widgetName,!a?.trim()){const c=n.target.querySelector("#widgetName");c?.focus(),c.style.border="2px solid red",c.style.outline="none",c.addEventListener("input",()=>{c.style.border=""});return}}const o=(await k())?.userId,s=document.getElementById("rename-widget-dialog"),r=s?.querySelector('button[type="submit"]');r.textContent="Saving";try{await qe();const l=await nt(t,"the_widget_name","name",a,o);await O.SyncDataOnline();const u=s?.querySelector("input"),c=s?.querySelectorAll("button");if(c&&c.forEach(d=>{d.disabled=!0}),u&&(u.disabled=!0),l){j.renderSavedWidgets(),_e("rename-widget-dialog"),A.successfullToast("Widget Renamed Successfully");const d=new URLSearchParams(window.location.search).get("widget-id");if(t===Number(d)){const g=document.getElementById("widget-builder");g.textContent=`Widget Builder Panel: ${a}`}return"widget Renamed successfully"}}catch(l){A.errorToast("Widget Rename Failed"),console.error("An error occurred during the rename operation:",l)}}const wa=async(n,e,t=!1)=>{const a=await rt(n,e),i=a?.data?.the_widget,o=i?.the_widget_name?.[0]?.data?.the_name,s=i?.the_widget_html?.[0]?.data?.the_html,r=i?.the_widget_clean?.[0]?.data?.the_clean,l=i?.the_widget_css?.[0]?.data?.the_css,u=i?.the_widget_js?.[0]?.data?.the_js,c=i?.the_widget_timestamp?.[0]?.data?.the_timestamp,d=i?.the_widget_widget?.[0].id,g=i?.the_widget_type?.[0]?.data?.the_type,m=i?.the_widget_after_render?.[0]?.data?.the_after_render,p=i?.the_widget_before_render?.[0]?.data?.the_bthe_widget_before_render,h=i?.the_widget_update?.[0]?.data?.the_update,w=i?.the_widget_mount_child?.[0]?.data?.the_mount_child;let b=[];const C=i?.the_widget_s_child;return C?.length&&(b=await Promise.all(C?.map(async v=>{const y=v?.data?.the_child_widget,E=y?.the_child_widget_type?.[0]?.data?.the_type,L=y?.the_child_widget_wrapper?.[0]?.data?.the_wrapper,_=y?.the_child_widget_info?.[0]?.data?.id?y?.the_child_widget_info?.[0]?.data?.id:y?.the_child_widget_parent?.[0]?.data?.the_parent,S=await wa(Number(_),e,t);return{id:v?.id,type:E,parent:_,wrapper:L,widget:S}}))),{id:a?.id,name:o,html:s,cleanHtml:r,css:l,js:u,timestamp:c,widgetId:d,typeValue:g,addEvent:m,onMount:p,onUpdate:h,mountChildWidgets:w,childs:b}},Pl=async n=>{document.getElementById("assets-upload-loader")?.classList.remove("d-none");const e=await k(),t=e?.entityId,a=e?.userId,i=await Y(t);try{if(n.target?.files?.length>0){const o=[];for(let l=0;l<n.target?.files?.length;l++){const u=n.target?.files[l];if(u.size>2*1024*1024){alert("Max Allowed Size is 2MB");continue}o.push(zi(u))}const s=await Promise.all(o);for(let l=0;l<s.length;l++){const u=s[l];u.success||alert("Some file failed: "+u.message);const c=await K("the_asset",u.url||"",!1,a,4);await q(i,c,"s_asset")}await O.SyncDataOnline(),A.successfullToast(`Asset${s.length>1?"s":""} uploaded successfully`),new El().setupAssetListener()}else{alert("No file found");return}}catch(o){throw console.error(o),o}document.getElementById("assets-upload-loader")?.classList.add("d-none")},$l=async(n,e)=>{if(confirm("Are you sure you want to delete this asset?"))try{n.target.closest(".asset-item").remove(),await Ae(e),A.successfullToast("Asset deleted successfully")}catch(a){console.error("Error deleting asset:",a),A.errorToast("Failed to delete asset")}};function Bl(n){const e=document.getElementById(n);if(e){e.value="";const t=new Event("keyup");e.dispatchEvent(t),Qi(n)}}function Qi(n){const e=document.getElementById(n),t=document.getElementById(`${n}-clear`);e&&t&&(t.style.display=e.value?"block":"none",t.style.cursor=e.value?"default":"")}async function Nl(n,e,t,a){n.preventDefault(),n.stopPropagation();const i=a.replace(/\\n/g,`
`).split(`
`).join("<br>"),o=`
  ...
  `,s=document.getElementById("widget-detail-modal");s&&s.remove(),document.querySelector("body #app")?.insertAdjacentHTML("beforeend",o),ce("widget-detail-modal")}window.viewPublicWidgetDetails=Nl;window.openCSSEditor=Tt;class Yi{editorView=null;styleElement=null;editorInitialized=!1;constructor(){document.querySelectorAll(".widgetStyle").forEach(e=>e.remove()),this.styleElement=document.createElement("style"),this.styleElement.classList.add("widgetStyle"),document.head.insertAdjacentElement("beforeend",this.styleElement)}updateCSS(e){if(this.styleElement){let t=function(i){if(!i)return;const{wrapper:o}=i,s=o&&o!=="0"?`#${o}`:".content-target";a=a+`${s} { ${i.css} }`,i.children.forEach(r=>{t(r)})},a="";f.selectedStaticWidgetTreeInfo.widgetTree.css?f.selectedStaticWidgetTreeInfo.widgetTree.css=e:(f.widgetTree.children.length===0||f.selectedStaticWidgetTreeInfo.widgetTree.widgetId===f.widgetTree.widgetId)&&(f.widgetTree.css=e),t(f.widgetTree),this.styleElement.textContent=a}}async getWidgetHtml(e){let t=[];e.forEach(a=>{a.classList.forEach(i=>{t.push(i)})}),this.insertCSS(t)}async getHtml(){return window.getEditorContent=this.getEditorContent.bind(this),""}handleTab=e=>{const{state:t,dispatch:a}=e,{selection:i}=t;return i.ranges.length===0?!1:(a({changes:{from:i.ranges[0].from,to:i.ranges[0].to,insert:"  "},scrollIntoView:!0}),!0)};async initializeEditor(){const e=document.getElementById("editor-container-css-split");e&&(e.innerHTML="",this.editorView=new te({doc:"/* Write your CSS here */",extensions:[it,ot,Mo(),tn(),te.lineWrapping,Le.tabSize.of(2),Le.allowMultipleSelections.of(!0),te.theme({"&":{fontSize:"14px"},".cm-content":{padding:"10px 0"},".cm-line":{padding:"0 9px"}}),nn.of([{key:"Tab",run:this.handleTab,preventDefault:!0}]),te.updateListener.of(async t=>{if(t.docChanged){const a=this.editorView?.state.doc.toString()||"";this.updateCSS(a)}})],parent:e}),this.editorView&&navigator.userAgent.toLowerCase().includes("firefox")&&this.editorView.scrollDOM.addEventListener("scroll",()=>{this.editorView?.requestMeasure()}))}getEditorContent(){return this.editorView?this.editorView.state.doc.toString():""}async insertCSS(e){if(this.editorInitialized||await this.initializeEditor(),this.editorView){for(const t of e)if(this.editorView){const{state:a,dispatch:i}=this.editorView;i({changes:{from:0,to:a.doc.length,insert:`.${t} {}`},scrollIntoView:!0})}}else console.error("Editor view is null. Ensure initializeEditor() has been called.")}}const Ra=async n=>{const e=new oi,t=Dl(n);if(Object.keys(t).length>0){const a=await e.validateField(t),i=await Gn(a),o=Gn(i);return Ol(n,o)}},jl=async n=>{const t=await new oi().validateField(n);return Object.keys(t).length>0?{status:!1,details:Gn(t)}:{status:!0}},Dl=n=>{const e={fieldName:"",value:null,fieldType:null,dataType:null,pattern:null,conceptType:null,maxLength:null,minLength:null,maxValue:null,minValue:null,accept:null,file:null,required:!1,isUnique:!1},t=n?.attributes;if(Array.isArray(t))t.forEach(a=>{const i=Hl(a);switch(a.name){case"name":e.fieldName=i||"";break;case"value":e.value=i||null;break;case"fieldtype":e.fieldType=i?i.trim():null;break;case"pattern":e.pattern=i||null;break;case"datatype":e.dataType=i?i.trim():null;break;case"typeconcept":e.conceptType=i||null;break;case"maxlength":e.maxLength=i?parseInt(i):null;break;case"minlength":e.minLength=i?parseInt(i):null;break;case"max":e.maxValue=i?parseInt(i):null;break;case"min":e.minValue=i?parseInt(i):null;break;case"accept":e.accept=i||null;break;case"file":e.file=i||null;break;case"required":e.required=i===!0;break;case"unique":e.isUnique=i===!0;break}});else throw console.error('attributesData["attributes"] is not an array',n.attributes),new Error('Invalid input data format: attributesData["attributes"] should be an array.');return e},Hl=n=>{switch(n.type){case"boolean":return n.value==="on";case"array":return n.selected||null;case"string":return n.value||null;default:return null}},Gn=n=>({datatype:n.dataType,pattern:n.pattern,max:n.maxValue,min:n.minValue,minlength:n.minLength,maxlength:n.maxLength,accept:n.accept,file:n.file,required:n.required,unique:n.unique}),Ol=(n,e)=>(n.attributes.forEach(t=>{const a=e[t.name];t.validationStatus=a?"invalid":"valid",t.validationErrorMessage=a||""}),n),ql=n=>({fieldName:n.getAttribute("name"),value:n instanceof HTMLInputElement?n.value:null,fieldType:n.getAttribute("fieldtype"),dataType:n.getAttribute("datatype"),pattern:n.getAttribute("pattern"),conceptType:n.getAttribute("typeconcept"),maxLength:n.getAttribute("maxlength"),minLength:n.getAttribute("minlength"),minValue:n.getAttribute("min"),maxValue:n.getAttribute("max"),file:n.hasAttribute("file"),accept:n.hasAttribute("accept"),required:n.hasAttribute("required"),isUnique:n.getAttribute("unique")==="on"});async function Ki(n){let e=n.nextElementSibling;(!e||!e.classList.contains("error-container"))&&(e=document.createElement("div"),e.className="error-container",n.parentNode?.insertBefore(e,n.nextSibling)),e.innerHTML="";const t=ql(n),a=await jl(t);try{if(a.status)n.classList.remove("invalid"),n.classList.add("valid");else if(n.classList.remove("valid"),n.classList.add("invalid"),a.details&&typeof a.details=="object"){const i=document.createElement("span");i.className="error-message",i.style.color="red",i.style.fontSize="12px";const o=Object.values(a.details).filter(Boolean);i.innerHTML=o.join("<br>"),e.appendChild(i)}}catch(i){console.error("Validation error:",i);const o=document.createElement("span");o.className="error-message",o.style.color="red",o.textContent="Validation failed. Please try again.",e.appendChild(o)}}var Ze=(n=>(n.STYLE="style",n.BOOLEAN="boolean",n.FORM="form",n.SPECIAL="special",n))(Ze||{});const Fl=new Map([["button",["button","submit","reset"]],["input",["button","checkbox","color","date","datetime","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"]]]),va=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a"],ba=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var"],Jt=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Vl=["p","h1","h2","h3","h4","h5","h6","div","span","td","th","label","li","button","a","strong","em","mark","small","sub","sup","blockquote","code","pre","b","i","address","footer","header","section","article","nav","aside","details","summary","time","var","del","ins","cite","q","dfn","abbr","bdi","bdo","s","u","kbd","samp","output","progress","meter"],Gt=["div","p","h1","h2","h3","h4","h5","h6","span","a","strong","em","b","i","code","abbr","acronym","mark","small","big","sub","sup","q","cite","dfn","var","s","u","time","bdi","bdo","ruby","rt","rp","button","label","textarea","input","select","option","blockquote"],we=new Map([["height",{property:"height",needsUnit:!0}],["width",{property:"width",needsUnit:!0}],["margin",{property:"margin",needsUnit:!0}],["padding",{property:"padding",needsUnit:!0}],["background-color",{property:"backgroundColor",needsUnit:!1}],["Background Color",{property:"backgroundColor",needsUnit:!1}],["bg-color",{property:"backgroundColor",needsUnit:!1}],["color",{property:"color",needsUnit:!1}],["Color",{property:"color",needsUnit:!1}],["font-size",{property:"fontSize",needsUnit:!0}],["border",{property:"border",needsUnit:!1}],["float",{property:"float",needsUnit:!1}],["Alignment",{property:"textAlign",needsUnit:!1}],["Font Family",{property:"fontFamily",needsUnit:!1}],["Font Weight",{property:"fontWeight",needsUnit:!1}],["Font Size",{property:"fontSize",needsUnit:!1}],["Minimum-Height",{property:"minHeight",needsUnit:!1}],["Minimum-Width",{property:"minWidth",needsUnit:!1}],["Maximum-Height",{property:"maxHeight",needsUnit:!1}],["Maximum-Width",{property:"maxWidth",needsUnit:!1}],["Opacity",{property:"opacity",needsUnit:!1}],["Text Transform",{property:"textTransform",needsUnit:!1}],["Line Height",{property:"lineHeight",needsUnit:!1}],["Letter Spacing",{property:"letterSpacing",needsUnit:!1}]]),Rl=new Set(["disabled","required","readonly","checked","selected","multiple","autofocus","hidden"]),Ul=new Set(["value","placeholder","pattern","min","max","step","maxlength","name","type","src","href","target","alt"]),zl=new Set(["elementContent","className","id"]),Zi=new Map([["method",["get","post"]],["target",["_blank","_self","_parent","_top"]],["autocomplete",["on","off"]],["enctype",["application/x-www-form-urlencoded","multipart/form-data","text/plain"]],["rel",["alternate","author","bookmark","external","help","license","next","nofollow","noreferrer","noopener","prev","search","tag"]],["align-items",["start","center","end"]],["text-align",["left","center","right"]],["loading",["eager","lazy"]],["wrap",["soft","hard"]],["float",["none","left","right"]],["font family",["Arial","Helvetica","Times New Roman","Courier New","Georgia","Verdana","sans-serif"]],["font weight",["normal","bold","100","200","300","400","500","600","700","800","900"]],["text transform",["none","capitalize","uppercase","lowercase"]]]);function pt(n){return n.toLowerCase()==="type"?!0:Zi.has(n.toLowerCase())}function Pt(n,e,t){const a=n.toLowerCase();if(a==="type"){const i=t?Fl.get(t.toLowerCase())||[]:[];return e&&e.includes(",")?e.split(","):i}return Zi.get(a)||[]}class fn{the_params;widgetProperties=[];categoryMap={General:["id","className","elementContent","onclick","type","name","disabled","value"],Display:["Background Color","background-color","display","visibility","Opacity","position","z-index","float"],Typography:["Color","color","Alignment","Font Family","Font Weight","Font Size","Text Transform","Line Height","Letter Spacing"],Size:["Height","height","Width","width","Minimum-Height","Minimum-Width","Maximum-Height","Maximum-Width"],Spacing:["margin","padding","Margin","Padding"],Borders:["border-style","border-width","border-color","border-radius"],Colors:["bg-color","Background Color","background-color"],Other:[]};constructor(e=null){this.the_params=e,window._attributeService=Do}async initializeView(){const e=document.querySelector(".right-aside");e&&(e.innerHTML=await this.getHtml())}openTab(e,t){zt.staticTabName=t;let a,i,o=document.getElementsByClassName("tabcontent");for(a=0;a<o.length;a++)o[a].style.display="none";for(i=document.getElementsByClassName("tablinks"),a=0;a<i.length;a++)i[a].className=i[a].className.replace(" active","");const s=document.getElementById(t);s.style.display="block",e.currentTarget.className+=" active"}initializeTabs(){const e=document.getElementsByClassName("tablinks");let t=this;for(let i=0;i<e.length;i++)e[i].addEventListener("click",function(o){const s=e[i].getAttribute("data-tab-id");t.openTab(o,s)});const a=document.querySelector(`button[data-tab-id='${zt.staticTabName}']`);a?a.click():e[0].click()}sortAttributes(e){return e.sort((t,a)=>{if(!t?.name||!a?.name)return 0;const i=this.findAttributeInMap(t.name),o=this.findAttributeInMap(a.name);if(i==="Other"&&o!=="Other")return 1;if(i!=="Other"&&o==="Other")return-1;if(i===o){const s=this.categoryMap[i].findIndex(l=>l.toLowerCase()===t.name.toLowerCase()),r=this.categoryMap[o].findIndex(l=>l.toLowerCase()===a.name.toLowerCase());return s-r}return 0})}getCategoryForAttribute(e){if(!e)return"General";const t=e.toLowerCase();for(const[a,i]of Object.entries(this.categoryMap))if(a!=="Other"&&i.some(o=>o.toLowerCase()===t))return a;return"Other"}findAttributeInMap(e){return this.getCategoryForAttribute(e)}setAttributes(e,t){setTimeout(()=>{const a=document.getElementById("element-attributes");if(!a){this.setAttributes(e,t);return}a.innerHTML="";const i=document.createElement("div");if(i.className="row",a.appendChild(i),!e){i.innerHTML="";return}(async()=>await Ra(e))().then(()=>{if(e?.attributes&&e?.attributes?.length){const s=this.sortAttributes(e.attributes),r={};s.forEach(u=>{const c=this.getCategoryForAttribute(u.name);r[c]||(r[c]=[]),r[c].push(u)});let l="";Object.entries(r).forEach(([u,c])=>{const d=c.map(m=>{let p="";if(m.name.toLowerCase()==="float")p=`
                ...
                `;else if(m.name==="Alignment"){const h=e?.tag?.toLowerCase();va.includes(h)&&(p=`
                  ...
                  `)}else if(m.name==="Font Family"){const h=e?.tag?.toLowerCase();if(ba.includes(h)&&pt(m.name)){const b=Pt(m.name,m.value,e?.tag).map(C=>{const T=C.toLowerCase()===(m?.value||"").replace(/"/g,"").trim().toLowerCase();return`<option value="${C}" ${T?"selected":""}>${C}</option>`}).join("");p=`
                      <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                        <option value="">Select Font Family</option>
                        ${b}
                      </select>
                    `}}else if(m.name==="Font Weight"){const h=e?.tag?.toLowerCase();if(Jt.includes(h)&&pt(m.name)){const b=Pt(m.name,m.value,e?.tag).map(C=>{const T=C.toLowerCase()===(m?.value||"").replace(/"/g,"").trim().toLowerCase();return`<option value="${C}" ${T?"selected":""}>${C}</option>`}).join("");p=`
                      <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                  ...
                  <div class="col-12 my-1 hidden">
                    ...
                    >${m?.value||""}</textarea>`;else if(pt(m.name)){const w=Pt(m.name,m.value,e?.tag).map(b=>`<option value="${b}" ${b===m?.value?"selected":""}>${b}</option>`).join("");p=`
                    <select class="form-select" onchange="updateElementAttribute(event, '${t}', ${e?.id})">
                      <option value="">Select ${m.name}</option>
                      ${w}
                    </select>
